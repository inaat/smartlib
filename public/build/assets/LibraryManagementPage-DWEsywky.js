import { d as defineComponent, r as ref, o as onMounted, a as createElementBlock, b as createBaseVNode, l as createCommentVNode, f as createVNode, n as normalizeClass, u as unref, t as toDisplayString, F as Fragment, j as renderList, z as withModifiers, p as withDirectives, v as vModelText, h as createBlock, B as vModelCheckbox, X as adminAPI, i as createTextVNode, w as withCtx, g as resolveComponent, k as openBlock } from "./main-DKJzpCzk.js";
...
const _hoisted_34 = { class: "flex items-center space-x-6 mt-1" };
const _hoisted_35 = { class: "w-20 h-20 rounded-lg border border-gray-250 bg-gray-50 overflow-hidden flex items-center justify-center flex-shrink-0" };
const _hoisted_36 = ["src"];
const _hoisted_37 = { class: "md:col-span-2" };
const _hoisted_38 = { class: "relative" };
const _hoisted_39 = { class: "flex items-center space-x-6 h-full pt-6" };
const _hoisted_40 = { class: "flex items-center space-x-2 cursor-pointer group" };
const _hoisted_41 = { class: "relative flex items-center" };
const _hoisted_42 = { class: "flex items-center space-x-2 cursor-pointer group" };
const _hoisted_43 = { class: "relative flex items-center" };
const _hoisted_44 = { class: "flex items-center space-x-3 pt-6 border-t border-gray-100" };
            ...
            createBaseVNode("form", {
                  ...
                  createBaseVNode("div", _hoisted_34, [
                    createBaseVNode("div", _hoisted_35, [
                      adminPhotoPreview.value || form.value.photo_url ? (openBlock(), createElementBlock("img", {
                        ...
                        class: "w-full h-full object-cover",
                        alt: "Library preview"
                      }, null, 8, _hoisted_36)) : (openBlock(), createBlock(unref(Building2), {
                        key: 1,
                        class: "w-8 h-8 text-gray-350"
                      }))
                    ]),
              ...
              createBaseVNode("div", _hoisted_44, [
                createBaseVNode("button", {
                  ...
                  saving.value ? (openBlock(), createElementBlock("span", _hoisted_46)) : createCommentVNode("", true),
                  createBaseVNode("span", _hoisted_47, toDisplayString(saving.value ? "Saving..." : isEditing.value ? "Update Library" : "Create Library"), 1)
                ], 8, _hoisted_45),
                createBaseVNode("button", {
                  type: "button",
