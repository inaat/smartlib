import { d as defineComponent, x as useAuth, r as ref, c as computed, o as onMounted, a as createElementBlock, b as createBaseVNode, F as Fragment, l as createCommentVNode, u as unref, f as createVNode, i as createTextVNode, t as toDisplayString, j as renderList, n as normalizeClass, C as useRouter, k as openBlock } from "./main-BV94XoeK.js";
...
const _hoisted_37 = { class: "text-sm font-semibold text-slate-800 tracking-tight uppercase leading-none mb-3.5" };
...
const _hoisted_40 = { class: "text-3xl font-bold text-slate-900" };
const _hoisted_41 = { class: "ml-1 text-slate-400 text-xs font-semibold" };
const _hoisted_42 = { class: "text-xs font-medium text-slate-500 mt-2.5 leading-none" };
const _hoisted_43 = {
  key: 0,
...
const _hoisted_46 = { class: "ml-3 text-xs text-slate-600 font-medium leading-normal text-left" };
...
const SubscriptionPage = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-dc14ce25"]]);
export {
