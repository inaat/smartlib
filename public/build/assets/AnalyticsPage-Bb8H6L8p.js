import { d as defineComponent, r as ref, D as computed, o as onMounted, c as createElementBlock, b as createBaseVNode, f as createVNode, n as normalizeClass, u as unref, F as Fragment, h as renderList, j as createTextVNode, m as createCommentVNode, a1 as ownerAPI, k as createBlock, l as resolveDynamicComponent, t as toDisplayString, I as normalizeStyle, i as openBlock } from "./main-DCJXrkf-.js";
              ...
              createBaseVNode("div", _hoisted_20, [
                revenueData.value.length > 0 ? (openBlock(true), createElementBlock(Fragment, { key: 0 }, renderList(revenueData.value, (month, idx) => {
                  return openBlock(), createElementBlock("div", {
                    ...
                    createBaseVNode("div", {
                      style: normalizeStyle({ height: `${Math.max(4, month.total / Math.max(...revenueData.value.map((d) => d.total)) * 100)}%` }),
