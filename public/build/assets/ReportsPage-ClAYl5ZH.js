...
import { S as Sheet } from "./sheet-DCc5Et0n.js";
import { F as FileText } from "./file-text-BdyNFna-.js";
...
import { D as Download } from "./download-BLhfcpVu.js";
...
`;
    ...
    const viewGeneratedReportArchive = (g) => {
      ...
      return openBlock(), createElementBlock("div", _hoisted_1, [
        createBaseVNode("div", _hoisted_2, [
          createBaseVNode("div", _hoisted_3, [
            _cache[37] || (_cache[37] = createBaseVNode("label", { class: "text-[10px] font-bold text-slate-400 uppercase tracking-widest mb-1.5 block ml-1 text-left" }, "Active Library", -1)),
            createBaseVNode("div", _hoisted_4, [
              withDirectives(createBaseVNode("select", {
                ...
                _cache[36] || (_cache[36] = createBaseVNode("option", { value: "all" }, "All Libraries (Combined)", -1)),
        ...
        createBaseVNode("div", _hoisted_8, [
          createBaseVNode("h2", _hoisted_9, [
            ...
            _cache[38] || (_cache[38] = createBaseVNode("span", null, "Configure Consolidated Parameters", -1))
          ]),
          createBaseVNode("div", {
            ...
            createBaseVNode("div", null, [
              _cache[39] || (_cache[39] = createBaseVNode("label", { class: "text-[10px] font-bold text-slate-400 uppercase tracking-widest mb-2 block ml-1" }, "Report Category", -1)),
              withDirectives(createBaseVNode("select", {
            ...
            createBaseVNode("div", null, [
              _cache[41] || (_cache[41] = createBaseVNode("label", { class: "text-[10px] font-bold text-slate-400 uppercase tracking-widest mb-2 block ml-1" }, "Time Range", -1)),
              withDirectives(createBaseVNode("select", {
                "onUpdate:modelValue": _cache[2] || (_cache[2] = ($event) => filters.timeRange = $event),
                onChange: handleTimeRangeChange,
                class: "w-full px-4 py-2.5 bg-slate-50 border border-slate-200 rounded-xl text-xs font-bold text-slate-700 focus:ring-2 focus:ring-purple-500/20 focus:border-purple-500 outline-none cursor-pointer"
              }, [..._cache[40] || (_cache[40] = [
                createStaticVNode('<option value="today" data-v-960c531a>Today</option><option value="week" data-v-960c531a>This Week</option><option value="month" data-v-960c531a>This Month</option><option value="year" data-v-960c531a>This Year</option><option value="custom" data-v-960c531a>Custom Range</option>', 5)
              ])], 544), [
                [vModelSelect, filters.timeRange]
              ])
            ]),
            filters.timeRange === "custom" ? (openBlock(), createElementBlock("div", _hoisted_11, [
              _cache[42] || (_cache[42] = createBaseVNode("label", { class: "text-[10px] font-bold text-slate-400 uppercase tracking-widest mb-2 block ml-1" }, "From Date", -1)),
            ...
            filters.timeRange === "custom" ? (openBlock(), createElementBlock("div", _hoisted_12, [
              _cache[43] || (_cache[43] = createBaseVNode("label", { class: "text-[10px] font-bold text-slate-400 uppercase tracking-widest mb-2 block ml-1" }, "To Date", -1)),
              withDirectives(createBaseVNode("input", {
          ...
          filters.category === "bookings" ? (openBlock(), createElementBlock("div", _hoisted_13, [
            _cache[52] || (_cache[52] = createBaseVNode("span", { class: "text-[10px] font-black text-purple-800 uppercase tracking-widest block" }, "Advanced Search & Filter Parameters", -1)),
            createBaseVNode("div", _hoisted_14, [
              createBaseVNode("div", null, [
                _cache[44] || (_cache[44] = createBaseVNode("label", { class: "text-[9px] font-bold text-slate-400 uppercase tracking-widest mb-1.5 block" }, "Student (Name / CRN)", -1)),
                withDirectives(createBaseVNode("input", {
              ...
              createBaseVNode("div", null, [
                _cache[45] || (_cache[45] = createBaseVNode("label", { class: "text-[9px] font-bold text-slate-400 uppercase tracking-widest mb-1.5 block" }, "Seat Number", -1)),
                withDirectives(createBaseVNode("input", {
              ...
              createBaseVNode("div", null, [
                _cache[47] || (_cache[47] = createBaseVNode("label", { class: "text-[9px] font-bold text-slate-400 uppercase tracking-widest mb-1.5 block" }, "Booking Status", -1)),
                withDirectives(createBaseVNode("select", {
                  ...
                  createStaticVNode('<option value="all" data-v-960c531a>All Statuses</option><option value="booked" data-v-960c531a>Booked</option><option value="checked_in" data-v-960c531a>Checked In</option><option value="checked_out" data-v-960c531a>Checked Out</option><option value="cancelled" data-v-960c531a>Cancelled</option>', 5)
                ])], 512), [
                  [vModelSelect, filters.bookingStatus]
                ])
              ]),
              createBaseVNode("div", null, [
                _cache[49] || (_cache[49] = createBaseVNode("label", { class: "text-[9px] font-bold text-slate-400 uppercase tracking-widest mb-1.5 block" }, "Check-in Status", -1)),
                withDirectives(createBaseVNode("select", {
              ...
              createBaseVNode("div", null, [
                _cache[51] || (_cache[51] = createBaseVNode("label", { class: "text-[9px] font-bold text-slate-400 uppercase tracking-widest mb-1.5 block" }, "Overstay Status", -1)),
                withDirectives(createBaseVNode("select", {
                  "onUpdate:modelValue": _cache[9] || (_cache[9] = ($event) => filters.overstayStatus = $event),
                  class: "w-full px-3 py-2 bg-white border border-slate-200 rounded-xl text-xs font-bold text-slate-700 focus:ring-2 focus:ring-purple-500/10 focus:border-purple-500 outline-none cursor-pointer"
                }, [..._cache[50] || (_cache[50] = [
                  createStaticVNode('<option value="all" data-v-960c531a>All Overstays</option><option value="on_time" data-v-960c531a>Checked Out On Time</option><option value="early" data-v-960c531a>Early Check-out</option><option value="overstay" data-v-960c531a>Overstay (&lt; 1 Hour)</option><option value="serious_overstay" data-v-960c531a>Serious Overstay (≥ 1 Hour)</option><option value="cancelled" data-v-960c531a>Auto Cancelled</option>', 6)
                ])], 512), [
          ...
          filters.category === "book_reservations" ? (openBlock(), createElementBlock("div", _hoisted_15, [
            _cache[61] || (_cache[61] = createBaseVNode("span", { class: "text-[10px] font-black text-purple-800 uppercase tracking-widest block" }, "Advanced Book Reservation Filter Parameters", -1)),
            createBaseVNode("div", _hoisted_16, [
              createBaseVNode("div", null, [
                _cache[53] || (_cache[53] = createBaseVNode("label", { class: "text-[9px] font-bold text-slate-400 uppercase tracking-widest mb-1.5 block" }, "Student (Name / CRN)", -1)),
                withDirectives(createBaseVNode("input", {
              ...
              createBaseVNode("div", null, [
                _cache[54] || (_cache[54] = createBaseVNode("label", { class: "text-[9px] font-bold text-slate-400 uppercase tracking-widest mb-1.5 block" }, "Book (Title / ISBN)", -1)),
                withDirectives(createBaseVNode("input", {
              ...
              createBaseVNode("div", null, [
                _cache[56] || (_cache[56] = createBaseVNode("label", { class: "text-[9px] font-bold text-slate-400 uppercase tracking-widest mb-1.5 block" }, "Book Category", -1)),
                withDirectives(createBaseVNode("select", {
                  "onUpdate:modelValue": _cache[12] || (_cache[12] = ($event) => filters.bookCategory = $event),
                  class: "w-full px-3 py-2 bg-white border border-slate-200 rounded-xl text-xs font-bold text-slate-700 focus:ring-2 focus:ring-purple-500/10 focus:border-purple-500 outline-none cursor-pointer"
                }, [..._cache[55] || (_cache[55] = [
                  createStaticVNode('<option value="all" data-v-960c531a>All Categories</option><option value="Fiction" data-v-960c531a>Fiction</option><option value="Science" data-v-960c531a>Science</option><option value="Technology" data-v-960c531a>Technology</option><option value="Mathematics" data-v-960c531a>Mathematics</option><option value="History" data-v-960c531a>History</option><option value="Biography" data-v-960c531a>Biography</option>', 7)
                ])], 512), [
                  [vModelSelect, filters.bookCategory]
                ])
              ]),
              createBaseVNode("div", null, [
                _cache[58] || (_cache[58] = createBaseVNode("label", { class: "text-[9px] font-bold text-slate-400 uppercase tracking-widest mb-1.5 block" }, "Reservation Status", -1)),
                withDirectives(createBaseVNode("select", {
                  "onUpdate:modelValue": _cache[13] || (_cache[13] = ($event) => filters.reservationStatus = $event),
                  class: "w-full px-3 py-2 bg-white border border-slate-200 rounded-xl text-xs font-bold text-slate-700 focus:ring-2 focus:ring-purple-500/10 focus:border-purple-500 outline-none cursor-pointer"
                }, [..._cache[57] || (_cache[57] = [
                  createStaticVNode('<option value="all" data-v-960c531a>All Statuses</option><option value="pending" data-v-960c531a>Pending Approval</option><option value="approved" data-v-960c531a>Approved</option><option value="rejected" data-v-960c531a>Rejected</option><option value="collected" data-v-960c531a>Collected</option>', 5)
                ])], 512), [
                  [vModelSelect, filters.reservationStatus]
                ])
              ]),
              createBaseVNode("div", null, [
                _cache[60] || (_cache[60] = createBaseVNode("label", { class: "text-[9px] font-bold text-slate-400 uppercase tracking-widest mb-1.5 block" }, "Return Status (Time Analysis)", -1)),
                withDirectives(createBaseVNode("select", {
                  "onUpdate:modelValue": _cache[14] || (_cache[14] = ($event) => filters.returnStatus = $event),
                  class: "w-full px-3 py-2 bg-white border border-slate-200 rounded-xl text-xs font-bold text-slate-700 focus:ring-2 focus:ring-purple-500/10 focus:border-purple-500 outline-none cursor-pointer"
                }, [..._cache[59] || (_cache[59] = [
                  createStaticVNode('<option value="all" data-v-960c531a>All Returns</option><option value="Returned On Time" data-v-960c531a>Returned On Time</option><option value="Returned Early" data-v-960c531a>Returned Early</option><option value="Returned Late" data-v-960c531a>Returned Late</option><option value="Not Picked Up" data-v-960c531a>Not Picked Up</option><option value="Borrowed" data-v-960c531a>Borrowed (Active)</option><option value="Overdue" data-v-960c531a>Overdue (Active)</option>', 7)
                ])], 512), [
          ...
          filters.category === "complaints" ? (openBlock(), createElementBlock("div", _hoisted_17, [
            _cache[69] || (_cache[69] = createBaseVNode("span", { class: "text-[10px] font-black text-purple-800 uppercase tracking-widest block" }, "Advanced Support Ticket / Complaints Filter Parameters", -1)),
            createBaseVNode("div", _hoisted_18, [
              createBaseVNode("div", null, [
                _cache[62] || (_cache[62] = createBaseVNode("label", { class: "text-[9px] font-bold text-slate-400 uppercase tracking-widest mb-1.5 block" }, "Student (Name / CRN)", -1)),
                withDirectives(createBaseVNode("input", {
              ...
              createBaseVNode("div", null, [
                _cache[64] || (_cache[64] = createBaseVNode("label", { class: "text-[9px] font-bold text-slate-400 uppercase tracking-widest mb-1.5 block" }, "Complaint Category", -1)),
                withDirectives(createBaseVNode("select", {
              ...
              createBaseVNode("div", null, [
                _cache[66] || (_cache[66] = createBaseVNode("label", { class: "text-[9px] font-bold text-slate-400 uppercase tracking-widest mb-1.5 block" }, "Priority", -1)),
                withDirectives(createBaseVNode("select", {
                  "onUpdate:modelValue": _cache[17] || (_cache[17] = ($event) => filters.complaintPriority = $event),
                  class: "w-full px-3 py-2 bg-white border border-slate-200 rounded-xl text-xs font-bold text-slate-700 focus:ring-2 focus:ring-purple-500/10 focus:border-purple-500 outline-none cursor-pointer"
                }, [..._cache[65] || (_cache[65] = [
                  createStaticVNode('<option value="all" data-v-960c531a>All Priorities</option><option value="low" data-v-960c531a>Low</option><option value="medium" data-v-960c531a>Medium</option><option value="high" data-v-960c531a>High</option><option value="urgent" data-v-960c531a>Urgent</option>', 5)
                ])], 512), [
                  [vModelSelect, filters.complaintPriority]
                ])
              ]),
              createBaseVNode("div", null, [
                _cache[68] || (_cache[68] = createBaseVNode("label", { class: "text-[9px] font-bold text-slate-400 uppercase tracking-widest mb-1.5 block" }, "Complaint Status", -1)),
                withDirectives(createBaseVNode("select", {
                  "onUpdate:modelValue": _cache[18] || (_cache[18] = ($event) => filters.complaintStatus = $event),
                  class: "w-full px-3 py-2 bg-white border border-slate-200 rounded-xl text-xs font-bold text-slate-700 focus:ring-2 focus:ring-purple-500/10 focus:border-purple-500 outline-none cursor-pointer"
                }, [..._cache[67] || (_cache[67] = [
                  createStaticVNode('<option value="all" data-v-960c531a>All Statuses</option><option value="open" data-v-960c531a>Pending</option><option value="in_progress" data-v-960c531a>In Progress</option><option value="resolved" data-v-960c531a>Resolved</option><option value="closed" data-v-960c531a>Closed</option>', 5)
                ])], 512), [
          ...
          filters.category === "events" ? (openBlock(), createElementBlock("div", _hoisted_19, [
            _cache[79] || (_cache[79] = createBaseVNode("span", { class: "text-[10px] font-black text-purple-800 uppercase tracking-widest block" }, "Advanced Campus Events Filter Parameters", -1)),
            createBaseVNode("div", _hoisted_20, [
              createBaseVNode("div", null, [
                _cache[70] || (_cache[70] = createBaseVNode("label", { class: "text-[9px] font-bold text-slate-400 uppercase tracking-widest mb-1.5 block" }, "Search Event (Title/Venue)", -1)),
                withDirectives(createBaseVNode("input", {
              ...
              createBaseVNode("div", null, [
                _cache[72] || (_cache[72] = createBaseVNode("label", { class: "text-[9px] font-bold text-slate-400 uppercase tracking-widest mb-1.5 block" }, "Event Type", -1)),
                withDirectives(createBaseVNode("select", {
                  "onUpdate:modelValue": _cache[20] || (_cache[20] = ($event) => filters.eventType = $event),
                  class: "w-full px-3 py-2 bg-white border border-slate-200 rounded-xl text-xs font-bold text-slate-700 focus:ring-2 focus:ring-purple-500/10 focus:border-purple-500 outline-none cursor-pointer"
                }, [..._cache[71] || (_cache[71] = [
                  createStaticVNode('<option value="all" data-v-960c531a>All Types</option><option value="seminar" data-v-960c531a>Seminar</option><option value="workshop" data-v-960c531a>Workshop</option><option value="study_group" data-v-960c531a>Study Group</option><option value="exam_prep" data-v-960c531a>Exam Prep</option><option value="career_guidance" data-v-960c531a>Career Guidance</option><option value="networking" data-v-960c531a>Networking</option>', 7)
                ])], 512), [
                  [vModelSelect, filters.eventType]
                ])
              ]),
              createBaseVNode("div", null, [
                _cache[74] || (_cache[74] = createBaseVNode("label", { class: "text-[9px] font-bold text-slate-400 uppercase tracking-widest mb-1.5 block" }, "Pricing Type", -1)),
                withDirectives(createBaseVNode("select", {
              ...
              createBaseVNode("div", null, [
                _cache[76] || (_cache[76] = createBaseVNode("label", { class: "text-[9px] font-bold text-slate-400 uppercase tracking-widest mb-1.5 block" }, "Capacity Status", -1)),
                withDirectives(createBaseVNode("select", {
              ...
              createBaseVNode("div", null, [
                _cache[78] || (_cache[78] = createBaseVNode("label", { class: "text-[9px] font-bold text-slate-400 uppercase tracking-widest mb-1.5 block" }, "Event Status", -1)),
                withDirectives(createBaseVNode("select", {
                  "onUpdate:modelValue": _cache[23] || (_cache[23] = ($event) => filters.eventStatus = $event),
                  class: "w-full px-3 py-2 bg-white border border-slate-200 rounded-xl text-xs font-bold text-slate-700 focus:ring-2 focus:ring-purple-500/10 focus:border-purple-500 outline-none cursor-pointer"
                }, [..._cache[77] || (_cache[77] = [
                  createStaticVNode('<option value="all" data-v-960c531a>All Statuses</option><option value="upcoming" data-v-960c531a>Upcoming</option><option value="ongoing" data-v-960c531a>Ongoing</option><option value="completed" data-v-960c531a>Completed</option><option value="cancelled" data-v-960c531a>Cancelled</option>', 5)
                ])], 512), [
          ...
          filters.category === "attendance" ? (openBlock(), createElementBlock("div", _hoisted_21, [
            _cache[86] || (_cache[86] = createBaseVNode("span", { class: "text-[10px] font-black text-purple-800 uppercase tracking-widest block" }, "Advanced Student Attendance Filter Parameters", -1)),
            createBaseVNode("div", _hoisted_22, [
              createBaseVNode("div", null, [
                _cache[80] || (_cache[80] = createBaseVNode("label", { class: "text-[9px] font-bold text-slate-400 uppercase tracking-widest mb-1.5 block" }, "Search Student (Name / CRN)", -1)),
                withDirectives(createBaseVNode("input", {
              ...
              createBaseVNode("div", null, [
                _cache[82] || (_cache[82] = createBaseVNode("label", { class: "text-[9px] font-bold text-slate-400 uppercase tracking-widest mb-1.5 block" }, "Attendance Status", -1)),
                withDirectives(createBaseVNode("select", {
              ...
              createBaseVNode("div", null, [
                _cache[84] || (_cache[84] = createBaseVNode("label", { class: "text-[9px] font-bold text-slate-400 uppercase tracking-widest mb-1.5 block" }, "Check-in Method", -1)),
                withDirectives(createBaseVNode("select", {
              ...
              createBaseVNode("div", null, [
                _cache[85] || (_cache[85] = createBaseVNode("label", { class: "text-[9px] font-bold text-slate-400 uppercase tracking-widest mb-1.5 block" }, "Seat Designation", -1)),
                withDirectives(createBaseVNode("input", {
        ...
        generatedReport.value ? (openBlock(), createElementBlock("div", _hoisted_25, [
          createBaseVNode("div", _hoisted_26, [
            createBaseVNode("div", _hoisted_27, [
              _cache[87] || (_cache[87] = createBaseVNode("span", { class: "w-2.5 h-2.5 rounded-full bg-purple-500 animate-ping" }, null, -1)),
            ...
            createBaseVNode("div", _hoisted_29, [
              createBaseVNode("button", {
                ...
                _cache[88] || (_cache[88] = createBaseVNode("span", null, "Export CSV", -1))
              ]),
              createBaseVNode("button", {
                ...
                _cache[89] || (_cache[89] = createBaseVNode("span", null, "Download PDF", -1))
              ]),
              createBaseVNode("button", {
                ...
                _cache[90] || (_cache[90] = createBaseVNode("span", null, "Print Report", -1))
              ])
            ])
          ]),
          createBaseVNode("div", _hoisted_30, [
            createBaseVNode("div", _hoisted_31, [
              createBaseVNode("div", _hoisted_32, [
                ...
                createBaseVNode("div", _hoisted_40, [
                  ...
                  createBaseVNode("p", _hoisted_42, [
                    _cache[91] || (_cache[91] = createTextVNode(" Period: ", -1)),
                      ...
                      return openBlock(), createElementBlock("tr", {
                        ...
                        createBaseVNode("td", _hoisted_106, [
                          createBaseVNode("div", _hoisted_107, [
                            createBaseVNode("div", null, [
                              _cache[94] || (_cache[94] = createTextVNode("Price: ", -1)),
                      ...
                      return openBlock(), createElementBlock("tr", {
                        ...
                        createBaseVNode("td", _hoisted_120, [
                          createBaseVNode("div", _hoisted_121, [
                            createBaseVNode("div", null, [
                              _cache[95] || (_cache[95] = createTextVNode("In: ", -1)),
                              createBaseVNode("span", _hoisted_122, toDisplayString(row.checkInTime), 1)
                            ]),
                            createBaseVNode("div", null, [
                              _cache[96] || (_cache[96] = createTextVNode("Out: ", -1)),
              ...
              createBaseVNode("div", _hoisted_132, [
                createBaseVNode("div", _hoisted_133, [
                  createBaseVNode("div", null, [
                    _cache[97] || (_cache[97] = createTextVNode("Total Records: ", -1)),
                  ...
                  filters.category === "bookings" ? (openBlock(), createElementBlock("div", _hoisted_135, [
                    _cache[98] || (_cache[98] = createTextVNode("Total Hours Used: ", -1)),
            ...
            createBaseVNode("div", _hoisted_141, [
              _cache[99] || (_cache[99] = createBaseVNode("div", null, "SmartLib Consolidated Audit Log", -1)),
              _cache[100] || (_cache[100] = createBaseVNode("div", { class: "text-center italic" }, "This report was generated automatically by SmartLib.", -1)),
          ...
          _cache[101] || (_cache[101] = createBaseVNode("h3", { class: "text-base font-bold text-slate-850" }, "No Consolidations Running", -1)),
          _cache[102] || (_cache[102] = createBaseVNode("p", { class: "text-slate-455 text-xs mt-1.5 max-w-sm mx-auto font-medium leading-relaxed" }, " Select target library, category, configure parameters and click **Generate Report** to view console logs. ", -1))
        ])),
        createBaseVNode("div", _hoisted_144, [
          createBaseVNode("div", _hoisted_145, [
            createBaseVNode("div", _hoisted_146, [
              ...
              _cache[103] || (_cache[103] = createBaseVNode("div", null, [
            ...
            createBaseVNode("div", _hoisted_148, [
              _cache[105] || (_cache[105] = createBaseVNode("label", { class: "text-[10px] font-bold text-slate-400 uppercase tracking-wider" }, "Frequency:", -1)),
              withDirectives(createBaseVNode("select", {
                "onUpdate:modelValue": _cache[33] || (_cache[33] = ($event) => frequencyFilter.value = $event),
          ...
          createBaseVNode("div", _hoisted_149, [
            createBaseVNode("button", {
              onClick: _cache[34] || (_cache[34] = ($event) => activeSubTab.value = "scheduled"),
            ...
            createBaseVNode("button", {
              onClick: _cache[35] || (_cache[35] = ($event) => activeSubTab.value = "history"),
              class: normalizeClass([
                "px-4 py-2 rounded-xl text-xs font-bold transition-all cursor-pointer flex items-center space-x-2",
          ...
          activeSubTab.value === "scheduled" ? (openBlock(), createElementBlock("div", _hoisted_150, [
            displayScheduledReports.value.length === 0 ? (openBlock(), createElementBlock("div", _hoisted_151, [
              ...
              _cache[106] || (_cache[106] = createBaseVNode("p", { class: "text-slate-400 text-xs font-bold uppercase tracking-wider" }, "No automated report schedules match your selection.", -1))
            ])) : (openBlock(), createElementBlock("div", _hoisted_152, [
              createBaseVNode("table", _hoisted_153, [
                _cache[110] || (_cache[110] = createBaseVNode("thead", null, [
                      ...
                      createBaseVNode("td", _hoisted_164, [
                        createBaseVNode("div", _hoisted_165, [
                          createBaseVNode("button", {
                            ...
                            _cache[107] || (_cache[107] = createBaseVNode("span", null, "View", -1))
                          ], 8, _hoisted_166),
                          createBaseVNode("button", {
                            ...
                            _cache[108] || (_cache[108] = createBaseVNode("span", null, "Download", -1))
                          ], 8, _hoisted_167),
                          createBaseVNode("button", {
                            ...
                            _cache[109] || (_cache[109] = createBaseVNode("span", null, "Print", -1))
                          ], 8, _hoisted_168)
                        ])
                      ])
                    ]);
          ...
          activeSubTab.value === "history" ? (openBlock(), createElementBlock("div", _hoisted_169, [
            displayGeneratedReports.value.length === 0 ? (openBlock(), createElementBlock("div", _hoisted_170, [
              ...
              _cache[111] || (_cache[111] = createBaseVNode("p", { class: "text-slate-400 text-xs font-bold uppercase tracking-wider" }, "No generated report archives match your selection.", -1))
                      ...
                      createBaseVNode("td", _hoisted_180, [
                        createBaseVNode("div", _hoisted_181, [
                          createBaseVNode("button", {
                            ...
                            createVNode(unref(Eye), { class: "w-3.5 h-3.5" }),
                            _cache[112] || (_cache[112] = createBaseVNode("span", null, "View", -1))
                          ], 8, _hoisted_182),
                          createBaseVNode("button", {
                            ...
                            createVNode(unref(Download), { class: "w-3.5 h-3.5" }),
                            _cache[113] || (_cache[113] = createBaseVNode("span", null, "Download", -1))
                          ], 8, _hoisted_183),
                          createBaseVNode("button", {
                            ...
                            createVNode(unref(Printer), { class: "w-3.5 h-3.5" }),
                            _cache[114] || (_cache[114] = createBaseVNode("span", null, "Print", -1))
                          ], 8, _hoisted_184)
                        ])
                      ])
                    ]);
...
const ReportsPage = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-960c531a"]]);
export {
