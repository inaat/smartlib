...
import { S as Star } from "./star-CGs5kbxc.js";
...
import { W as Wifi } from "./wifi-CZVFb9Ig.js";
import { C as CircleAlert } from "./circle-alert-CbhTHhAn.js";
import { C as Coffee, W as Wind } from "./wind-BTGFN0Rl.js";
...
const _hoisted_64 = { class: "bg-white rounded-2xl p-6 shadow-sm border border-slate-200 sticky top-24 text-left" };
const _hoisted_65 = { class: "space-y-2 mb-6" };
const _hoisted_66 = { class: "flex justify-between text-xs font-medium leading-none" };
const _hoisted_67 = { class: "text-green-600" };
const _hoisted_68 = { class: "w-full bg-slate-100 rounded-full h-1.5 overflow-hidden" };
const _hoisted_69 = { class: "mt-5 pt-5 border-t border-slate-100 space-y-3.5" };
const _hoisted_70 = { class: "flex items-center text-xs text-slate-600 font-semibold leading-none" };
const _hoisted_71 = { class: "flex items-center text-xs text-slate-600 font-semibold leading-none" };
const _hoisted_72 = { class: "truncate" };
const _hoisted_73 = {
  key: 0,
...
const _hoisted_74 = { class: "flex flex-col text-left" };
const _hoisted_75 = { class: "font-mono text-xs font-bold text-emerald-900 mt-1 select-all" };
const _hoisted_76 = { class: "bg-white rounded-2xl p-6 shadow-sm border border-slate-100 text-left" };
const _hoisted_77 = { class: "space-y-3" };
const _hoisted_78 = {
  key: 0,
            ...
            createBaseVNode("div", _hoisted_64, [
              ...
              createBaseVNode("div", _hoisted_65, [
                createBaseVNode("div", _hoisted_66, [
                  ...
                  createBaseVNode("span", _hoisted_67, toDisplayString(library.value.availableSeats || 0) + " / " + toDisplayString(libraryCapacity.value), 1)
                ]),
              ...
              createBaseVNode("div", _hoisted_69, [
                ...
                createBaseVNode("div", _hoisted_71, [
                  ...
                  createBaseVNode("span", _hoisted_72, toDisplayString(library.value.contact_info?.email || "Not available"), 1)
                ]),
                library.value.wifi_password ? (openBlock(), createElementBlock("div", _hoisted_73, [
                  ...
                  createBaseVNode("div", _hoisted_74, [
                    ...
                    createBaseVNode("span", _hoisted_75, toDisplayString(library.value.wifi_password), 1)
                  ])
                ])) : createCommentVNode("", true)
              ])
            ]),
              ...
              createBaseVNode("div", _hoisted_77, [
                (openBlock(true), createElementBlock(Fragment, null, renderList(library.value.operating_days, (day) => {
                  return openBlock(), createElementBlock("div", {
                    ...
                    day.isOpen ? (openBlock(), createElementBlock("span", _hoisted_78, toDisplayString(day.openTime) + " - " + toDisplayString(day.closeTime), 1)) : (openBlock(), createElementBlock("span", _hoisted_79, "Closed"))
                  ], 2);
                }), 128))
              ])
            ])
...
const LibraryDetailsPage = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-059f8a83"]]);
export {
