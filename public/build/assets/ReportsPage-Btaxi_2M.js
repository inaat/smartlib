import { c as createLucideIcon, d as defineComponent, z as useAuth, r as ref, A as reactive, a as computed, o as onMounted, b as createElementBlock, e as createBaseVNode, s as withDirectives, H as vModelSelect, F as Fragment, k as renderList, t as toDisplayString, g as createVNode, u as unref, p as createCommentVNode, n as normalizeClass, f as createStaticVNode, v as vModelText, R as RefreshCw, j as createTextVNode, C as Clock, W as librarianAPI, a0 as supportAPI, m as openBlock, _ as _export_sfc } from "./main-BeUqjoax.js";
...
import { S as Sheet } from "./sheet-BBAcFLQm.js";
import { F as FileText } from "./file-text-C-8QcjRK.js";
import { P as Printer } from "./printer-qHWgtc5c.js";
...
const _hoisted_25 = {
  key: 0,
  id: "generated-report-view",
  class: "space-y-5 animate-in fade-in duration-300 scroll-mt-6"
};
...
const _hoisted_144 = { class: "bg-white rounded-2xl border border-slate-200/80 shadow-sm overflow-hidden text-left space-y-0" };
const _hoisted_145 = { class: "p-6 border-b border-slate-100 flex flex-col md:flex-row md:items-center justify-between gap-4" };
const _hoisted_146 = { class: "flex items-center space-x-3.5" };
const _hoisted_147 = { class: "w-11 h-11 rounded-2xl bg-purple-50 flex items-center justify-center text-purple-700 border border-purple-100 flex-shrink-0" };
const _hoisted_148 = { class: "flex items-center space-x-2" };
const _hoisted_149 = { class: "bg-slate-50/70 border-b border-slate-100 px-6 py-2.5 flex items-center space-x-2" };
const _hoisted_150 = {
  key: 0,
  class: "p-6"
};
...
const _hoisted_153 = { class: "w-full text-xs" };
const _hoisted_154 = { class: "divide-y divide-slate-100 bg-white" };
const _hoisted_155 = { class: "py-3.5 px-4 font-bold text-slate-800" };
const _hoisted_156 = { class: "py-3.5 px-4" };
const _hoisted_157 = { class: "block text-slate-800 font-bold" };
const _hoisted_158 = { class: "text-[10px] text-slate-400 font-medium" };
const _hoisted_159 = { class: "py-3.5 px-4 capitalize font-bold text-purple-700" };
const _hoisted_160 = { class: "py-3.5 px-4" };
const _hoisted_161 = { class: "py-3.5 px-4 uppercase text-[10px] font-bold" };
const _hoisted_162 = { class: "py-3.5 px-4 font-medium text-slate-500" };
const _hoisted_163 = { class: "py-3.5 px-4" };
const _hoisted_164 = { class: "py-3.5 px-4 text-right" };
const _hoisted_165 = { class: "flex items-center justify-end gap-1.5" };
...
const _hoisted_172 = { class: "w-full text-xs" };
const _hoisted_173 = { class: "divide-y divide-slate-100 bg-white" };
const _hoisted_174 = { class: "py-3 px-4 font-bold text-slate-800" };
const _hoisted_175 = { class: "py-3 px-4 font-bold text-purple-900" };
const _hoisted_176 = { class: "py-3 px-4 capitalize" };
const _hoisted_177 = { class: "px-2 py-0.5 rounded text-[10px] font-bold uppercase border bg-slate-50 border-slate-200 text-slate-700" };
const _hoisted_178 = { class: "py-3 px-4 uppercase text-[10px] font-bold" };
const _hoisted_179 = { class: "py-3 px-4 text-slate-500 font-medium" };
const _hoisted_180 = { class: "py-3 px-4 text-right" };
const _hoisted_181 = { class: "flex items-center justify-end gap-1.5" };
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const handleLibraryChange = () => {
      ...
      fetchSuperadminScheduledReports();
    };
    ...
    const generateOnScreenReport = async (overrideScheduledInfo) => {
      ...
      try {
        ...
        const scheduledByInfo = overrideScheduledInfo ? {
          isScheduled: true,
          label: "Scheduled By:",
          name: overrideScheduledInfo.librarian_name || overrideScheduledInfo.user?.name || "Librarian",
          role: "Librarian",
          staffId: `ID-${overrideScheduledInfo.user_id || overrideScheduledInfo.librarian_id || overrideScheduledInfo.id || "2"}`
        } : {
          isScheduled: false,
          label: "Generated By:",
          name: user.value?.name || "System Admin",
          role: "Super Admin",
          staffId: user.value?.crn || `ID-${user.value?.id || "1"}`
        };
        generatedReport.value = {
          ...
          isScheduled: scheduledByInfo.isScheduled,
          headerLabel: scheduledByInfo.label,
          generatedBy: {
            name: scheduledByInfo.name,
            role: scheduledByInfo.role,
            staffId: scheduledByInfo.staffId
          }
        };
      } catch (error) {
        console.error(error);
    ...
    <html>
      ...
      <body>
        ...
        <div class="generated-by-bar">
          <div>${report.headerLabel || "Generated By:"} <span>${report.generatedBy.name}</span></div>
...
`;
      csv += `"${report.headerLabel || "Generated By"}","${report.generatedBy.name} (${report.generatedBy.role})"
`;
...
`;
    ...
    const generatedReportsList = ref([]);
    const activeSubTab = ref("scheduled");
    const frequencyFilter = ref("all");
    const displayScheduledReports = computed(() => {
      let list = scheduledReportsList.value;
      if (frequencyFilter.value !== "all") {
        list = list.filter((s) => s.frequency === frequencyFilter.value);
      }
      return list;
    });
    const displayGeneratedReports = computed(() => {
      let list = generatedReportsList.value;
      if (frequencyFilter.value !== "all") {
        list = list.filter((g) => g.frequency === frequencyFilter.value);
      }
      return list;
    });
    const fetchSuperadminScheduledReports = async () => {
      try {
        const params = {};
        if (selectedLibraryId.value !== "all") params.library_id = selectedLibraryId.value;
        const resSched = await superadminAPI.getScheduledReports(params);
        scheduledReportsList.value = resSched.scheduled_reports || [];
        const resGen = await superadminAPI.getGeneratedReports(params);
        generatedReportsList.value = resGen.generated_reports || [];
      } catch (err) {
        console.error("Failed to fetch superadmin scheduled reports:", err);
      }
    };
    ...
    const viewScheduledReport = async (s) => {
    ...
    const downloadScheduledReport = async (s) => {
      try {
        await superadminAPI.runScheduledReportNow(s.id);
        await fetchSuperadminScheduledReports();
        if (generatedReportsList.value.length > 0) {
          window.open(`/api/admin/generated-reports/${generatedReportsList.value[0].id}/download`, "_blank");
        }
      } catch (err) {
        showError("Error", "Failed to download report file.");
      }
    };
    const printScheduledReport = async (s) => {
      if (s.library_id) selectedLibraryId.value = s.library_id;
      if (s.report_type) filters.category = s.report_type;
      await generateOnScreenReport(s);
      scrollToReportView();
    ...
    const viewGeneratedReportArchive = async (g) => {
    ...
    const downloadGeneratedReportArchive = (g) => {
      window.open(`/api/admin/generated-reports/${g.id}/download`, "_blank");
    };
    const printGeneratedReportArchive = (g) => {
      if (g.library_id) selectedLibraryId.value = g.library_id;
      if (g.report_type) filters.category = g.report_type;
      ...
      return openBlock(), createElementBlock("div", _hoisted_1, [
        createBaseVNode("div", _hoisted_2, [
          createBaseVNode("div", _hoisted_3, [
            _cache[38] || (_cache[38] = createBaseVNode("label", { class: "text-[10px] font-bold text-slate-400 uppercase tracking-widest mb-1.5 block ml-1 text-left" }, "Active Library", -1)),
            createBaseVNode("div", _hoisted_4, [
              withDirectives(createBaseVNode("select", {
                ...
                _cache[37] || (_cache[37] = createBaseVNode("option", { value: "all" }, "All Libraries (Combined)", -1)),
        ...
        createBaseVNode("div", _hoisted_8, [
          createBaseVNode("h2", _hoisted_9, [
            ...
            _cache[39] || (_cache[39] = createBaseVNode("span", null, "Configure Consolidated Parameters", -1))
          ]),
          createBaseVNode("div", {
            ...
            createBaseVNode("div", null, [
              _cache[40] || (_cache[40] = createBaseVNode("label", { class: "text-[10px] font-bold text-slate-400 uppercase tracking-widest mb-2 block ml-1" }, "Report Category", -1)),
              withDirectives(createBaseVNode("select", {
            ...
            createBaseVNode("div", null, [
              _cache[42] || (_cache[42] = createBaseVNode("label", { class: "text-[10px] font-bold text-slate-400 uppercase tracking-widest mb-2 block ml-1" }, "Time Range", -1)),
              withDirectives(createBaseVNode("select", {
                "onUpdate:modelValue": _cache[2] || (_cache[2] = ($event) => filters.timeRange = $event),
                onChange: handleTimeRangeChange,
                class: "w-full px-4 py-2.5 bg-slate-50 border border-slate-200 rounded-xl text-xs font-bold text-slate-700 focus:ring-2 focus:ring-purple-500/20 focus:border-purple-500 outline-none cursor-pointer"
              }, [..._cache[41] || (_cache[41] = [
                createStaticVNode('<option value="today" data-v-43581010>Today</option><option value="week" data-v-43581010>This Week</option><option value="month" data-v-43581010>This Month</option><option value="year" data-v-43581010>This Year</option><option value="custom" data-v-43581010>Custom Range</option>', 5)
              ])], 544), [
                [vModelSelect, filters.timeRange]
              ])
            ]),
            filters.timeRange === "custom" ? (openBlock(), createElementBlock("div", _hoisted_11, [
              _cache[43] || (_cache[43] = createBaseVNode("label", { class: "text-[10px] font-bold text-slate-400 uppercase tracking-widest mb-2 block ml-1" }, "From Date", -1)),
            ...
            filters.timeRange === "custom" ? (openBlock(), createElementBlock("div", _hoisted_12, [
              _cache[44] || (_cache[44] = createBaseVNode("label", { class: "text-[10px] font-bold text-slate-400 uppercase tracking-widest mb-2 block ml-1" }, "To Date", -1)),
              withDirectives(createBaseVNode("input", {
          ...
          filters.category === "bookings" ? (openBlock(), createElementBlock("div", _hoisted_13, [
            _cache[53] || (_cache[53] = createBaseVNode("span", { class: "text-[10px] font-black text-purple-800 uppercase tracking-widest block" }, "Advanced Search & Filter Parameters", -1)),
            createBaseVNode("div", _hoisted_14, [
              createBaseVNode("div", null, [
                _cache[45] || (_cache[45] = createBaseVNode("label", { class: "text-[9px] font-bold text-slate-400 uppercase tracking-widest mb-1.5 block" }, "Student (Name / CRN)", -1)),
                withDirectives(createBaseVNode("input", {
              ...
              createBaseVNode("div", null, [
                _cache[46] || (_cache[46] = createBaseVNode("label", { class: "text-[9px] font-bold text-slate-400 uppercase tracking-widest mb-1.5 block" }, "Seat Number", -1)),
                withDirectives(createBaseVNode("input", {
              ...
              createBaseVNode("div", null, [
                _cache[48] || (_cache[48] = createBaseVNode("label", { class: "text-[9px] font-bold text-slate-400 uppercase tracking-widest mb-1.5 block" }, "Booking Status", -1)),
                withDirectives(createBaseVNode("select", {
                  ...
                  createStaticVNode('<option value="all" data-v-43581010>All Statuses</option><option value="booked" data-v-43581010>Booked</option><option value="checked_in" data-v-43581010>Checked In</option><option value="checked_out" data-v-43581010>Checked Out</option><option value="cancelled" data-v-43581010>Cancelled</option>', 5)
                ])], 512), [
                  [vModelSelect, filters.bookingStatus]
                ])
              ]),
              createBaseVNode("div", null, [
                _cache[50] || (_cache[50] = createBaseVNode("label", { class: "text-[9px] font-bold text-slate-400 uppercase tracking-widest mb-1.5 block" }, "Check-in Status", -1)),
                withDirectives(createBaseVNode("select", {
              ...
              createBaseVNode("div", null, [
                _cache[52] || (_cache[52] = createBaseVNode("label", { class: "text-[9px] font-bold text-slate-400 uppercase tracking-widest mb-1.5 block" }, "Overstay Status", -1)),
                withDirectives(createBaseVNode("select", {
                  "onUpdate:modelValue": _cache[9] || (_cache[9] = ($event) => filters.overstayStatus = $event),
                  class: "w-full px-3 py-2 bg-white border border-slate-200 rounded-xl text-xs font-bold text-slate-700 focus:ring-2 focus:ring-purple-500/10 focus:border-purple-500 outline-none cursor-pointer"
                }, [..._cache[51] || (_cache[51] = [
                  createStaticVNode('<option value="all" data-v-43581010>All Overstays</option><option value="on_time" data-v-43581010>Checked Out On Time</option><option value="early" data-v-43581010>Early Check-out</option><option value="overstay" data-v-43581010>Overstay (&lt; 1 Hour)</option><option value="serious_overstay" data-v-43581010>Serious Overstay (≥ 1 Hour)</option><option value="cancelled" data-v-43581010>Auto Cancelled</option>', 6)
                ])], 512), [
          ...
          filters.category === "book_reservations" ? (openBlock(), createElementBlock("div", _hoisted_15, [
            _cache[62] || (_cache[62] = createBaseVNode("span", { class: "text-[10px] font-black text-purple-800 uppercase tracking-widest block" }, "Advanced Book Reservation Filter Parameters", -1)),
            createBaseVNode("div", _hoisted_16, [
              createBaseVNode("div", null, [
                _cache[54] || (_cache[54] = createBaseVNode("label", { class: "text-[9px] font-bold text-slate-400 uppercase tracking-widest mb-1.5 block" }, "Student (Name / CRN)", -1)),
                withDirectives(createBaseVNode("input", {
              ...
              createBaseVNode("div", null, [
                _cache[55] || (_cache[55] = createBaseVNode("label", { class: "text-[9px] font-bold text-slate-400 uppercase tracking-widest mb-1.5 block" }, "Book (Title / ISBN)", -1)),
                withDirectives(createBaseVNode("input", {
              ...
              createBaseVNode("div", null, [
                _cache[57] || (_cache[57] = createBaseVNode("label", { class: "text-[9px] font-bold text-slate-400 uppercase tracking-widest mb-1.5 block" }, "Book Category", -1)),
                withDirectives(createBaseVNode("select", {
                  "onUpdate:modelValue": _cache[12] || (_cache[12] = ($event) => filters.bookCategory = $event),
                  class: "w-full px-3 py-2 bg-white border border-slate-200 rounded-xl text-xs font-bold text-slate-700 focus:ring-2 focus:ring-purple-500/10 focus:border-purple-500 outline-none cursor-pointer"
                }, [..._cache[56] || (_cache[56] = [
                  createStaticVNode('<option value="all" data-v-43581010>All Categories</option><option value="Fiction" data-v-43581010>Fiction</option><option value="Science" data-v-43581010>Science</option><option value="Technology" data-v-43581010>Technology</option><option value="Mathematics" data-v-43581010>Mathematics</option><option value="History" data-v-43581010>History</option><option value="Biography" data-v-43581010>Biography</option>', 7)
                ])], 512), [
                  [vModelSelect, filters.bookCategory]
                ])
              ]),
              createBaseVNode("div", null, [
                _cache[59] || (_cache[59] = createBaseVNode("label", { class: "text-[9px] font-bold text-slate-400 uppercase tracking-widest mb-1.5 block" }, "Reservation Status", -1)),
                withDirectives(createBaseVNode("select", {
                  "onUpdate:modelValue": _cache[13] || (_cache[13] = ($event) => filters.reservationStatus = $event),
                  class: "w-full px-3 py-2 bg-white border border-slate-200 rounded-xl text-xs font-bold text-slate-700 focus:ring-2 focus:ring-purple-500/10 focus:border-purple-500 outline-none cursor-pointer"
                }, [..._cache[58] || (_cache[58] = [
                  createStaticVNode('<option value="all" data-v-43581010>All Statuses</option><option value="pending" data-v-43581010>Pending Approval</option><option value="approved" data-v-43581010>Approved</option><option value="rejected" data-v-43581010>Rejected</option><option value="collected" data-v-43581010>Collected</option>', 5)
                ])], 512), [
                  [vModelSelect, filters.reservationStatus]
                ])
              ]),
              createBaseVNode("div", null, [
                _cache[61] || (_cache[61] = createBaseVNode("label", { class: "text-[9px] font-bold text-slate-400 uppercase tracking-widest mb-1.5 block" }, "Return Status (Time Analysis)", -1)),
                withDirectives(createBaseVNode("select", {
                  "onUpdate:modelValue": _cache[14] || (_cache[14] = ($event) => filters.returnStatus = $event),
                  class: "w-full px-3 py-2 bg-white border border-slate-200 rounded-xl text-xs font-bold text-slate-700 focus:ring-2 focus:ring-purple-500/10 focus:border-purple-500 outline-none cursor-pointer"
                }, [..._cache[60] || (_cache[60] = [
                  createStaticVNode('<option value="all" data-v-43581010>All Returns</option><option value="Returned On Time" data-v-43581010>Returned On Time</option><option value="Returned Early" data-v-43581010>Returned Early</option><option value="Returned Late" data-v-43581010>Returned Late</option><option value="Not Picked Up" data-v-43581010>Not Picked Up</option><option value="Borrowed" data-v-43581010>Borrowed (Active)</option><option value="Overdue" data-v-43581010>Overdue (Active)</option>', 7)
                ])], 512), [
          ...
          filters.category === "complaints" ? (openBlock(), createElementBlock("div", _hoisted_17, [
            _cache[70] || (_cache[70] = createBaseVNode("span", { class: "text-[10px] font-black text-purple-800 uppercase tracking-widest block" }, "Advanced Support Ticket / Complaints Filter Parameters", -1)),
            createBaseVNode("div", _hoisted_18, [
              createBaseVNode("div", null, [
                _cache[63] || (_cache[63] = createBaseVNode("label", { class: "text-[9px] font-bold text-slate-400 uppercase tracking-widest mb-1.5 block" }, "Student (Name / CRN)", -1)),
                withDirectives(createBaseVNode("input", {
              ...
              createBaseVNode("div", null, [
                _cache[65] || (_cache[65] = createBaseVNode("label", { class: "text-[9px] font-bold text-slate-400 uppercase tracking-widest mb-1.5 block" }, "Complaint Category", -1)),
                withDirectives(createBaseVNode("select", {
              ...
              createBaseVNode("div", null, [
                _cache[67] || (_cache[67] = createBaseVNode("label", { class: "text-[9px] font-bold text-slate-400 uppercase tracking-widest mb-1.5 block" }, "Priority", -1)),
                withDirectives(createBaseVNode("select", {
                  "onUpdate:modelValue": _cache[17] || (_cache[17] = ($event) => filters.complaintPriority = $event),
                  class: "w-full px-3 py-2 bg-white border border-slate-200 rounded-xl text-xs font-bold text-slate-700 focus:ring-2 focus:ring-purple-500/10 focus:border-purple-500 outline-none cursor-pointer"
                }, [..._cache[66] || (_cache[66] = [
                  createStaticVNode('<option value="all" data-v-43581010>All Priorities</option><option value="low" data-v-43581010>Low</option><option value="medium" data-v-43581010>Medium</option><option value="high" data-v-43581010>High</option><option value="urgent" data-v-43581010>Urgent</option>', 5)
                ])], 512), [
                  [vModelSelect, filters.complaintPriority]
                ])
              ]),
              createBaseVNode("div", null, [
                _cache[69] || (_cache[69] = createBaseVNode("label", { class: "text-[9px] font-bold text-slate-400 uppercase tracking-widest mb-1.5 block" }, "Complaint Status", -1)),
                withDirectives(createBaseVNode("select", {
                  "onUpdate:modelValue": _cache[18] || (_cache[18] = ($event) => filters.complaintStatus = $event),
                  class: "w-full px-3 py-2 bg-white border border-slate-200 rounded-xl text-xs font-bold text-slate-700 focus:ring-2 focus:ring-purple-500/10 focus:border-purple-500 outline-none cursor-pointer"
                }, [..._cache[68] || (_cache[68] = [
                  createStaticVNode('<option value="all" data-v-43581010>All Statuses</option><option value="open" data-v-43581010>Pending</option><option value="in_progress" data-v-43581010>In Progress</option><option value="resolved" data-v-43581010>Resolved</option><option value="closed" data-v-43581010>Closed</option>', 5)
                ])], 512), [
          ...
          filters.category === "events" ? (openBlock(), createElementBlock("div", _hoisted_19, [
            _cache[80] || (_cache[80] = createBaseVNode("span", { class: "text-[10px] font-black text-purple-800 uppercase tracking-widest block" }, "Advanced Campus Events Filter Parameters", -1)),
            createBaseVNode("div", _hoisted_20, [
              createBaseVNode("div", null, [
                _cache[71] || (_cache[71] = createBaseVNode("label", { class: "text-[9px] font-bold text-slate-400 uppercase tracking-widest mb-1.5 block" }, "Search Event (Title/Venue)", -1)),
                withDirectives(createBaseVNode("input", {
              ...
              createBaseVNode("div", null, [
                _cache[73] || (_cache[73] = createBaseVNode("label", { class: "text-[9px] font-bold text-slate-400 uppercase tracking-widest mb-1.5 block" }, "Event Type", -1)),
                withDirectives(createBaseVNode("select", {
                  "onUpdate:modelValue": _cache[20] || (_cache[20] = ($event) => filters.eventType = $event),
                  class: "w-full px-3 py-2 bg-white border border-slate-200 rounded-xl text-xs font-bold text-slate-700 focus:ring-2 focus:ring-purple-500/10 focus:border-purple-500 outline-none cursor-pointer"
                }, [..._cache[72] || (_cache[72] = [
                  createStaticVNode('<option value="all" data-v-43581010>All Types</option><option value="seminar" data-v-43581010>Seminar</option><option value="workshop" data-v-43581010>Workshop</option><option value="study_group" data-v-43581010>Study Group</option><option value="exam_prep" data-v-43581010>Exam Prep</option><option value="career_guidance" data-v-43581010>Career Guidance</option><option value="networking" data-v-43581010>Networking</option>', 7)
                ])], 512), [
                  [vModelSelect, filters.eventType]
                ])
              ]),
              createBaseVNode("div", null, [
                _cache[75] || (_cache[75] = createBaseVNode("label", { class: "text-[9px] font-bold text-slate-400 uppercase tracking-widest mb-1.5 block" }, "Pricing Type", -1)),
                withDirectives(createBaseVNode("select", {
              ...
              createBaseVNode("div", null, [
                _cache[77] || (_cache[77] = createBaseVNode("label", { class: "text-[9px] font-bold text-slate-400 uppercase tracking-widest mb-1.5 block" }, "Capacity Status", -1)),
                withDirectives(createBaseVNode("select", {
              ...
              createBaseVNode("div", null, [
                _cache[79] || (_cache[79] = createBaseVNode("label", { class: "text-[9px] font-bold text-slate-400 uppercase tracking-widest mb-1.5 block" }, "Event Status", -1)),
                withDirectives(createBaseVNode("select", {
                  "onUpdate:modelValue": _cache[23] || (_cache[23] = ($event) => filters.eventStatus = $event),
                  class: "w-full px-3 py-2 bg-white border border-slate-200 rounded-xl text-xs font-bold text-slate-700 focus:ring-2 focus:ring-purple-500/10 focus:border-purple-500 outline-none cursor-pointer"
                }, [..._cache[78] || (_cache[78] = [
                  createStaticVNode('<option value="all" data-v-43581010>All Statuses</option><option value="upcoming" data-v-43581010>Upcoming</option><option value="ongoing" data-v-43581010>Ongoing</option><option value="completed" data-v-43581010>Completed</option><option value="cancelled" data-v-43581010>Cancelled</option>', 5)
                ])], 512), [
          ...
          filters.category === "attendance" ? (openBlock(), createElementBlock("div", _hoisted_21, [
            _cache[87] || (_cache[87] = createBaseVNode("span", { class: "text-[10px] font-black text-purple-800 uppercase tracking-widest block" }, "Advanced Student Attendance Filter Parameters", -1)),
            createBaseVNode("div", _hoisted_22, [
              createBaseVNode("div", null, [
                _cache[81] || (_cache[81] = createBaseVNode("label", { class: "text-[9px] font-bold text-slate-400 uppercase tracking-widest mb-1.5 block" }, "Search Student (Name / CRN)", -1)),
                withDirectives(createBaseVNode("input", {
              ...
              createBaseVNode("div", null, [
                _cache[83] || (_cache[83] = createBaseVNode("label", { class: "text-[9px] font-bold text-slate-400 uppercase tracking-widest mb-1.5 block" }, "Attendance Status", -1)),
                withDirectives(createBaseVNode("select", {
              ...
              createBaseVNode("div", null, [
                _cache[85] || (_cache[85] = createBaseVNode("label", { class: "text-[9px] font-bold text-slate-400 uppercase tracking-widest mb-1.5 block" }, "Check-in Method", -1)),
                withDirectives(createBaseVNode("select", {
              ...
              createBaseVNode("div", null, [
                _cache[86] || (_cache[86] = createBaseVNode("label", { class: "text-[9px] font-bold text-slate-400 uppercase tracking-widest mb-1.5 block" }, "Seat Designation", -1)),
                withDirectives(createBaseVNode("input", {
        ...
        generatedReport.value ? (openBlock(), createElementBlock("div", _hoisted_25, [
          createBaseVNode("div", _hoisted_26, [
            createBaseVNode("div", _hoisted_27, [
              _cache[88] || (_cache[88] = createBaseVNode("span", { class: "w-2.5 h-2.5 rounded-full bg-purple-500 animate-ping" }, null, -1)),
            ...
            createBaseVNode("div", _hoisted_29, [
              createBaseVNode("button", {
                ...
                _cache[89] || (_cache[89] = createBaseVNode("span", null, "Export CSV", -1))
              ]),
              createBaseVNode("button", {
                ...
                _cache[90] || (_cache[90] = createBaseVNode("span", null, "Download PDF", -1))
              ]),
              createBaseVNode("button", {
                ...
                _cache[91] || (_cache[91] = createBaseVNode("span", null, "Print Report", -1))
              ]),
              createBaseVNode("button", {
                onClick: _cache[31] || (_cache[31] = ($event) => generatedReport.value = null),
                ...
                createVNode(unref(X), { class: "w-4 h-4 text-slate-500" }),
                _cache[92] || (_cache[92] = createBaseVNode("span", null, "Close View", -1))
              ])
            ])
          ]),
          createBaseVNode("div", _hoisted_30, [
            createBaseVNode("div", _hoisted_31, [
              createBaseVNode("div", _hoisted_32, [
                ...
                createBaseVNode("div", _hoisted_40, [
                  ...
                  createBaseVNode("p", _hoisted_42, [
                    _cache[93] || (_cache[93] = createTextVNode(" Period: ", -1)),
                      ...
                      return openBlock(), createElementBlock("tr", {
                        ...
                        createBaseVNode("td", _hoisted_106, [
                          createBaseVNode("div", _hoisted_107, [
                            createBaseVNode("div", null, [
                              _cache[96] || (_cache[96] = createTextVNode("Price: ", -1)),
                      ...
                      return openBlock(), createElementBlock("tr", {
                        ...
                        createBaseVNode("td", _hoisted_120, [
                          createBaseVNode("div", _hoisted_121, [
                            createBaseVNode("div", null, [
                              _cache[97] || (_cache[97] = createTextVNode("In: ", -1)),
                              createBaseVNode("span", _hoisted_122, toDisplayString(row.checkInTime), 1)
                            ]),
                            createBaseVNode("div", null, [
                              _cache[98] || (_cache[98] = createTextVNode("Out: ", -1)),
                      ...
                      return openBlock(), createElementBlock("tr", {
                        ...
                        (openBlock(true), createElementBlock(Fragment, null, renderList(Object.values(row).slice(1), (val, colIdx) => {
                          return openBlock(), createElementBlock("td", {
                            ...
                            colIdx === Object.keys(row).length - 2 && isStatusField(String(val)) ? (openBlock(), createElementBlock("span", {
                              key: 0,
                              innerHTML: statusBadgeHtml(String(val))
              ...
              createBaseVNode("div", _hoisted_132, [
                createBaseVNode("div", _hoisted_133, [
                  createBaseVNode("div", null, [
                    _cache[99] || (_cache[99] = createTextVNode("Total Records: ", -1)),
                  ...
                  filters.category === "bookings" ? (openBlock(), createElementBlock("div", _hoisted_135, [
                    _cache[100] || (_cache[100] = createTextVNode("Total Hours Used: ", -1)),
                ...
                totalPages.value > 1 ? (openBlock(), createElementBlock("div", _hoisted_137, [
                  createBaseVNode("button", {
                    onClick: _cache[32] || (_cache[32] = ($event) => currentPage.value = Math.max(1, currentPage.value - 1)),
                  ...
                  createBaseVNode("button", {
                    onClick: _cache[33] || (_cache[33] = ($event) => currentPage.value = Math.min(totalPages.value, currentPage.value + 1)),
            ...
            createBaseVNode("div", _hoisted_141, [
              _cache[101] || (_cache[101] = createBaseVNode("div", null, "SmartLib Consolidated Audit Log", -1)),
              _cache[102] || (_cache[102] = createBaseVNode("div", { class: "text-center italic" }, "This report was generated automatically by SmartLib.", -1)),
          ...
          _cache[103] || (_cache[103] = createBaseVNode("h3", { class: "text-base font-bold text-slate-850" }, "No Consolidations Running", -1)),
          _cache[104] || (_cache[104] = createBaseVNode("p", { class: "text-slate-455 text-xs mt-1.5 max-w-sm mx-auto font-medium leading-relaxed" }, " Select target library, category, configure parameters and click **Generate Report** to view console logs. ", -1))
        ])),
        createBaseVNode("div", _hoisted_144, [
          createBaseVNode("div", _hoisted_145, [
            createBaseVNode("div", _hoisted_146, [
              createBaseVNode("div", _hoisted_147, [
                createVNode(unref(CalendarDays), { class: "w-6 h-6" })
              ]),
              _cache[105] || (_cache[105] = createBaseVNode("div", null, [
                createBaseVNode("h3", { class: "text-base font-bold text-slate-800 tracking-tight" }, "Automated Library Reports Hub"),
                createBaseVNode("p", { class: "text-xs text-slate-500 font-medium mt-0.5" }, "View, manage and download daily, weekly & monthly reports scheduled by librarians across libraries.")
              ], -1))
            ]),
            createBaseVNode("div", _hoisted_148, [
              _cache[107] || (_cache[107] = createBaseVNode("label", { class: "text-[10px] font-bold text-slate-400 uppercase tracking-wider" }, "Frequency:", -1)),
              withDirectives(createBaseVNode("select", {
                "onUpdate:modelValue": _cache[34] || (_cache[34] = ($event) => frequencyFilter.value = $event),
                class: "px-3.5 py-2 bg-slate-50 border border-slate-200 rounded-xl text-xs font-bold text-slate-700 outline-none cursor-pointer focus:ring-2 focus:ring-purple-500/20 focus:border-purple-400 shadow-sm"
              }, [..._cache[106] || (_cache[106] = [
                createBaseVNode("option", { value: "all" }, "All Frequencies", -1),
                createBaseVNode("option", { value: "daily" }, "Daily Base", -1),
                createBaseVNode("option", { value: "weekly" }, "Weekly Base", -1),
                createBaseVNode("option", { value: "monthly" }, "Monthly Base", -1)
              ])], 512), [
                [vModelSelect, frequencyFilter.value]
              ])
            ])
          ]),
          createBaseVNode("div", _hoisted_149, [
            createBaseVNode("button", {
              onClick: _cache[35] || (_cache[35] = ($event) => activeSubTab.value = "scheduled"),
              class: normalizeClass([
                "px-4 py-2 rounded-xl text-xs font-bold transition-all cursor-pointer flex items-center space-x-2",
                activeSubTab.value === "scheduled" ? "bg-white text-purple-900 shadow-sm border border-slate-200/80 font-extrabold" : "text-slate-500 hover:text-slate-800 hover:bg-white/60"
              ])
            }, [
              createVNode(unref(Clock), { class: "w-4 h-4 text-purple-600" }),
              createBaseVNode("span", null, "Scheduled Automations (" + toDisplayString(displayScheduledReports.value.length) + ")", 1)
            ], 2),
            createBaseVNode("button", {
              onClick: _cache[36] || (_cache[36] = ($event) => activeSubTab.value = "history"),
              class: normalizeClass([
                "px-4 py-2 rounded-xl text-xs font-bold transition-all cursor-pointer flex items-center space-x-2",
                activeSubTab.value === "history" ? "bg-white text-purple-900 shadow-sm border border-slate-200/80 font-extrabold" : "text-slate-500 hover:text-slate-800 hover:bg-white/60"
              ])
            }, [
              createVNode(unref(History), { class: "w-4 h-4 text-emerald-600" }),
              createBaseVNode("span", null, "Generated Reports Archive (" + toDisplayString(displayGeneratedReports.value.length) + ")", 1)
            ], 2)
          ]),
          activeSubTab.value === "scheduled" ? (openBlock(), createElementBlock("div", _hoisted_150, [
            displayScheduledReports.value.length === 0 ? (openBlock(), createElementBlock("div", _hoisted_151, [
              createVNode(unref(CalendarDays), { class: "w-10 h-10 text-slate-300 mx-auto mb-3" }),
              _cache[108] || (_cache[108] = createBaseVNode("p", { class: "text-slate-400 text-xs font-bold uppercase tracking-wider" }, "No automated report schedules match your selection.", -1))
            ])) : (openBlock(), createElementBlock("div", _hoisted_152, [
              createBaseVNode("table", _hoisted_153, [
                _cache[112] || (_cache[112] = createBaseVNode("thead", null, [
                  createBaseVNode("tr", { class: "bg-slate-50/80 text-slate-400 font-bold uppercase tracking-wider border-b border-slate-100" }, [
                    createBaseVNode("th", { class: "py-3 px-4 font-bold text-left" }, "Library Name"),
                    createBaseVNode("th", { class: "py-3 px-4 font-bold text-left" }, "Librarian"),
                    createBaseVNode("th", { class: "py-3 px-4 font-bold text-left" }, "Report Type"),
                    createBaseVNode("th", { class: "py-3 px-4 font-bold text-left" }, "Frequency"),
                    createBaseVNode("th", { class: "py-3 px-4 font-bold text-left" }, "Format"),
                    createBaseVNode("th", { class: "py-3 px-4 font-bold text-left" }, "Delivery Time"),
                    createBaseVNode("th", { class: "py-3 px-4 font-bold text-left" }, "Status"),
                    createBaseVNode("th", { class: "py-3 px-4 font-bold text-right" }, "Action")
                  ])
                ], -1)),
                createBaseVNode("tbody", _hoisted_154, [
                  (openBlock(true), createElementBlock(Fragment, null, renderList(displayScheduledReports.value, (s) => {
                    return openBlock(), createElementBlock("tr", {
                      key: s.id,
                      class: "hover:bg-slate-50/50 font-semibold text-slate-650"
                    }, [
                      createBaseVNode("td", _hoisted_155, [
                        createBaseVNode("span", null, toDisplayString(s.library_name), 1)
                      ]),
                      createBaseVNode("td", _hoisted_156, [
                        createBaseVNode("span", _hoisted_157, toDisplayString(s.librarian_name), 1),
                        createBaseVNode("span", _hoisted_158, toDisplayString(s.recipient_email), 1)
                      ]),
                      createBaseVNode("td", _hoisted_159, toDisplayString(s.report_type), 1),
                      createBaseVNode("td", _hoisted_160, [
                        createBaseVNode("span", {
                          class: normalizeClass([
                            "px-2.5 py-1 rounded-lg text-[10px] font-extrabold uppercase border",
                            s.frequency === "daily" ? "bg-blue-50 border-blue-100 text-blue-700" : s.frequency === "weekly" ? "bg-purple-50 border-purple-100 text-purple-700" : "bg-amber-50 border-amber-100 text-amber-700"
                          ])
                        }, toDisplayString(s.frequency) + " Base ", 3)
                      ]),
                      createBaseVNode("td", _hoisted_161, [
                        createBaseVNode("span", {
                          class: normalizeClass(s.format === "pdf" ? "text-red-600 bg-red-50 px-2 py-0.5 rounded border border-red-100" : "text-emerald-700 bg-emerald-50 px-2 py-0.5 rounded border border-emerald-100")
                        }, toDisplayString(s.format), 3)
                      ]),
                      createBaseVNode("td", _hoisted_162, toDisplayString(s.send_time || "08:00"), 1),
                      createBaseVNode("td", _hoisted_163, [
                        createBaseVNode("span", {
                          class: normalizeClass(s.status === "active" ? "text-emerald-700 bg-emerald-50 border border-emerald-100 px-2.5 py-0.5 rounded-full text-[9px] font-bold uppercase" : "text-slate-500 bg-slate-100 px-2.5 py-0.5 rounded-full text-[9px] font-bold uppercase")
                        }, toDisplayString(s.status), 3)
                      ]),
                      createBaseVNode("td", _hoisted_164, [
                        createBaseVNode("div", _hoisted_165, [
                          createBaseVNode("button", {
                            onClick: ($event) => viewScheduledReport(s),
                            class: "px-2.5 py-1.5 bg-purple-50 hover:bg-purple-100 text-purple-700 border border-purple-200/80 rounded-lg font-bold text-[11px] transition-all cursor-pointer inline-flex items-center gap-1 shadow-sm",
                            title: "View Report Details"
                          }, [
                            createVNode(unref(Eye), { class: "w-3.5 h-3.5" }),
                            _cache[109] || (_cache[109] = createBaseVNode("span", null, "View", -1))
                          ], 8, _hoisted_166),
                          createBaseVNode("button", {
                            onClick: ($event) => downloadScheduledReport(s),
                            class: "px-2.5 py-1.5 bg-emerald-50 hover:bg-emerald-100 text-emerald-700 border border-emerald-200/80 rounded-lg font-bold text-[11px] transition-all cursor-pointer inline-flex items-center gap-1 shadow-sm",
                            title: "Download Report File"
                          }, [
                            createVNode(unref(Download), { class: "w-3.5 h-3.5" }),
                            _cache[110] || (_cache[110] = createBaseVNode("span", null, "Download", -1))
                          ], 8, _hoisted_167),
                          createBaseVNode("button", {
                            onClick: ($event) => printScheduledReport(s),
                            class: "px-2.5 py-1.5 bg-slate-100 hover:bg-slate-200 text-slate-700 border border-slate-200/80 rounded-lg font-bold text-[11px] transition-all cursor-pointer inline-flex items-center gap-1 shadow-sm",
                            title: "Print Report"
                          }, [
                            createVNode(unref(Printer), { class: "w-3.5 h-3.5" }),
                            _cache[111] || (_cache[111] = createBaseVNode("span", null, "Print", -1))
                          ], 8, _hoisted_168)
                        ])
                      ])
                    ]);
          ...
          activeSubTab.value === "history" ? (openBlock(), createElementBlock("div", _hoisted_169, [
            displayGeneratedReports.value.length === 0 ? (openBlock(), createElementBlock("div", _hoisted_170, [
              createVNode(unref(History), { class: "w-10 h-10 text-slate-300 mx-auto mb-3" }),
              _cache[113] || (_cache[113] = createBaseVNode("p", { class: "text-slate-400 text-xs font-bold uppercase tracking-wider" }, "No generated report archives match your selection.", -1))
            ])) : (openBlock(), createElementBlock("div", _hoisted_171, [
              createBaseVNode("table", _hoisted_172, [
                _cache[117] || (_cache[117] = createBaseVNode("thead", null, [
                  createBaseVNode("tr", { class: "bg-slate-50/80 text-slate-400 font-bold uppercase tracking-wider border-b border-slate-100" }, [
                    createBaseVNode("th", { class: "py-3 px-4 font-bold text-left" }, "Library"),
                ...
                createBaseVNode("tbody", _hoisted_173, [
                  (openBlock(true), createElementBlock(Fragment, null, renderList(displayGeneratedReports.value, (g) => {
                    return openBlock(), createElementBlock("tr", {
                      key: g.id,
                      class: "hover:bg-slate-50/50 font-semibold text-slate-650"
                    }, [
                      createBaseVNode("td", _hoisted_174, [
                        createBaseVNode("span", null, toDisplayString(g.library_name), 1)
                      ]),
                      createBaseVNode("td", _hoisted_175, toDisplayString(g.report_title), 1),
                      createBaseVNode("td", _hoisted_176, [
                        createBaseVNode("span", _hoisted_177, toDisplayString(g.frequency) + " Base ", 1)
                      ]),
                      createBaseVNode("td", _hoisted_178, [
                        createBaseVNode("span", {
                          class: normalizeClass(g.format === "pdf" ? "text-red-600 bg-red-50 px-2 py-0.5 rounded border border-red-100" : "text-emerald-700 bg-emerald-50 px-2 py-0.5 rounded border border-emerald-100")
                        }, toDisplayString(g.format), 3)
                      ]),
                      createBaseVNode("td", _hoisted_179, toDisplayString(g.generatedAt), 1),
                      createBaseVNode("td", _hoisted_180, [
                        createBaseVNode("div", _hoisted_181, [
                          createBaseVNode("button", {
                            onClick: ($event) => viewGeneratedReportArchive(g),
                            class: "px-2.5 py-1.5 bg-purple-50 hover:bg-purple-100 text-purple-700 border border-purple-200/80 rounded-lg font-bold text-[11px] transition-all cursor-pointer inline-flex items-center gap-1 shadow-sm",
                            title: "View Report Details"
                          }, [
                            createVNode(unref(Eye), { class: "w-3.5 h-3.5" }),
                            _cache[114] || (_cache[114] = createBaseVNode("span", null, "View", -1))
                          ], 8, _hoisted_182),
                          createBaseVNode("button", {
                            onClick: ($event) => downloadGeneratedReportArchive(g),
                            class: "px-2.5 py-1.5 bg-emerald-600 hover:bg-emerald-700 text-white rounded-lg font-bold text-[11px] transition-all cursor-pointer inline-flex items-center gap-1 shadow-sm",
                            title: "Download Report File"
                          }, [
                            createVNode(unref(Download), { class: "w-3.5 h-3.5" }),
                            _cache[115] || (_cache[115] = createBaseVNode("span", null, "Download", -1))
                          ], 8, _hoisted_183),
                          createBaseVNode("button", {
                            onClick: ($event) => printGeneratedReportArchive(g),
                            class: "px-2.5 py-1.5 bg-slate-100 hover:bg-slate-200 text-slate-700 border border-slate-200/80 rounded-lg font-bold text-[11px] transition-all cursor-pointer inline-flex items-center gap-1 shadow-sm",
                            title: "Print Report"
                          }, [
                            createVNode(unref(Printer), { class: "w-3.5 h-3.5" }),
                            _cache[116] || (_cache[116] = createBaseVNode("span", null, "Print", -1))
                          ], 8, _hoisted_184)
                        ])
                      ])
                    ]);
...
const ReportsPage = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-43581010"]]);
export {
