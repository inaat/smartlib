import { d as defineComponent, r as ref, E as watch, o as onMounted, c as computed, x as useAuth, H as onUnmounted, a as createElementBlock, b as createBaseVNode, j as createCommentVNode, f as createVNode, w as withCtx, g as resolveComponent, u as unref, t as toDisplayString, n as normalizeClass, i as createTextVNode, h as createBlock, F as Fragment, p as withDirectives, D as vModelSelect, k as renderList, v as vModelText, C as useRouter, G as useRoute, L as studentAPI, l as openBlock } from "./main-D4odWxzi.js";
import { _ as _sfc_main$1, S as SeatLayoutRenderer } from "./SeatLayoutRenderer-CwwdXUOF.js";
import { u as useSwal } from "./useSwal-pQW_XkRe.js";
import { u as useGeolocation } from "./useGeolocation-CzuynqYt.js";
...
import { U as UserX } from "./user-x-BlJ7MBTf.js";
...
import "./chevron-down-DGoXiOPy.js";
const _hoisted_1 = {
  key: 0,
...
const _hoisted_27 = { class: "text-[10px] text-slate-800 font-medium leading-normal m-0" };
const _hoisted_28 = {
  key: 1,
  class: "p-3 bg-red-50 border border-red-100 rounded-xl flex items-start space-x-2"
};
const _hoisted_29 = { class: "grid grid-cols-2 gap-3" };
const _hoisted_30 = ["min", "max"];
const _hoisted_31 = { class: "text-[10px] font-semibold text-slate-400 uppercase tracking-wider mb-1.5 flex items-center justify-between" };
const _hoisted_32 = {
  key: 0,
...
const _hoisted_33 = { class: "pt-4 border-t border-slate-100" };
...
const _hoisted_37 = { class: "p-5 bg-gradient-to-br from-slate-50 to-white rounded-xl border border-slate-100 text-center relative overflow-hidden" };
const _hoisted_38 = { class: "flex items-center justify-center space-x-1.5 mb-3.5 leading-none" };
const _hoisted_39 = { class: "text-xl font-black text-slate-800 leading-none" };
const _hoisted_40 = { class: "space-y-3" };
...
const _hoisted_44 = { class: "w-12 h-12 bg-slate-50 border border-slate-200 rounded-full flex items-center justify-center mx-auto mb-3 text-slate-400 shadow-inner" };
const _hoisted_45 = { class: "bg-orange-50/50 p-5 rounded-2xl border border-orange-100 text-left" };
const _hoisted_46 = { class: "flex items-center mb-2" };
const _hoisted_47 = {
  key: 0,
  class: "fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/40 backdrop-blur-sm"
};
const _hoisted_48 = { class: "bg-white rounded-2xl p-6 max-w-sm w-full text-center shadow-2xl border border-slate-100 animate-fade-in" };
const _hoisted_49 = { class: "w-16 h-16 bg-emerald-50 border border-emerald-100 text-emerald-600 rounded-full flex items-center justify-center mx-auto mb-4" };
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const resetToCurrentTime = () => {
      isManualTime.value = false;
      selectedDate.value = toLocalDateStr(/* @__PURE__ */ new Date());
      selectedTime.value = toLocalTimeStr(/* @__PURE__ */ new Date());
      updateLiveTime();
    };
    const onDateChange = () => {
        ...
        createBaseVNode("div", _hoisted_6, [
          ...
          createBaseVNode("div", _hoisted_8, [
            createBaseVNode("div", _hoisted_9, [
              _cache[20] || (_cache[20] = createBaseVNode("h3", { class: "text-sm font-bold text-slate-700 uppercase tracking-wider mb-5" }, "Booking Summary", -1)),
              selectedSeat.value ? (openBlock(), createElementBlock("div", _hoisted_10, [
                ...
                getSeatOverrideStatus(selectedSeat.value.id) === "approved" ? (openBlock(), createElementBlock("div", _hoisted_15, [
                  ...
                  _cache[7] || (_cache[7] = createBaseVNode("p", { class: "text-[11px] text-emerald-900 font-bold leading-tight m-0" }, " Override Request Approved! You can now reserve this seat for today. ", -1))
                ...
                isGenderMismatch(selectedSeat.value) ? (openBlock(), createElementBlock("div", _hoisted_16, [
                  ...
                  createBaseVNode("div", _hoisted_17, [
                    ...
                    createBaseVNode("div", null, [
                      createBaseVNode("p", {
                        ...
                        _cache[9] || (_cache[9] = createTextVNode(" This seat is restricted to ", -1)),
                        ...
                        _cache[10] || (_cache[10] = createTextVNode(" students. ", -1))
                      ], 2),
                  ...
                  userOverrideRequests.value.length === 0 ? (openBlock(), createElementBlock("button", {
                    ...
                    createBaseVNode("span", null, toDisplayString(submitting.value ? "Submitting Request..." : "Request Override from Librarian"), 1)
                  ...
                  createBaseVNode("div", _hoisted_23, [
                    createBaseVNode("div", null, [
                      _cache[11] || (_cache[11] = createBaseVNode("label", { class: "text-[10px] font-semibold text-slate-400 uppercase tracking-wider mb-1.5 block" }, "Duration", -1)),
                      withDirectives(createBaseVNode("select", {
                        ...
                        (openBlock(true), createElementBlock(Fragment, null, renderList(durationOptions.value, (opt) => {
                          return openBlock(), createElementBlock("option", {
                            key: opt.value,
                            value: opt.value
                          }, toDisplayString(opt.label), 9, _hoisted_25);
                        }), 128))
                      ], 8, _hoisted_24), [
                        [vModelSelect, bookingDuration.value]
                      ])
                    ]),
                    showClosingTimeNotice.value ? (openBlock(), createElementBlock("div", _hoisted_26, [
                      createVNode(unref(CircleAlert), { class: "w-4 h-4 text-slate-600 flex-shrink-0 mt-0.5" }),
                      createBaseVNode("p", _hoisted_27, " You can book this seat for a maximum of " + toDisplayString(formatHours(maxAvailableHours.value)) + " because the library closes at " + toDisplayString(formatTimeOnly(libraryClosingTime.value)) + ". ", 1)
                    ])) : createCommentVNode("", true),
                    maxAvailableHours.value === 0 ? (openBlock(), createElementBlock("div", _hoisted_28, [
                      createVNode(unref(CircleAlert), { class: "w-4 h-4 text-red-600 flex-shrink-0 mt-0.5" }),
                      _cache[12] || (_cache[12] = createBaseVNode("p", { class: "text-[10px] text-red-650 font-medium leading-normal m-0" }, " The library is closed during the selected start time. Please choose another date or time. ", -1))
                    ])) : createCommentVNode("", true),
                    createBaseVNode("div", _hoisted_29, [
                      createBaseVNode("div", null, [
                        _cache[13] || (_cache[13] = createBaseVNode("label", { class: "text-[10px] font-semibold text-slate-400 uppercase tracking-wider mb-1.5 flex items-center justify-between" }, [
                      ...
                      createBaseVNode("div", null, [
                        createBaseVNode("label", _hoisted_31, [
                          _cache[15] || (_cache[15] = createBaseVNode("span", null, "Start Time", -1)),
                          !isManualTime.value && selectedDate.value === minDate.value ? (openBlock(), createElementBlock("span", _hoisted_32, [..._cache[14] || (_cache[14] = [
                            createBaseVNode("span", { class: "w-1.5 h-1.5 rounded-full bg-emerald-500 animate-pulse" }, null, -1),
                            createTextVNode(" Live ", -1)
                          ])])) : isManualTime.value && selectedDate.value === minDate.value ? (openBlock(), createElementBlock("button", {
                            key: 1,
                            onClick: resetToCurrentTime,
                            type: "button",
                            class: "text-[8.5px] font-bold text-blue-600 hover:underline uppercase tracking-tight"
                          }, " Use Now ")) : createCommentVNode("", true)
                        ]),
                        withDirectives(createBaseVNode("input", {
                          type: "time",
                  ...
                  createBaseVNode("div", _hoisted_33, [
                    selectedSeat.value.status === "available" ? (openBlock(), createElementBlock("button", {
                      ...
                      submitting.value ? (openBlock(), createElementBlock("span", _hoisted_35)) : createCommentVNode("", true),
                      createBaseVNode("span", null, toDisplayString(submitting.value ? "Confirming..." : "Confirm Booking"), 1)
                    ], 8, _hoisted_34)) : (openBlock(), createElementBlock("div", _hoisted_36, [
                      createBaseVNode("div", _hoisted_37, [
                        _cache[17] || (_cache[17] = createBaseVNode("div", { class: "absolute top-0 right-0 w-16 h-16 bg-orange-500/5 rounded-full -mr-8 -mt-8" }, null, -1)),
                        _cache[18] || (_cache[18] = createBaseVNode("p", { class: "text-[9px] font-bold uppercase tracking-widest mb-2.5 leading-none text-amber-600" }, "Free Soon", -1)),
                        createBaseVNode("div", _hoisted_38, [
                          createVNode(unref(Clock), { class: "w-4.5 h-4.5 text-orange-500" }),
                          createBaseVNode("p", _hoisted_39, toDisplayString(Math.floor(selectedSeat.value.remaining_minutes / 60)) + "h " + toDisplayString(Math.floor(selectedSeat.value.remaining_minutes % 60)) + "m ", 1)
                        ]),
                        createBaseVNode("div", _hoisted_40, [
                          _cache[16] || (_cache[16] = createBaseVNode("div", { class: "p-2.5 bg-orange-50 border border-orange-100 rounded-xl text-center leading-normal" }, [
                ...
                _cache[19] || (_cache[19] = createBaseVNode("p", { class: "text-xs text-slate-400 max-w-[180px] mx-auto leading-normal" }, "Please select a seat from the map to continue", -1))
              ]))
            ]),
            createBaseVNode("div", _hoisted_45, [
              createBaseVNode("div", _hoisted_46, [
                createVNode(unref(Zap), { class: "w-4.5 h-4.5 text-orange-600 mr-2 fill-current" }),
                _cache[21] || (_cache[21] = createBaseVNode("h4", { class: "font-semibold text-orange-900 text-xs uppercase tracking-wide" }, "Quick Tip", -1))
              ]),
              _cache[22] || (_cache[22] = createBaseVNode("p", { class: "text-[11px] text-orange-800/90 leading-relaxed font-semibold" }, " Seats near windows are popular in the morning. Group study areas require all members to check in within 15 minutes. ", -1))
            ])
          ])
        ]),
        showSuccessModal.value ? (openBlock(), createElementBlock("div", _hoisted_47, [
          createBaseVNode("div", _hoisted_48, [
            createBaseVNode("div", _hoisted_49, [
              createVNode(unref(CircleCheckBig), { class: "w-8 h-8" })
            ]),
            _cache[23] || (_cache[23] = createBaseVNode("h2", { class: "text-lg font-semibold text-slate-800 mb-1" }, "Booking Confirmed!", -1)),
            _cache[24] || (_cache[24] = createBaseVNode("p", { class: "text-xs text-slate-400 mb-6 leading-relaxed" }, "Your seat has been reserved. Please check in within 15 minutes of your start time.", -1)),
            createBaseVNode("button", {
...
const SeatBookingPage = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-e7f17d7e"]]);
export {
