import { d as defineComponent, z as useAuth, a as computed, r as ref, o as onMounted, K as onUnmounted, b as createElementBlock, e as createBaseVNode, t as toDisplayString, u as unref, p as createCommentVNode, g as createVNode, j as createTextVNode, C as Clock, w as withCtx, h as resolveComponent, F as Fragment, k as renderList, f as createStaticVNode, x as normalizeStyle, W as librarianAPI, n as normalizeClass, m as openBlock, _ as _export_sfc } from "./main-BeUqjoax.js";
  ...
  setup(__props) {
    ...
    const fetchDashboardData = async (isSilent = false) => {
      ...
      try {
        ...
        recentBookings.value = (data.recentBookings || []).slice(0, 7).map((b) => ({
          id: b.id,
          ...
          createBaseVNode("div", _hoisted_31, [
            ...
            createBaseVNode("div", _hoisted_33, [
              createBaseVNode("div", _hoisted_34, [
                _cache[22] || (_cache[22] = createBaseVNode("div", { class: "flex items-center space-x-2" }, [
                  createBaseVNode("h2", { class: "text-lg font-bold text-slate-700" }, "Recent Activity")
                ], -1)),
                createVNode(_component_router_link, {
                  to: "/librarian/bookings",
                  class: "text-xs text-emerald-600 hover:text-emerald-700 font-bold flex items-center"
                }, {
          ...
          createBaseVNode("div", _hoisted_47, [
            ...
            createBaseVNode("div", _hoisted_53, [
              ...
              createBaseVNode("div", _hoisted_54, [
                ...
                _cache[27] || (_cache[27] = createStaticVNode('<div class="mt-4 space-y-2 pt-2 border-t border-slate-100" data-v-cec95bc0><div class="flex items-center justify-between text-xs font-semibold" data-v-cec95bc0><span class="text-slate-500" data-v-cec95bc0>Peak Hours Today</span><span class="font-bold text-gray-700 bg-slate-100 px-2 py-0.5 rounded-lg" data-v-cec95bc0>2:00 PM - 6:00 PM</span></div><div class="flex items-center justify-between text-xs font-semibold" data-v-cec95bc0><span class="text-slate-500" data-v-cec95bc0>Avg. Study Duration</span><span class="font-bold text-gray-700 bg-slate-100 px-2 py-0.5 rounded-lg" data-v-cec95bc0>3.5 Hours</span></div></div>', 1))
              ])
            ])
          ])
        ]),
...
const Dashboard = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-cec95bc0"]]);
export {
