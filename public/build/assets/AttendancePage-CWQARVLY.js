import { d as defineComponent, r as ref, o as onMounted, a as createElementBlock, b as createBaseVNode, j as createCommentVNode, f as createVNode, p as withDirectives, u as unref, v as vModelText, t as toDisplayString, D as vModelSelect, g as resolveComponent, F as Fragment, k as renderList, i as createTextVNode, S as withKeys, n as normalizeClass, O as librarianAPI, l as openBlock } from "./main-CP29_5Dg.js";
...
const _hoisted_47 = { class: "text-xs font-semibold text-slate-400 uppercase tracking-wider" };
const _hoisted_48 = { class: "text-slate-700 font-bold" };
const _hoisted_49 = { class: "text-slate-700 font-bold" };
const _hoisted_50 = { class: "text-slate-700 font-bold" };
const _hoisted_51 = { class: "flex items-center space-x-1.5" };
...
const _hoisted_56 = { class: "relative bg-white rounded-3xl shadow-2xl w-full max-w-sm overflow-hidden border border-slate-100 text-left animate-in duration-200" };
const _hoisted_57 = { class: "p-6 border-b border-slate-55 flex justify-between items-center bg-slate-50/20" };
const _hoisted_58 = { class: "p-6 space-y-5 text-left" };
    ...
    return (_ctx, _cache) => {
      ...
      return openBlock(), createElementBlock("div", _hoisted_1, [
        ...
        createBaseVNode("div", _hoisted_5, [
          ...
          createBaseVNode("div", _hoisted_14, [
            createBaseVNode("div", _hoisted_15, [
              ...
              createBaseVNode("h3", _hoisted_16, toDisplayString(formatDuration(stats.value.avg_minutes)), 1)
            ]),
        ...
        createBaseVNode("div", _hoisted_22, [
                    ...
                    createBaseVNode("td", _hoisted_28, [
                      createBaseVNode("div", _hoisted_29, [
                        ...
                        createBaseVNode("div", _hoisted_33, [
                          ...
                          createBaseVNode("div", _hoisted_35, "CRN: " + toDisplayString(record.user?.crn || "N/A"), 1)
                        ])
                      ])
                    ]),
                    createBaseVNode("td", _hoisted_36, toDisplayString(formatTime(record.check_in_time)), 1),
                    createBaseVNode("td", _hoisted_37, [
                      record.check_out_time ? (openBlock(), createElementBlock("span", _hoisted_38, toDisplayString(formatTime(record.check_out_time)), 1)) : (openBlock(), createElementBlock("span", _hoisted_39, [..._cache[21] || (_cache[21] = [
                        createBaseVNode("span", { class: "w-1.5 h-1.5 rounded-full bg-green-500 animate-pulse" }, null, -1),
                        createBaseVNode("span", null, "Present", -1)
                      ])]))
                    ]),
                    createBaseVNode("td", _hoisted_40, toDisplayString(record.total_minutes ? formatDuration(record.total_minutes) : "-"), 1),
          ...
          pagination.value.total > 0 ? (openBlock(), createElementBlock("div", _hoisted_45, [
            createBaseVNode("div", _hoisted_46, [
              createBaseVNode("div", _hoisted_47, [
                _cache[23] || (_cache[23] = createTextVNode(" Showing ", -1)),
                createBaseVNode("span", _hoisted_48, toDisplayString(pagination.value.from), 1),
                _cache[24] || (_cache[24] = createTextVNode(" to ", -1)),
                createBaseVNode("span", _hoisted_49, toDisplayString(pagination.value.to), 1),
                _cache[25] || (_cache[25] = createTextVNode(" of ", -1)),
                createBaseVNode("span", _hoisted_50, toDisplayString(pagination.value.total), 1),
              ...
              createBaseVNode("div", _hoisted_51, [
                ...
                (openBlock(true), createElementBlock(Fragment, null, renderList(pagination.value.last_page, (page) => {
                  ...
                  }, toDisplayString(page), 11, _hoisted_53);
                }), 128)),
                createBaseVNode("button", {
        ...
        showMarkModal.value ? (openBlock(), createElementBlock("div", _hoisted_55, [
          createBaseVNode("div", {
            ...
            createBaseVNode("div", _hoisted_58, [
              ...
              createBaseVNode("div", _hoisted_59, [
                ...
                createBaseVNode("button", {
                  ...
                  disabled: marking.value,
                  class: normalizeClass(["flex flex-col items-center justify-center p-4 border rounded-xl hover:border-red-600 hover:bg-red-50/50 group cursor-pointer transition-all", markForm.value.type === "check_out" ? "border-red-600 bg-red-50" : "border-slate-150"])
                }, [
                  createVNode(unref(LogOut), { class: "w-6 h-6 mb-2 text-slate-400 group-hover:text-blue-600" }),
                  _cache[30] || (_cache[30] = createBaseVNode("span", { class: "text-xs font-bold text-slate-600 group-hover:text-blue-600" }, "Check Out", -1))
                ], 10, _hoisted_61)
              ])
            ])
          ])
...
const AttendancePage = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-1bc4df3f"]]);
export {
