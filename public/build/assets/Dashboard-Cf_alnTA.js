import { d as defineComponent, r as ref, o as onMounted, C as onUnmounted, H as watch, c as createElementBlock, b as createBaseVNode, F as Fragment, h as renderList, f as createVNode, u as unref, I as normalizeStyle, t as toDisplayString, n as normalizeClass, m as createCommentVNode, j as createTextVNode, i as openBlock, D as useApp, E as computed, g as resolveComponent, w as withCtx, A as useRouter, k as createBlock, l as resolveDynamicComponent, p as useAuth, J as studentAPI } from "./main-TSJawxZI.js";
...
import { F as Flame } from "./flame-BV6PY4oX.js";
import { C as ChartColumn } from "./chart-column-NDtKoNz5.js";
import { A as Activity } from "./activity-B-QfRRNC.js";
...
const _hoisted_12$2 = { class: "space-y-2 text-xs text-gray-600" };
const _hoisted_13$1 = {
  key: 0,
  class: "mb-3 p-2 bg-orange-50 border border-orange-200 rounded-lg flex items-center text-orange-700"
};
const _hoisted_14$1 = { class: "flex items-center" };
const _hoisted_15$1 = { class: "flex items-center" };
const _hoisted_16$1 = { class: "flex flex-wrap gap-2 mt-1" };
const _hoisted_17$1 = {
  key: 0,
...
const _hoisted_20$1 = { class: "mt-4 flex gap-2" };
            ...
            return openBlock(), createElementBlock("div", {
              ...
              createBaseVNode("div", _hoisted_6$2, [
                ...
                createBaseVNode("div", _hoisted_11$2, [
                  createBaseVNode("p", {
                    class: normalizeClass(["text-[10px] font-bold uppercase", isOverdue(booking) ? "text-red-400" : "text-gray-400"])
                  }, toDisplayString(getTimerLabel(booking)), 3),
                  createBaseVNode("p", {
                    class: normalizeClass(["text-sm font-black font-mono", isOverdue(booking) ? "text-red-500" : "text-blue-600"])
                  }, toDisplayString(getRemainingTime(booking)), 3)
                ])
              ]),
              createBaseVNode("div", _hoisted_12$2, [
                booking.status === "checked_in" && isEndingSoon(booking) ? (openBlock(), createElementBlock("div", _hoisted_13$1, [
                  createVNode(unref(TriangleAlert), { class: "w-4 h-4 mr-2" }),
                  _cache[3] || (_cache[3] = createBaseVNode("span", { class: "font-bold" }, "Session Ending Soon!", -1))
                ])) : createCommentVNode("", true),
                ...
                createBaseVNode("div", _hoisted_16$1, [
                  booking.seat?.has_computer ? (openBlock(), createElementBlock("span", _hoisted_17$1, [
                    createVNode(unref(Monitor), { class: "w-2.5 h-2.5 mr-1" }),
                    _cache[4] || (_cache[4] = createTextVNode(" PC ", -1))
                  ])) : createCommentVNode("", true),
                  booking.seat?.near_window ? (openBlock(), createElementBlock("span", _hoisted_18$1, [
                    createVNode(unref(PanelsTopLeft), { class: "w-2.5 h-2.5 mr-1" }),
                    _cache[5] || (_cache[5] = createTextVNode(" Window ", -1))
                  ])) : createCommentVNode("", true),
                  booking.seat && (booking.seat.socket_count ?? 0) > 0 ? (openBlock(), createElementBlock("span", _hoisted_19$1, [
              ...
              createBaseVNode("div", _hoisted_20$1, [
                ...
                }, " Check In ", 8, _hoisted_21$1)) : createCommentVNode("", true),
                booking.status === "booked" ? (openBlock(), createElementBlock("button", {
                  key: 1,
                ...
                }, " Cancel ", 8, _hoisted_22$1)) : createCommentVNode("", true),
                ...
                }, " Check Out ", 8, _hoisted_23$1)) : createCommentVNode("", true),
                booking.status === "checked_in" ? (openBlock(), createElementBlock("button", {
                  key: 3,
                ...
                }, " Extend ", 8, _hoisted_24$1)) : createCommentVNode("", true)
              ])
            ]);
          }), 128))
        ]))
