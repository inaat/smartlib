import { d as defineComponent, r as ref, o as onMounted, a as createElementBlock, b as createBaseVNode, F as Fragment, j as renderList, f as createVNode, u as unref, w as withCtx, g as resolveComponent, L as studentAPI, t as toDisplayString, n as normalizeClass, l as createCommentVNode, i as createTextVNode, k as openBlock } from "./main-DKJzpCzk.js";
...
const _hoisted_21 = {
  key: 2,
  class: "text-center text-xs text-slate-400 font-extrabold uppercase tracking-wide bg-slate-50 border border-slate-100/50 rounded-xl px-4 py-2"
};
const _hoisted_22 = {
  key: 2,
    ...
    return (_ctx, _cache) => {
      ...
      return openBlock(), createElementBlock("div", _hoisted_1, [
        loading.value ? (openBlock(), createElementBlock("div", _hoisted_2, [..._cache[0] || (_cache[0] = [
            ...
            return openBlock(), createElementBlock("div", {
              ...
              createBaseVNode("div", _hoisted_7, [
                createBaseVNode("div", _hoisted_8, [
                  createBaseVNode("div", _hoisted_9, [
                    createBaseVNode("h3", {
                      class: "font-extrabold text-slate-800 text-base leading-snug line-clamp-1",
                  ...
                  createBaseVNode("span", {
                    class: normalizeClass([
                      "px-2.5 py-0.5 rounded-lg text-[9px] font-black uppercase tracking-wider border w-fit leading-none",
                ...
                createBaseVNode("div", _hoisted_12, [
                  ...
                  createBaseVNode("div", _hoisted_15, [
                    ...
                    createBaseVNode("span", {
                      class: normalizeClass(["font-bold uppercase tracking-wide text-[10px]", getDaysRemainingColor(reservation.due_date)])
              ...
              createBaseVNode("div", _hoisted_16, [
                reservation.status === "approved" ? (openBlock(), createElementBlock("button", {
                  ...
                  class: "px-5 py-2.5 bg-gradient-to-r from-emerald-500 to-teal-500 hover:opacity-95 text-white text-xs font-extrabold rounded-xl shadow-md shadow-emerald-500/10 active:scale-98 transition-all flex items-center justify-center space-x-1.5 disabled:opacity-50"
                }, [
                ...
                reservation.status === "collected" || reservation.status === "overdue" ? (openBlock(), createElementBlock("button", {
                  ...
                  class: "px-5 py-2.5 bg-blue-600 hover:opacity-95 text-white text-xs font-extrabold rounded-xl shadow-md shadow-blue-500/10 active:scale-98 transition-all flex items-center justify-center space-x-1.5 disabled:opacity-50"
                }, [
          ...
          _cache[4] || (_cache[4] = createBaseVNode("h3", { class: "text-base font-bold text-slate-800 mb-1" }, "No active reservations", -1)),
          ...
          createVNode(_component_router_link, {
            to: "/student/books",
            class: "inline-flex items-center px-5 py-2.5 bg-blue-600 text-white rounded-xl text-xs font-extrabold shadow-md shadow-blue-500/10 active:scale-98 hover:opacity-95 transition-all uppercase tracking-wider"
          }, {
...
const MyReservationsPage = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-d4c5cdd2"]]);
export {
