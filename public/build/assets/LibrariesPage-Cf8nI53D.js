...
const LibraryMap = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-5ef68f08"]]);
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", _hoisted_1, [
        libraryFilterMode.value === "nearby" && unref(locationLoading) ? (openBlock(), createElementBlock("div", _hoisted_2, [..._cache[6] || (_cache[6] = [
          createStaticVNode('<div class="w-10 h-10 bg-blue-100/80 rounded-xl flex items-center justify-center flex-shrink-0" data-v-903eff6a><div class="animate-spin rounded-full h-5 w-5 border-2 border-blue-600 border-t-transparent" data-v-903eff6a></div></div><div class="text-left" data-v-903eff6a><p class="text-sm font-bold text-blue-900" data-v-903eff6a>Detecting your location...</p><p class="text-xs text-blue-600/80 mt-0.5" data-v-903eff6a>Please allow browser location access to find nearby libraries</p></div>', 2)
...
const LibrariesPage = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-903eff6a"]]);
export {
