import { d as defineComponent, p as useAuth, r as ref, o as onMounted, c as createElementBlock, b as createBaseVNode, u as unref, t as toDisplayString, f as createVNode, m as createCommentVNode, j as createTextVNode, s as withModifiers, v as withDirectives, x as vModelText, J as studentAPI, i as openBlock } from "./main-DCJXrkf-.js";
import { _ as _sfc_main$1 } from "./SessionManagement.vue_vue_type_script_setup_true_lang-B-Din-R0.js";
import { u as useSwal } from "./useSwal-BUxo5JBv.js";
import { C as Camera } from "./camera-CwuUy5A1.js";
import { M as Mail } from "./mail-CUfT7a_z.js";
import { P as Phone } from "./phone-CG2KN6fv.js";
import { U as User } from "./user-C8gwTBBi.js";
import { L as Lock } from "./lock-DF6cXPUS.js";
import { S as ShieldCheck } from "./shield-check-D5teOuYB.js";
/* empty css               */
import "./refresh-cw-DCq6mbXe.js";
import "./createLucideIcon-CDsoUk2K.js";
import "./shield-alert-hljDaMG2.js";
import "./monitor-MB0i7ldh.js";
import "./smartphone-CV_LqMVY.js";
import "./globe-C4lv0B9h.js";
import "./clock-B7PYed5-.js";
import "./log-out--hPc7NJn.js";
import "./format-CDOmCKsg.js";
...
const _hoisted_5 = { class: "w-32 h-32 rounded-full bg-gradient-to-tr from-purple-600 to-indigo-600 flex items-center justify-center text-white text-4xl font-bold shadow-lg overflow-hidden" };
...
const _hoisted_13 = { class: "mt-6 flex flex-wrap justify-center md:justify-start gap-3" };
const _hoisted_14 = {
  key: 0,
  class: "px-4 py-1.5 bg-blue-50 text-blue-700 rounded-full text-sm font-bold border border-blue-100"
};
const _hoisted_15 = { class: "bg-white rounded-3xl p-8 shadow-sm border border-gray-100" };
const _hoisted_16 = { class: "flex items-center justify-between mb-6" };
const _hoisted_17 = { class: "text-xl font-bold text-gray-800 flex items-center" };
...
const _hoisted_31 = { class: "bg-white rounded-3xl p-8 shadow-sm border border-gray-100" };
const _hoisted_32 = { class: "text-xl font-bold text-gray-800 flex items-center mb-6" };
      ...
      return openBlock(), createElementBlock("div", _hoisted_1, [
            ...
            createBaseVNode("div", _hoisted_8, [
              ...
              createBaseVNode("div", _hoisted_10, [
                createBaseVNode("div", _hoisted_11, [
                  createVNode(unref(Mail), { class: "w-4 h-4 mr-2 text-purple-500" }),
                  createTextVNode(" " + toDisplayString(unref(user)?.email), 1)
                ]),
                unref(user)?.phone ? (openBlock(), createElementBlock("div", _hoisted_12, [
                  createVNode(unref(Phone), { class: "w-4 h-4 mr-2 text-purple-500" }),
                  createTextVNode(" " + toDisplayString(unref(user)?.phone), 1)
                ])) : createCommentVNode("", true)
              ]),
              createBaseVNode("div", _hoisted_13, [
                _cache[6] || (_cache[6] = createBaseVNode("span", { class: "px-4 py-1.5 bg-purple-50 text-purple-700 rounded-full text-sm font-bold border border-purple-100" }, " LIBRARIAN ", -1)),
        ...
        createBaseVNode("div", _hoisted_15, [
          createBaseVNode("div", _hoisted_16, [
            createBaseVNode("h2", _hoisted_17, [
              createVNode(unref(User), { class: "w-5 h-5 mr-2 text-purple-600" }),
        ...
        createBaseVNode("div", _hoisted_31, [
          createBaseVNode("h2", _hoisted_32, [
            createVNode(unref(ShieldCheck), { class: "w-5 h-5 mr-2 text-purple-600" }),
