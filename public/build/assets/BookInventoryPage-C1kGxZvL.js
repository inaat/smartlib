import { d as defineComponent, r as ref, E as watch, o as onMounted, a as createElementBlock, b as createBaseVNode, f as createVNode, j as createCommentVNode, p as withDirectives, u as unref, v as vModelText, F as Fragment, k as renderList, z as withModifiers, t as toDisplayString, D as vModelSelect, e as createStaticVNode, h as createBlock, n as normalizeClass, l as openBlock } from "./main-BGbL_8Ba.js";
...
import { B as Book } from "./book-CELDvwdx.js";
/* empty css               */
...
const _hoisted_27 = { class: "bg-white rounded-2xl shadow-2xl max-w-2xl w-full mx-auto overflow-hidden border border-slate-100 animate-in fade-in zoom-in duration-200 flex flex-col max-h-[90vh]" };
const _hoisted_28 = { class: "px-6 py-5 bg-gradient-to-r from-emerald-800 via-emerald-700 to-teal-800 text-white flex items-center justify-between text-left" };
const _hoisted_29 = { class: "flex items-center space-x-3" };
const _hoisted_30 = { class: "w-10 h-10 rounded-xl bg-white/10 backdrop-blur-md flex items-center justify-center border border-white/20" };
const _hoisted_31 = { class: "text-base font-bold text-white tracking-wide" };
...
const _hoisted_35 = { class: "grid grid-cols-1 md:grid-cols-2 gap-4" };
const _hoisted_36 = ["value"];
const _hoisted_37 = { key: 0 };
const _hoisted_38 = { class: "grid grid-cols-1 md:grid-cols-2 gap-4" };
const _hoisted_39 = { key: 0 };
const _hoisted_40 = { key: 1 };
const _hoisted_41 = { class: "flex items-center space-x-3 pt-4" };
        ...
        createBaseVNode("div", _hoisted_2, [
          createBaseVNode("div", _hoisted_3, [
            createBaseVNode("div", _hoisted_4, [
              _cache[14] || (_cache[14] = createBaseVNode("label", { class: "block text-xs font-semibold text-gray-500 uppercase mb-1 ml-1" }, "Search Books", -1)),
          ...
          createBaseVNode("div", _hoisted_7, [
            createBaseVNode("table", _hoisted_8, [
              ...
              createBaseVNode("tbody", _hoisted_9, [
                ...
                books.value.length === 0 ? (openBlock(), createElementBlock("tr", _hoisted_26, [..._cache[15] || (_cache[15] = [
                  createBaseVNode("td", {
                    colspan: "5",
          ...
          createBaseVNode("div", _hoisted_27, [
            createBaseVNode("div", _hoisted_28, [
              createBaseVNode("div", _hoisted_29, [
                ...
                createBaseVNode("div", null, [
                  createBaseVNode("h3", _hoisted_31, toDisplayString(isEditing.value ? "Edit Book Details" : "Add New Book"), 1),
                  _cache[17] || (_cache[17] = createBaseVNode("p", { class: "text-[11px] text-emerald-100/80 font-medium" }, "Provide the inventory parameters for this publication.", -1))
                ])
              ]),
              createBaseVNode("button", {
                onClick: closeModal,
            ...
            createBaseVNode("form", {
              ...
              createBaseVNode("div", _hoisted_32, [
                createBaseVNode("div", null, [
                  _cache[18] || (_cache[18] = createBaseVNode("label", { class: "block text-sm font-medium text-gray-700 mb-1" }, "Title", -1)),
                  withDirectives(createBaseVNode("input", {
                ...
                createBaseVNode("div", null, [
                  _cache[19] || (_cache[19] = createBaseVNode("label", { class: "block text-sm font-medium text-gray-700 mb-1" }, "Author", -1)),
                  withDirectives(createBaseVNode("input", {
              ...
              createBaseVNode("div", _hoisted_33, [
                createBaseVNode("div", null, [
                  _cache[20] || (_cache[20] = createBaseVNode("label", { class: "block text-sm font-medium text-gray-700 mb-1" }, "ISBN", -1)),
                  withDirectives(createBaseVNode("input", {
                ...
                createBaseVNode("div", null, [
                  _cache[23] || (_cache[23] = createBaseVNode("label", { class: "block text-sm font-medium text-gray-700 mb-1" }, "Category *", -1)),
                  withDirectives(createBaseVNode("select", {
                    "onUpdate:modelValue": _cache[5] || (_cache[5] = ($event) => form.value.category = $event),
                    required: "",
                    class: "w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500"
                  }, [..._cache[21] || (_cache[21] = [
                    createStaticVNode('<option value="" disabled>Select Category</option><option value="Accounting">Accounting</option><option value="Audit">Audit</option><option value="Taxation">Taxation</option><option value="Law">Law</option><option value="Finance">Finance</option><option value="Management">Management</option><option value="Economics">Economics</option><option value="Other">Other</option>', 9)
                  ])], 512), [
                    [vModelSelect, form.value.category]
                  ]),
                  form.value.category === "Other" ? (openBlock(), createElementBlock("div", _hoisted_34, [
                    _cache[22] || (_cache[22] = createBaseVNode("label", { class: "block text-xs font-bold text-emerald-700 mb-1" }, "Enter Category Name *", -1)),
                    withDirectives(createBaseVNode("input", {
                      "onUpdate:modelValue": _cache[6] || (_cache[6] = ($event) => customCategory.value = $event),
                      type: "text",
                      required: "",
                      class: "w-full px-4 py-2 border border-emerald-300 rounded-lg focus:ring-2 focus:ring-emerald-500",
                      placeholder: "e.g. Science, Fiction, General"
                    }, null, 512), [
              ...
              createBaseVNode("div", _hoisted_35, [
                createBaseVNode("div", null, [
                  _cache[25] || (_cache[25] = createBaseVNode("label", { class: "block text-sm font-medium text-gray-700 mb-1" }, "Library", -1)),
                  withDirectives(createBaseVNode("select", {
                    "onUpdate:modelValue": _cache[7] || (_cache[7] = ($event) => form.value.library_id = $event),
                    class: "w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500"
                  }, [
                    _cache[24] || (_cache[24] = createBaseVNode("option", { value: null }, "Global (No Library)", -1)),
                    (openBlock(true), createElementBlock(Fragment, null, renderList(libraries.value, (lib) => {
                      return openBlock(), createElementBlock("option", {
                        key: lib.id,
                        value: lib.id
                      }, toDisplayString(lib.name), 9, _hoisted_36);
                    }), 128))
                  ], 512), [
                ...
                createBaseVNode("div", null, [
                  _cache[27] || (_cache[27] = createBaseVNode("label", { class: "block text-sm font-medium text-gray-700 mb-1" }, "Type", -1)),
                  withDirectives(createBaseVNode("select", {
                    "onUpdate:modelValue": _cache[8] || (_cache[8] = ($event) => form.value.type = $event),
                    class: "w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500"
                  }, [..._cache[26] || (_cache[26] = [
                ...
                form.value.type === "physical" ? (openBlock(), createElementBlock("div", _hoisted_37, [
                  _cache[28] || (_cache[28] = createBaseVNode("label", { class: "block text-sm font-medium text-gray-700 mb-1" }, "Borrowing Period (Days)", -1)),
                  withDirectives(createBaseVNode("input", {
                    "onUpdate:modelValue": _cache[9] || (_cache[9] = ($event) => form.value.borrowing_period = $event),
                    type: "number",
                    min: "1",
                    class: "w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500",
                    placeholder: "e.g. 7"
              ...
              createBaseVNode("div", null, [
                ...
                withDirectives(createBaseVNode("textarea", {
                  "onUpdate:modelValue": _cache[10] || (_cache[10] = ($event) => form.value.description = $event),
                  rows: "3",
                  required: "",
                  class: "w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500"
                }, null, 512), [
              ...
              createBaseVNode("div", _hoisted_38, [
                createBaseVNode("div", null, [
                  _cache[30] || (_cache[30] = createBaseVNode("label", { class: "block text-sm font-medium text-gray-700 mb-1" }, "Cover Image", -1)),
                ...
                form.value.type === "digital" ? (openBlock(), createElementBlock("div", _hoisted_39, [
                  _cache[31] || (_cache[31] = createBaseVNode("label", { class: "block text-sm font-medium text-gray-700 mb-1" }, "PDF File", -1)),
                  createBaseVNode("input", {
                    type: "file",
                  ...
                  _cache[32] || (_cache[32] = createBaseVNode("label", { class: "block text-sm font-medium text-gray-700 mb-1" }, "Location (Shelf/Row)", -1)),
                  withDirectives(createBaseVNode("input", {
                    "onUpdate:modelValue": _cache[11] || (_cache[11] = ($event) => form.value.location = $event),
                    type: "text",
                    class: "w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500",
              ...
              createBaseVNode("div", _hoisted_41, [
                ...
                }, toDisplayString(loading.value ? "Saving..." : isEditing.value ? "Update Book" : "Create Book"), 9, _hoisted_42),
                createBaseVNode("button", {
                  type: "button",
                  onClick: closeModal,
