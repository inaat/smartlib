import { d as defineComponent, r as ref, x as useAuth, c as computed, o as onMounted, a as createElementBlock, b as createBaseVNode, j as createCommentVNode, f as createVNode, n as normalizeClass, u as unref, t as toDisplayString, F as Fragment, k as renderList, i as createTextVNode, q as normalizeStyle, g as resolveComponent, l as openBlock } from "./main-BGbL_8Ba.js";
import { E as E$1 } from "./jspdf.es.min-2MvfdkH9.js";
import { s as studentAPI } from "./studentApi-BtCKxYqQ.js";
...
const _hoisted_30 = {
  key: 3,
  class: "fixed inset-0 z-50 flex justify-center items-start p-4 bg-slate-900/60 backdrop-blur-md overflow-y-auto animate-in fade-in duration-300"
};
...
const _hoisted_32 = { class: "p-5 flex items-center justify-end border-b border-slate-200/80 bg-slate-50 flex-shrink-0" };
const _hoisted_33 = { class: "p-6 flex flex-col items-center bg-slate-100/50" };
const _hoisted_34 = { class: "p-5 space-y-4" };
const _hoisted_35 = { class: "space-y-1" };
const _hoisted_36 = { class: "inline-block text-[9px] font-semibold text-blue-600 bg-blue-50 px-2 py-0.5 rounded border border-blue-150 uppercase tracking-widest" };
const _hoisted_37 = { class: "text-lg font-semibold leading-tight text-slate-900 tracking-tight line-clamp-2" };
const _hoisted_38 = { class: "grid grid-cols-2 gap-4 bg-slate-50 border border-slate-100 rounded-xl p-3.5" };
const _hoisted_39 = { class: "text-[11px] font-semibold text-slate-800 mt-0.5" };
const _hoisted_40 = { class: "text-[11px] font-semibold text-slate-800 mt-0.5" };
const _hoisted_41 = { class: "text-[11px] font-semibold text-slate-800 mt-0.5 truncate" };
const _hoisted_42 = { class: "text-[11px] font-semibold text-blue-600 mt-0.5" };
const _hoisted_43 = { class: "p-5 flex items-center justify-between space-x-4 bg-slate-50/50" };
const _hoisted_44 = { class: "min-w-0 flex-1 space-y-4" };
const _hoisted_45 = { class: "flex items-center space-x-3" };
const _hoisted_46 = { class: "w-12 h-12 rounded-xl overflow-hidden border border-slate-200 shadow-inner bg-slate-100 flex-shrink-0" };
const _hoisted_47 = ["src"];
const _hoisted_48 = { class: "min-w-0" };
const _hoisted_49 = { class: "text-xs font-semibold truncate text-slate-900 leading-snug" };
const _hoisted_50 = { class: "text-[11px] font-mono font-bold text-slate-700 mt-0.5" };
const _hoisted_51 = { class: "flex-shrink-0 flex flex-col items-center space-y-1" };
const _hoisted_52 = { class: "p-1.5 bg-white rounded-xl shadow-md border border-slate-200" };
const _hoisted_53 = ["src"];
const _hoisted_54 = { class: "text-[7px] font-mono font-bold text-slate-400 tracking-wider" };
const _hoisted_55 = { class: "p-5 border-t border-slate-200 bg-slate-50 grid grid-cols-2 gap-3" };
          ...
          createBaseVNode("div", _hoisted_31, [
            ...
            createBaseVNode("div", _hoisted_33, [
              createBaseVNode("div", {
                ...
                _cache[13] || (_cache[13] = createBaseVNode("div", { class: "p-5 bg-gradient-to-r from-blue-600 to-blue-700 border-b border-blue-700/20 flex items-center justify-center text-white" }, [
                  createBaseVNode("h4", { class: "text-sm font-bold uppercase tracking-[0.2em] text-white" }, "DIGITAL PASS")
                ], -1)),
                createBaseVNode("div", _hoisted_34, [
                  createBaseVNode("div", _hoisted_35, [
                    createBaseVNode("span", _hoisted_36, toDisplayString(selectedPassEvent.value?.type?.replace("_", " ") || "Workshop"), 1),
                    createBaseVNode("h3", _hoisted_37, toDisplayString(selectedPassEvent.value?.title), 1)
                  ]),
                  createBaseVNode("div", _hoisted_38, [
                    createBaseVNode("div", null, [
                      _cache[6] || (_cache[6] = createBaseVNode("span", { class: "text-[8px] font-medium text-slate-400 uppercase tracking-widest" }, "Date", -1)),
                      createBaseVNode("p", _hoisted_39, toDisplayString(selectedPassEvent.value ? formatDate(selectedPassEvent.value.date) : ""), 1)
                    ]),
                    createBaseVNode("div", null, [
                      _cache[7] || (_cache[7] = createBaseVNode("span", { class: "text-[8px] font-medium text-slate-400 uppercase tracking-widest" }, "Time", -1)),
                      createBaseVNode("p", _hoisted_40, toDisplayString(selectedPassEvent.value ? formatTime(selectedPassEvent.value.start_time) : ""), 1)
                    ]),
                    createBaseVNode("div", null, [
                      _cache[8] || (_cache[8] = createBaseVNode("span", { class: "text-[8px] font-medium text-slate-400 uppercase tracking-widest" }, "Venue", -1)),
                      createBaseVNode("p", _hoisted_41, toDisplayString(selectedPassEvent.value?.venue || "Main Hall"), 1)
                    ]),
                    createBaseVNode("div", null, [
                      _cache[9] || (_cache[9] = createBaseVNode("span", { class: "text-[8px] font-medium text-slate-400 uppercase tracking-widest" }, "Seat", -1)),
                      createBaseVNode("p", _hoisted_42, toDisplayString(selectedPassEvent.value?.seat_number ? "Seat " + selectedPassEvent.value.seat_number : "General Admission"), 1)
                    ])
                  ])
                ]),
                _cache[14] || (_cache[14] = createBaseVNode("div", { class: "relative flex items-center justify-between px-3" }, [
                ...
                createBaseVNode("div", _hoisted_43, [
                  createBaseVNode("div", _hoisted_44, [
                    createBaseVNode("div", _hoisted_45, [
                      ...
                      createBaseVNode("div", _hoisted_48, [
                        _cache[10] || (_cache[10] = createBaseVNode("span", { class: "text-[8px] font-medium text-slate-400 uppercase tracking-widest" }, "Attendee", -1)),
                        createBaseVNode("h5", _hoisted_49, toDisplayString(unref(user)?.name), 1),
                        _cache[11] || (_cache[11] = createBaseVNode("p", { class: "text-[9px] text-blue-600 font-semibold uppercase mt-0.5" }, "Verified", -1))
                      ])
                    ]),
                    createBaseVNode("div", null, [
                      _cache[12] || (_cache[12] = createBaseVNode("span", { class: "text-[8px] font-medium text-slate-400 uppercase tracking-widest" }, "Student CRN", -1)),
                      createBaseVNode("p", _hoisted_50, toDisplayString(unref(user)?.crn || "N/A"), 1)
                    ])
                  ]),
                  createBaseVNode("div", _hoisted_51, [
                    ...
                    createBaseVNode("span", _hoisted_54, "PASS-" + toDisplayString(selectedPassEvent.value?.id) + "-" + toDisplayString(unref(user)?.id), 1)
                  ])
                ])
              ], 512)
            ]),
            createBaseVNode("div", _hoisted_55, [
              createBaseVNode("button", {
                ...
                _cache[15] || (_cache[15] = createBaseVNode("span", null, "Image", -1))
              ], 8, _hoisted_56),
              createBaseVNode("button", {
                ...
                _cache[16] || (_cache[16] = createBaseVNode("span", null, "PDF", -1))
              ], 8, _hoisted_57)
            ])
          ])
        ])) : createCommentVNode("", true)
...
const EventsPage = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-1efc2e21"]]);
export {
