import { d as defineComponent, C as useApp, r as ref, D as computed, o as onMounted, G as onUnmounted, c as createElementBlock, b as createBaseVNode, f as createVNode, w as withCtx, g as resolveComponent, j as createTextVNode, u as unref, F as Fragment, h as renderList, m as createCommentVNode, n as normalizeClass, t as toDisplayString, M as parseISO, A as useRouter, i as openBlock } from "./main-DCJXrkf-.js";
...
const _hoisted_23 = { class: "text-xs text-gray-400 font-black uppercase tracking-widest mb-1" };
const _hoisted_24 = { class: "text-4xl font-black text-gray-800 font-mono tracking-tighter" };
const _hoisted_25 = { class: "flex flex-wrap gap-3" };
const _hoisted_26 = ["onClick"];
const _hoisted_27 = ["onClick"];
const _hoisted_28 = ["onClick"];
const _hoisted_29 = { class: "pt-8" };
const _hoisted_30 = { class: "flex flex-col md:flex-row md:items-center justify-between gap-4 mb-8" };
const _hoisted_31 = { class: "text-xl font-bold text-gray-800 flex items-center px-2" };
const _hoisted_32 = { class: "flex items-center gap-2 bg-gray-100 p-1 rounded-2xl" };
...
const _hoisted_36 = { class: "flex items-start justify-between mb-4" };
const _hoisted_37 = { class: "flex items-center gap-3" };
const _hoisted_38 = { class: "font-bold text-gray-800" };
const _hoisted_39 = { class: "text-[10px] text-gray-400 font-black uppercase" };
const _hoisted_40 = { class: "space-y-3 pt-3 border-t border-gray-50 text-sm text-gray-600" };
      ...
      return openBlock(), createElementBlock("div", _hoisted_1, [
          ...
          createBaseVNode("div", _hoisted_3, [
            ...
            createVNode(_component_router_link, {
              ...
              default: withCtx(() => [
                ...
                _cache[0] || (_cache[0] = createTextVNode(" Book New Seat ", -1))
              ]),
              _: 1
            })
          ])
        ...
        createBaseVNode("div", _hoisted_4, [
          ...
          activeBookings.value.length === 0 ? (openBlock(), createElementBlock("div", _hoisted_7, [
            ...
            _cache[4] || (_cache[4] = createBaseVNode("h3", { class: "text-xl font-bold text-gray-800 mb-2" }, "No Active Bookings", -1)),
            _cache[5] || (_cache[5] = createBaseVNode("p", { class: "text-gray-500 max-w-xs mx-auto mb-8" }, "You don't have any active seat reservations at the moment. Find a library to book your spot!", -1)),
            createVNode(_component_router_link, {
              to: "/student/libraries",
                ...
                createBaseVNode("div", _hoisted_11, [
                    ...
                    createBaseVNode("div", _hoisted_13, [
                      ...
                      createBaseVNode("div", _hoisted_17, [
                        booking.seat?.has_computer ? (openBlock(), createElementBlock("span", _hoisted_18, [
                          ...
                          _cache[6] || (_cache[6] = createTextVNode(" Computer Available ", -1))
                  ...
                  createBaseVNode("div", _hoisted_21, [
                    createBaseVNode("div", _hoisted_22, [
                      createBaseVNode("p", _hoisted_23, toDisplayString(booking.status === "checked_in" ? "Session Ends In" : "Starts In"), 1),
                      createBaseVNode("p", _hoisted_24, toDisplayString(getRemainingTime(booking)), 1)
                    ]),
        ...
        createBaseVNode("div", _hoisted_29, [
          createBaseVNode("div", _hoisted_30, [
            ...
            createBaseVNode("div", _hoisted_32, [
              (openBlock(), createElementBlock(Fragment, null, renderList(["all", "completed", "cancelled"], (filter) => {
                ...
                }, toDisplayString(filter), 11, _hoisted_33);
              }), 64))
            ])
          ]),
          !filteredHistory.value || filteredHistory.value.length === 0 ? (openBlock(), createElementBlock("div", _hoisted_34, [
            createVNode(unref(Clock), { class: "w-16 h-16 text-gray-200 mx-auto mb-4" }),
            _cache[9] || (_cache[9] = createBaseVNode("p", { class: "text-gray-500 font-medium" }, "No past bookings found.", -1))
              ...
              return openBlock(), createElementBlock("div", {
                ...
                createBaseVNode("div", _hoisted_36, [
                  createBaseVNode("div", _hoisted_37, [
                    ...
                    createBaseVNode("div", null, [
                      createBaseVNode("h3", _hoisted_38, "Seat " + toDisplayString(booking.seat?.seat_number), 1),
                      createBaseVNode("p", _hoisted_39, "ID #" + toDisplayString(booking.id), 1)
                    ])
                  ]),
                  createBaseVNode("span", {
                    class: normalizeClass([
                ...
                createBaseVNode("div", _hoisted_40, [
                  createBaseVNode("div", _hoisted_41, [
                    ...
                    createBaseVNode("span", _hoisted_42, toDisplayString(booking.seat?.library?.name), 1)
                  ]),
                  createBaseVNode("div", _hoisted_43, [
                    createVNode(unref(Calendar), { class: "w-4 h-4 mr-2.5 text-gray-400" }),
                    createBaseVNode("span", _hoisted_44, toDisplayString(formatDate(booking.booking_time)), 1)
                  ]),
                  createBaseVNode("div", _hoisted_45, [
                    createVNode(unref(Clock), { class: "w-4 h-4 mr-2.5 text-gray-400" }),
                    createBaseVNode("span", _hoisted_46, toDisplayString(formatTime(booking.booking_time)) + " - " + toDisplayString(formatTime(booking.scheduled_end_time)), 1)
                  ]),
                  booking.total_minutes ? (openBlock(), createElementBlock("div", _hoisted_47, [
          ...
          filteredHistory.value && filteredHistory.value.length >= 10 ? (openBlock(), createElementBlock("div", _hoisted_48, [..._cache[10] || (_cache[10] = [
