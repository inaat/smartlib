import { d as defineComponent, r as ref, E as watch, o as onMounted, a as createElementBlock, b as createBaseVNode, l as createCommentVNode, n as normalizeClass, f as createVNode, u as unref, p as withDirectives, v as vModelText, D as vModelSelect, t as toDisplayString, F as Fragment, j as renderList, i as createTextVNode, P as librarianAPI, k as openBlock } from "./main-BV94XoeK.js";
...
import { L as LogOut } from "./log-out-Btb4GVQn.js";
...
const _hoisted_68 = { class: "flex items-center space-x-2 text-xs font-semibold text-slate-600" };
const _hoisted_69 = { class: "font-semibold text-slate-800" };
const _hoisted_70 = { class: "text-[10px] text-slate-400 font-semibold bg-slate-50 px-2 py-0.5 border border-gray-200 rounded-md" };
const _hoisted_71 = { class: "px-6 py-4 whitespace-nowrap text-left" };
const _hoisted_72 = { class: "px-2.5 py-0.5 rounded text-[10px] font-bold uppercase bg-purple-50 border border-purple-100 text-purple-700" };
const _hoisted_73 = { class: "px-6 py-4 whitespace-nowrap text-left text-xs font-semibold text-slate-600" };
const _hoisted_74 = { class: "px-6 py-4 whitespace-nowrap text-left" };
const _hoisted_75 = { class: "px-6 py-4 whitespace-nowrap text-right text-sm font-medium" };
const _hoisted_76 = {
  key: 0,
...
const _hoisted_81 = { class: "bg-white rounded-xl shadow-xl w-full max-w-md overflow-hidden animate-in fade-in zoom-in duration-200 border border-gray-200" };
const _hoisted_82 = { class: "p-6 border-b border-gray-100 flex items-center justify-between text-left" };
const _hoisted_83 = { class: "flex items-center space-x-3" };
const _hoisted_84 = { class: "w-10 h-10 rounded-lg bg-emerald-50 flex items-center justify-center text-emerald-600 border border-emerald-100/50 flex-shrink-0" };
const _hoisted_85 = { class: "text-[10px] font-semibold text-slate-400 uppercase tracking-wider mt-0.5" };
const _hoisted_86 = { class: "p-6 space-y-5 text-left font-outfit text-slate-700" };
const _hoisted_87 = { class: "flex items-center space-x-3.5 pb-4 border-b border-gray-100" };
const _hoisted_88 = { class: "w-12 h-12 rounded-xl overflow-hidden flex-shrink-0 flex items-center justify-center shadow-sm" };
...
const _hoisted_91 = { class: "font-bold text-slate-700 text-sm leading-snug" };
const _hoisted_92 = { class: "text-[11px] text-slate-400 font-semibold mt-0.5" };
const _hoisted_93 = { class: "text-[10px] text-slate-400 font-semibold tracking-wider mt-0.5 uppercase" };
const _hoisted_94 = { class: "grid grid-cols-2 gap-4 pb-4 border-b border-gray-100" };
const _hoisted_95 = { class: "font-bold text-slate-700 text-sm" };
const _hoisted_96 = { class: "font-semibold text-slate-700 text-xs" };
const _hoisted_97 = { class: "pb-4 border-b border-gray-100 space-y-2" };
const _hoisted_98 = { class: "font-semibold text-slate-700 text-xs" };
const _hoisted_99 = { class: "font-semibold text-slate-700 text-xs" };
const _hoisted_100 = { class: "space-y-2.5 pb-1" };
const _hoisted_101 = { class: "text-[11px] text-slate-500 font-semibold space-y-1.5 pt-1" };
const _hoisted_102 = { key: 0 };
const _hoisted_103 = { class: "font-bold text-slate-700" };
const _hoisted_104 = { key: 1 };
const _hoisted_105 = { class: "font-bold text-slate-700" };
const _hoisted_106 = { class: "pt-4 flex items-center space-x-3 border-t border-gray-100" };
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", _hoisted_1, [
                    ...
                    return openBlock(), createElementBlock("tr", {
                      ...
                      createBaseVNode("td", _hoisted_34, [
                        booking.status === "checked_in" ? (openBlock(), createElementBlock("div", _hoisted_35, [
                          ...
                          createVNode(unref(LogOut), { class: "w-4 h-4 text-blue-600" }),
                      ...
                      createBaseVNode("td", _hoisted_39, [
                        createBaseVNode("div", _hoisted_40, [
                          ...
                          }, " Check In ", 8, _hoisted_42)) : createCommentVNode("", true),
                          ...
                          }, " Check Out ", 8, _hoisted_43)) : createCommentVNode("", true),
                          booking.status === "booked" ? (openBlock(), createElementBlock("button", {
                            key: 2,
                          ...
                          }, " Cancel ", 8, _hoisted_44)) : createCommentVNode("", true)
                        ])
                      ])
                    ]);
                  }), 128))
                    ...
                    return openBlock(), createElementBlock("tr", {
                      ...
                      createBaseVNode("td", _hoisted_67, [
                        createBaseVNode("div", _hoisted_68, [
                          createVNode(unref(MapPin), { class: "w-4 h-4 text-slate-400 flex-shrink-0" }),
                          createBaseVNode("span", _hoisted_69, "Seat " + toDisplayString(req.seat?.seat_number), 1),
                          createBaseVNode("span", _hoisted_70, toDisplayString(req.seat?.floor?.name), 1)
                        ])
                      ]),
                      createBaseVNode("td", _hoisted_71, [
                        createBaseVNode("span", _hoisted_72, toDisplayString(req.seat?.seat_section?.academic_level || "N/A"), 1)
                      ]),
                      createBaseVNode("td", _hoisted_73, toDisplayString(formatDate(req.created_at)), 1),
                      ...
                      createBaseVNode("td", _hoisted_75, [
                        req.status === "pending" ? (openBlock(), createElementBlock("div", _hoisted_76, [
                          createBaseVNode("button", {
                          ...
                          }, " Reject ", 8, _hoisted_78)
                        ])) : (openBlock(), createElementBlock("div", _hoisted_79, " Processed "))
                      ])
                    ]);
                  }), 128))
                ])
        ...
        selectedBooking.value ? (openBlock(), createElementBlock("div", _hoisted_80, [
            ...
            createBaseVNode("div", _hoisted_82, [
              createBaseVNode("div", _hoisted_83, [
                ...
                createBaseVNode("div", null, [
                  ...
                  createBaseVNode("p", _hoisted_85, "Booking identification #" + toDisplayString(selectedBooking.value.id), 1)
                ])
              ]),
              createBaseVNode("button", {
            ...
            createBaseVNode("div", _hoisted_86, [
              createBaseVNode("div", _hoisted_87, [
                createBaseVNode("div", _hoisted_88, [
                  ...
                  }, null, 8, _hoisted_89)) : (openBlock(), createElementBlock("div", _hoisted_90, toDisplayString(selectedBooking.value.user?.name?.charAt(0).toUpperCase()), 1))
                ]),
                createBaseVNode("div", null, [
                  createBaseVNode("h4", _hoisted_91, toDisplayString(selectedBooking.value.user?.name || "N/A"), 1),
                  createBaseVNode("p", _hoisted_92, toDisplayString(selectedBooking.value.user?.email || "N/A"), 1),
                  createBaseVNode("p", _hoisted_93, "CRN: " + toDisplayString(selectedBooking.value.user?.crn || "N/A"), 1)
                ])
              ]),
              createBaseVNode("div", _hoisted_94, [
                createBaseVNode("div", null, [
                  ...
                  createBaseVNode("span", _hoisted_95, "Seat " + toDisplayString(selectedBooking.value.seat?.seat_number || "N/A"), 1)
                ]),
                createBaseVNode("div", null, [
                  ...
                  createBaseVNode("span", _hoisted_96, toDisplayString(selectedBooking.value.seat?.floor?.name || "N/A"), 1)
                ])
              ]),
              createBaseVNode("div", _hoisted_97, [
                createBaseVNode("div", null, [
                  ...
                  createBaseVNode("span", _hoisted_98, toDisplayString(formatDate(selectedBooking.value.booking_time)), 1)
                ]),
                createBaseVNode("div", null, [
                  ...
                  createBaseVNode("span", _hoisted_99, toDisplayString(formatTime(selectedBooking.value.booking_time)) + " - " + toDisplayString(formatTime(selectedBooking.value.scheduled_end_time)), 1)
                ])
              ]),
              createBaseVNode("div", _hoisted_100, [
                ...
                createBaseVNode("div", _hoisted_101, [
                  selectedBooking.value.check_in_time ? (openBlock(), createElementBlock("p", _hoisted_102, [
                    _cache[24] || (_cache[24] = createTextVNode("Checked In: ", -1)),
                    createBaseVNode("span", _hoisted_103, toDisplayString(formatTime(selectedBooking.value.check_in_time)), 1)
                  ])) : createCommentVNode("", true),
                  selectedBooking.value.check_out_time ? (openBlock(), createElementBlock("p", _hoisted_104, [
                    _cache[25] || (_cache[25] = createTextVNode("Checked Out: ", -1)),
                    createBaseVNode("span", _hoisted_105, toDisplayString(formatTime(selectedBooking.value.check_out_time)), 1)
                  ])) : createCommentVNode("", true)
                ])
              ]),
...
const BookingsPage = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-99560780"]]);
export {
