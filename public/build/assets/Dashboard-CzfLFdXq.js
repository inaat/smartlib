import { d as defineComponent, r as ref, o as onMounted, H as onUnmounted, G as watch, a as createElementBlock, b as createBaseVNode, f as createVNode, u as unref, F as Fragment, j as renderList, q as normalizeStyle, t as toDisplayString, n as normalizeClass, l as createCommentVNode, k as openBlock, J as useApp, c as computed, i as createTextVNode, g as resolveComponent, w as withCtx, C as useRouter, h as createBlock, m as resolveDynamicComponent, x as useAuth, L as studentAPI } from "./main-DKJzpCzk.js";
import { S as Sparkles } from "./sparkles-HS9Wmq55.js";
import { C as ChevronLeft } from "./chevron-left-C5nHd5Vr.js";
...
import { S as SeatExtensionModal } from "./SeatExtensionModal-CF2RCWqH.js";
...
import { F as Flame } from "./flame-eJraDxXK.js";
...
import "./circle-alert-CKXiS_Iq.js";
...
const _hoisted_15$3 = { class: "font-bold text-slate-800 text-base mb-2 tracking-tight leading-snug" };
const _hoisted_16$3 = { class: "text-xs text-slate-500 mb-4.5 leading-relaxed font-normal max-w-xl" };
const _hoisted_17$3 = { class: "flex flex-wrap items-center gap-x-5 gap-y-2 text-[10px] font-bold text-slate-400" };
const _hoisted_18$3 = {
  key: 0,
              ...
              return openBlock(), createElementBlock("div", {
                ...
                createBaseVNode("div", _hoisted_13$3, [
                  createBaseVNode("div", _hoisted_14$3, [
                    createBaseVNode("div", {
                      class: normalizeClass(["inline-flex px-2.5 py-0.5 rounded-full text-[9px] font-bold uppercase tracking-wider mb-3 border", getTypeColor(recommendation.type)])
                  ...
                  createBaseVNode("div", _hoisted_22$3, [
                    createBaseVNode("button", {
                      ...
                      class: normalizeClass(["px-5 py-2.5 rounded-xl text-white text-xs font-bold uppercase tracking-wider transition-all duration-200 hover-lift active:scale-98 shadow-sm", getButtonColor(recommendation.type)])
...
const RecommendationSlider = /* @__PURE__ */ _export_sfc(_sfc_main$5, [["__scopeId", "data-v-166f2079"]]);
...
const UpcomingBookings = /* @__PURE__ */ _export_sfc(_sfc_main$4, [["__scopeId", "data-v-fc2b18f3"]]);
const _hoisted_1$3 = {
  key: 0,
...
const _hoisted_2$2 = { class: "text-sm font-bold text-slate-800 uppercase tracking-wider mb-5 flex items-center" };
...
const _hoisted_5$2 = { class: "font-bold text-slate-800 text-xs tracking-wide" };
...
const _hoisted_4 = { class: "text-2xl font-extrabold mb-1" };
const _hoisted_5 = { class: "grid grid-cols-2 md:grid-cols-4 gap-4" };
const _hoisted_6 = { class: "bg-white rounded-xl shadow-sm border border-gray-100 p-5 flex flex-col space-y-2 hover:shadow-md transition-shadow" };
const _hoisted_7 = { class: "flex items-center space-x-2" };
const _hoisted_8 = { class: "p-2 bg-blue-50 rounded-lg" };
const _hoisted_9 = { class: "text-3xl font-extrabold text-slate-800" };
const _hoisted_10 = { class: "bg-white rounded-xl shadow-sm border border-gray-100 p-5 flex flex-col space-y-2 hover:shadow-md transition-shadow" };
const _hoisted_11 = { class: "flex items-center space-x-2" };
const _hoisted_12 = { class: "p-2 bg-purple-50 rounded-lg" };
const _hoisted_13 = { class: "text-3xl font-extrabold text-slate-800" };
const _hoisted_14 = { class: "bg-white rounded-xl shadow-sm border border-gray-100 p-5 flex flex-col space-y-2 hover:shadow-md transition-shadow" };
const _hoisted_15 = { class: "flex items-center space-x-2" };
const _hoisted_16 = { class: "p-2 bg-emerald-50 rounded-lg" };
const _hoisted_17 = { class: "text-3xl font-extrabold text-slate-800" };
const _hoisted_18 = { class: "bg-white rounded-xl shadow-sm border border-gray-100 p-5 flex flex-col space-y-2 hover:shadow-md transition-shadow" };
const _hoisted_19 = { class: "flex items-center space-x-2" };
const _hoisted_20 = { class: "p-2 bg-orange-50 rounded-lg" };
const _hoisted_21 = { class: "text-3xl font-extrabold text-slate-800" };
const _hoisted_22 = { class: "grid grid-cols-1 lg:grid-cols-3 gap-6" };
const _hoisted_23 = { class: "lg:col-span-2 space-y-6" };
const _hoisted_24 = { class: "bg-white rounded-xl shadow-sm border border-gray-200 p-6" };
const _hoisted_25 = { class: "flex items-center justify-between mb-6" };
const _hoisted_26 = { class: "text-xl font-bold text-gray-900 flex items-center" };
const _hoisted_27 = { class: "flex items-center space-x-1 bg-slate-100 p-1 rounded-xl" };
const _hoisted_28 = { class: "mb-6" };
const _hoisted_29 = { class: "flex items-center justify-between mb-4" };
const _hoisted_30 = { class: "text-sm font-semibold text-slate-500 uppercase tracking-wider" };
const _hoisted_31 = { class: "text-xs font-bold text-blue-600 bg-blue-50 border border-blue-100 px-2.5 py-1 rounded-full shadow-sm" };
const _hoisted_32 = { class: "relative h-48 mb-3" };
const _hoisted_33 = { class: "absolute inset-0 flex flex-col justify-between pointer-events-none" };
const _hoisted_34 = { class: "absolute inset-0 flex items-end justify-between space-x-3.5 pt-4" };
const _hoisted_35 = { class: "absolute -top-10 left-1/2 transform -translate-x-1/2 bg-slate-800 text-white text-[10px] font-bold px-2.5 py-1.5 rounded-lg opacity-0 group-hover:opacity-100 transition-all duration-200 whitespace-nowrap shadow-lg border border-slate-700 pointer-events-none z-20" };
const _hoisted_36 = { class: "flex justify-between px-2 pt-2 border-t border-slate-100 text-[10px] font-extrabold text-slate-400 uppercase tracking-widest" };
const _hoisted_37 = { class: "grid grid-cols-3 gap-4 pt-4 border-t border-gray-200" };
const _hoisted_38 = { class: "text-center" };
const _hoisted_39 = { class: "text-2xl font-bold text-gray-900" };
...
const _hoisted_44 = { class: "bg-white rounded-xl shadow-sm border border-gray-200 p-6 relative overflow-hidden" };
const _hoisted_45 = { class: "text-lg font-bold text-slate-800 mb-6 flex items-center" };
const _hoisted_46 = { class: "relative pl-6 border-l-2 border-slate-100 space-y-6 ml-3 text-left" };
const _hoisted_47 = { class: "p-4 bg-slate-50 border border-slate-100 rounded-2xl hover:border-slate-200/80 hover:bg-slate-50/80 transition-all hover-lift flex items-start space-x-3.5 relative" };
const _hoisted_48 = { class: "flex-1 min-w-0" };
const _hoisted_49 = { class: "text-xs font-bold text-slate-800" };
const _hoisted_50 = { class: "text-[11px] text-slate-500 mt-0.5 leading-relaxed" };
const _hoisted_51 = { class: "text-[10px] font-semibold text-slate-400 text-right whitespace-nowrap self-start" };
const _hoisted_52 = { class: "space-y-6" };
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", _hoisted_1, [
        createBaseVNode("div", _hoisted_2, [
          _cache[3] || (_cache[3] = createBaseVNode("div", { class: "absolute top-0 right-0 w-64 h-64 bg-white opacity-5 rounded-full -mr-32 -mt-32" }, null, -1)),
          _cache[4] || (_cache[4] = createBaseVNode("div", { class: "absolute bottom-0 left-0 w-48 h-48 bg-white opacity-5 rounded-full -ml-24 -mb-24" }, null, -1)),
          createBaseVNode("div", _hoisted_3, [
            createBaseVNode("h1", _hoisted_4, "Welcome back, " + toDisplayString(unref(user)?.name) + "! 👋", 1),
            _cache[2] || (_cache[2] = createBaseVNode("p", { class: "text-blue-200 text-sm font-medium" }, "Ready to continue your learning journey? Your library world awaits.", -1))
          ])
        ]),
        createBaseVNode("div", _hoisted_5, [
          createBaseVNode("div", _hoisted_6, [
            createBaseVNode("div", _hoisted_7, [
              ...
              _cache[5] || (_cache[5] = createBaseVNode("span", { class: "text-xs font-bold text-slate-400 uppercase tracking-wider" }, "Total Bookings", -1))
            ]),
            createBaseVNode("div", _hoisted_9, toDisplayString(checkedInBookingsCount.value), 1),
            _cache[6] || (_cache[6] = createBaseVNode("div", { class: "text-[10px] text-slate-400 font-medium" }, "Reservations completed this month", -1))
          ]),
          createBaseVNode("div", _hoisted_10, [
            createBaseVNode("div", _hoisted_11, [
              ...
              _cache[7] || (_cache[7] = createBaseVNode("span", { class: "text-xs font-bold text-slate-400 uppercase tracking-wider" }, "Hours Today", -1))
            ]),
            createBaseVNode("div", _hoisted_13, toDisplayString(hoursToday.value) + "h", 1),
            _cache[8] || (_cache[8] = createBaseVNode("div", { class: "text-[10px] text-slate-400 font-medium" }, "Study hours logged in libraries", -1))
          ]),
          createBaseVNode("div", _hoisted_14, [
            createBaseVNode("div", _hoisted_15, [
              ...
              _cache[9] || (_cache[9] = createBaseVNode("span", { class: "text-xs font-bold text-slate-400 uppercase tracking-wider" }, "Reserved Books", -1))
            ]),
            createBaseVNode("div", _hoisted_17, toDisplayString(reservedBooksCount.value), 1),
            _cache[10] || (_cache[10] = createBaseVNode("div", { class: "text-[10px] text-slate-400 font-medium" }, "Catalog items ready at desk", -1))
          ]),
          createBaseVNode("div", _hoisted_18, [
            createBaseVNode("div", _hoisted_19, [
              ...
              _cache[11] || (_cache[11] = createBaseVNode("span", { class: "text-xs font-bold text-slate-400 uppercase tracking-wider" }, "Available Libraries", -1))
            ]),
            createBaseVNode("div", _hoisted_21, toDisplayString(unref(libraries).length), 1),
            _cache[12] || (_cache[12] = createBaseVNode("div", { class: "text-[10px] text-slate-400 font-medium" }, "National partner locations", -1))
          ])
        ]),
          ...
          createBaseVNode("div", _hoisted_23, [
            ...
            createBaseVNode("div", _hoisted_24, [
              createBaseVNode("div", _hoisted_25, [
                createBaseVNode("h2", _hoisted_26, [
                  ...
                  _cache[13] || (_cache[13] = createTextVNode(" Study Analytics ", -1))
                ]),
              ...
              createBaseVNode("div", _hoisted_28, [
                createBaseVNode("div", _hoisted_29, [
                  createBaseVNode("span", _hoisted_30, toDisplayString(activeTab.value === "weekly" ? "Weekly Study Hours" : "Monthly Study Hours"), 1),
                  createBaseVNode("span", _hoisted_31, toDisplayString(chartTotalHours.value) + "h total ", 1)
                ]),
                    ...
                    (openBlock(true), createElementBlock(Fragment, null, renderList(activeChartData.value, (item, index) => {
                      return openBlock(), createElementBlock("div", {
                        ...
                        createBaseVNode("div", {
                          ...
                          createBaseVNode("div", _hoisted_35, toDisplayString(item.hours) + "h ", 1)
                        ], 4)
                      ]);
                    }), 128))
                  ])
              ...
              createBaseVNode("div", _hoisted_37, [
                createBaseVNode("div", _hoisted_38, [
                  createBaseVNode("div", _hoisted_39, toDisplayString(avgSessionDuration.value) + "h", 1),
                  _cache[14] || (_cache[14] = createBaseVNode("div", { class: "text-xs text-gray-600" }, "Avg. Session", -1))
                ]),
                createBaseVNode("div", _hoisted_40, [
                  createBaseVNode("div", _hoisted_41, toDisplayString(totalSessions.value), 1),
                  _cache[15] || (_cache[15] = createBaseVNode("div", { class: "text-xs text-gray-600" }, "Total Sessions", -1))
                ]),
                createBaseVNode("div", _hoisted_42, [
                  createBaseVNode("div", _hoisted_43, toDisplayString(focusScore.value) + "%", 1),
                  _cache[16] || (_cache[16] = createBaseVNode("div", { class: "text-xs text-gray-600" }, "Focus Score", -1))
                ])
              ])
            ]),
            createBaseVNode("div", _hoisted_44, [
              createBaseVNode("h2", _hoisted_45, [
                ...
                _cache[17] || (_cache[17] = createTextVNode(" Recent Activity ", -1))
              ]),
                  ...
                  return openBlock(), createElementBlock("div", {
                    ...
                    createBaseVNode("div", _hoisted_47, [
                      ...
                      createBaseVNode("div", _hoisted_48, [
                        createBaseVNode("p", _hoisted_49, toDisplayString(activity.title), 1),
                        createBaseVNode("p", _hoisted_50, toDisplayString(activity.description), 1)
                      ]),
                      createBaseVNode("div", _hoisted_51, toDisplayString(activity.time), 1)
                    ])
                  ]);
                }), 128))
              ])
