import { c as createLucideIcon, d as defineComponent, J as useRoute, r as ref, o as onMounted, a as computed, b as createElementBlock, e as createBaseVNode, p as createCommentVNode, g as createVNode, u as unref, n as normalizeClass, i as createBlock, t as toDisplayString, R as RefreshCw, F as Fragment, k as renderList, C as Clock, B as withModifiers, s as withDirectives, v as vModelText, H as vModelSelect, f as createStaticVNode, E as vModelCheckbox, W as librarianAPI, G as useRouter, j as createTextVNode, M as LogOut, m as openBlock, _ as _export_sfc } from "./main-BeUqjoax.js";
...
const _hoisted_26 = { class: "lg:col-span-2 space-y-6" };
const _hoisted_27 = { class: "bg-white rounded-xl p-6 shadow-sm border border-gray-100" };
const _hoisted_28 = { class: "flex items-center space-x-1.5 bg-slate-50 border border-slate-100 p-1 rounded-xl w-max mb-6" };
...
const _hoisted_32 = { class: "flex items-center justify-between border-b border-slate-50 pb-2.5" };
const _hoisted_33 = { class: "flex items-center space-x-2.5" };
const _hoisted_34 = { class: "w-8 h-8 rounded-xl bg-blue-50 border border-blue-100 flex items-center justify-center text-blue-600 font-bold text-xs" };
const _hoisted_35 = { class: "font-bold text-slate-800 text-xs leading-none" };
const _hoisted_36 = { class: "text-slate-400 font-normal text-[11px]" };
const _hoisted_37 = { class: "text-[10px] font-medium text-slate-400 mt-0.5 block" };
const _hoisted_38 = { class: "flex items-center space-x-2" };
const _hoisted_39 = {
  key: 0,
  class: "w-1.5 h-1.5 rounded-full bg-emerald-500 animate-pulse"
};
const _hoisted_40 = { class: "grid grid-cols-1 sm:grid-cols-4 gap-2.5 pt-0.5" };
const _hoisted_41 = { class: "flex items-center space-x-2 bg-slate-50/60 p-2.5 rounded-xl border border-slate-100" };
const _hoisted_42 = { class: "w-7 h-7 rounded-lg bg-blue-100/70 text-blue-700 flex items-center justify-center flex-shrink-0" };
const _hoisted_43 = { class: "text-[11px] font-bold text-slate-800 leading-none" };
const _hoisted_44 = { class: "flex items-center space-x-2 bg-slate-50/60 p-2.5 rounded-xl border border-slate-100" };
const _hoisted_45 = { class: "w-7 h-7 rounded-lg bg-emerald-100/70 text-emerald-700 flex items-center justify-center flex-shrink-0" };
const _hoisted_46 = { class: "text-[11px] font-bold text-slate-800 leading-none" };
const _hoisted_47 = { class: "flex items-center space-x-2 bg-slate-50/60 p-2.5 rounded-xl border border-slate-100" };
const _hoisted_48 = { class: "w-7 h-7 rounded-lg bg-rose-100/70 text-rose-700 flex items-center justify-center flex-shrink-0" };
const _hoisted_49 = { class: "text-[11px] font-bold text-slate-800 leading-none" };
const _hoisted_50 = { class: "flex items-center space-x-2 bg-slate-50/60 p-2.5 rounded-xl border border-slate-100" };
const _hoisted_51 = { class: "w-7 h-7 rounded-lg bg-indigo-100/70 text-indigo-700 flex items-center justify-center flex-shrink-0" };
const _hoisted_52 = { class: "text-[11px] font-bold text-slate-800 leading-none" };
const _hoisted_53 = {
  key: 1,
...
const _hoisted_55 = { class: "grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4" };
const _hoisted_56 = { class: "p-4 bg-slate-50/70 border border-slate-100 rounded-2xl flex items-center space-x-3 text-left" };
const _hoisted_57 = { class: "w-10 h-10 rounded-xl bg-blue-50 border border-blue-100 text-blue-600 flex items-center justify-center flex-shrink-0" };
const _hoisted_58 = { class: "text-base font-bold text-slate-800" };
const _hoisted_59 = { class: "p-4 bg-slate-50/70 border border-slate-100 rounded-2xl flex items-center space-x-3 text-left" };
const _hoisted_60 = { class: "w-10 h-10 rounded-xl bg-purple-50 border border-purple-100 text-purple-600 flex items-center justify-center flex-shrink-0" };
const _hoisted_61 = { class: "text-base font-bold text-slate-800" };
const _hoisted_62 = { class: "p-4 bg-slate-50/70 border border-slate-100 rounded-2xl flex items-center space-x-3 text-left" };
const _hoisted_63 = { class: "w-10 h-10 rounded-xl bg-emerald-50 border border-emerald-100 text-emerald-600 flex items-center justify-center flex-shrink-0" };
const _hoisted_64 = { class: "text-base font-bold text-slate-800" };
const _hoisted_65 = { class: "p-4 bg-slate-50/70 border border-slate-100 rounded-2xl flex items-center space-x-3 text-left" };
const _hoisted_66 = { class: "w-10 h-10 rounded-xl bg-indigo-50 border border-indigo-100 text-indigo-600 flex items-center justify-center flex-shrink-0" };
const _hoisted_67 = { class: "text-base font-bold text-slate-800" };
const _hoisted_68 = { class: "space-y-3" };
const _hoisted_69 = { class: "flex items-center justify-between border-b border-slate-50 pb-2.5" };
const _hoisted_70 = { class: "flex items-center space-x-2.5" };
const _hoisted_71 = { class: "w-8 h-8 rounded-xl bg-slate-100 border border-slate-200/60 flex items-center justify-center text-slate-500 font-bold text-xs" };
const _hoisted_72 = { class: "font-bold text-slate-800 text-xs leading-none" };
const _hoisted_73 = { class: "text-[10px] font-medium text-slate-400 mt-0.5 block" };
const _hoisted_74 = { class: "flex items-center space-x-2" };
const _hoisted_75 = {
  key: 0,
  class: "w-1.5 h-1.5 rounded-full bg-emerald-500 animate-pulse"
};
const _hoisted_76 = { class: "grid grid-cols-1 sm:grid-cols-3 gap-3 pt-0.5" };
const _hoisted_77 = { class: "flex items-center space-x-2 bg-slate-50/60 p-2.5 rounded-xl border border-slate-100" };
const _hoisted_78 = { class: "w-7 h-7 rounded-lg bg-emerald-100/70 text-emerald-700 flex items-center justify-center flex-shrink-0" };
const _hoisted_79 = { class: "text-xs font-bold text-slate-800 leading-none" };
const _hoisted_80 = { class: "flex items-center space-x-2 bg-slate-50/60 p-2.5 rounded-xl border border-slate-100" };
const _hoisted_81 = { class: "w-7 h-7 rounded-lg bg-rose-100/70 text-rose-700 flex items-center justify-center flex-shrink-0" };
const _hoisted_82 = { class: "text-xs font-bold text-slate-800 leading-none" };
const _hoisted_83 = { class: "flex items-center space-x-2 bg-slate-50/60 p-2.5 rounded-xl border border-slate-100" };
const _hoisted_84 = { class: "w-7 h-7 rounded-lg bg-blue-100/70 text-blue-700 flex items-center justify-center flex-shrink-0" };
const _hoisted_85 = { class: "text-xs font-bold text-slate-800 leading-none" };
const _hoisted_86 = {
  key: 0,
  class: "flex flex-col sm:flex-row items-center justify-between border-t border-slate-100 pt-4 mt-2 gap-3 text-left"
};
const _hoisted_87 = { class: "text-xs font-semibold text-slate-500" };
const _hoisted_88 = { class: "flex items-center space-x-2" };
const _hoisted_89 = ["disabled"];
const _hoisted_90 = { class: "text-xs font-bold text-slate-700 px-2" };
...
const _hoisted_94 = { class: "font-bold text-slate-800 text-xs" };
const _hoisted_95 = { class: "text-[10px] text-slate-400 font-semibold mt-0.5 uppercase" };
const _hoisted_96 = {
  key: 1,
...
const _hoisted_102 = { class: "bg-white rounded-xl shadow-xl w-full max-w-md overflow-hidden animate-in fade-in zoom-in duration-200 border border-gray-200" };
const _hoisted_103 = { class: "p-6 border-b border-slate-100 flex items-center justify-between text-left" };
const _hoisted_104 = { class: "grid grid-cols-2 gap-4" };
const _hoisted_105 = { class: "grid grid-cols-2 gap-4" };
const _hoisted_106 = { key: 0 };
const _hoisted_107 = { class: "flex items-center space-x-2 pt-1" };
const _hoisted_108 = { class: "flex items-center space-x-2" };
const _hoisted_109 = { class: "pt-4 flex items-center space-x-3" };
...
const _hoisted_114 = { class: "bg-white rounded-xl shadow-xl w-full max-w-md overflow-hidden animate-in fade-in zoom-in duration-200 border border-gray-200" };
const _hoisted_115 = { class: "p-6 border-b border-gray-100 flex items-center justify-between text-left" };
const _hoisted_116 = { class: "flex items-center space-x-3" };
const _hoisted_117 = { class: "w-10 h-10 rounded-lg bg-rose-50 flex items-center justify-center text-rose-600 border border-rose-100/50 flex-shrink-0" };
const _hoisted_118 = { class: "text-[10px] font-semibold text-slate-400 uppercase tracking-wider mt-0.5" };
const _hoisted_119 = { class: "flex items-start space-x-2.5 p-3.5 bg-rose-50/50 text-rose-700 border border-rose-100/65 rounded-xl text-[11px] font-semibold leading-relaxed" };
const _hoisted_120 = { class: "pt-2 flex items-center space-x-3" };
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", _hoisted_1, [
            ...
            createBaseVNode("div", _hoisted_27, [
              createBaseVNode("div", _hoisted_28, [
                (openBlock(), createElementBlock(Fragment, null, renderList(tabs, (tab) => {
                  ...
                  }, toDisplayString(tab.label), 11, _hoisted_29);
                }), 64))
              ]),
              createBaseVNode("div", _hoisted_30, [
                activeTab.value === "bookings" ? (openBlock(), createElementBlock("div", _hoisted_31, [
                    ...
                    return openBlock(), createElementBlock("div", {
                      ...
                      createBaseVNode("div", _hoisted_32, [
                        createBaseVNode("div", _hoisted_33, [
                          ...
                          createBaseVNode("div", null, [
                            createBaseVNode("h4", _hoisted_35, [
                              ...
                              createBaseVNode("span", _hoisted_36, "(" + toDisplayString(booking.seat?.floor?.name || booking.seat?.section?.floor?.name || "1st Floor") + ")", 1)
                            ]),
                            createBaseVNode("span", _hoisted_37, toDisplayString(booking.seat?.library?.name || "Library Booking") + " • " + toDisplayString(formatDate(booking.booking_time)), 1)
                          ])
                        ]),
                        createBaseVNode("div", _hoisted_38, [
                          createBaseVNode("span", {
                            ...
                            booking.status === "checked_in" ? (openBlock(), createElementBlock("span", _hoisted_39)) : createCommentVNode("", true),
                      ...
                      createBaseVNode("div", _hoisted_40, [
                        createBaseVNode("div", _hoisted_41, [
                          ...
                          createBaseVNode("div", null, [
                            _cache[24] || (_cache[24] = createBaseVNode("span", { class: "text-[9px] font-semibold text-slate-400 uppercase tracking-wider block leading-none mb-0.5" }, "Slot Time", -1)),
                            createBaseVNode("span", _hoisted_43, toDisplayString(formatTime(booking.booking_time)) + " - " + toDisplayString(formatTime(booking.scheduled_end_time)), 1)
                          ])
                        ]),
                        createBaseVNode("div", _hoisted_44, [
                          ...
                          createBaseVNode("div", null, [
                            _cache[25] || (_cache[25] = createBaseVNode("span", { class: "text-[9px] font-semibold text-slate-400 uppercase tracking-wider block leading-none mb-0.5" }, "Check In", -1)),
                            createBaseVNode("span", _hoisted_46, toDisplayString(booking.check_in_time ? formatTime(booking.check_in_time) : booking.status === "checked_in" ? "Checked In" : "--:--"), 1)
                          ])
                        ]),
                        createBaseVNode("div", _hoisted_47, [
                          ...
                          createBaseVNode("div", null, [
                            _cache[26] || (_cache[26] = createBaseVNode("span", { class: "text-[9px] font-semibold text-slate-400 uppercase tracking-wider block leading-none mb-0.5" }, "Check Out", -1)),
                            createBaseVNode("span", _hoisted_49, toDisplayString(booking.check_out_time ? formatTime(booking.check_out_time) : booking.status === "checked_in" ? "In Session" : "--:--"), 1)
                          ])
                        ]),
                        createBaseVNode("div", _hoisted_50, [
                          ...
                          createBaseVNode("div", null, [
                            _cache[27] || (_cache[27] = createBaseVNode("span", { class: "text-[9px] font-semibold text-slate-400 uppercase tracking-wider block leading-none mb-0.5" }, "Duration", -1)),
                            createBaseVNode("span", _hoisted_52, toDisplayString(formatDuration(booking.total_minutes) || (booking.status === "checked_in" ? "Active" : "--")), 1)
                          ])
                        ])
                      ])
                    ]);
                  }), 128)) : (openBlock(), createElementBlock("div", _hoisted_53, [
                    createVNode(unref(Search), { class: "w-10 h-10 text-slate-200 mb-3" }),
                    _cache[28] || (_cache[28] = createBaseVNode("p", { class: "text-xs font-bold text-slate-400 uppercase tracking-widest" }, "No seat bookings found", -1))
                  ]))
                ])) : createCommentVNode("", true),
                activeTab.value === "attendance" ? (openBlock(), createElementBlock("div", _hoisted_54, [
                  createBaseVNode("div", _hoisted_55, [
                    createBaseVNode("div", _hoisted_56, [
                      ...
                      createBaseVNode("div", null, [
                        _cache[29] || (_cache[29] = createBaseVNode("span", { class: "text-[10px] font-semibold text-slate-400 uppercase tracking-wider block" }, "Total Visits", -1)),
                        createBaseVNode("span", _hoisted_58, toDisplayString(student.value.attendance?.length || 0) + " Sessions", 1)
                      ])
                    ]),
                    createBaseVNode("div", _hoisted_59, [
                      ...
                      createBaseVNode("div", null, [
                        _cache[30] || (_cache[30] = createBaseVNode("span", { class: "text-[10px] font-semibold text-slate-400 uppercase tracking-wider block" }, "This Month", -1)),
                        createBaseVNode("span", _hoisted_61, toDisplayString(attendanceThisMonth.value) + " Visits", 1)
                      ])
                    ]),
                    createBaseVNode("div", _hoisted_62, [
                      ...
                      createBaseVNode("div", null, [
                        _cache[31] || (_cache[31] = createBaseVNode("span", { class: "text-[10px] font-semibold text-slate-400 uppercase tracking-wider block" }, "Total Hours", -1)),
                        createBaseVNode("span", _hoisted_64, toDisplayString(formattedTotalHours.value), 1)
                      ])
                    ]),
                    createBaseVNode("div", _hoisted_65, [
                      ...
                      createBaseVNode("div", null, [
                        _cache[32] || (_cache[32] = createBaseVNode("span", { class: "text-[10px] font-semibold text-slate-400 uppercase tracking-wider block" }, "Active Days", -1)),
                        createBaseVNode("span", _hoisted_67, toDisplayString(uniqueAttendanceDays.value) + " Days", 1)
                      ])
                    ])
                  ]),
                  currentMonthAttendance.value.length > 0 ? (openBlock(), createElementBlock(Fragment, { key: 0 }, [
                        ...
                        return openBlock(), createElementBlock("div", {
                          ...
                          createBaseVNode("div", _hoisted_69, [
                            createBaseVNode("div", _hoisted_70, [
                              ...
                              createBaseVNode("div", null, [
                                createBaseVNode("h4", _hoisted_72, toDisplayString(formatDate(log.date)), 1),
                                createBaseVNode("span", _hoisted_73, toDisplayString(log.library?.name || "Library Entry"), 1)
                              ])
                            ]),
                            createBaseVNode("div", _hoisted_74, [
                              ...
                              createBaseVNode("span", {
                                ...
                                !log.check_out_time ? (openBlock(), createElementBlock("span", _hoisted_75)) : createCommentVNode("", true),
                          ...
                          createBaseVNode("div", _hoisted_76, [
                            createBaseVNode("div", _hoisted_77, [
                              ...
                              createBaseVNode("div", null, [
                                _cache[33] || (_cache[33] = createBaseVNode("span", { class: "text-[9px] font-semibold text-slate-400 uppercase tracking-wider block leading-none mb-0.5" }, "Check In", -1)),
                                createBaseVNode("span", _hoisted_79, toDisplayString(formatLogTime(log.check_in_time)), 1)
                              ])
                            ]),
                            createBaseVNode("div", _hoisted_80, [
                              ...
                              createBaseVNode("div", null, [
                                _cache[34] || (_cache[34] = createBaseVNode("span", { class: "text-[9px] font-semibold text-slate-400 uppercase tracking-wider block leading-none mb-0.5" }, "Check Out", -1)),
                                createBaseVNode("span", _hoisted_82, toDisplayString(log.check_out_time ? formatLogTime(log.check_out_time) : "In Progress"), 1)
                              ])
                            ]),
                            createBaseVNode("div", _hoisted_83, [
                              ...
                              createBaseVNode("div", null, [
                                _cache[35] || (_cache[35] = createBaseVNode("span", { class: "text-[9px] font-semibold text-slate-400 uppercase tracking-wider block leading-none mb-0.5" }, "Session Duration", -1)),
                                createBaseVNode("span", _hoisted_85, toDisplayString(formatDuration(log.total_minutes) || (log.check_out_time ? "N/A" : "Active")), 1)
                              ])
                            ])
                          ])
                        ]);
                    ...
                    currentMonthAttendance.value.length > 0 ? (openBlock(), createElementBlock("div", _hoisted_86, [
                      createBaseVNode("span", _hoisted_87, " Showing " + toDisplayString((attendancePage.value - 1) * attendancePerPage + 1) + " to " + toDisplayString(Math.min(attendancePage.value * attendancePerPage, currentMonthAttendance.value.length)) + " of " + toDisplayString(currentMonthAttendance.value.length) + " entries (This Month) ", 1),
                      createBaseVNode("div", _hoisted_88, [
                        ...
                        }, " Previous ", 8, _hoisted_89),
                        createBaseVNode("span", _hoisted_90, " Page " + toDisplayString(attendancePage.value) + " of " + toDisplayString(totalAttendancePages.value), 1),
                        createBaseVNode("button", {
                  ...
                  ], 64)) : (openBlock(), createElementBlock("div", _hoisted_92, [
                    createVNode(unref(Clock), { class: "w-10 h-10 text-slate-300 mb-3" }),
                    _cache[36] || (_cache[36] = createBaseVNode("p", { class: "text-xs font-bold text-slate-400 uppercase tracking-wider" }, "No attendance logs recorded for this month", -1))
                  ]))
                ])) : createCommentVNode("", true),
                activeTab.value === "events" ? (openBlock(), createElementBlock("div", _hoisted_93, [
                  student.value.events && student.value.events.length > 0 ? (openBlock(true), createElementBlock(Fragment, { key: 0 }, renderList(student.value.events, (event) => {
                    return openBlock(), createElementBlock("div", {
                      ...
                      createBaseVNode("div", null, [
                        createBaseVNode("h4", _hoisted_94, toDisplayString(event.title), 1),
                        createBaseVNode("p", _hoisted_95, toDisplayString(formatDate(event.start_time)) + " • " + toDisplayString(event.location || "Library Hall"), 1)
                      ]),
                      _cache[37] || (_cache[37] = createBaseVNode("span", { class: "text-[9px] font-bold px-2.5 py-1 rounded-full border border-green-200 text-green-700 bg-white uppercase tracking-wider" }, " Joined ", -1))
                    ]);
                  }), 128)) : (openBlock(), createElementBlock("div", _hoisted_96, [
                    createVNode(unref(Search), { class: "w-10 h-10 text-slate-200 mb-4" }),
                    _cache[38] || (_cache[38] = createBaseVNode("p", { class: "text-xs font-bold text-slate-455 uppercase tracking-widest" }, "No events registered", -1))
                  ]))
                ])) : createCommentVNode("", true),
                activeTab.value === "books" ? (openBlock(), createElementBlock("div", _hoisted_97, [
                  student.value.reservations && student.value.reservations.length > 0 ? (openBlock(true), createElementBlock(Fragment, { key: 0 }, renderList(student.value.reservations, (res) => {
                    return openBlock(), createElementBlock("div", {
                      ...
                      createBaseVNode("div", null, [
                        createBaseVNode("h4", _hoisted_98, toDisplayString(res.book?.title), 1),
                        createBaseVNode("p", _hoisted_99, " Author: " + toDisplayString(res.book?.author) + " • Reserved: " + toDisplayString(formatDate(res.reserved_at)), 1)
                      ]),
                      createBaseVNode("span", {
                        class: normalizeClass([
                    ...
                    createVNode(unref(Search), { class: "w-10 h-10 text-slate-200 mb-4" }),
                    _cache[39] || (_cache[39] = createBaseVNode("p", { class: "text-xs font-bold text-slate-400 uppercase tracking-widest" }, "No book reservations found", -1))
                  ]))
                ])) : createCommentVNode("", true)
              ])
            ])
        ...
        showModal.value ? (openBlock(), createElementBlock("div", _hoisted_101, [
          createBaseVNode("div", _hoisted_102, [
            createBaseVNode("div", _hoisted_103, [
              _cache[40] || (_cache[40] = createBaseVNode("h2", { class: "text-lg font-bold text-slate-800" }, "Edit Student", -1)),
              createBaseVNode("button", {
            ...
            createBaseVNode("form", {
              ...
              createBaseVNode("div", null, [
                _cache[41] || (_cache[41] = createBaseVNode("label", { class: "block text-xs font-bold text-slate-500 mb-1.5 uppercase tracking-wider" }, "Full Name", -1)),
              ...
              createBaseVNode("div", _hoisted_104, [
                createBaseVNode("div", null, [
                  _cache[42] || (_cache[42] = createBaseVNode("label", { class: "block text-xs font-bold text-slate-500 mb-1.5 uppercase tracking-wider" }, "Student ID (CRN)", -1)),
                  withDirectives(createBaseVNode("input", {
                ...
                createBaseVNode("div", null, [
                  _cache[44] || (_cache[44] = createBaseVNode("label", { class: "block text-xs font-bold text-slate-500 mb-1.5 uppercase tracking-wider" }, "CA Level", -1)),
                  withDirectives(createBaseVNode("select", {
                    ...
                    createStaticVNode('<option value="" data-v-e3fb576d>Select Level</option><option value="PRC" data-v-e3fb576d>PRC</option><option value="CAF" data-v-e3fb576d>CAF</option><option value="CFAP" data-v-e3fb576d>CFAP</option><option value="MSA" data-v-e3fb576d>MSA</option>', 5)
                  ])], 512), [
              ...
              createBaseVNode("div", _hoisted_105, [
                createBaseVNode("div", null, [
                  _cache[45] || (_cache[45] = createBaseVNode("label", { class: "block text-xs font-bold text-slate-500 mb-1.5 uppercase tracking-wider" }, "Email Address", -1)),
                  withDirectives(createBaseVNode("input", {
                ...
                createBaseVNode("div", null, [
                  _cache[46] || (_cache[46] = createBaseVNode("label", { class: "block text-xs font-bold text-slate-500 mb-1.5 uppercase tracking-wider" }, "Phone Number", -1)),
                  withDirectives(createBaseVNode("input", {
              ...
              createBaseVNode("div", null, [
                _cache[48] || (_cache[48] = createBaseVNode("label", { class: "block text-xs font-bold text-slate-500 mb-1.5 uppercase tracking-wider" }, "Gender", -1)),
                withDirectives(createBaseVNode("select", {
              ...
              changePassword.value ? (openBlock(), createElementBlock("div", _hoisted_106, [
                _cache[49] || (_cache[49] = createBaseVNode("label", { class: "block text-xs font-bold text-slate-500 mb-1.5 uppercase tracking-wider" }, "Password", -1)),
                withDirectives(createBaseVNode("input", {
              ...
              createBaseVNode("div", _hoisted_108, [
                ...
                _cache[51] || (_cache[51] = createBaseVNode("label", {
                  for: "isActive",
                  class: "text-xs font-bold text-slate-550 cursor-pointer"
                }, "Account Active", -1))
              ]),
              createBaseVNode("div", _hoisted_109, [
                ...
                createBaseVNode("button", {
                  ...
                  saving.value ? (openBlock(), createElementBlock("span", _hoisted_111, "Saving...")) : (openBlock(), createElementBlock("span", _hoisted_112, "Update Details"))
                ], 8, _hoisted_110)
              ])
            ], 32)
          ])
        ])) : createCommentVNode("", true),
        showBanModal.value ? (openBlock(), createElementBlock("div", _hoisted_113, [
          createBaseVNode("div", _hoisted_114, [
            createBaseVNode("div", _hoisted_115, [
              createBaseVNode("div", _hoisted_116, [
                ...
                createBaseVNode("div", null, [
                  _cache[52] || (_cache[52] = createBaseVNode("h2", { class: "text-base font-bold text-slate-800 leading-snug" }, "Restrict Student", -1)),
                  createBaseVNode("p", _hoisted_118, "Restrict access for " + toDisplayString(student.value.name), 1)
                ])
              ]),
              createBaseVNode("button", {
            ...
            createBaseVNode("form", {
              ...
              createBaseVNode("div", null, [
                _cache[53] || (_cache[53] = createBaseVNode("label", { class: "block text-xs font-semibold text-slate-550 mb-1.5 uppercase tracking-wider" }, "Duration (Days)", -1)),
                withDirectives(createBaseVNode("input", {
              ...
              createBaseVNode("div", null, [
                _cache[54] || (_cache[54] = createBaseVNode("label", { class: "block text-xs font-semibold text-slate-550 mb-1.5 uppercase tracking-wider" }, "Reason", -1)),
              ...
              createBaseVNode("div", _hoisted_119, [
                ...
                _cache[55] || (_cache[55] = createBaseVNode("p", null, "Restricting this student will block their seat bookings, check-in access, and library requests for the specified duration.", -1))
              ]),
              createBaseVNode("div", _hoisted_120, [
                ...
                }, toDisplayString(banning.value ? "Restricting..." : "Confirm Restriction"), 9, _hoisted_121)
              ])
            ], 32)
          ])
        ])) : createCommentVNode("", true)
...
const StudentDetailsPage = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-e3fb576d"]]);
export {
