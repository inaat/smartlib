import { d as defineComponent, r as ref, c as computed, o as onMounted, a as createElementBlock, l as createCommentVNode, b as createBaseVNode, F as Fragment, f as createVNode, u as unref, t as toDisplayString, n as normalizeClass, i as createTextVNode, q as normalizeStyle, j as renderList, k as openBlock } from "./main-DKJzpCzk.js";
...
const _hoisted_9 = { class: "text-3xl font-black text-slate-800 mt-2.5 leading-none" };
...
const _hoisted_19 = { class: "inline-flex items-center px-2 py-0.5 rounded-full text-[9px] font-bold uppercase tracking-wider bg-indigo-50 border border-indigo-200 text-indigo-700" };
const _hoisted_20 = { class: "flex justify-between items-baseline mt-2.5" };
const _hoisted_21 = { class: "text-lg font-black text-slate-700 tracking-tight leading-none" };
const _hoisted_22 = { class: "text-xs font-black text-indigo-600 leading-none" };
...
const _hoisted_34 = { class: "px-6 py-4 whitespace-nowrap text-xs font-bold text-slate-700" };
          ...
          createBaseVNode("div", _hoisted_3, [
            createBaseVNode("div", _hoisted_4, [
              ...
              createBaseVNode("div", _hoisted_8, [
                _cache[1] || (_cache[1] = createBaseVNode("p", { class: "text-[10px] font-extrabold text-slate-400 uppercase tracking-widest leading-none" }, "Total Points Balance", -1)),
            ...
            createBaseVNode("div", {
              ...
              createBaseVNode("div", _hoisted_11, [
                ...
                _cache[2] || (_cache[2] = createBaseVNode("div", { class: "inline-flex items-center px-2 py-0.5 rounded-full text-[9px] font-bold uppercase tracking-wider bg-slate-50 border border-slate-200 text-slate-500" }, " Current Rank ", -1))
              ]),
                ...
                loyaltyData.value.next_tier ? (openBlock(), createElementBlock("div", _hoisted_16, [
                  ...
                  createBaseVNode("div", _hoisted_20, [
                    createBaseVNode("h4", _hoisted_21, [
                      ...
                      _cache[4] || (_cache[4] = createBaseVNode("span", { class: "text-[11px] font-bold text-slate-400 uppercase tracking-wide" }, "pts to go", -1))
                    ]),
                  ...
                  _cache[6] || (_cache[6] = createBaseVNode("h4", { class: "text-sm font-bold text-slate-800" }, "Max Rank Attained", -1)),
          ...
          createBaseVNode("div", _hoisted_26, [
            createBaseVNode("div", _hoisted_27, [
              createBaseVNode("div", _hoisted_28, [
                ...
                _cache[8] || (_cache[8] = createBaseVNode("h3", { class: "font-extrabold text-slate-800 text-sm" }, "Recent Transactions", -1))
              ])
            ]),
              ...
              createBaseVNode("table", _hoisted_31, [
                _cache[10] || (_cache[10] = createBaseVNode("thead", { class: "bg-slate-50/40" }, [
                  createBaseVNode("tr", null, [
                    createBaseVNode("th", {
                      scope: "col",
                      class: "px-6 py-3.5 text-left text-[10px] font-extrabold text-slate-400 uppercase tracking-widest"
                    }, "Date & Time"),
                    createBaseVNode("th", {
                      scope: "col",
                      class: "px-6 py-3.5 text-left text-[10px] font-extrabold text-slate-400 uppercase tracking-widest"
                    ...
                    createBaseVNode("th", {
                      scope: "col",
                      class: "px-6 py-3.5 text-right text-[10px] font-extrabold text-slate-400 uppercase tracking-widest"
                    }, "Points")
                  ])
                ], -1)),
                    ...
                    return openBlock(), createElementBlock("tr", {
                      ...
                      createBaseVNode("td", _hoisted_35, [
                        createBaseVNode("span", {
                          class: normalizeClass(["inline-flex items-center px-2.5 py-0.5 rounded-full text-[9px] font-bold uppercase tracking-wider", transaction.points > 0 ? "bg-emerald-50 border border-emerald-200 text-emerald-700" : "bg-rose-50 border border-rose-200 text-rose-700"])
                        }, toDisplayString(transaction.type), 3)
                      ]),
                      createBaseVNode("td", {
                        class: normalizeClass(["px-6 py-4 whitespace-nowrap text-xs text-right font-black", transaction.points > 0 ? "text-emerald-600" : "text-rose-600"])
...
const LoyaltyPage = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-27078cc3"]]);
export {
