...
import { H as House } from "./house-BEd7tWKC.js";
...
import { C as CalendarCheck } from "./calendar-check-Cwxw43FG.js";
...
import { M as Menu } from "./menu-BT-AHF2O.js";
...
const _hoisted_5$3 = { class: "space-y-1" };
const _hoisted_6$3 = ["onMouseenter"];
const _hoisted_7$2 = {
  key: 0,
...
const StudentSidebar = /* @__PURE__ */ _export_sfc(_sfc_main$4, [["__scopeId", "data-v-91e6ac5e"]]);
const _hoisted_1$2 = {
  key: 0,
...
const _hoisted_5$2 = { class: "flex items-center space-x-4" };
const _hoisted_6$2 = { class: "hidden lg:block text-left" };
...
const _hoisted_11 = { class: "px-4 py-3 border-b border-slate-100 flex items-center justify-between bg-slate-50/30 flex-shrink-0" };
const _hoisted_12 = {
  key: 0,
  class: "text-[10px] font-semibold text-blue-600 bg-blue-50 px-2 py-0.5 rounded-full"
};
const _hoisted_13 = { class: "flex-1 overflow-y-auto min-h-0" };
const _hoisted_14 = {
  key: 0,
...
const _hoisted_17 = { class: "flex items-start space-x-2.5" };
const _hoisted_18 = { class: "flex-1 min-w-0 text-left" };
const _hoisted_19 = { class: "flex items-center justify-between mb-0.5 gap-1" };
const _hoisted_20 = { class: "text-[9px] text-slate-400 font-semibold flex-shrink-0 whitespace-nowrap" };
const _hoisted_21 = { class: "text-[11px] text-slate-500 font-medium leading-normal break-words line-clamp-2" };
const _hoisted_22 = {
  key: 0,
                          ...
                          createBaseVNode("div", _hoisted_17, [
                            ...
                            createBaseVNode("div", _hoisted_18, [
                              createBaseVNode("div", _hoisted_19, [
                                ...
                                createBaseVNode("span", _hoisted_20, toDisplayString(formatDate(notification.created_at)), 1)
                              ]),
                              createBaseVNode("p", _hoisted_21, toDisplayString(notification.message), 1)
                            ])
                          ]),
...
const StudentTopbar = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["__scopeId", "data-v-98cfd6ac"]]);
const _hoisted_1$1 = {
  key: 0,
...
const _hoisted_5$1 = { class: "text-gray-500 mb-6 text-center leading-relaxed" };
const _hoisted_6$1 = {
  key: 0,
    ...
    return (_ctx, _cache) => {
      return unref(showExtensionModal) ? (openBlock(), createElementBlock("div", _hoisted_1$1, [
        createBaseVNode("div", _hoisted_2$1, [
          ...
          createBaseVNode("p", _hoisted_5$1, " Your session for Seat " + toDisplayString(unref(expiredBooking)?.seat?.seat_number) + " " + toDisplayString(isExpired.value ? "has ended" : "will end in 15 minutes") + ". ", 1),
          !isExpired.value ? (openBlock(), createElementBlock("div", _hoisted_6$1, [..._cache[0] || (_cache[0] = [
