import { d as defineComponent, x as useAuth, r as ref, c as computed, E as useRoute, G as watch, o as onMounted, H as onUnmounted, a as createElementBlock, F as Fragment, b as createBaseVNode, h as createBlock, n as normalizeClass, l as createCommentVNode, e as createStaticVNode, z as withModifiers, f as createVNode, u as unref, j as renderList, I as Teleport, q as normalizeStyle, T as Transition, w as withCtx, i as createTextVNode, t as toDisplayString, m as resolveDynamicComponent, g as resolveComponent, k as openBlock, C as useRouter, J as useApp, K as renderSlot } from "./main-DKJzpCzk.js";
...
import { H as House } from "./house-Dr_3Zd7E.js";
...
import { M as Menu } from "./menu-m08sc_Rb.js";
...
const _hoisted_19$1 = { class: "p-4 border-t border-white/10 bg-transparent flex-shrink-0 flex flex-col justify-end" };
const _hoisted_20$1 = {
  key: 0,
  class: "tracking-wide animate-fade-in"
};
        ...
        createBaseVNode("aside", {
          ...
          createBaseVNode("div", {
            ...
            !showCollapsed.value ? (openBlock(), createElementBlock("div", _hoisted_1$3, [
              _cache[11] || (_cache[11] = createStaticVNode('<div class="w-9 h-9 rounded-full bg-white/15 flex items-center justify-center text-white shadow-md shadow-white/5 group-hover:scale-105 transition-transform flex-shrink-0" data-v-2c76b21a><svg viewBox="0 0 32 32" class="w-5 h-5 text-white" fill="currentColor" data-v-2c76b21a><circle cx="11" cy="16" r="4.5" data-v-2c76b21a></circle><circle cx="21" cy="16" r="4.5" data-v-2c76b21a></circle><rect x="11" y="13.5" width="10" height="5" data-v-2c76b21a></rect></svg></div>', 1)),
              !__props.isCollapsed || !isDesktop.value ? (openBlock(), createElementBlock("div", _hoisted_2$3, [..._cache[10] || (_cache[10] = [
          ...
          createBaseVNode("nav", {
            ...
            createBaseVNode("div", null, [
              ...
              createBaseVNode("div", _hoisted_5$2, [
                (openBlock(true), createElementBlock(Fragment, null, renderList(mainNavItems.slice(0, 2), (item) => {
                    ...
                    default: withCtx(({ isActive: isLinkActive }) => [
                      createBaseVNode("div", {
                        ...
                        class: normalizeClass([
                          ...
                          isLinkActive ? "bg-white text-blue-700 shadow-md shadow-blue-950/15 animate-fade-in" : "text-white hover:bg-white/10"
                        ])
                      }, [
                ...
                createBaseVNode("div", _hoisted_8$2, [
                  createBaseVNode("div", {
                    ...
                    class: normalizeClass([
                      ...
                      isReservationsDropdownActive.value && showCollapsed.value ? "bg-white text-blue-700 shadow-md" : "",
                    ...
                    createVNode(unref(BookMarked), {
                      class: normalizeClass([
                        "w-5 h-5 transition-colors",
                        isReservationsDropdownActive.value && showCollapsed.value ? "text-blue-700" : isReservationsDropdownActive.value ? "text-white" : "text-white/90 group-hover:text-white"
                      ])
                    }, null, 8, ["class"]),
                  ...
                  (openBlock(), createBlock(Teleport, { to: "body" }, [
                    showReservationsPopover.value && showCollapsed.value ? (openBlock(), createElementBlock("div", {
                      ...
                      _cache[13] || (_cache[13] = createBaseVNode("div", { class: "px-3 py-1.5 text-[10px] font-semibold text-white/60 uppercase tracking-widest border-b border-white/10 mb-1" }, " Reservations ", -1)),
                          ...
                          default: withCtx(({ isActive: isSubActive }) => [
                            createBaseVNode("div", {
                              class: normalizeClass([
                                ...
                                isSubActive ? "text-blue-700 bg-white shadow-sm" : "text-white hover:bg-white/10"
                              ])
                            }, [
                  ...
                  createVNode(Transition, { name: "slide-fade" }, {
                    default: withCtx(() => [
                      isReservationsExpanded.value && !showCollapsed.value ? (openBlock(), createElementBlock("div", _hoisted_11$1, [
                        (openBlock(), createElementBlock(Fragment, null, renderList(reservationsSubItems, (subItem, index) => {
                          return createBaseVNode("div", {
                            ...
                            _cache[14] || (_cache[14] = createBaseVNode("div", { class: "absolute left-2.5 top-1/2 -translate-y-1/2 w-3 h-px bg-white/20" }, null, -1)),
                ...
                (openBlock(true), createElementBlock(Fragment, null, renderList(mainNavItems.slice(2), (item) => {
                  return openBlock(), createBlock(_component_router_link, {
                    key: item.path,
                    to: item.path,
          ...
          createBaseVNode("div", _hoisted_19$1, [
            createBaseVNode("button", {
              ...
              !showCollapsed.value ? (openBlock(), createElementBlock("span", _hoisted_20$1, "Sign Out")) : createCommentVNode("", true)
            ], 34)
          ])
        ], 2),
        (openBlock(), createBlock(Teleport, { to: "body" }, [
          showGlobalTooltip.value ? (openBlock(), createElementBlock("div", {
            ...
            _cache[15] || (_cache[15] = createBaseVNode("div", { class: "absolute right-full top-1/2 -translate-y-1/2 border-4 border-transparent border-r-slate-900" }, null, -1))
          ], 4)) : createCommentVNode("", true)
        ]))
      ], 64);
    };
...
const StudentSidebar = /* @__PURE__ */ _export_sfc(_sfc_main$4, [["__scopeId", "data-v-2c76b21a"]]);
const _hoisted_1$2 = {
  key: 0,
...
const _hoisted_13 = {
  key: 0,
  class: "text-[10px] font-extrabold text-blue-600 bg-blue-50 px-2 py-0.5 rounded-full"
};
...
const _hoisted_21 = { class: "text-xs font-bold text-slate-800" };
...
const _hoisted_30 = { class: "text-xs font-bold text-slate-800 leading-none" };
...
const _hoisted_34 = { class: "text-xs font-bold text-slate-800" };
...
const StudentTopbar = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["__scopeId", "data-v-e4e9b231"]]);
const _hoisted_1$1 = {
  key: 0,
...
const _hoisted_3 = { class: "flex-1 flex flex-col min-h-screen lg:ml-0" };
const _hoisted_4 = { class: "flex-1 overflow-y-auto bg-gray-50 p-5" };
