import { d as defineComponent, J as useApp, r as ref, c as computed, E as watch, o as onMounted, H as onUnmounted, a as createElementBlock, l as createCommentVNode, z as withModifiers, b as createBaseVNode, f as createVNode, u as unref, t as toDisplayString, F as Fragment, j as renderList, p as withDirectives, v as vModelText, n as normalizeClass, k as openBlock } from "./main-BV94XoeK.js";
...
import { A as ArrowRight } from "./arrow-right-BDYEf8RJ.js";
...
const _hoisted_4 = { class: "w-16 h-16 bg-blue-50 text-blue-600 rounded-full flex items-center justify-center mb-6 border border-blue-100/60 shadow-inner" };
const _hoisted_5 = { class: "w-full bg-slate-50 border border-slate-100/80 rounded-2xl p-4 flex items-center gap-3.5 mb-6" };
const _hoisted_6 = { class: "w-10 h-10 rounded-xl bg-blue-50 text-blue-600 flex items-center justify-center flex-shrink-0" };
const _hoisted_7 = { class: "min-w-0 flex-1" };
const _hoisted_8 = { class: "text-xs font-semibold text-slate-700" };
const _hoisted_9 = { class: "text-[10px] text-slate-400 font-semibold truncate" };
const _hoisted_10 = {
  key: 0,
  class: "text-right flex-shrink-0"
};
const _hoisted_11 = { class: "text-xs font-semibold text-slate-650" };
const _hoisted_12 = {
  key: 0,
...
const _hoisted_15 = { class: "grid grid-cols-3 gap-3" };
const _hoisted_16 = ["onClick", "disabled"];
const _hoisted_17 = { class: "flex items-center justify-between mb-2" };
const _hoisted_18 = { class: "flex items-center gap-1.5" };
const _hoisted_19 = ["max"];
const _hoisted_20 = { class: "flex items-center gap-4" };
const _hoisted_21 = ["max"];
const _hoisted_22 = { class: "text-[10px] font-semibold text-slate-450 font-mono" };
const _hoisted_23 = { class: "bg-blue-50/40 border border-blue-100/50 rounded-2xl p-4.5 space-y-3" };
const _hoisted_24 = { class: "grid grid-cols-3 items-center text-center gap-1" };
const _hoisted_25 = { class: "text-xs font-semibold text-slate-700 font-mono" };
const _hoisted_26 = { class: "flex flex-col items-center" };
const _hoisted_27 = { class: "text-[10px] font-bold text-blue-650 mt-0.5 bg-blue-50 px-2 py-0.5 rounded-md font-mono" };
const _hoisted_28 = { class: "text-xs font-black text-slate-800 font-mono" };
const _hoisted_29 = { class: "flex gap-4 relative z-10 pt-2 border-t border-slate-100" };
    ...
    return (_ctx, _cache) => {
      return __props.show ? (openBlock(), createElementBlock("div", {
        ...
        createBaseVNode("div", _hoisted_1, [
          _cache[14] || (_cache[14] = createBaseVNode("div", { class: "absolute top-0 right-0 -mr-16 -mt-16 w-36 h-36 rounded-full bg-blue-500/5 blur-3xl" }, null, -1)),
          _cache[15] || (_cache[15] = createBaseVNode("div", { class: "absolute bottom-0 left-0 -ml-16 -mb-16 w-36 h-36 rounded-full bg-blue-500/5 blur-3xl" }, null, -1)),
          ...
          createBaseVNode("div", _hoisted_3, [
            ...
            createBaseVNode("div", _hoisted_5, [
              ...
              createBaseVNode("div", _hoisted_7, [
                createBaseVNode("h4", _hoisted_8, "Seat " + toDisplayString(__props.booking?.seat?.seat_number), 1),
                createBaseVNode("p", _hoisted_9, toDisplayString(__props.booking?.seat?.library?.name), 1)
              ]),
              libraryClosingTime.value ? (openBlock(), createElementBlock("div", _hoisted_10, [
                ...
                createBaseVNode("p", _hoisted_11, toDisplayString(formatTimeOnly(libraryClosingTime.value)), 1)
              ])) : createCommentVNode("", true)
            ]),
            isExtensionRestricted.value ? (openBlock(), createElementBlock("div", _hoisted_12, [
            ...
            ])) : maxExtensionMinutes.value < 10 || isLibraryClosingSoon.value ? (openBlock(), createElementBlock("div", _hoisted_13, [
            ...
            isExtensionAllowed.value ? (openBlock(), createElementBlock("div", _hoisted_14, [
              ...
              createBaseVNode("div", null, [
                ...
                createBaseVNode("div", _hoisted_20, [
                  _cache[9] || (_cache[9] = createBaseVNode("span", { class: "text-[10px] font-semibold text-slate-450 font-mono" }, "10m", -1)),
                  withDirectives(createBaseVNode("input", {
                    type: "range",
                  ...
                  createBaseVNode("span", _hoisted_22, toDisplayString(maxExtensionMinutes.value) + "m", 1)
                ])
              ]),
              createBaseVNode("div", _hoisted_23, [
                _cache[12] || (_cache[12] = createBaseVNode("h5", { class: "text-[9.5px] font-semibold text-blue-500 uppercase tracking-widest" }, "Time Extension Preview", -1)),
                createBaseVNode("div", _hoisted_24, [
                  createBaseVNode("div", null, [
                    _cache[10] || (_cache[10] = createBaseVNode("p", { class: "text-[9px] text-slate-400 font-semibold uppercase mb-0.5" }, "Current End", -1)),
                    createBaseVNode("p", _hoisted_25, toDisplayString(formatTimeOnly(currentEndTime.value)), 1)
                  ]),
                  createBaseVNode("div", _hoisted_26, [
                    createVNode(unref(ArrowRight), { class: "w-4 h-4 text-blue-400" }),
                    createBaseVNode("span", _hoisted_27, toDisplayString(formatAddedTime.value), 1)
                  ]),
                  createBaseVNode("div", null, [
                    _cache[11] || (_cache[11] = createBaseVNode("p", { class: "text-[9px] text-slate-400 font-semibold uppercase mb-0.5" }, "New End Time", -1)),
                    createBaseVNode("p", _hoisted_28, toDisplayString(formatTimeOnly(newEndTime.value)), 1)
                  ])
                ])
              ])
            ])) : createCommentVNode("", true)
          ...
          createBaseVNode("div", _hoisted_29, [
            ...
            createBaseVNode("button", {
              ...
              loading.value ? (openBlock(), createElementBlock("span", _hoisted_31)) : createCommentVNode("", true),
              _cache[13] || (_cache[13] = createBaseVNode("span", null, "Confirm Extension", -1))
            ], 8, _hoisted_30)
          ])
        ])
      ])) : createCommentVNode("", true);
...
const SeatExtensionModal = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-2e57fb1a"]]);
export {
