import { c as createLucideIcon, d as defineComponent, a as computed, b as createElementBlock, e as createBaseVNode, p as createCommentVNode, g as createVNode, u as unref, n as normalizeClass, t as toDisplayString, C as Clock, F as Fragment, k as renderList, i as createBlock, q as resolveDynamicComponent, w as withCtx, j as createTextVNode, h as resolveComponent, m as openBlock, _ as _export_sfc, I as watch, o as onMounted, r as ref, f as createStaticVNode, s as withDirectives, v as vModelText, H as vModelSelect, S as studentAPI } from "./main-BeUqjoax.js";
...
import { N as Navigation } from "./navigation-B4U5Fjei.js";
  ...
  setup(__props) {
    ...
    const todayHoursDisplay = computed(() => {
      ...
      if (props.library?.operating_days && Array.isArray(props.library.operating_days)) {
        const todaySchedule = props.library.operating_days.find((d) => d.day === todayName);
        if (todaySchedule) {
        ...
        createBaseVNode("div", _hoisted_7$2, [
          createBaseVNode("div", _hoisted_8$2, [
            ...
            createBaseVNode("div", _hoisted_15$1, [
              createVNode(unref(Clock), { class: "w-3.5 h-3.5 mr-1.5 text-blue-500 flex-shrink-0" }),
              createBaseVNode("span", null, toDisplayString(todayHoursDisplay.value), 1)
            ]),
...
const LibraryCard = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["__scopeId", "data-v-18eec247"]]);
...
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const getTodayHoursDisplay = (library) => {
      const days = ["Sunday", "Monday", "Tuesday", "Wednesday", "Thursday", "Friday", "Saturday"];
      const now = /* @__PURE__ */ new Date();
      const todayName = days[now.getDay()];
      if (library?.operating_days && Array.isArray(library.operating_days)) {
        const todaySchedule = library.operating_days.find((d) => d.day === todayName);
        if (todaySchedule) {
          if (!todaySchedule.isOpen) {
            return "Closed Today";
          }
    ...
    const updateUserMarker = () => {
      ...
      if (latitude.value && longitude.value) {
        ...
        userMarker = L.marker([latitude.value, longitude.value], { icon: userIcon }).bindPopup("<b>Your Current Location</b>").addTo(map);
      }
    };
    ...
    `;
        const markerLayer = L.marker([lat, lng], { icon: customIcon }).bindPopup(infoContent).addTo(map);
        markers.push({
                  ...
                  createBaseVNode("div", _hoisted_7$1, [
                    ...
                    createBaseVNode("div", _hoisted_11$1, [
                      ...
                      createBaseVNode("div", _hoisted_13$1, [
                        createVNode(unref(Clock), { class: "w-3.5 h-3.5 mr-1 text-blue-500" }),
                        createBaseVNode("span", null, toDisplayString(getTodayHoursDisplay(library)), 1)
                      ])
                    ])
                  ])
                ]),
...
const LibraryMap = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-4d2e2556"]]);
...
const _hoisted_19 = { class: "relative w-full sm:w-52 group" };
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", _hoisted_1, [
        libraryFilterMode.value === "nearby" && unref(locationLoading) ? (openBlock(), createElementBlock("div", _hoisted_2, [..._cache[6] || (_cache[6] = [
          createStaticVNode('<div class="w-10 h-10 bg-blue-100/80 rounded-xl flex items-center justify-center flex-shrink-0" data-v-2cbbeac5><div class="animate-spin rounded-full h-5 w-5 border-2 border-blue-600 border-t-transparent" data-v-2cbbeac5></div></div><div class="text-left" data-v-2cbbeac5><p class="text-sm font-bold text-blue-900" data-v-2cbbeac5>Detecting your location...</p><p class="text-xs text-blue-600/80 mt-0.5" data-v-2cbbeac5>Please allow browser location access to find nearby libraries</p></div>', 2)
          ...
          createBaseVNode("div", _hoisted_6, [
            createBaseVNode("button", {
              ...
              _cache[8] || (_cache[8] = createBaseVNode("span", null, "Access My Location", -1))
            ]),
            createBaseVNode("button", {
          ...
          createBaseVNode("div", _hoisted_13, [
            createBaseVNode("div", _hoisted_14, [
              createBaseVNode("button", {
                ...
                createVNode(unref(Navigation), { class: "w-3.5 h-3.5" }),
                _cache[9] || (_cache[9] = createBaseVNode("span", null, "Nearby", -1))
              ], 2),
              createBaseVNode("button", {
                ...
                _cache[10] || (_cache[10] = createBaseVNode("span", null, "All Libraries", -1))
              ], 2)
            ]),
            createBaseVNode("div", _hoisted_15, [
              createBaseVNode("button", {
                ...
                _cache[11] || (_cache[11] = createBaseVNode("span", null, "List View", -1))
              ], 2),
              createBaseVNode("button", {
                ...
                _cache[12] || (_cache[12] = createBaseVNode("span", null, "Map View", -1))
              ], 2)
            ])
          ])
        ]),
          ...
          createBaseVNode("div", _hoisted_17, [
            ...
            createBaseVNode("div", _hoisted_19, [
              ...
              withDirectives(createBaseVNode("select", {
                ...
                _cache[13] || (_cache[13] = createBaseVNode("option", { value: "" }, "All Facilities", -1)),
            ...
            libraryFilterMode.value === "nearby" && unref(locationGranted) ? (openBlock(), createElementBlock("div", _hoisted_21, [
              createBaseVNode("div", _hoisted_22, [
                _cache[14] || (_cache[14] = createBaseVNode("span", { class: "text-[11px] font-bold text-slate-400 uppercase tracking-wider" }, "Distance:", -1)),
        ...
        loadingLibraries.value || libraryFilterMode.value === "nearby" && unref(locationLoading) ? (openBlock(), createElementBlock("div", _hoisted_24, [
          _cache[15] || (_cache[15] = createBaseVNode("div", { class: "animate-spin rounded-full h-10 w-10 border-2 border-blue-600 border-t-transparent" }, null, -1)),
          ...
          _cache[18] || (_cache[18] = createBaseVNode("h3", { class: "text-lg font-bold text-slate-800 mb-2" }, "Location Access Required", -1)),
          _cache[19] || (_cache[19] = createBaseVNode("p", { class: "text-xs text-slate-500 max-w-md mx-auto leading-relaxed mb-6" }, " Device location access is currently turned off or denied. To view nearby libraries around your current location, please enable location services and allow browser access. ", -1)),
          createBaseVNode("div", _hoisted_28, [
            createBaseVNode("button", {
              ...
              _cache[16] || (_cache[16] = createBaseVNode("span", null, "Access My Location", -1))
            ]),
            createBaseVNode("button", {
              onClick: handleSelectAllMode,
              ...
              _cache[17] || (_cache[17] = createBaseVNode("span", null, "View All Libraries", -1))
            ])
          ])
          ...
          filteredLibraries.value.length === 0 ? (openBlock(), createElementBlock("div", _hoisted_30, [
            ...
            _cache[21] || (_cache[21] = createBaseVNode("h3", { class: "text-base font-semibold text-slate-800 mb-1" }, "No Libraries Found", -1)),
            libraryFilterMode.value === "nearby" && closestLibrary.value ? (openBlock(), createElementBlock("p", _hoisted_32, [
              ...
              _cache[20] || (_cache[20] = createTextVNode(" to view it. ", -1))
...
const LibrariesPage = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-2cbbeac5"]]);
export {
