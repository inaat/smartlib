import { d as defineComponent, r as ref, c as computed, E as watch, o as onMounted, a as createElementBlock, b as createBaseVNode, f as createVNode, u as unref, i as createTextVNode, t as toDisplayString, F as Fragment, j as renderList, e as createStaticVNode, q as normalizeStyle, n as normalizeClass, w as withCtx, g as resolveComponent, L as studentAPI, l as createCommentVNode, k as openBlock } from "./main-BV94XoeK.js";
...
import { C as CalendarCheck } from "./calendar-check-DU5qClnW.js";
import { C as ChevronLeft } from "./chevron-left-ZxXk07l-.js";
...
const _hoisted_59 = { class: "px-6 py-4 bg-slate-50/30 border-t border-slate-100 flex items-center justify-between text-[10px] font-semibold text-slate-400 uppercase tracking-widest" };
        ...
        createBaseVNode("div", _hoisted_2, [
          createBaseVNode("div", _hoisted_3, [
            ...
            createBaseVNode("div", _hoisted_6, [
              _cache[1] || (_cache[1] = createBaseVNode("p", { class: "text-[10px] font-semibold text-slate-400 uppercase tracking-widest leading-none mb-2" }, "This Month", -1)),
              createBaseVNode("p", _hoisted_7, [
                createTextVNode(toDisplayString(stats.value.attendance_this_month || 0) + " ", 1),
                _cache[0] || (_cache[0] = createBaseVNode("span", { class: "text-xs font-semibold text-slate-400 ml-1 uppercase tracking-wide" }, "Days", -1))
              ])
            ])
          ]),
          ...
          createBaseVNode("div", _hoisted_13, [
            ...
            createBaseVNode("div", _hoisted_16, [
              ...
              createBaseVNode("p", _hoisted_17, [
                ...
                _cache[4] || (_cache[4] = createBaseVNode("span", { class: "text-xs font-semibold text-slate-400 ml-1 uppercase tracking-wide" }, "Hours", -1))
              ])
            ])
          ])
        ]),
        createBaseVNode("div", _hoisted_18, [
          createBaseVNode("div", _hoisted_19, [
            ...
            createBaseVNode("div", _hoisted_29, [
              ...
              _cache[9] || (_cache[9] = createStaticVNode('<div class="flex flex-wrap gap-x-4 gap-y-1.5 pt-1" data-v-3d4769e8><div class="flex items-center space-x-1.5 text-[10px] font-semibold text-slate-400 uppercase tracking-wide" data-v-3d4769e8><div class="w-2.5 h-2.5 rounded-full bg-emerald-50 border border-emerald-300" data-v-3d4769e8></div><span data-v-3d4769e8>Attended</span></div><div class="flex items-center space-x-1.5 text-[10px] font-extrabold text-slate-400 uppercase tracking-wide" data-v-3d4769e8><div class="w-2.5 h-2.5 rounded-full bg-blue-600" data-v-3d4769e8></div><span data-v-3d4769e8>Today</span></div><div class="flex items-center space-x-1.5 text-[10px] font-extrabold text-slate-400 uppercase tracking-wide" data-v-3d4769e8><div class="w-2.5 h-2.5 rounded-full bg-white border border-slate-200" data-v-3d4769e8></div><span data-v-3d4769e8>Absent</span></div></div>', 1))
            ])
          ]),
          createBaseVNode("div", _hoisted_35, [
            createBaseVNode("div", _hoisted_36, [
              _cache[10] || (_cache[10] = createBaseVNode("div", { class: "text-left" }, [
                createBaseVNode("h2", { class: "text-base font-semibold text-slate-800" }, "Attendance Logs"),
            ...
            loading.value ? (openBlock(), createElementBlock("div", _hoisted_37, [..._cache[11] || (_cache[11] = [
              ...
              _cache[13] || (_cache[13] = createBaseVNode("h3", { class: "text-base font-semibold text-slate-800 mb-1" }, "No Attendance Yet", -1)),
...
const AttendancePage = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-3d4769e8"]]);
export {
