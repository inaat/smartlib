import { d as defineComponent, x as useAuth, c as computed, r as ref, o as onMounted, G as watch, a as createElementBlock, b as createBaseVNode, l as createCommentVNode, n as normalizeClass, f as createVNode, u as unref, t as toDisplayString, p as withDirectives, v as vModelText, F as Fragment, j as renderList, i as createTextVNode, S as withKeys, z as withModifiers, h as createBlock, D as vModelSelect, U as supportAPI, L as studentAPI, N as nextTick, k as openBlock } from "./main-DKJzpCzk.js";
...
import { C as CircleCheck } from "./circle-check-CRs2yXKo.js";
        ...
        createBaseVNode("div", _hoisted_2, [
          createBaseVNode("div", {
            ...
            class: normalizeClass([
              ...
              filterStatus.value === "all" ? userRole.value === "student" ? "bg-gradient-to-br from-blue-600 to-blue-700 border-blue-700 text-white shadow-blue-500/10" : "bg-gradient-to-br from-emerald-600 to-teal-700 border-emerald-600 text-white shadow-emerald-500/10" : "bg-white border-slate-100 hover:border-slate-200 hover:translate-y-[-1px] text-slate-800"
            ])
          }, [
          ...
          createBaseVNode("div", {
            ...
            class: normalizeClass([
              "p-5 rounded-2xl border transition-all cursor-pointer shadow-sm relative overflow-hidden group text-left flex flex-col justify-between min-h-[110px]",
              filterStatus.value === "open" ? userRole.value === "student" ? "bg-gradient-to-br from-blue-600 to-blue-700 border-blue-700 text-white shadow-blue-500/10" : "bg-gradient-to-br from-emerald-600 to-teal-700 border-emerald-600 text-white shadow-emerald-500/10" : "bg-white border-slate-100 hover:border-slate-200 hover:translate-y-[-1px] text-slate-800"
            ])
          }, [
          ...
          createBaseVNode("div", {
            ...
            class: normalizeClass([
              "p-5 rounded-2xl border transition-all cursor-pointer shadow-sm relative overflow-hidden group text-left flex flex-col justify-between min-h-[110px]",
              filterStatus.value === "closed" ? userRole.value === "student" ? "bg-gradient-to-br from-blue-600 to-blue-700 border-blue-700 text-white shadow-blue-500/10" : "bg-gradient-to-br from-emerald-600 to-teal-700 border-emerald-600 text-white shadow-emerald-500/10" : "bg-white border-slate-100 hover:border-slate-200 hover:translate-y-[-1px] text-slate-800"
            ])
          }, [
...
const SupportSystem = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-478be892"]]);
export {
  SupportSystem as S
};
