import { d as defineComponent, r as ref, c as computed, o as onMounted, a as createElementBlock, b as createBaseVNode, l as createCommentVNode, f as createVNode, u as unref, t as toDisplayString, p as withDirectives, v as vModelText, D as vModelSelect, F as Fragment, j as renderList, e as createStaticVNode, n as normalizeClass, z as withModifiers, X as adminAPI, h as createBlock, i as createTextVNode, k as openBlock } from "./main-BV94XoeK.js";
...
import { C as CreditCard } from "./credit-card-BSmPl4dC.js";
...
const _hoisted_12 = { class: "p-3.5 rounded-xl bg-green-50 text-green-600" };
...
const _hoisted_34 = { class: "w-10 h-10 rounded-lg overflow-hidden flex-shrink-0 flex items-center justify-center bg-purple-50 border border-purple-200 text-purple-600 font-bold text-sm" };
const _hoisted_35 = { class: "text-left" };
const _hoisted_36 = { class: "text-sm font-medium text-slate-700" };
const _hoisted_37 = { class: "text-[10px] text-slate-400 font-semibold tracking-wide mt-0.5 uppercase" };
const _hoisted_38 = { class: "px-6 py-4 whitespace-nowrap text-left" };
const _hoisted_39 = { class: "text-xs font-bold text-slate-700" };
const _hoisted_40 = { class: "text-[10px] text-slate-400 font-semibold tracking-wide mt-0.5 uppercase" };
const _hoisted_41 = { class: "px-6 py-4 whitespace-nowrap text-left" };
const _hoisted_42 = {
  key: 0,
  class: "flex flex-col"
};
const _hoisted_43 = { class: "inline-flex items-center px-2.5 py-0.5 rounded-full text-[10px] font-bold bg-purple-50 text-purple-700 border border-purple-100" };
const _hoisted_44 = { class: "text-[9px] text-slate-400 mt-1" };
const _hoisted_45 = {
  key: 1,
  class: "text-xs text-slate-400 italic"
};
const _hoisted_46 = { class: "px-6 py-4 whitespace-nowrap text-left" };
const _hoisted_47 = ["onClick", "disabled"];
const _hoisted_48 = { class: "px-6 py-4 whitespace-nowrap text-right" };
const _hoisted_49 = { class: "flex items-center justify-end space-x-2" };
...
const _hoisted_55 = { class: "bg-white rounded-3xl shadow-xl w-full max-w-md overflow-hidden animate-in fade-in zoom-in duration-200 border border-slate-100 flex flex-col" };
const _hoisted_56 = { class: "p-6 border-b border-slate-100 flex items-center justify-between text-left" };
const _hoisted_57 = { class: "text-lg font-bold text-slate-800" };
const _hoisted_58 = { class: "grid grid-cols-2 gap-4" };
const _hoisted_59 = { key: 0 };
const _hoisted_60 = { class: "grid grid-cols-2 gap-4" };
const _hoisted_61 = { class: "pt-4 flex items-center space-x-3" };
...
const _hoisted_66 = { class: "bg-white rounded-3xl shadow-xl w-full max-w-md overflow-hidden animate-in fade-in zoom-in duration-200 border border-slate-100 flex flex-col" };
const _hoisted_67 = { class: "p-6 border-b border-slate-100 flex items-center justify-between text-left" };
const _hoisted_68 = { class: "text-xs text-slate-500 mt-1 mb-2 font-medium" };
const _hoisted_69 = { class: "pt-4 flex items-center space-x-3" };
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", _hoisted_1, [
        createBaseVNode("div", _hoisted_2, [
          createBaseVNode("div", _hoisted_3, [
            createBaseVNode("button", {
              ...
              _cache[16] || (_cache[16] = createBaseVNode("span", null, "Add Student", -1))
            ])
          ])
        ]),
        createBaseVNode("div", _hoisted_4, [
          createBaseVNode("div", _hoisted_5, [
            createBaseVNode("div", _hoisted_6, [
              _cache[17] || (_cache[17] = createBaseVNode("p", { class: "text-xs font-bold text-slate-400 uppercase tracking-widest" }, "Total Students", -1)),
          ...
          createBaseVNode("div", _hoisted_9, [
            createBaseVNode("div", _hoisted_10, [
              _cache[18] || (_cache[18] = createBaseVNode("p", { class: "text-xs font-bold text-slate-400 uppercase tracking-widest" }, "Active Plans", -1)),
              createBaseVNode("h3", _hoisted_11, toDisplayString(activeSubscriptionsCount.value), 1)
            ]),
          ...
          createBaseVNode("div", _hoisted_13, [
            createBaseVNode("div", _hoisted_14, [
              _cache[19] || (_cache[19] = createBaseVNode("p", { class: "text-xs font-bold text-slate-400 uppercase tracking-widest" }, "Pending", -1)),
          ...
          createBaseVNode("div", _hoisted_17, [
            createBaseVNode("div", _hoisted_18, [
              _cache[20] || (_cache[20] = createBaseVNode("p", { class: "text-xs font-bold text-slate-400 uppercase tracking-widest" }, "Total Bookings", -1)),
        ...
        createBaseVNode("div", _hoisted_21, [
          createBaseVNode("div", _hoisted_22, [
            ...
            withDirectives(createBaseVNode("select", {
              ...
              _cache[21] || (_cache[21] = createBaseVNode("option", { value: "" }, "All Libraries", -1)),
            ...
            withDirectives(createBaseVNode("select", {
              ...
              createStaticVNode('<option value="" data-v-96c5bdd9>All Status</option><option value="approved" data-v-96c5bdd9>Approved</option><option value="pending" data-v-96c5bdd9>Pending</option><option value="suspended" data-v-96c5bdd9>Suspended</option><option value="banned" data-v-96c5bdd9>Banned</option>', 5)
            ])], 512), [
        ...
        loading.value && users.value.length === 0 ? (openBlock(), createElementBlock("div", _hoisted_26, [..._cache[23] || (_cache[23] = [
          ...
          _cache[24] || (_cache[24] = createBaseVNode("p", { class: "text-xs font-bold text-slate-455 uppercase tracking-widest" }, "No students found matching your criteria.", -1))
        ])) : (openBlock(), createElementBlock("div", _hoisted_28, [
          createBaseVNode("div", _hoisted_29, [
            createBaseVNode("table", _hoisted_30, [
              _cache[25] || (_cache[25] = createBaseVNode("thead", { class: "bg-gray-50/50" }, [
                  ...
                  return openBlock(), createElementBlock("tr", {
                    ...
                    createBaseVNode("td", _hoisted_32, [
                      createBaseVNode("div", _hoisted_33, [
                        createBaseVNode("div", _hoisted_34, toDisplayString(user.name.charAt(0).toUpperCase()), 1),
                        createBaseVNode("div", _hoisted_35, [
                          createBaseVNode("div", _hoisted_36, toDisplayString(user.name), 1),
                          createBaseVNode("div", _hoisted_37, toDisplayString(user.email), 1)
                        ])
                      ])
                    ]),
                    createBaseVNode("td", _hoisted_38, [
                      createBaseVNode("div", _hoisted_39, "CRN: " + toDisplayString(user.crn || "N/A"), 1),
                      createBaseVNode("div", _hoisted_40, "Level: " + toDisplayString(user.ca_level || "No Level"), 1)
                    ]),
                    createBaseVNode("td", _hoisted_41, [
                      user.active_subscription ? (openBlock(), createElementBlock("div", _hoisted_42, [
                        createBaseVNode("span", _hoisted_43, toDisplayString(user.active_subscription.subscription_plan?.name), 1),
                        createBaseVNode("span", _hoisted_44, "Expires: " + toDisplayString(formatDate(user.active_subscription.expires_at)), 1)
                      ])) : (openBlock(), createElementBlock("div", _hoisted_45, "No active plan"))
                    ]),
        ...
        showModal.value ? (openBlock(), createElementBlock("div", _hoisted_54, [
          createBaseVNode("div", _hoisted_55, [
            createBaseVNode("div", _hoisted_56, [
              createBaseVNode("h2", _hoisted_57, toDisplayString(isEditing.value ? "Edit Student" : "Add New Student"), 1),
              createBaseVNode("button", {
            ...
            createBaseVNode("form", {
              ...
              createBaseVNode("div", null, [
                _cache[26] || (_cache[26] = createBaseVNode("label", { class: "block text-xs font-bold text-slate-500 mb-1.5 uppercase tracking-wider" }, "Full Name", -1)),
                withDirectives(createBaseVNode("input", {
              ...
              createBaseVNode("div", null, [
                _cache[27] || (_cache[27] = createBaseVNode("label", { class: "block text-xs font-bold text-slate-500 mb-1.5 uppercase tracking-wider" }, "Email Address", -1)),
                withDirectives(createBaseVNode("input", {
              ...
              createBaseVNode("div", _hoisted_58, [
                createBaseVNode("div", null, [
                  _cache[28] || (_cache[28] = createBaseVNode("label", { class: "block text-xs font-bold text-slate-500 mb-1.5 uppercase tracking-wider" }, "Student ID (CRN)", -1)),
                  withDirectives(createBaseVNode("input", {
                ...
                createBaseVNode("div", null, [
                  _cache[30] || (_cache[30] = createBaseVNode("label", { class: "block text-xs font-bold text-slate-500 mb-1.5 uppercase tracking-wider" }, "CA Level", -1)),
                  withDirectives(createBaseVNode("select", {
              ...
              !isEditing.value ? (openBlock(), createElementBlock("div", _hoisted_59, [
                _cache[31] || (_cache[31] = createBaseVNode("label", { class: "block text-xs font-bold text-slate-500 mb-1.5 uppercase tracking-wider" }, "Password", -1)),
                withDirectives(createBaseVNode("input", {
              ...
              createBaseVNode("div", _hoisted_60, [
                createBaseVNode("div", null, [
                  _cache[33] || (_cache[33] = createBaseVNode("label", { class: "block text-xs font-bold text-slate-500 mb-1.5 uppercase tracking-wider" }, "Account Status", -1)),
                  withDirectives(createBaseVNode("select", {
              ...
              createBaseVNode("div", _hoisted_61, [
                ...
                createBaseVNode("button", {
                  ...
                  saving.value ? (openBlock(), createElementBlock("span", _hoisted_63, "Saving...")) : (openBlock(), createElementBlock("span", _hoisted_64, toDisplayString(isEditing.value ? "Update Student" : "Create Student"), 1))
                ], 8, _hoisted_62)
              ])
            ], 32)
          ])
        ])) : createCommentVNode("", true),
        showBanModal.value ? (openBlock(), createElementBlock("div", _hoisted_65, [
          createBaseVNode("div", _hoisted_66, [
            createBaseVNode("div", _hoisted_67, [
              _cache[36] || (_cache[36] = createBaseVNode("h2", { class: "text-lg font-bold text-slate-800" }, "Ban Student", -1)),
              createBaseVNode("button", {
            ...
            createBaseVNode("form", {
              ...
              createBaseVNode("div", null, [
                _cache[37] || (_cache[37] = createBaseVNode("label", { class: "block text-xs font-bold text-slate-500 mb-1.5 uppercase tracking-wider" }, "Restrict Access For", -1)),
                createBaseVNode("p", _hoisted_68, "Student: " + toDisplayString(banForm.value.userName), 1)
              ]),
              createBaseVNode("div", null, [
                _cache[38] || (_cache[38] = createBaseVNode("label", { class: "block text-xs font-bold text-slate-500 mb-1.5 uppercase tracking-wider" }, "Ban Duration (Days)", -1)),
                withDirectives(createBaseVNode("input", {
              ...
              createBaseVNode("div", null, [
                _cache[39] || (_cache[39] = createBaseVNode("label", { class: "block text-xs font-bold text-slate-500 mb-1.5 uppercase tracking-wider" }, "Reason", -1)),
              ...
              createBaseVNode("div", _hoisted_69, [
                ...
                createBaseVNode("button", {
                  ...
                  banning.value ? (openBlock(), createElementBlock("span", _hoisted_71, "Banning...")) : (openBlock(), createElementBlock("span", _hoisted_72, "Confirm Ban"))
                ], 8, _hoisted_70)
              ])
            ], 32)
          ])
...
const UserManagementPage = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-96c5bdd9"]]);
export {
