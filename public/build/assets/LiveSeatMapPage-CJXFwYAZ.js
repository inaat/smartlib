import { d as defineComponent, r as ref, c as computed, o as onMounted, H as onUnmounted, a as createElementBlock, b as createBaseVNode, h as createBlock, f as createVNode, u as unref, e as createStaticVNode, n as normalizeClass, t as toDisplayString, F as Fragment, k as renderList, w as withCtx, T as Transition, I as Teleport, O as librarianAPI, j as createCommentVNode, z as withModifiers, i as createTextVNode, l as openBlock } from "./main-D4odWxzi.js";
...
const _hoisted_16 = { class: "text-sm font-extrabold text-slate-800 tracking-tight" };
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    onMounted(() => {
      fetchData();
      refreshInterval = setInterval(() => fetchData(true), 15e3);
      ...
      return openBlock(), createElementBlock("div", _hoisted_1, [
        createBaseVNode("div", _hoisted_2, [
          ...
          createBaseVNode("div", _hoisted_6, [
            _cache[8] || (_cache[8] = createStaticVNode('<div class="flex items-center space-x-2 px-3.5 py-2 bg-emerald-50 border border-emerald-200 rounded-full" data-v-6405603f><span class="relative flex h-2.5 w-2.5" data-v-6405603f><span class="animate-ping absolute inline-flex h-full w-full rounded-full bg-emerald-400 opacity-75" data-v-6405603f></span><span class="relative inline-flex rounded-full h-2.5 w-2.5 bg-emerald-500" data-v-6405603f></span></span><span class="text-xs font-bold text-emerald-700 uppercase tracking-wider" data-v-6405603f>Live</span></div>', 1)),
...
const LiveSeatMapPage = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-6405603f"]]);
export {
