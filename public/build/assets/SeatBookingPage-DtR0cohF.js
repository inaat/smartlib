import { d as defineComponent, r as ref, x as useAuth, c as computed, E as watch, o as onMounted, a as createElementBlock, b as createBaseVNode, j as createCommentVNode, e as createStaticVNode, f as createVNode, w as withCtx, g as resolveComponent, u as unref, t as toDisplayString, F as Fragment, p as withDirectives, D as vModelSelect, k as renderList, v as vModelText, h as createBlock, C as useRouter, G as useRoute, L as studentAPI, i as createTextVNode, l as openBlock } from "./main-CP29_5Dg.js";
...
import { U as UserX } from "./user-x-DJqx4gsx.js";
...
const _hoisted_15 = { class: "text-[10px] text-blue-500 font-medium mt-1.5 uppercase tracking-wide capitalize leading-none" };
const _hoisted_16 = {
  key: 0,
...
const _hoisted_17 = {
  key: 1,
  class: "p-3 bg-amber-50 rounded-xl border border-amber-100 flex items-start space-x-2"
};
const _hoisted_18 = { class: "text-[11px] text-amber-800 font-medium leading-normal" };
...
const _hoisted_23 = { class: "text-[10px] text-amber-800 font-medium leading-normal m-0" };
const _hoisted_24 = {
  key: 1,
  class: "p-3 bg-red-50 border border-red-100 rounded-xl flex items-start space-x-2"
};
const _hoisted_25 = { class: "grid grid-cols-2 gap-3" };
const _hoisted_26 = ["min", "max"];
const _hoisted_27 = { class: "pt-4 border-t border-slate-100" };
...
const _hoisted_31 = { class: "p-5 bg-gradient-to-br from-slate-50 to-white rounded-xl border border-slate-100 text-center relative overflow-hidden" };
const _hoisted_32 = { class: "flex items-center justify-center space-x-1.5 mb-3.5 leading-none" };
const _hoisted_33 = { class: "text-xl font-black text-slate-800 leading-none" };
...
const _hoisted_38 = { class: "w-12 h-12 bg-slate-50 border border-slate-200 rounded-full flex items-center justify-center mx-auto mb-3 text-slate-400 shadow-inner" };
const _hoisted_39 = { class: "bg-orange-50/50 p-5 rounded-2xl border border-orange-100 text-left" };
const _hoisted_40 = { class: "flex items-center mb-2" };
const _hoisted_41 = {
  key: 0,
  class: "fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/40 backdrop-blur-sm"
};
const _hoisted_42 = { class: "bg-white rounded-2xl p-6 max-w-sm w-full text-center shadow-2xl border border-slate-100 animate-fade-in" };
const _hoisted_43 = { class: "w-16 h-16 bg-emerald-50 border border-emerald-100 text-emerald-600 rounded-full flex items-center justify-center mx-auto mb-4" };
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const getSectionLevelName = (sectionId) => {
      ...
      return loading.value ? (openBlock(), createElementBlock("div", _hoisted_1, [..._cache[4] || (_cache[4] = [
        ...
        createBaseVNode("div", _hoisted_3, [
          createBaseVNode("div", null, [
            ...
            _cache[6] || (_cache[6] = createBaseVNode("h1", { class: "text-xl font-bold text-slate-800 leading-none" }, "Select Your Seat", -1))
          ]),
          _cache[7] || (_cache[7] = createStaticVNode('<div class="flex flex-wrap items-center gap-2 bg-slate-50 border border-slate-100 p-1.5 rounded-xl" data-v-5f1ff666><div class="flex items-center px-3 py-1 text-[10px] font-semibold text-slate-500 uppercase tracking-wider" data-v-5f1ff666><div class="w-2.5 h-2.5 rounded-full bg-[#29B072] mr-2" data-v-5f1ff666></div><span data-v-5f1ff666>Available</span></div><div class="flex items-center px-3 py-1 text-[10px] font-extrabold text-slate-500 uppercase tracking-wider" data-v-5f1ff666><div class="w-2.5 h-2.5 rounded-full bg-[#FF9D43] mr-2" data-v-5f1ff666></div><span data-v-5f1ff666>Occupied</span></div><div class="flex items-center px-3 py-1 text-[10px] font-extrabold text-slate-500 uppercase tracking-wider" data-v-5f1ff666><div class="w-2.5 h-2.5 rounded-full bg-[#617DFF] mr-2" data-v-5f1ff666></div><span data-v-5f1ff666>Reserved</span></div><div class="flex items-center px-3 py-1 text-[10px] font-extrabold text-slate-500 uppercase tracking-wider" data-v-5f1ff666><div class="w-2.5 h-2.5 rounded-full bg-blue-600 mr-2" data-v-5f1ff666></div><span data-v-5f1ff666>Selected</span></div></div>', 1))
        ]),
        createBaseVNode("div", _hoisted_6, [
          createBaseVNode("div", _hoisted_7, [
            ...
            }, null, 8, ["seats", "floors", "sections", "tables", "selected-seat", "layout-mode"])
          ]),
          createBaseVNode("div", _hoisted_8, [
            createBaseVNode("div", _hoisted_9, [
              _cache[17] || (_cache[17] = createBaseVNode("h3", { class: "text-sm font-bold text-slate-700 uppercase tracking-wider mb-5" }, "Booking Summary", -1)),
              selectedSeat.value ? (openBlock(), createElementBlock("div", _hoisted_10, [
                ...
                isGenderMismatch(selectedSeat.value) ? (openBlock(), createElementBlock("div", _hoisted_16, [
                  ...
                  _cache[8] || (_cache[8] = createBaseVNode("p", { class: "text-[11px] text-red-600 font-medium leading-normal" }, "This section is restricted to another gender.", -1))
                ])) : createCommentVNode("", true),
                isLevelMismatch(selectedSeat.value) ? (openBlock(), createElementBlock("div", _hoisted_17, [
                  createVNode(unref(CircleAlert), { class: "w-4.5 h-4.5 text-amber-600 flex-shrink-0 mt-0.5" }),
                  createBaseVNode("p", _hoisted_18, " This seat is reserved for " + toDisplayString(getSectionLevelName(selectedSeat.value.section_id)) + " students. ", 1)
                ])) : (openBlock(), createElementBlock(Fragment, { key: 2 }, [
                  createBaseVNode("div", _hoisted_19, [
                    createBaseVNode("div", null, [
                      _cache[9] || (_cache[9] = createBaseVNode("label", { class: "text-[10px] font-semibold text-slate-400 uppercase tracking-wider mb-1.5 block" }, "Duration", -1)),
                      withDirectives(createBaseVNode("select", {
                        ...
                        (openBlock(true), createElementBlock(Fragment, null, renderList(durationOptions.value, (opt) => {
                          return openBlock(), createElementBlock("option", {
                            key: opt.value,
                            value: opt.value
                          }, toDisplayString(opt.label), 9, _hoisted_21);
                        }), 128))
                      ], 8, _hoisted_20), [
                        [vModelSelect, bookingDuration.value]
                      ])
                    ]),
                    showClosingTimeNotice.value ? (openBlock(), createElementBlock("div", _hoisted_22, [
                      createVNode(unref(CircleAlert), { class: "w-4 h-4 text-amber-600 flex-shrink-0 mt-0.5" }),
                      createBaseVNode("p", _hoisted_23, " You can book this seat for a maximum of " + toDisplayString(formatHours(maxAvailableHours.value)) + " because the library closes at " + toDisplayString(formatTimeOnly(libraryClosingTime.value)) + ". ", 1)
                    ])) : createCommentVNode("", true),
                    maxAvailableHours.value === 0 ? (openBlock(), createElementBlock("div", _hoisted_24, [
                      createVNode(unref(CircleAlert), { class: "w-4 h-4 text-red-600 flex-shrink-0 mt-0.5" }),
                      _cache[10] || (_cache[10] = createBaseVNode("p", { class: "text-[10px] text-red-650 font-medium leading-normal m-0" }, " The library is closed during the selected start time. Please choose another date or time. ", -1))
                    ])) : createCommentVNode("", true),
                    createBaseVNode("div", _hoisted_25, [
                      createBaseVNode("div", null, [
                        _cache[11] || (_cache[11] = createBaseVNode("label", { class: "text-[10px] font-semibold text-slate-400 uppercase tracking-wider mb-1.5 block" }, "Date", -1)),
                      ...
                      createBaseVNode("div", null, [
                        _cache[12] || (_cache[12] = createBaseVNode("label", { class: "text-[10px] font-semibold text-slate-400 uppercase tracking-wider mb-1.5 block" }, "Start Time", -1)),
                        withDirectives(createBaseVNode("input", {
                          type: "time",
                  ...
                  createBaseVNode("div", _hoisted_27, [
                    selectedSeat.value.status === "available" ? (openBlock(), createElementBlock("button", {
                      ...
                      submitting.value ? (openBlock(), createElementBlock("span", _hoisted_29)) : createCommentVNode("", true),
                      createBaseVNode("span", null, toDisplayString(submitting.value ? "Confirming..." : "Confirm Booking"), 1)
                    ], 8, _hoisted_28)) : (openBlock(), createElementBlock("div", _hoisted_30, [
                      createBaseVNode("div", _hoisted_31, [
                        ...
                        _cache[15] || (_cache[15] = createBaseVNode("p", { class: "text-[9px] font-bold uppercase tracking-widest mb-2.5 leading-none text-amber-600" }, "Free Soon", -1)),
                        createBaseVNode("div", _hoisted_32, [
                          createVNode(unref(Clock), { class: "w-4.5 h-4.5 text-orange-500" }),
                          createBaseVNode("p", _hoisted_33, toDisplayString(Math.floor(selectedSeat.value.remaining_minutes / 60)) + "h " + toDisplayString(Math.floor(selectedSeat.value.remaining_minutes % 60)) + "m ", 1)
                        ]),
            ...
            createBaseVNode("div", _hoisted_39, [
              createBaseVNode("div", _hoisted_40, [
                ...
                _cache[18] || (_cache[18] = createBaseVNode("h4", { class: "font-semibold text-orange-900 text-xs uppercase tracking-wide" }, "Quick Tip", -1))
              ]),
        ...
        showSuccessModal.value ? (openBlock(), createElementBlock("div", _hoisted_41, [
          createBaseVNode("div", _hoisted_42, [
            createBaseVNode("div", _hoisted_43, [
              createVNode(unref(CircleCheckBig), { class: "w-8 h-8" })
            ]),
            _cache[20] || (_cache[20] = createBaseVNode("h2", { class: "text-lg font-semibold text-slate-800 mb-1" }, "Booking Confirmed!", -1)),
...
const SeatBookingPage = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-5f1ff666"]]);
export {
