import { d as defineComponent, x as useAuth, r as ref, y as reactive, c as computed, o as onMounted, a as createElementBlock, l as openBlock, e as createStaticVNode, b as createBaseVNode, j as createCommentVNode, f as createVNode, u as unref, n as normalizeClass, p as withDirectives, D as vModelSelect, F as Fragment, k as renderList, t as toDisplayString, v as vModelText, i as createTextVNode, h as createBlock, z as withModifiers, O as librarianAPI, U as supportAPI } from "./main-CP29_5Dg.js";
...
import { S as Sheet } from "./sheet-BqlqKBOM.js";
...
import { H as History } from "./history-rVbaSFy5.js";
import { T as Trash2 } from "./trash-2-ml0ufkck.js";
import { D as Download } from "./download-DNzBS0lf.js";
...
const _hoisted_12 = { class: "grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4" };
const _hoisted_13 = {
  key: 3,
  class: "bg-slate-50/50 p-5 rounded-2xl border border-slate-100 space-y-4"
};
...
const _hoisted_17 = { class: "flex justify-end gap-3 pt-5 border-t border-slate-50" };
const _hoisted_18 = ["disabled"];
const _hoisted_19 = {
  key: 0,
  class: "space-y-5 animate-in fade-in duration-300"
};
const _hoisted_20 = { class: "bg-white rounded-2xl border border-slate-100 shadow-sm p-4 flex items-center justify-between" };
const _hoisted_21 = { class: "flex items-center gap-2 text-left" };
const _hoisted_22 = { class: "text-xs font-bold text-slate-655" };
const _hoisted_23 = { class: "flex items-center gap-2" };
const _hoisted_24 = { class: "bg-white rounded-2xl border border-slate-100 shadow-sm overflow-hidden relative" };
const _hoisted_25 = { class: "p-8 space-y-6" };
const _hoisted_26 = { class: "flex flex-col md:flex-row md:justify-between items-start border-b border-slate-100 pb-6 gap-6 text-left" };
const _hoisted_27 = { class: "flex items-start gap-4" };
const _hoisted_28 = { class: "w-14 h-14 rounded-2xl bg-emerald-50 border border-emerald-200/60 flex items-center justify-center text-emerald-700 shadow-sm flex-shrink-0" };
const _hoisted_29 = { class: "text-xl font-black text-slate-800 leading-snug" };
const _hoisted_30 = { class: "text-xs font-medium text-slate-500 mt-1 max-w-sm" };
const _hoisted_31 = { class: "flex flex-wrap gap-x-4 gap-y-1 mt-2 text-[10px] font-bold text-slate-400" };
const _hoisted_32 = { class: "flex items-center gap-1" };
const _hoisted_33 = { class: "flex items-center gap-1" };
const _hoisted_34 = { class: "md:text-right flex-shrink-0 space-y-1" };
const _hoisted_35 = { class: "text-sm font-black uppercase tracking-wider text-emerald-700" };
const _hoisted_36 = { class: "text-xs font-bold text-slate-700" };
const _hoisted_37 = { key: 0 };
const _hoisted_38 = { key: 1 };
const _hoisted_39 = { class: "text-[10px] font-bold text-slate-400" };
const _hoisted_40 = { class: "bg-slate-50 rounded-xl p-3 flex flex-wrap items-center justify-between text-xs font-bold text-slate-500 text-left gap-2 border border-slate-100" };
const _hoisted_41 = { class: "text-slate-800" };
const _hoisted_42 = { class: "text-emerald-700 uppercase tracking-widest text-[9px]" };
const _hoisted_43 = { class: "text-slate-800" };
const _hoisted_44 = { class: "grid grid-cols-2 lg:grid-cols-4 xl:grid-cols-7 gap-3 text-left" };
const _hoisted_45 = { class: "text-[8px] font-black text-slate-400 uppercase tracking-wider block" };
const _hoisted_46 = { class: "text-xl font-black text-slate-800 mt-1 block leading-none" };
const _hoisted_47 = { class: "overflow-x-auto rounded-xl border border-slate-100 shadow-sm" };
const _hoisted_48 = { class: "w-full text-xs text-left" };
const _hoisted_49 = { class: "bg-emerald-700 text-white font-bold uppercase tracking-wider" };
const _hoisted_50 = { class: "divide-y divide-slate-100 bg-white" };
const _hoisted_51 = { class: "py-3 px-4 font-bold text-slate-800 whitespace-nowrap" };
const _hoisted_52 = { class: "text-[10px] text-slate-400 font-semibold mt-0.5" };
const _hoisted_53 = { class: "py-3 px-4 font-semibold text-slate-655 whitespace-nowrap" };
const _hoisted_54 = { class: "py-3 px-4 font-bold text-emerald-800 whitespace-nowrap" };
const _hoisted_55 = { class: "py-3 px-4 font-semibold text-slate-500 whitespace-nowrap" };
const _hoisted_56 = { class: "py-3 px-4 font-semibold text-slate-500 whitespace-nowrap" };
const _hoisted_57 = { class: "py-3 px-4 font-semibold text-slate-600 whitespace-nowrap" };
const _hoisted_58 = { class: "flex flex-col gap-0.5 text-[10px]" };
const _hoisted_59 = {
  key: 0,
  class: "text-emerald-600 font-bold"
};
const _hoisted_60 = { class: "text-slate-800 font-bold" };
const _hoisted_61 = { class: "py-3 px-4 whitespace-nowrap" };
const _hoisted_62 = ["innerHTML"];
const _hoisted_63 = { class: "py-3 px-4 font-bold text-slate-800 whitespace-nowrap" };
const _hoisted_64 = { class: "text-[10px] text-slate-400 font-semibold mt-0.5" };
const _hoisted_65 = { class: "py-3 px-4 font-bold text-slate-850 whitespace-nowrap" };
const _hoisted_66 = ["title"];
const _hoisted_67 = { class: "text-[10px] text-slate-400 font-semibold mt-0.5" };
const _hoisted_68 = { class: "py-3 px-4 text-slate-500 whitespace-nowrap" };
const _hoisted_69 = { class: "text-[10px] space-y-0.5" };
const _hoisted_70 = { class: "py-3 px-4 text-slate-500 whitespace-nowrap" };
const _hoisted_71 = { class: "text-[10px] space-y-0.5" };
const _hoisted_72 = { class: "py-3 px-4 font-semibold text-slate-655 whitespace-nowrap" };
const _hoisted_73 = { class: "py-3 px-4 whitespace-nowrap" };
const _hoisted_74 = ["innerHTML"];
const _hoisted_75 = ["innerHTML"];
const _hoisted_76 = { class: "py-3 px-4 font-bold text-slate-800 whitespace-nowrap" };
const _hoisted_77 = { class: "text-[10px] text-slate-400 font-semibold mt-0.5" };
const _hoisted_78 = { class: "py-3 px-4 font-bold text-slate-850 whitespace-nowrap text-left" };
const _hoisted_79 = { class: "font-extrabold text-slate-800" };
const _hoisted_80 = ["title"];
const _hoisted_81 = { class: "text-[9px] text-slate-450 mt-0.5" };
const _hoisted_82 = { class: "py-3 px-4 text-slate-500 whitespace-nowrap" };
const _hoisted_83 = { class: "text-[10px] space-y-0.5 font-semibold" };
const _hoisted_84 = {
  key: 0,
  class: "font-bold text-emerald-700"
};
const _hoisted_85 = { class: "py-3 px-4 whitespace-nowrap" };
const _hoisted_86 = ["innerHTML"];
const _hoisted_87 = { class: "py-3 px-4 font-extrabold text-slate-800 whitespace-nowrap" };
const _hoisted_88 = { class: "py-3 px-4 font-bold text-slate-800 whitespace-nowrap" };
const _hoisted_89 = { class: "text-[10px] text-slate-400 font-semibold mt-0.5" };
const _hoisted_90 = { class: "py-3 px-4 font-bold text-emerald-800 whitespace-nowrap" };
const _hoisted_91 = { class: "py-3 px-4 font-semibold text-slate-655 whitespace-nowrap" };
const _hoisted_92 = { class: "py-3 px-4 font-semibold text-slate-500 whitespace-nowrap" };
const _hoisted_93 = { class: "py-3 px-4 font-semibold whitespace-nowrap" };
const _hoisted_94 = { class: "py-3 px-4 font-bold text-slate-700 whitespace-nowrap" };
const _hoisted_95 = { class: "px-2.5 py-1 bg-slate-100 rounded-lg text-slate-700 text-xs font-semibold" };
const _hoisted_96 = { class: "py-3 px-4 whitespace-nowrap" };
const _hoisted_97 = ["innerHTML"];
const _hoisted_98 = { class: "py-3 px-4 font-bold text-slate-800 whitespace-nowrap" };
const _hoisted_99 = { class: "text-[10px] text-slate-400 font-semibold mt-0.5" };
const _hoisted_100 = { class: "py-3 px-4 font-semibold text-slate-700 whitespace-nowrap" };
const _hoisted_101 = { class: "py-3 px-4 text-slate-500 whitespace-nowrap" };
const _hoisted_102 = { class: "text-[10px] space-y-0.5" };
const _hoisted_103 = { class: "py-3 px-4 text-slate-655 whitespace-nowrap" };
const _hoisted_104 = { class: "py-3 px-4 text-slate-500 whitespace-nowrap" };
const _hoisted_105 = { class: "text-[10px] space-y-0.5 font-bold" };
const _hoisted_106 = {
  key: 0,
  class: "text-emerald-700 font-extrabold"
};
const _hoisted_107 = { class: "py-3 px-4 text-slate-500 whitespace-nowrap" };
const _hoisted_108 = { class: "text-[10px] space-y-0.5" };
const _hoisted_109 = { class: "font-bold text-slate-850" };
const _hoisted_110 = {
  key: 0,
...
const _hoisted_112 = { class: "py-3 px-4 whitespace-nowrap" };
const _hoisted_113 = ["innerHTML"];
const _hoisted_114 = ["innerHTML"];
const _hoisted_115 = ["innerHTML"];
const _hoisted_116 = { key: 1 };
const _hoisted_117 = { key: 6 };
const _hoisted_118 = ["colspan"];
const _hoisted_119 = { class: "flex flex-col sm:flex-row items-center justify-between gap-4 pt-3 border-t border-slate-100 text-xs font-bold text-slate-500" };
const _hoisted_120 = { class: "text-left flex items-center gap-4" };
const _hoisted_121 = { class: "text-slate-800" };
const _hoisted_122 = { key: 0 };
const _hoisted_123 = { class: "text-emerald-700" };
const _hoisted_124 = { key: 1 };
const _hoisted_125 = { class: "text-emerald-700" };
const _hoisted_126 = {
  key: 0,
  class: "flex items-center gap-1.5"
};
const _hoisted_127 = ["disabled"];
const _hoisted_128 = { class: "px-2" };
const _hoisted_129 = ["disabled"];
const _hoisted_130 = { class: "bg-slate-50/80 px-8 py-4 border-t border-slate-100 flex flex-wrap items-center justify-between text-[10px] font-bold text-slate-400 text-left gap-3" };
const _hoisted_131 = {
  key: 1,
  class: "bg-slate-50 border border-slate-100 rounded-3xl p-16 text-center animate-in fade-in duration-300"
};
const _hoisted_132 = { class: "w-14 h-14 rounded-2xl bg-white border border-slate-100 shadow-sm flex items-center justify-center mx-auto mb-5 text-emerald-600" };
const _hoisted_133 = { class: "bg-white rounded-2xl border border-slate-100 shadow-sm overflow-hidden text-left" };
const _hoisted_134 = { class: "flex items-center space-x-1.5 bg-slate-50/50 border-b border-slate-100 p-2" };
const _hoisted_135 = {
  key: 0,
  class: "p-6"
};
...
const _hoisted_137 = { class: "w-12 h-12 rounded-full bg-slate-50 border border-slate-100 flex items-center justify-center mx-auto mb-3 text-slate-350" };
const _hoisted_138 = {
  key: 1,
  class: "overflow-x-auto rounded-xl border border-slate-100"
};
const _hoisted_139 = { class: "w-full text-xs" };
const _hoisted_140 = { class: "divide-y divide-slate-100" };
const _hoisted_141 = { class: "py-3 px-4 font-bold text-slate-800 capitalize" };
const _hoisted_142 = { class: "py-3 px-4 capitalize" };
const _hoisted_143 = { class: "py-3 px-4" };
const _hoisted_144 = { class: "py-3 px-4 text-slate-500 font-medium" };
const _hoisted_145 = { class: "py-3 px-4" };
const _hoisted_146 = { class: "py-3 px-4" };
const _hoisted_147 = { class: "py-3 px-4 text-right" };
const _hoisted_148 = { class: "flex items-center justify-end gap-1.5" };
const _hoisted_149 = ["onClick", "title"];
...
const _hoisted_153 = { class: "w-12 h-12 rounded-full bg-slate-50 border border-slate-100 flex items-center justify-center mx-auto mb-3 text-slate-355" };
const _hoisted_154 = {
  key: 1,
  class: "overflow-x-auto rounded-xl border border-slate-100"
};
const _hoisted_155 = { class: "w-full text-xs" };
const _hoisted_156 = { class: "divide-y divide-slate-100" };
const _hoisted_157 = { class: "py-3 px-4 font-bold text-slate-800" };
const _hoisted_158 = { class: "py-3 px-4" };
const _hoisted_159 = { class: "py-3 px-4 text-slate-450" };
const _hoisted_160 = { class: "py-3 px-4 text-right" };
const _hoisted_161 = ["onClick"];
const _hoisted_162 = { class: "bg-white rounded-2xl shadow-xl w-full max-w-md overflow-hidden animate-in fade-in zoom-in duration-200 border border-slate-100" };
const _hoisted_163 = { class: "p-6 border-b border-slate-100 flex items-center justify-between text-left" };
const _hoisted_164 = { class: "flex items-center space-x-3" };
const _hoisted_165 = { class: "w-10 h-10 rounded-lg bg-emerald-50 flex items-center justify-center text-emerald-600 border border-emerald-100 flex-shrink-0" };
const _hoisted_166 = { class: "text-[10px] font-semibold text-slate-400 uppercase mt-0.5" };
const _hoisted_167 = { class: "p-6 space-y-5 text-left font-outfit text-slate-700" };
const _hoisted_168 = { class: "grid grid-cols-3 gap-2" };
const _hoisted_169 = ["onClick"];
const _hoisted_170 = { class: "grid grid-cols-2 gap-2" };
const _hoisted_171 = { class: "p-6 border-t border-slate-100 bg-slate-50/50 flex gap-3" };
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
        ...
        if (filters.category === "bookings") {
          ...
          if (filters.category === "attendance") {
            ...
            items = list.map((a) => {
              ...
              let durationMins = 0;
              if (checkIn && checkOut) {
                durationMins = Math.max(0, Math.floor((checkOut.getTime() - checkIn.getTime()) / (60 * 1e3)));
              } else if (checkIn) {
                durationMins = Math.max(0, Math.floor(((/* @__PURE__ */ new Date()).getTime() - checkIn.getTime()) / (60 * 1e3)));
              }
              const dateStr = a.date ? new Date(a.date).toLocaleDateString("en-US", { day: "numeric", month: "short", year: "numeric" }) : checkIn ? checkIn.toLocaleDateString("en-US", { day: "numeric", month: "short", year: "numeric" }) : "—";
              return {
                id: `ATT-${a.id}`,
                attendanceId: `A-${a.id}`,
    ...
    const totalAttendanceHours = computed(() => {
      ...
      const totalMins = processedItems.value.reduce((acc, item) => acc + (item.durationMins || 0), 0);
    ...
    const summaryStats = computed(() => {
      ...
      if (filters.category === "attendance") {
        const list2 = processedItems.value;
        const total2 = list2.length;
        const present = list2.filter((a) => a.rawStatus === "present").length;
        const left = list2.filter((a) => a.rawStatus === "left").length;
        const totalMins = list2.reduce((sum, a) => sum + (a.durationMins || 0), 0);
        const avgMins = total2 > 0 ? Math.round(totalMins / total2) : 0;
        return [
...
`;
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", _hoisted_1, [
        _cache[123] || (_cache[123] = createStaticVNode('<div class="relative overflow-hidden rounded-xl bg-emerald-700 p-6 text-white shadow-md text-left" data-v-6681d2f1><div class="absolute top-0 right-0 w-64 h-64 bg-white/5 rounded-full -translate-y-1/2 translate-x-1/3" data-v-6681d2f1></div><div class="absolute bottom-0 left-16 w-40 h-40 bg-white/5 rounded-full translate-y-1/2" data-v-6681d2f1></div><div class="relative z-10 max-w-2xl" data-v-6681d2f1><h1 class="text-2xl font-bold tracking-tight leading-tight" data-v-6681d2f1>Library Reports Center</h1><p class="text-white/70 mt-1 text-xs font-medium leading-relaxed" data-v-6681d2f1> Generate real-time analytics, export data spreadsheets, or configure automated report delivery directly to your inbox. </p></div></div>', 1)),
        createBaseVNode("div", _hoisted_2, [
          createBaseVNode("h2", _hoisted_3, [
            createVNode(unref(Zap), { class: "w-4.5 h-4.5 text-amber-500" }),
            _cache[41] || (_cache[41] = createBaseVNode("span", null, "Configure Report Parameters", -1))
          ]),
          createBaseVNode("div", {
            ...
            createBaseVNode("div", null, [
              _cache[42] || (_cache[42] = createBaseVNode("label", { class: "text-[10px] font-bold text-slate-400 uppercase tracking-widest mb-2 block ml-1" }, "Report Category", -1)),
            ...
            createBaseVNode("div", null, [
              _cache[44] || (_cache[44] = createBaseVNode("label", { class: "text-[10px] font-bold text-slate-400 uppercase tracking-widest mb-2 block ml-1" }, "Time Range", -1)),
              withDirectives(createBaseVNode("select", {
                "onUpdate:modelValue": _cache[1] || (_cache[1] = ($event) => filters.timeRange = $event),
                onChange: handleTimeRangeChange,
                class: "w-full px-4 py-2.5 bg-slate-50 border border-slate-200 rounded-xl text-xs font-bold text-slate-700 focus:ring-2 focus:ring-emerald-500/20 focus:border-emerald-500 outline-none cursor-pointer"
              }, [..._cache[43] || (_cache[43] = [
                createStaticVNode('<option value="today" data-v-6681d2f1>Today</option><option value="week" data-v-6681d2f1>This Week</option><option value="month" data-v-6681d2f1>This Month</option><option value="year" data-v-6681d2f1>This Year</option><option value="custom" data-v-6681d2f1>Custom Range</option>', 5)
              ])], 544), [
                [vModelSelect, filters.timeRange]
              ])
            ]),
            filters.timeRange === "custom" ? (openBlock(), createElementBlock("div", _hoisted_5, [
              _cache[45] || (_cache[45] = createBaseVNode("label", { class: "text-[10px] font-bold text-slate-400 uppercase tracking-widest mb-2 block ml-1" }, "From Date", -1)),
            ...
            filters.timeRange === "custom" ? (openBlock(), createElementBlock("div", _hoisted_6, [
              _cache[46] || (_cache[46] = createBaseVNode("label", { class: "text-[10px] font-bold text-slate-400 uppercase tracking-widest mb-2 block ml-1" }, "To Date", -1)),
              withDirectives(createBaseVNode("input", {
          ...
          filters.category === "bookings" ? (openBlock(), createElementBlock("div", _hoisted_7, [
            _cache[55] || (_cache[55] = createBaseVNode("span", { class: "text-[10px] font-black text-emerald-800 uppercase tracking-widest block" }, "Advanced Search & Filter Parameters", -1)),
            createBaseVNode("div", _hoisted_8, [
              createBaseVNode("div", null, [
                _cache[47] || (_cache[47] = createBaseVNode("label", { class: "text-[9px] font-bold text-slate-400 uppercase tracking-widest mb-1.5 block" }, "Student (Name / CRN)", -1)),
                withDirectives(createBaseVNode("input", {
              ...
              createBaseVNode("div", null, [
                _cache[48] || (_cache[48] = createBaseVNode("label", { class: "text-[9px] font-bold text-slate-400 uppercase tracking-widest mb-1.5 block" }, "Seat Number", -1)),
                withDirectives(createBaseVNode("input", {
              ...
              createBaseVNode("div", null, [
                _cache[50] || (_cache[50] = createBaseVNode("label", { class: "text-[9px] font-bold text-slate-400 uppercase tracking-widest mb-1.5 block" }, "Booking Status", -1)),
                withDirectives(createBaseVNode("select", {
                  ...
                  createStaticVNode('<option value="all" data-v-6681d2f1>All Statuses</option><option value="booked" data-v-6681d2f1>Booked</option><option value="checked_in" data-v-6681d2f1>Checked In</option><option value="checked_out" data-v-6681d2f1>Checked Out</option><option value="cancelled" data-v-6681d2f1>Cancelled</option>', 5)
                ])], 512), [
                  [vModelSelect, filters.bookingStatus]
                ])
              ]),
              createBaseVNode("div", null, [
                _cache[52] || (_cache[52] = createBaseVNode("label", { class: "text-[9px] font-bold text-slate-400 uppercase tracking-widest mb-1.5 block" }, "Check-in Status", -1)),
                withDirectives(createBaseVNode("select", {
              ...
              createBaseVNode("div", null, [
                _cache[54] || (_cache[54] = createBaseVNode("label", { class: "text-[9px] font-bold text-slate-400 uppercase tracking-widest mb-1.5 block" }, "Overstay Status", -1)),
                withDirectives(createBaseVNode("select", {
                  "onUpdate:modelValue": _cache[8] || (_cache[8] = ($event) => filters.overstayStatus = $event),
                  class: "w-full px-3 py-2 bg-white border border-slate-200 rounded-xl text-xs font-bold text-slate-700 focus:ring-2 focus:ring-emerald-500/10 focus:border-emerald-500 outline-none cursor-pointer"
                }, [..._cache[53] || (_cache[53] = [
                  createStaticVNode('<option value="all" data-v-6681d2f1>All Overstays</option><option value="on_time" data-v-6681d2f1>Checked Out On Time</option><option value="early" data-v-6681d2f1>Early Check-out</option><option value="overstay" data-v-6681d2f1>Overstay (&lt; 1 Hour)</option><option value="serious_overstay" data-v-6681d2f1>Serious Overstay (≥ 1 Hour)</option><option value="cancelled" data-v-6681d2f1>Auto Cancelled</option>', 6)
                ])], 512), [
          ...
          filters.category === "book_reservations" ? (openBlock(), createElementBlock("div", _hoisted_9, [
            _cache[64] || (_cache[64] = createBaseVNode("span", { class: "text-[10px] font-black text-emerald-800 uppercase tracking-widest block" }, "Advanced Book Reservation Filter Parameters", -1)),
            createBaseVNode("div", _hoisted_10, [
              createBaseVNode("div", null, [
                _cache[56] || (_cache[56] = createBaseVNode("label", { class: "text-[9px] font-bold text-slate-400 uppercase tracking-widest mb-1.5 block" }, "Student (Name / CRN)", -1)),
                withDirectives(createBaseVNode("input", {
              ...
              createBaseVNode("div", null, [
                _cache[57] || (_cache[57] = createBaseVNode("label", { class: "text-[9px] font-bold text-slate-400 uppercase tracking-widest mb-1.5 block" }, "Book (Title / ISBN)", -1)),
                withDirectives(createBaseVNode("input", {
              ...
              createBaseVNode("div", null, [
                _cache[59] || (_cache[59] = createBaseVNode("label", { class: "text-[9px] font-bold text-slate-400 uppercase tracking-widest mb-1.5 block" }, "Book Category", -1)),
                withDirectives(createBaseVNode("select", {
                  "onUpdate:modelValue": _cache[11] || (_cache[11] = ($event) => filters.bookCategory = $event),
                  class: "w-full px-3 py-2 bg-white border border-slate-200 rounded-xl text-xs font-bold text-slate-700 focus:ring-2 focus:ring-emerald-500/10 focus:border-emerald-500 outline-none cursor-pointer"
                }, [..._cache[58] || (_cache[58] = [
                  createStaticVNode('<option value="all" data-v-6681d2f1>All Categories</option><option value="Fiction" data-v-6681d2f1>Fiction</option><option value="Science" data-v-6681d2f1>Science</option><option value="Technology" data-v-6681d2f1>Technology</option><option value="Mathematics" data-v-6681d2f1>Mathematics</option><option value="History" data-v-6681d2f1>History</option><option value="Biography" data-v-6681d2f1>Biography</option>', 7)
                ])], 512), [
                  [vModelSelect, filters.bookCategory]
                ])
              ]),
              createBaseVNode("div", null, [
                _cache[61] || (_cache[61] = createBaseVNode("label", { class: "text-[9px] font-bold text-slate-400 uppercase tracking-widest mb-1.5 block" }, "Reservation Status", -1)),
                withDirectives(createBaseVNode("select", {
                  "onUpdate:modelValue": _cache[12] || (_cache[12] = ($event) => filters.reservationStatus = $event),
                  class: "w-full px-3 py-2 bg-white border border-slate-200 rounded-xl text-xs font-bold text-slate-700 focus:ring-2 focus:ring-emerald-500/10 focus:border-emerald-500 outline-none cursor-pointer"
                }, [..._cache[60] || (_cache[60] = [
                  createStaticVNode('<option value="all" data-v-6681d2f1>All Statuses</option><option value="pending" data-v-6681d2f1>Pending Approval</option><option value="approved" data-v-6681d2f1>Approved</option><option value="rejected" data-v-6681d2f1>Rejected</option><option value="collected" data-v-6681d2f1>Collected</option>', 5)
                ])], 512), [
                  [vModelSelect, filters.reservationStatus]
                ])
              ]),
              createBaseVNode("div", null, [
                _cache[63] || (_cache[63] = createBaseVNode("label", { class: "text-[9px] font-bold text-slate-400 uppercase tracking-widest mb-1.5 block" }, "Return Status (Time Analysis)", -1)),
                withDirectives(createBaseVNode("select", {
                  "onUpdate:modelValue": _cache[13] || (_cache[13] = ($event) => filters.returnStatus = $event),
                  class: "w-full px-3 py-2 bg-white border border-slate-200 rounded-xl text-xs font-bold text-slate-700 focus:ring-2 focus:ring-emerald-500/10 focus:border-emerald-500 outline-none cursor-pointer"
                }, [..._cache[62] || (_cache[62] = [
                  createStaticVNode('<option value="all" data-v-6681d2f1>All Returns</option><option value="Returned On Time" data-v-6681d2f1>Returned On Time</option><option value="Returned Early" data-v-6681d2f1>Returned Early</option><option value="Returned Late" data-v-6681d2f1>Returned Late</option><option value="Not Picked Up" data-v-6681d2f1>Not Picked Up</option><option value="Borrowed" data-v-6681d2f1>Borrowed (Active)</option><option value="Overdue" data-v-6681d2f1>Overdue (Active)</option>', 7)
                ])], 512), [
          ...
          filters.category === "complaints" ? (openBlock(), createElementBlock("div", _hoisted_11, [
            _cache[72] || (_cache[72] = createBaseVNode("span", { class: "text-[10px] font-black text-emerald-800 uppercase tracking-widest block" }, "Advanced Support Ticket / Complaints Filter Parameters", -1)),
            createBaseVNode("div", _hoisted_12, [
              createBaseVNode("div", null, [
                _cache[65] || (_cache[65] = createBaseVNode("label", { class: "text-[9px] font-bold text-slate-400 uppercase tracking-widest mb-1.5 block" }, "Student (Name / CRN)", -1)),
                withDirectives(createBaseVNode("input", {
              ...
              createBaseVNode("div", null, [
                _cache[67] || (_cache[67] = createBaseVNode("label", { class: "text-[9px] font-bold text-slate-400 uppercase tracking-widest mb-1.5 block" }, "Complaint Category", -1)),
                withDirectives(createBaseVNode("select", {
                  "onUpdate:modelValue": _cache[15] || (_cache[15] = ($event) => filters.complaintCategory = $event),
                  class: "w-full px-3 py-2 bg-white border border-slate-200 rounded-xl text-xs font-bold text-slate-700 focus:ring-2 focus:ring-emerald-500/10 focus:border-emerald-500 outline-none cursor-pointer"
                }, [..._cache[66] || (_cache[66] = [
              ...
              createBaseVNode("div", null, [
                _cache[69] || (_cache[69] = createBaseVNode("label", { class: "text-[9px] font-bold text-slate-400 uppercase tracking-widest mb-1.5 block" }, "Priority", -1)),
                withDirectives(createBaseVNode("select", {
                  "onUpdate:modelValue": _cache[16] || (_cache[16] = ($event) => filters.complaintPriority = $event),
                  class: "w-full px-3 py-2 bg-white border border-slate-200 rounded-xl text-xs font-bold text-slate-700 focus:ring-2 focus:ring-emerald-500/10 focus:border-emerald-500 outline-none cursor-pointer"
                }, [..._cache[68] || (_cache[68] = [
                  createStaticVNode('<option value="all" data-v-6681d2f1>All Priorities</option><option value="low" data-v-6681d2f1>Low</option><option value="medium" data-v-6681d2f1>Medium</option><option value="high" data-v-6681d2f1>High</option><option value="urgent" data-v-6681d2f1>Urgent</option>', 5)
                ])], 512), [
                  [vModelSelect, filters.complaintPriority]
                ])
              ]),
              createBaseVNode("div", null, [
                _cache[71] || (_cache[71] = createBaseVNode("label", { class: "text-[9px] font-bold text-slate-400 uppercase tracking-widest mb-1.5 block" }, "Complaint Status", -1)),
                withDirectives(createBaseVNode("select", {
                  "onUpdate:modelValue": _cache[17] || (_cache[17] = ($event) => filters.complaintStatus = $event),
                  class: "w-full px-3 py-2 bg-white border border-slate-200 rounded-xl text-xs font-bold text-slate-700 focus:ring-2 focus:ring-emerald-500/10 focus:border-emerald-500 outline-none cursor-pointer"
                }, [..._cache[70] || (_cache[70] = [
                  createStaticVNode('<option value="all" data-v-6681d2f1>All Statuses</option><option value="open" data-v-6681d2f1>Pending</option><option value="in_progress" data-v-6681d2f1>In Progress</option><option value="resolved" data-v-6681d2f1>Resolved</option><option value="closed" data-v-6681d2f1>Closed</option>', 5)
                ])], 512), [
          ...
          filters.category === "events" ? (openBlock(), createElementBlock("div", _hoisted_13, [
            _cache[82] || (_cache[82] = createBaseVNode("span", { class: "text-[10px] font-black text-emerald-800 uppercase tracking-widest block" }, "Advanced Campus Events Filter Parameters", -1)),
            createBaseVNode("div", _hoisted_14, [
              createBaseVNode("div", null, [
                _cache[73] || (_cache[73] = createBaseVNode("label", { class: "text-[9px] font-bold text-slate-400 uppercase tracking-widest mb-1.5 block" }, "Search Event (Title/Venue)", -1)),
                withDirectives(createBaseVNode("input", {
                  "onUpdate:modelValue": _cache[18] || (_cache[18] = ($event) => filters.eventSearch = $event),
                  type: "text",
              ...
              createBaseVNode("div", null, [
                _cache[75] || (_cache[75] = createBaseVNode("label", { class: "text-[9px] font-bold text-slate-400 uppercase tracking-widest mb-1.5 block" }, "Event Type", -1)),
                withDirectives(createBaseVNode("select", {
                  "onUpdate:modelValue": _cache[19] || (_cache[19] = ($event) => filters.eventType = $event),
                  class: "w-full px-3 py-2 bg-white border border-slate-200 rounded-xl text-xs font-bold text-slate-700 focus:ring-2 focus:ring-emerald-500/10 focus:border-emerald-500 outline-none cursor-pointer"
                }, [..._cache[74] || (_cache[74] = [
                  createStaticVNode('<option value="all" data-v-6681d2f1>All Types</option><option value="seminar" data-v-6681d2f1>Seminar</option><option value="workshop" data-v-6681d2f1>Workshop</option><option value="study_group" data-v-6681d2f1>Study Group</option><option value="exam_prep" data-v-6681d2f1>Exam Prep</option><option value="career_guidance" data-v-6681d2f1>Career Guidance</option><option value="networking" data-v-6681d2f1>Networking</option>', 7)
                ])], 512), [
                  [vModelSelect, filters.eventType]
                ])
              ]),
              createBaseVNode("div", null, [
                _cache[77] || (_cache[77] = createBaseVNode("label", { class: "text-[9px] font-bold text-slate-400 uppercase tracking-widest mb-1.5 block" }, "Pricing Type", -1)),
                withDirectives(createBaseVNode("select", {
                  "onUpdate:modelValue": _cache[20] || (_cache[20] = ($event) => filters.eventPricing = $event),
                  class: "w-full px-3 py-2 bg-white border border-slate-200 rounded-xl text-xs font-bold text-slate-700 focus:ring-2 focus:ring-emerald-500/10 focus:border-emerald-500 outline-none cursor-pointer"
                }, [..._cache[76] || (_cache[76] = [
              ...
              createBaseVNode("div", null, [
                _cache[79] || (_cache[79] = createBaseVNode("label", { class: "text-[9px] font-bold text-slate-400 uppercase tracking-widest mb-1.5 block" }, "Capacity Status", -1)),
                withDirectives(createBaseVNode("select", {
                  "onUpdate:modelValue": _cache[21] || (_cache[21] = ($event) => filters.eventCapacityStatus = $event),
                  class: "w-full px-3 py-2 bg-white border border-slate-200 rounded-xl text-xs font-bold text-slate-700 focus:ring-2 focus:ring-emerald-500/10 focus:border-emerald-500 outline-none cursor-pointer"
                }, [..._cache[78] || (_cache[78] = [
              ...
              createBaseVNode("div", null, [
                _cache[81] || (_cache[81] = createBaseVNode("label", { class: "text-[9px] font-bold text-slate-400 uppercase tracking-widest mb-1.5 block" }, "Event Status", -1)),
                withDirectives(createBaseVNode("select", {
                  "onUpdate:modelValue": _cache[22] || (_cache[22] = ($event) => filters.eventStatus = $event),
                  class: "w-full px-3 py-2 bg-white border border-slate-200 rounded-xl text-xs font-bold text-slate-700 focus:ring-2 focus:ring-emerald-500/10 focus:border-emerald-500 outline-none cursor-pointer"
                }, [..._cache[80] || (_cache[80] = [
                  createStaticVNode('<option value="all" data-v-6681d2f1>All Statuses</option><option value="upcoming" data-v-6681d2f1>Upcoming</option><option value="ongoing" data-v-6681d2f1>Ongoing</option><option value="completed" data-v-6681d2f1>Completed</option><option value="cancelled" data-v-6681d2f1>Cancelled</option>', 5)
                ])], 512), [
          ...
          filters.category === "attendance" ? (openBlock(), createElementBlock("div", _hoisted_15, [
            _cache[89] || (_cache[89] = createBaseVNode("span", { class: "text-[10px] font-black text-emerald-800 uppercase tracking-widest block" }, "Advanced Attendance Audit Filter Parameters", -1)),
            createBaseVNode("div", _hoisted_16, [
              createBaseVNode("div", null, [
                _cache[83] || (_cache[83] = createBaseVNode("label", { class: "text-[9px] font-bold text-slate-400 uppercase tracking-widest mb-1.5 block" }, "Student (Name / CRN)", -1)),
                withDirectives(createBaseVNode("input", {
                  "onUpdate:modelValue": _cache[23] || (_cache[23] = ($event) => filters.attendanceStudentSearch = $event),
                  type: "text",
                  placeholder: "Search student...",
                  class: "w-full px-3 py-2 bg-white border border-slate-200 rounded-xl text-xs font-semibold text-slate-700 focus:ring-2 focus:ring-emerald-500/10 focus:border-emerald-500 outline-none"
                }, null, 512), [
                  [vModelText, filters.attendanceStudentSearch]
                ])
              ]),
              createBaseVNode("div", null, [
                _cache[84] || (_cache[84] = createBaseVNode("label", { class: "text-[9px] font-bold text-slate-400 uppercase tracking-widest mb-1.5 block" }, "Seat Number", -1)),
                withDirectives(createBaseVNode("input", {
                  "onUpdate:modelValue": _cache[24] || (_cache[24] = ($event) => filters.attendanceSeatNumber = $event),
                  type: "text",
                  placeholder: "e.g. S-101",
                  class: "w-full px-3 py-2 bg-white border border-slate-200 rounded-xl text-xs font-semibold text-slate-700 focus:ring-2 focus:ring-emerald-500/10 focus:border-emerald-500 outline-none"
                }, null, 512), [
                  [vModelText, filters.attendanceSeatNumber]
                ])
              ]),
              createBaseVNode("div", null, [
                _cache[86] || (_cache[86] = createBaseVNode("label", { class: "text-[9px] font-bold text-slate-400 uppercase tracking-widest mb-1.5 block" }, "Attendance Status", -1)),
                withDirectives(createBaseVNode("select", {
                  ...
                  createBaseVNode("option", { value: "present" }, "Present (Active Session)", -1),
              ...
              createBaseVNode("div", null, [
                _cache[88] || (_cache[88] = createBaseVNode("label", { class: "text-[9px] font-bold text-slate-400 uppercase tracking-widest mb-1.5 block" }, "Session Duration", -1)),
                withDirectives(createBaseVNode("select", {
                  "onUpdate:modelValue": _cache[26] || (_cache[26] = ($event) => filters.attendanceDurationFilter = $event),
                  class: "w-full px-3 py-2 bg-white border border-slate-200 rounded-xl text-xs font-bold text-slate-700 focus:ring-2 focus:ring-emerald-500/10 focus:border-emerald-500 outline-none cursor-pointer"
                }, [..._cache[87] || (_cache[87] = [
                  createStaticVNode('<option value="all" data-v-6681d2f1>All Durations</option><option value="under_30m" data-v-6681d2f1>&lt; 30 Minutes</option><option value="30m_1h" data-v-6681d2f1>30 Mins – 1 Hour</option><option value="1h_3h" data-v-6681d2f1>1 Hour – 3 Hours</option><option value="over_3h" data-v-6681d2f1>&gt; 3 Hours</option>', 5)
                ])], 512), [
                  [vModelSelect, filters.attendanceDurationFilter]
                ])
              ])
            ])
          ])) : createCommentVNode("", true),
          createBaseVNode("div", _hoisted_17, [
            createBaseVNode("button", {
              ...
              _cache[90] || (_cache[90] = createBaseVNode("span", null, "Schedule Automation", -1))
            ]),
            createBaseVNode("button", {
        ...
        generatedReport.value ? (openBlock(), createElementBlock("div", _hoisted_19, [
          createBaseVNode("div", _hoisted_20, [
            createBaseVNode("div", _hoisted_21, [
              _cache[91] || (_cache[91] = createBaseVNode("span", { class: "w-2.5 h-2.5 rounded-full bg-emerald-500 animate-ping" }, null, -1)),
              createBaseVNode("span", _hoisted_22, "Active Report Compiled (" + toDisplayString(processedItems.value.length) + " Records)", 1)
            ]),
            createBaseVNode("div", _hoisted_23, [
              createBaseVNode("button", {
                onClick: _cache[27] || (_cache[27] = ($event) => exportReport("excel")),
                ...
                _cache[92] || (_cache[92] = createBaseVNode("span", null, "Export CSV", -1))
              ]),
              createBaseVNode("button", {
                onClick: _cache[28] || (_cache[28] = ($event) => exportReport("pdf")),
                ...
                _cache[93] || (_cache[93] = createBaseVNode("span", null, "Download PDF", -1))
              ]),
              createBaseVNode("button", {
                ...
                _cache[94] || (_cache[94] = createBaseVNode("span", null, "Print Report", -1))
              ])
            ])
          ]),
          createBaseVNode("div", _hoisted_24, [
            createBaseVNode("div", _hoisted_25, [
              createBaseVNode("div", _hoisted_26, [
                createBaseVNode("div", _hoisted_27, [
                  ...
                  createBaseVNode("div", null, [
                    createBaseVNode("h3", _hoisted_29, toDisplayString(generatedReport.value.libraryInfo?.name), 1),
                    createBaseVNode("p", _hoisted_30, toDisplayString(generatedReport.value.libraryInfo?.address || "SmartLib Campus"), 1),
                    createBaseVNode("div", _hoisted_31, [
                      createBaseVNode("span", _hoisted_32, "📞 " + toDisplayString(generatedReport.value.libraryInfo?.contact_info?.phone || "N/A"), 1),
                      createBaseVNode("span", _hoisted_33, "✉️ " + toDisplayString(generatedReport.value.libraryInfo?.contact_info?.email || "N/A"), 1)
                    ])
                  ])
                ]),
                createBaseVNode("div", _hoisted_34, [
                  createBaseVNode("h4", _hoisted_35, toDisplayString(generatedReport.value.label) + " Report", 1),
                  createBaseVNode("p", _hoisted_36, [
                    _cache[95] || (_cache[95] = createTextVNode(" Period: ", -1)),
                    generatedReport.value.timeRange === "custom" ? (openBlock(), createElementBlock("span", _hoisted_37, " From " + toDisplayString(fmtDate(generatedReport.value.fromDate)) + " To " + toDisplayString(fmtDate(generatedReport.value.toDate)), 1)) : (openBlock(), createElementBlock("span", _hoisted_38, toDisplayString(fmtDate(generatedReport.value.fromDate)) + " — " + toDisplayString(fmtDate(generatedReport.value.toDate)), 1))
                  ]),
              ...
              createBaseVNode("div", _hoisted_40, [
                createBaseVNode("div", null, [
                  _cache[96] || (_cache[96] = createTextVNode("Generated By: ", -1)),
                  createBaseVNode("span", _hoisted_41, toDisplayString(generatedReport.value.generatedBy.name), 1)
                ]),
                createBaseVNode("div", null, [
                  _cache[97] || (_cache[97] = createTextVNode("Role: ", -1)),
                  createBaseVNode("span", _hoisted_42, toDisplayString(generatedReport.value.generatedBy.role), 1)
                ]),
                createBaseVNode("div", null, [
                  _cache[98] || (_cache[98] = createTextVNode("Staff ID: ", -1)),
                  createBaseVNode("span", _hoisted_43, toDisplayString(generatedReport.value.generatedBy.staffId), 1)
                ])
              ]),
              createBaseVNode("div", _hoisted_44, [
                (openBlock(true), createElementBlock(Fragment, null, renderList(summaryStats.value, (stat) => {
                  return openBlock(), createElementBlock("div", {
                    ...
                    createBaseVNode("span", _hoisted_45, toDisplayString(stat.label), 1),
                    createBaseVNode("span", _hoisted_46, toDisplayString(stat.value), 1)
                  ]);
                }), 128))
              ]),
              createBaseVNode("div", _hoisted_47, [
                createBaseVNode("table", _hoisted_48, [
                  createBaseVNode("thead", null, [
                    createBaseVNode("tr", _hoisted_49, [
                  ...
                  createBaseVNode("tbody", _hoisted_50, [
                    filters.category === "bookings" ? (openBlock(true), createElementBlock(Fragment, { key: 0 }, renderList(paginatedItems.value, (row, idx) => {
                      return openBlock(), createElementBlock("tr", {
                        ...
                        createBaseVNode("td", _hoisted_51, [
                          ...
                          createBaseVNode("div", _hoisted_52, "CRN: " + toDisplayString(row.crn), 1)
                        ]),
                        createBaseVNode("td", _hoisted_53, toDisplayString(row.bookingDate), 1),
                        createBaseVNode("td", _hoisted_54, "Seat " + toDisplayString(row.seatNumber), 1),
                        ...
                        createBaseVNode("td", _hoisted_57, [
                          createBaseVNode("div", _hoisted_58, [
                            ...
                            row.extendedTime !== "0m" ? (openBlock(), createElementBlock("div", _hoisted_59, "Extended: " + toDisplayString(row.extendedTime), 1)) : createCommentVNode("", true),
                            createBaseVNode("div", null, "Total Reserved: " + toDisplayString(row.reservedDuration), 1),
                            createBaseVNode("div", _hoisted_60, "Used: " + toDisplayString(row.usedDuration), 1)
                          ])
                        ]),
                      ...
                      return openBlock(), createElementBlock("tr", {
                        ...
                        createBaseVNode("td", _hoisted_63, [
                          createBaseVNode("div", null, toDisplayString(row.studentName), 1),
                          createBaseVNode("div", _hoisted_64, "CRN: " + toDisplayString(row.crn), 1)
                        ]),
                        createBaseVNode("td", _hoisted_65, [
                          createBaseVNode("div", {
                            class: "max-w-[200px] truncate",
                            title: row.bookTitle
                          }, toDisplayString(row.bookTitle), 9, _hoisted_66),
                          createBaseVNode("div", _hoisted_67, "ISBN: " + toDisplayString(row.isbn), 1)
                        ]),
                        ...
                        createBaseVNode("td", _hoisted_72, toDisplayString(row.approvedBy), 1),
                        createBaseVNode("td", _hoisted_73, [
                          ...
                          }, null, 8, _hoisted_75)) : createCommentVNode("", true)
                        ])
                      ]);
                      ...
                      return openBlock(), createElementBlock("tr", {
                        ...
                        createBaseVNode("td", _hoisted_76, [
                          createBaseVNode("div", null, toDisplayString(row.studentName), 1),
                          createBaseVNode("div", _hoisted_77, "CRN: " + toDisplayString(row.crn), 1)
                        ]),
                        createBaseVNode("td", _hoisted_78, [
                          createBaseVNode("div", _hoisted_79, "#" + toDisplayString(row.complaintId), 1),
                          createBaseVNode("div", {
                            class: "text-[10px] text-slate-550 font-bold mt-0.5 truncate max-w-[220px]",
                            title: row.subject
                          }, toDisplayString(row.subject), 9, _hoisted_80),
                          createBaseVNode("div", _hoisted_81, "Filed: " + toDisplayString(row.submittedDate), 1),
                          createBaseVNode("div", {
                        ...
                        createBaseVNode("td", _hoisted_82, [
                          createBaseVNode("div", _hoisted_83, [
                            ...
                            row.resolutionTime !== "—" ? (openBlock(), createElementBlock("div", _hoisted_84, "Time taken: " + toDisplayString(row.resolutionTime), 1)) : createCommentVNode("", true)
                          ])
                        ]),
                    ...
                    }), 128)) : filters.category === "attendance" ? (openBlock(true), createElementBlock(Fragment, { key: 3 }, renderList(paginatedItems.value, (row, idx) => {
                      return openBlock(), createElementBlock("tr", {
                        key: idx,
                        class: "hover:bg-slate-50/60 transition-colors"
                      }, [
                        createBaseVNode("td", _hoisted_87, toDisplayString(row.attendanceId), 1),
                        createBaseVNode("td", _hoisted_88, [
                          createBaseVNode("div", null, toDisplayString(row.studentName), 1),
                          createBaseVNode("div", _hoisted_89, "CRN: " + toDisplayString(row.crn), 1)
                        ]),
                        createBaseVNode("td", _hoisted_90, "Seat " + toDisplayString(row.seatNumber), 1),
                        createBaseVNode("td", _hoisted_91, toDisplayString(row.date), 1),
                        createBaseVNode("td", _hoisted_92, toDisplayString(row.checkInTime), 1),
                        createBaseVNode("td", _hoisted_93, [
                          createBaseVNode("span", {
                            class: normalizeClass(row.rawStatus === "present" ? "text-emerald-600 font-bold" : "text-slate-600")
                          }, toDisplayString(row.checkOutTime), 3)
                        ]),
                        createBaseVNode("td", _hoisted_94, [
                          createBaseVNode("span", _hoisted_95, toDisplayString(row.durationStr), 1)
                        ]),
                      ...
                      return openBlock(), createElementBlock("tr", {
                        ...
                        createBaseVNode("td", _hoisted_98, [
                          ...
                          createBaseVNode("div", _hoisted_99, toDisplayString(row.eventId), 1)
                        ]),
                        ...
                        createBaseVNode("td", _hoisted_104, [
                          createBaseVNode("div", _hoisted_105, [
                            ...
                            row.registered > 0 ? (openBlock(), createElementBlock("div", _hoisted_106, "Attended Rate: " + toDisplayString(row.attendanceRate) + "%", 1)) : createCommentVNode("", true)
                          ])
                        ]),
                        createBaseVNode("td", _hoisted_107, [
                          createBaseVNode("div", _hoisted_108, [
                            createBaseVNode("div", null, [
                              _cache[99] || (_cache[99] = createTextVNode("Price: ", -1)),
                              createBaseVNode("span", _hoisted_109, toDisplayString(row.priceStr), 1)
                            ]),
                            row.isPaid ? (openBlock(), createElementBlock("div", _hoisted_110, "Rev: PKR " + toDisplayString(row.revenue.toFixed(2)), 1)) : createCommentVNode("", true),
                            createBaseVNode("div", null, [
                              createTextVNode("Cap: " + toDisplayString(row.capacityStr) + " ", 1),
                              row.capacity ? (openBlock(), createElementBlock("span", _hoisted_111, "(" + toDisplayString(row.fillRate) + "% filled)", 1)) : createCommentVNode("", true)
                            ])
                          ])
                        ]),
                        createBaseVNode("td", _hoisted_112, [
                          ...
                          }, null, 8, _hoisted_114)) : createCommentVNode("", true)
                        ])
                      ]);
                      ...
                      return openBlock(), createElementBlock("tr", {
                        ...
                        (openBlock(true), createElementBlock(Fragment, null, renderList(Object.values(row).slice(1), (val, colIdx) => {
                          return openBlock(), createElementBlock("td", {
                            ...
                            }, null, 8, _hoisted_115)) : (openBlock(), createElementBlock("span", _hoisted_116, toDisplayString(val), 1))
                          ]);
                        }), 128))
                      ]);
                    }), 128)),
                    processedItems.value.length === 0 ? (openBlock(), createElementBlock("tr", _hoisted_117, [
                      createBaseVNode("td", {
                        colspan: tableHeaders.value.length,
                        class: "text-center py-10 font-bold text-slate-400"
                      }, " No bookings match the selected filters. ", 8, _hoisted_118)
                    ])) : createCommentVNode("", true)
                  ])
                ])
              ]),
              createBaseVNode("div", _hoisted_119, [
                createBaseVNode("div", _hoisted_120, [
                  createBaseVNode("div", null, [
                    _cache[100] || (_cache[100] = createTextVNode("Total Records: ", -1)),
                    createBaseVNode("span", _hoisted_121, toDisplayString(processedItems.value.length), 1)
                  ]),
                  filters.category === "bookings" ? (openBlock(), createElementBlock("div", _hoisted_122, [
                    _cache[101] || (_cache[101] = createTextVNode("Total Hours Used: ", -1)),
                    createBaseVNode("span", _hoisted_123, toDisplayString(totalHoursUsed.value) + " Hours", 1)
                  ])) : createCommentVNode("", true),
                  filters.category === "attendance" ? (openBlock(), createElementBlock("div", _hoisted_124, [
                    _cache[102] || (_cache[102] = createTextVNode("Total Time Attended: ", -1)),
                    createBaseVNode("span", _hoisted_125, toDisplayString(totalAttendanceHours.value), 1)
                  ])) : createCommentVNode("", true)
                ]),
                totalPages.value > 1 ? (openBlock(), createElementBlock("div", _hoisted_126, [
                  createBaseVNode("button", {
                    onClick: _cache[30] || (_cache[30] = ($event) => currentPage.value = Math.max(1, currentPage.value - 1)),
                  ...
                  }, " Previous ", 8, _hoisted_127),
                  createBaseVNode("span", _hoisted_128, "Page " + toDisplayString(currentPage.value) + " of " + toDisplayString(totalPages.value), 1),
                  createBaseVNode("button", {
                    onClick: _cache[31] || (_cache[31] = ($event) => currentPage.value = Math.min(totalPages.value, currentPage.value + 1)),
            ...
            createBaseVNode("div", _hoisted_130, [
              _cache[103] || (_cache[103] = createBaseVNode("div", null, "SmartLib System • Automatically Compiled", -1)),
              _cache[104] || (_cache[104] = createBaseVNode("div", { class: "text-center italic" }, "This report was generated automatically by SmartLib.", -1)),
          ...
          _cache[105] || (_cache[105] = createBaseVNode("h3", { class: "text-base font-bold text-slate-850" }, "No Active Report Generated", -1)),
          _cache[106] || (_cache[106] = createBaseVNode("p", { class: "text-slate-455 text-xs mt-1.5 max-w-sm mx-auto font-medium leading-relaxed" }, " Select a category, configure your filters above, and click **Generate Report** to view logs. ", -1))
        ])),
        createBaseVNode("div", _hoisted_133, [
          createBaseVNode("div", _hoisted_134, [
            createBaseVNode("button", {
              onClick: _cache[32] || (_cache[32] = ($event) => activeTab.value = "scheduled"),
              ...
              _cache[107] || (_cache[107] = createBaseVNode("span", null, "Scheduled Reports", -1))
            ], 2),
            createBaseVNode("button", {
              onClick: _cache[33] || (_cache[33] = ($event) => activeTab.value = "history"),
              class: normalizeClass([
                "px-4 py-2.5 text-xs font-bold rounded-xl transition-all cursor-pointer flex items-center space-x-2",
              ...
              _cache[108] || (_cache[108] = createBaseVNode("span", null, "Report History", -1))
            ], 2)
          ]),
          activeTab.value === "scheduled" ? (openBlock(), createElementBlock("div", _hoisted_135, [
            scheduledReports.value.length === 0 ? (openBlock(), createElementBlock("div", _hoisted_136, [
              createBaseVNode("div", _hoisted_137, [
                createVNode(unref(CalendarClock), { class: "w-6 h-6" })
              ]),
              _cache[109] || (_cache[109] = createBaseVNode("p", { class: "text-slate-455 font-bold text-xs uppercase tracking-wider" }, "No Scheduled Reports", -1)),
              _cache[110] || (_cache[110] = createBaseVNode("p", { class: "text-[11px] text-slate-400 mt-1 font-medium" }, "Schedule automated delivery directly from report parameters setup.", -1))
            ])) : (openBlock(), createElementBlock("div", _hoisted_138, [
              createBaseVNode("table", _hoisted_139, [
                ...
                createBaseVNode("tbody", _hoisted_140, [
                  (openBlock(true), createElementBlock(Fragment, null, renderList(scheduledReports.value, (sr, idx) => {
                    return openBlock(), createElementBlock("tr", {
                      ...
                      createBaseVNode("td", _hoisted_141, toDisplayString(sr.type) + " Summary", 1),
                      createBaseVNode("td", _hoisted_142, toDisplayString(sr.frequency), 1),
                      ...
                      createBaseVNode("td", _hoisted_144, toDisplayString(sr.recipient), 1),
                      createBaseVNode("td", _hoisted_145, toDisplayString(sr.time), 1),
          ...
          activeTab.value === "history" ? (openBlock(), createElementBlock("div", _hoisted_151, [
            reportHistory.value.length === 0 ? (openBlock(), createElementBlock("div", _hoisted_152, [
              createBaseVNode("div", _hoisted_153, [
                createVNode(unref(History), { class: "w-6 h-6" })
              ]),
              _cache[112] || (_cache[112] = createBaseVNode("p", { class: "text-slate-455 font-bold text-xs uppercase tracking-wider" }, "No Report Logs", -1)),
              _cache[113] || (_cache[113] = createBaseVNode("p", { class: "text-[11px] text-slate-400 mt-1 font-medium" }, "Exported history logs will display here dynamically.", -1))
            ])) : (openBlock(), createElementBlock("div", _hoisted_154, [
              createBaseVNode("table", _hoisted_155, [
                _cache[115] || (_cache[115] = createBaseVNode("thead", null, [
                ...
                createBaseVNode("tbody", _hoisted_156, [
                  (openBlock(true), createElementBlock(Fragment, null, renderList(reportHistory.value, (h, idx) => {
                    return openBlock(), createElementBlock("tr", {
                      key: idx,
                      class: "hover:bg-slate-50/40 font-semibold text-slate-655"
                    }, [
                      createBaseVNode("td", _hoisted_157, toDisplayString(h.name), 1),
                      createBaseVNode("td", _hoisted_158, [
                        createBaseVNode("span", {
                      ...
                      createBaseVNode("td", _hoisted_159, toDisplayString(h.generatedAt), 1),
                      createBaseVNode("td", _hoisted_160, [
                        createBaseVNode("button", {
                          ...
                          _cache[114] || (_cache[114] = createBaseVNode("span", null, "Re-download", -1))
                        ], 8, _hoisted_161)
                      ])
                    ]);
                  }), 128))
        ...
        scheduleModal.show ? (openBlock(), createElementBlock("div", {
          ...
          onClick: _cache[40] || (_cache[40] = withModifiers(($event) => scheduleModal.show = false, ["self"]))
        }, [
          createBaseVNode("div", _hoisted_162, [
            createBaseVNode("div", _hoisted_163, [
              createBaseVNode("div", _hoisted_164, [
                ...
                createBaseVNode("div", null, [
                  _cache[116] || (_cache[116] = createBaseVNode("h3", { class: "text-base font-bold text-slate-800 leading-snug" }, "Schedule Automated Report", -1)),
                  createBaseVNode("p", _hoisted_166, "Category: " + toDisplayString(scheduleModal.reportType), 1)
                ])
              ]),
              createBaseVNode("button", {
                onClick: _cache[34] || (_cache[34] = ($event) => scheduleModal.show = false),
            ...
            createBaseVNode("div", _hoisted_167, [
              createBaseVNode("div", null, [
                _cache[117] || (_cache[117] = createBaseVNode("label", { class: "text-[10px] font-bold text-slate-400 uppercase tracking-wider mb-2 block" }, "Delivery Frequency", -1)),
                createBaseVNode("div", _hoisted_168, [
                  (openBlock(), createElementBlock(Fragment, null, renderList(["daily", "weekly", "monthly"], (f) => {
                    ...
                    }, toDisplayString(f), 11, _hoisted_169);
                  }), 64))
                ])
              ]),
              createBaseVNode("div", null, [
                _cache[120] || (_cache[120] = createBaseVNode("label", { class: "text-[10px] font-bold text-slate-400 uppercase tracking-wider mb-2 block" }, "Document Format", -1)),
                createBaseVNode("div", _hoisted_170, [
                  createBaseVNode("button", {
                    onClick: _cache[35] || (_cache[35] = ($event) => scheduleModal.format = "pdf"),
                    class: normalizeClass([
                    ...
                    createVNode(unref(FileText), { class: "w-4 h-4 text-red-500" }),
                    _cache[118] || (_cache[118] = createTextVNode(" PDF ", -1))
                  ], 2),
                  createBaseVNode("button", {
                    onClick: _cache[36] || (_cache[36] = ($event) => scheduleModal.format = "excel"),
                    class: normalizeClass([
                      "py-2 rounded-xl font-bold text-xs transition-all border-2 flex items-center justify-center gap-2 cursor-pointer",
                    ...
                    createVNode(unref(Sheet), { class: "w-4 h-4 text-emerald-600" }),
                    _cache[119] || (_cache[119] = createTextVNode(" CSV Excel ", -1))
                  ], 2)
                ])
              ]),
              createBaseVNode("div", null, [
                _cache[121] || (_cache[121] = createBaseVNode("label", { class: "text-[10px] font-bold text-slate-400 uppercase tracking-wider mb-2 block font-bold" }, "Recipient Email Address", -1)),
                withDirectives(createBaseVNode("input", {
                  "onUpdate:modelValue": _cache[37] || (_cache[37] = ($event) => scheduleModal.recipient = $event),
                  type: "email",
              ...
              createBaseVNode("div", null, [
                _cache[122] || (_cache[122] = createBaseVNode("label", { class: "text-[10px] font-bold text-slate-400 uppercase tracking-wider mb-2 block font-bold" }, "Daily Send Time", -1)),
                withDirectives(createBaseVNode("input", {
                  "onUpdate:modelValue": _cache[38] || (_cache[38] = ($event) => scheduleModal.time = $event),
                  type: "time",
                  class: "w-full px-4 py-2.5 border border-slate-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-emerald-500/20 focus:border-emerald-400 text-sm text-slate-700 bg-slate-50/50"
                }, null, 512), [
            ...
            createBaseVNode("div", _hoisted_171, [
              createBaseVNode("button", {
                onClick: _cache[39] || (_cache[39] = ($event) => scheduleModal.show = false),
...
const ReportsPage = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-6681d2f1"]]);
export {
