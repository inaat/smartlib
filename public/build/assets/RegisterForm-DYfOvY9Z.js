      ...
      return openBlock(), createElementBlock("div", _hoisted_1, [
        createBaseVNode("div", _hoisted_2, [
          createBaseVNode("div", _hoisted_3, [
            ...
            _cache[23] || (_cache[23] = createStaticVNode('<h1 class="text-5xl font-bold mb-6 leading-tight text-black" data-v-5538648f> Join Smart Library<br data-v-5538648f>Today </h1><p class="text-xl text-gray-600 mb-12 leading-relaxed" data-v-5538648f> Start your journey to smarter studying with our intelligent library management system. </p><div class="space-y-6" data-v-5538648f><div class="flex items-start space-x-4" data-v-5538648f><div class="flex-shrink-0 w-12 h-12 bg-indigo-600 rounded-xl flex items-center justify-center" data-v-5538648f><svg class="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-v-5538648f><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v13m0-13V6a2 2 0 112 2h-2zm0 0V5.5A2.5 2.5 0 109.5 8H12zm-7 4h14M5 12a2 2 0 110-4h14a2 2 0 110 4M5 12v7a2 2 0 002 2h10a2 2 0 002-2v-7" data-v-5538648f></path></svg></div><div data-v-5538648f><h4 class="text-lg font-semibold text-black mb-1" data-v-5538648f>7-Day Free Trial</h4><p class="text-gray-600" data-v-5538648f>Get started with full access for new students</p></div></div><div class="flex items-start space-x-4" data-v-5538648f><div class="flex-shrink-0 w-12 h-12 bg-indigo-600 rounded-xl flex items-center justify-center" data-v-5538648f><svg class="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-v-5538648f><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z" data-v-5538648f></path></svg></div><div data-v-5538648f><h4 class="text-lg font-semibold text-black mb-1" data-v-5538648f>Track Your Progress</h4><p class="text-gray-600" data-v-5538648f>Monitor study progress &amp; maintain streaks</p></div></div><div class="flex items-start space-x-4" data-v-5538648f><div class="flex-shrink-0 w-12 h-12 bg-indigo-600 rounded-xl flex items-center justify-center" data-v-5538648f><svg class="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-v-5538648f><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z" data-v-5538648f></path></svg></div><div data-v-5538648f><h4 class="text-lg font-semibold text-black mb-1" data-v-5538648f>Join Study Groups</h4><p class="text-gray-600" data-v-5538648f>Connect with peers and attend events</p></div></div></div>', 3))
          ])
        ]),
        createBaseVNode("div", _hoisted_4, [
          createBaseVNode("div", _hoisted_5, [
            _cache[43] || (_cache[43] = createStaticVNode('<div class="text-center" data-v-5538648f><div class="inline-flex items-center justify-center w-16 h-16 bg-gradient-to-br from-indigo-600 to-purple-700 rounded-2xl shadow-lg mb-4 transform hover:scale-105 transition-transform" data-v-5538648f><svg class="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-v-5538648f><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M18 9v3m0 0v3m0-3h3m-3 0h-3m-2-5a4 4 0 11-8 0 4 4 0 018 0zM3 20a6 6 0 0112 0v1H3v-1z" data-v-5538648f></path></svg></div><h2 class="text-3xl font-bold text-gray-900 mb-2" data-v-5538648f> Create Account </h2><p class="text-gray-600" data-v-5538648f> Fill in your details to get started </p></div>', 1)),
...
const RegisterForm = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-5538648f"]]);
export {
