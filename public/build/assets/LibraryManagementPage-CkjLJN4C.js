import { d as defineComponent, r as ref, a as computed, o as onMounted, b as createElementBlock, e as createBaseVNode, p as createCommentVNode, g as createVNode, u as unref, s as withDirectives, v as vModelText, H as vModelSelect, n as normalizeClass, R as RefreshCw, F as Fragment, k as renderList, t as toDisplayString, B as withModifiers, i as createBlock, E as vModelCheckbox, a3 as adminAPI, j as createTextVNode, x as normalizeStyle, w as withCtx, h as resolveComponent, m as openBlock, _ as _export_sfc } from "./main-BeUqjoax.js";
...
const _hoisted_39 = { class: "flex items-center space-x-4 mt-1" };
const _hoisted_40 = { class: "w-12 h-12 rounded-lg border border-slate-200 bg-slate-50 overflow-hidden flex items-center justify-center flex-shrink-0" };
const _hoisted_41 = ["src"];
const _hoisted_42 = { class: "flex items-center space-x-4 pt-1" };
const _hoisted_43 = { class: "flex items-center space-x-2 cursor-pointer" };
const _hoisted_44 = { class: "flex items-center space-x-2 cursor-pointer" };
const _hoisted_45 = { class: "pt-4 flex items-center space-x-3" };
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      ...
      return openBlock(), createElementBlock("div", _hoisted_1, [
        createBaseVNode("div", _hoisted_2, [
          createBaseVNode("div", _hoisted_3, [
            createBaseVNode("button", {
              ...
              _cache[10] || (_cache[10] = createBaseVNode("span", null, "Add Library", -1))
            ])
          ])
        ]),
        ...
        loading.value && libraries.value.length === 0 ? (openBlock(), createElementBlock("div", _hoisted_8, [..._cache[12] || (_cache[12] = [
          ...
          _cache[13] || (_cache[13] = createBaseVNode("p", { class: "text-xs font-bold text-slate-455 uppercase tracking-widest" }, "No libraries found matching your criteria.", -1))
              ...
              createBaseVNode("div", _hoisted_15, [
                createBaseVNode("div", _hoisted_16, [
                  ...
                  createBaseVNode("div", _hoisted_23, [
                    createBaseVNode("div", _hoisted_24, [
                      _cache[14] || (_cache[14] = createBaseVNode("span", null, "Occupancy", -1)),
                  ...
                  createBaseVNode("div", _hoisted_26, [
                    createBaseVNode("div", _hoisted_27, [
                      _cache[15] || (_cache[15] = createBaseVNode("span", { class: "text-[9px] text-slate-400 font-bold uppercase tracking-wider" }, "Total Seats", -1)),
                      createBaseVNode("span", _hoisted_28, toDisplayString(library.totalSeats || library.capacity), 1)
                    ]),
                    createBaseVNode("div", _hoisted_29, [
                      _cache[16] || (_cache[16] = createBaseVNode("span", { class: "text-[9px] text-slate-400 font-bold uppercase tracking-wider" }, "Available", -1)),
                ...
                createBaseVNode("div", _hoisted_31, [
                  ...
                  createVNode(_component_router_link, {
                    ...
                    default: withCtx(() => [
                      _cache[17] || (_cache[17] = createBaseVNode("span", null, "Manage Seats", -1)),
        ...
        showModal.value ? (openBlock(), createElementBlock("div", _hoisted_35, [
          createBaseVNode("div", _hoisted_36, [
            ...
            createBaseVNode("form", {
              ...
              createBaseVNode("div", null, [
                _cache[18] || (_cache[18] = createBaseVNode("label", { class: "block text-xs font-bold text-slate-500 mb-1.5 uppercase tracking-wider" }, "Library Name", -1)),
                withDirectives(createBaseVNode("input", {
              ...
              createBaseVNode("div", null, [
                _cache[19] || (_cache[19] = createBaseVNode("label", { class: "block text-xs font-bold text-slate-500 mb-1.5 uppercase tracking-wider" }, "Address", -1)),
                withDirectives(createBaseVNode("input", {
              ...
              createBaseVNode("div", null, [
                _cache[20] || (_cache[20] = createBaseVNode("label", { class: "block text-xs font-bold text-slate-500 mb-1.5 uppercase tracking-wider" }, "Library Cover Photo", -1)),
                createBaseVNode("div", _hoisted_39, [
                  createBaseVNode("div", _hoisted_40, [
                    adminPhotoPreview.value || form.value.photo_url ? (openBlock(), createElementBlock("img", {
                      ...
                      class: "w-full h-full object-cover",
                      alt: "Library preview"
                    }, null, 8, _hoisted_41)) : (openBlock(), createBlock(unref(Building2), {
                      key: 1,
              ...
              createBaseVNode("div", null, [
                _cache[21] || (_cache[21] = createBaseVNode("label", { class: "block text-xs font-bold text-slate-500 mb-1.5 uppercase tracking-wider" }, "Description", -1)),
              ...
              createBaseVNode("div", null, [
                _cache[22] || (_cache[22] = createBaseVNode("label", { class: "block text-xs font-bold text-slate-500 mb-1.5 uppercase tracking-wider" }, "WiFi Password (Optional)", -1)),
                withDirectives(createBaseVNode("input", {
                  "onUpdate:modelValue": _cache[6] || (_cache[6] = ($event) => form.value.wifi_password = $event),
                  type: "text",
                  class: "w-full px-4 py-2 border border-slate-200 rounded-xl focus:ring-2 focus:ring-purple-500/20 focus:border-purple-500 outline-none text-xs font-semibold text-slate-655 bg-white",
              ...
              createBaseVNode("div", _hoisted_42, [
                createBaseVNode("label", _hoisted_43, [
                  withDirectives(createBaseVNode("input", {
                    type: "checkbox",
                    "onUpdate:modelValue": _cache[7] || (_cache[7] = ($event) => form.value.parking_available = $event),
                    id: "parking",
              ...
              createBaseVNode("div", _hoisted_45, [
                ...
                createBaseVNode("button", {
                  ...
                  saving.value ? (openBlock(), createElementBlock("span", _hoisted_47, "Saving...")) : (openBlock(), createElementBlock("span", _hoisted_48, toDisplayString(isEditing.value ? "Update Library" : "Create Library"), 1))
                ], 8, _hoisted_46)
              ])
            ], 32)
          ])
...
const LibraryManagementPage = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-34cac7ab"]]);
export {
