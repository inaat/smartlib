import { c as createLucideIcon, d as defineComponent, r as ref, a as computed, o as onMounted, b as createElementBlock, e as createBaseVNode, g as createVNode, j as createTextVNode, u as unref, n as normalizeClass, R as RefreshCw, t as toDisplayString, i as createBlock, F as Fragment, k as renderList, q as resolveDynamicComponent, a3 as adminAPI, s as withDirectives, v as vModelText, m as openBlock } from "./main-BeUqjoax.js";
...
import { G as Globe } from "./globe-BLQTZYkL.js";
/* empty css               */
...
const _hoisted_14 = { class: "lg:col-span-3" };
const _hoisted_15 = { class: "bg-white rounded-3xl shadow-sm border border-slate-100 overflow-hidden flex flex-col justify-between" };
const _hoisted_16 = { class: "px-8 py-5 border-b border-slate-100 bg-slate-50/50 flex items-center justify-between text-left" };
const _hoisted_17 = { class: "flex items-center space-x-3" };
const _hoisted_18 = { class: "p-2.5 bg-purple-50 border border-purple-100 rounded-xl text-purple-600" };
const _hoisted_19 = { class: "text-sm font-bold text-slate-800 uppercase tracking-wider" };
const _hoisted_20 = { class: "text-xs text-slate-500 mt-0.5 font-normal" };
const _hoisted_21 = { class: "p-8 space-y-6 divide-y divide-slate-100" };
const _hoisted_22 = { class: "md:col-span-1 pr-2" };
const _hoisted_23 = { class: "block text-xs font-bold text-slate-700 mb-1" };
const _hoisted_24 = { class: "text-[11px] text-slate-500 leading-relaxed font-normal" };
const _hoisted_25 = { class: "md:col-span-2" };
const _hoisted_26 = {
  key: 0,
...
const _hoisted_35 = { class: "px-8 py-4 bg-slate-50/50 border-t border-slate-100 flex items-center justify-between" };
          ...
          createBaseVNode("div", _hoisted_11, [
            (openBlock(true), createElementBlock(Fragment, null, renderList(groupKeys.value, (groupKey) => {
              return openBlock(), createElementBlock("button", {
                ...
                createBaseVNode("span", _hoisted_13, toDisplayString(formatGroupName(groupKey)), 1)
              ], 10, _hoisted_12);
            }), 128))
          ]),
              ...
              createBaseVNode("div", _hoisted_16, [
                createBaseVNode("div", _hoisted_17, [
                  ...
                  createBaseVNode("div", null, [
                    createBaseVNode("h3", _hoisted_19, toDisplayString(formatGroupName(activeGroup.value)) + " Settings", 1),
                    createBaseVNode("p", _hoisted_20, "Configure and manage parameters for " + toDisplayString(formatGroupName(activeGroup.value).toLowerCase()) + ".", 1)
                  ])
                ])
              ]),
                ...
                (openBlock(true), createElementBlock(Fragment, null, renderList(settingsGroups.value[activeGroup.value], (setting, index) => {
                  return openBlock(), createElementBlock("div", {
                    ...
                    createBaseVNode("div", _hoisted_22, [
                      createBaseVNode("label", _hoisted_23, toDisplayString(setting.label), 1),
                      createBaseVNode("p", _hoisted_24, toDisplayString(setting.description), 1)
                    ]),
                    createBaseVNode("div", _hoisted_25, [
                      setting.type === "boolean" ? (openBlock(), createElementBlock("div", _hoisted_26, [
                        createBaseVNode("button", {
                          type: "button",
                      ...
                      ])) : setting.type === "number" ? (openBlock(), createElementBlock("div", _hoisted_28, [
                        ...
                        [vModelText, setting.value]
                      ]) : setting.type === "color" ? (openBlock(), createElementBlock("div", _hoisted_31, [
                        withDirectives(createBaseVNode("input", {
                          "onUpdate:modelValue": ($event) => setting.value = $event,
                          type: "color",
