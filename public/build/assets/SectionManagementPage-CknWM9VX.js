import { d as defineComponent, z as useAuth, r as ref, o as onMounted, b as createElementBlock, e as createBaseVNode, p as createCommentVNode, s as withDirectives, g as createVNode, H as vModelSelect, F as Fragment, k as renderList, u as unref, n as normalizeClass, R as RefreshCw, B as withModifiers, t as toDisplayString, j as createTextVNode, v as vModelText, E as vModelCheckbox, i as createBlock, W as librarianAPI, m as openBlock, _ as _export_sfc } from "./main-BeUqjoax.js";
  ...
  `;
      ...
      `;
          seats.forEach((seat) => {
            ...
            const displaySeatName = seat.seat_type === "private_room" ? `CABIN ${seat.cabin_number || seat.seat_number}` : `SEAT ${seat.seat_number}`;
...
const SectionManagementPage = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-d15d4a00"]]);
export {
