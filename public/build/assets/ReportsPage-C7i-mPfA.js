import { d as defineComponent, r as ref, c as computed, y as reactive, o as onMounted, a as createElementBlock, b as createBaseVNode, l as createCommentVNode, f as createVNode, p as withDirectives, D as vModelSelect, F as Fragment, j as renderList, u as unref, i as createTextVNode, t as toDisplayString, z as withModifiers, n as normalizeClass, h as createBlock, w as withCtx, T as Transition, P as librarianAPI, m as resolveDynamicComponent, k as openBlock } from "./main-BV94XoeK.js";
...
const _hoisted_6 = { class: "absolute left-4 top-1/2 -translate-y-1/2 text-purple-600 transition-transform" };
const _hoisted_7 = { class: "absolute right-4 top-1/2 -translate-y-1/2 text-slate-400 pointer-events-none" };
const _hoisted_8 = {
  key: 0,
  class: "bg-purple-50/50 border border-purple-100/80 rounded-3xl p-12 text-center"
};
const _hoisted_9 = { class: "w-16 h-16 bg-white border border-purple-100 rounded-2xl flex items-center justify-center shadow-sm mx-auto mb-6" };
const _hoisted_10 = {
  key: 1,
  class: "animate-in fade-in slide-in-from-bottom-4 duration-500 space-y-8"
};
const _hoisted_11 = { class: "text-sm font-bold text-slate-700 mb-4 flex items-center uppercase tracking-wider" };
const _hoisted_12 = { class: "space-y-3" };
const _hoisted_13 = { class: "flex items-center gap-3" };
const _hoisted_14 = { class: "text-xs font-bold text-slate-700" };
const _hoisted_15 = { class: "flex items-center gap-2 flex-wrap" };
const _hoisted_16 = ["onClick"];
const _hoisted_17 = ["onClick"];
const _hoisted_18 = { class: "text-sm font-bold text-slate-700 mb-4 flex items-center uppercase tracking-wider" };
const _hoisted_19 = { class: "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5" };
const _hoisted_20 = { class: "flex items-center gap-3 mb-3" };
const _hoisted_21 = { class: "font-bold text-slate-750 text-sm" };
const _hoisted_22 = { class: "text-xs text-slate-500 mb-5 space-y-1 pl-1 font-medium leading-relaxed" };
const _hoisted_23 = { class: "flex items-center gap-2 flex-wrap pt-2" };
const _hoisted_24 = ["onClick"];
const _hoisted_25 = ["onClick"];
const _hoisted_26 = { class: "bg-white rounded-2xl border border-slate-100 shadow-sm overflow-hidden" };
const _hoisted_27 = { class: "px-6 py-5 border-b border-slate-50 flex items-center justify-between text-left" };
const _hoisted_28 = { class: "text-sm font-bold text-slate-700 flex items-center uppercase tracking-wider" };
const _hoisted_29 = { class: "p-6" };
const _hoisted_30 = {
  key: 0,
...
const _hoisted_32 = { class: "min-w-full divide-y divide-slate-100" };
const _hoisted_33 = { class: "divide-y divide-slate-50 bg-white" };
const _hoisted_34 = { class: "py-4 px-4 whitespace-nowrap text-left font-bold text-slate-700 text-xs" };
const _hoisted_35 = { class: "py-4 px-4 whitespace-nowrap text-left" };
const _hoisted_36 = { class: "py-4 px-4 whitespace-nowrap text-left text-xs text-slate-500 font-medium" };
const _hoisted_37 = { class: "py-4 px-4 whitespace-nowrap text-right" };
const _hoisted_38 = ["onClick"];
const _hoisted_39 = { class: "bg-white rounded-3xl p-6 max-w-sm w-full shadow-xl border border-slate-100 text-left flex flex-col animate-in fade-in zoom-in duration-200" };
const _hoisted_40 = { class: "flex items-center justify-between mb-5" };
const _hoisted_41 = { class: "text-xs text-slate-500 mt-1 font-semibold" };
const _hoisted_42 = { class: "mb-5" };
const _hoisted_43 = { class: "grid grid-cols-3 gap-2" };
const _hoisted_44 = ["onClick"];
const _hoisted_45 = { class: "text-xs font-bold" };
const _hoisted_46 = { class: "flex gap-3 pt-2" };
const _hoisted_47 = {
  key: 0,
  class: "fixed bottom-6 right-6 z-50 bg-white rounded-2xl shadow-xl border border-slate-100 p-4 flex items-center gap-3.5 min-w-[320px]"
};
const _hoisted_48 = {
  key: 0,
...
const _hoisted_51 = { class: "font-bold text-slate-800 text-xs" };
const _hoisted_52 = { class: "text-[10px] text-slate-450 mt-0.5 font-bold uppercase tracking-wider" };
      ...
      return openBlock(), createElementBlock("div", _hoisted_1, [
        createBaseVNode("div", _hoisted_2, [
          createBaseVNode("div", _hoisted_3, [
            _cache[6] || (_cache[6] = createBaseVNode("label", { class: "text-[10px] font-bold text-slate-400 uppercase tracking-widest mb-1.5 block ml-1" }, "Active Library", -1)),
        ...
        !selectedLibraryId.value ? (openBlock(), createElementBlock("div", _hoisted_8, [
          createBaseVNode("div", _hoisted_9, [
            createVNode(unref(MousePointer2), { class: "w-8 h-8 text-purple-600 animate-bounce" })
          ]),
          _cache[7] || (_cache[7] = createBaseVNode("h3", { class: "text-base font-bold text-slate-800 mb-2" }, "Select a library to begin", -1)),
          _cache[8] || (_cache[8] = createBaseVNode("p", { class: "text-slate-550 max-w-sm mx-auto text-xs font-medium" }, "Please choose a library from the dropdown above to access its specific reporting tools and data.", -1))
        ])) : (openBlock(), createElementBlock("div", _hoisted_10, [
          createBaseVNode("div", null, [
            createBaseVNode("h2", _hoisted_11, [
              createVNode(unref(Zap), { class: "w-4.5 h-4.5 mr-2 text-amber-500" }),
              ...
              (openBlock(), createElementBlock(Fragment, null, renderList(quickSummaries, (summary) => {
                return createBaseVNode("div", {
                  ...
                  createBaseVNode("div", _hoisted_13, [
                    createBaseVNode("div", {
                      class: normalizeClass(["w-10 h-10 rounded-xl flex items-center justify-center bg-slate-50", summary.bgColor])
                    }, [
                      (openBlock(), createBlock(resolveDynamicComponent(summary.icon), {
                        class: normalizeClass(["w-5 h-5", summary.iconColor])
                      }, null, 8, ["class"]))
                    ], 2),
                    createBaseVNode("span", _hoisted_14, toDisplayString(summary.label), 1)
                  ]),
                  createBaseVNode("div", _hoisted_15, [
                    createBaseVNode("button", {
                      ...
                      _cache[9] || (_cache[9] = createTextVNode(" Export PDF ", -1))
                    ], 8, _hoisted_16),
                    createBaseVNode("button", {
                      ...
                      _cache[10] || (_cache[10] = createTextVNode(" Export Excel ", -1))
                    ], 8, _hoisted_17)
                  ])
                ]);
              }), 64))
          ...
          createBaseVNode("div", null, [
            createBaseVNode("h2", _hoisted_18, [
              createVNode(unref(LayoutGrid), { class: "w-4.5 h-4.5 mr-2 text-purple-600" }),
              _cache[11] || (_cache[11] = createTextVNode(" Report Categories ", -1))
            ]),
                ...
                return createBaseVNode("div", {
                  ...
                  createBaseVNode("div", null, [
                    createBaseVNode("div", _hoisted_20, [
                      createBaseVNode("div", {
                        class: normalizeClass(["w-10 h-10 rounded-xl flex items-center justify-center bg-slate-50", cat.bgColor])
                      }, [
                        (openBlock(), createBlock(resolveDynamicComponent(cat.icon), {
                          class: normalizeClass(["w-5 h-5", cat.iconColor])
                        }, null, 8, ["class"]))
                      ], 2),
                      createBaseVNode("h3", _hoisted_21, toDisplayString(cat.label), 1)
                    ]),
                    createBaseVNode("ul", _hoisted_22, [
                      (openBlock(true), createElementBlock(Fragment, null, renderList(cat.descriptions, (desc) => {
                        return openBlock(), createElementBlock("li", {
                          ...
                          _cache[12] || (_cache[12] = createBaseVNode("span", { class: "mr-1.5 text-slate-300" }, "•", -1)),
                  ...
                  createBaseVNode("div", _hoisted_23, [
                    createBaseVNode("button", {
                      ...
                      _cache[13] || (_cache[13] = createTextVNode(" PDF ", -1))
                    ], 8, _hoisted_24),
                    createBaseVNode("button", {
                      ...
                      _cache[14] || (_cache[14] = createTextVNode(" Excel ", -1))
                    ], 8, _hoisted_25)
                  ])
                ]);
              }), 64))
          ...
          createBaseVNode("div", _hoisted_26, [
            ...
            createBaseVNode("div", _hoisted_29, [
              libraryReportHistory.value.length === 0 ? (openBlock(), createElementBlock("div", _hoisted_30, [
                createVNode(unref(History), { class: "w-10 h-10 text-slate-200 mx-auto mb-3 animate-pulse" }),
                _cache[15] || (_cache[15] = createBaseVNode("p", { class: "text-slate-400 text-xs font-bold uppercase tracking-wider" }, "No reports generated for this library yet.", -1))
              ])) : (openBlock(), createElementBlock("div", _hoisted_31, [
                createBaseVNode("table", _hoisted_32, [
                  _cache[17] || (_cache[17] = createBaseVNode("thead", { class: "bg-slate-50/20" }, [
                    createBaseVNode("tr", null, [
                      createBaseVNode("th", {
                        scope: "col",
                        class: "px-4 py-3.5 text-left text-xs font-semibold text-slate-400 uppercase tracking-widest"
                      }, "Report"),
                      createBaseVNode("th", {
                        scope: "col",
                        class: "px-4 py-3.5 text-left text-xs font-semibold text-slate-400 uppercase tracking-widest"
                      ...
                      createBaseVNode("th", {
                        scope: "col",
                        class: "px-4 py-3.5 text-right text-xs font-semibold text-slate-400 uppercase tracking-widest"
                      }, "Action")
                    ])
                  ], -1)),
                  createBaseVNode("tbody", _hoisted_33, [
                    (openBlock(true), createElementBlock(Fragment, null, renderList(libraryReportHistory.value, (h, idx) => {
                      return openBlock(), createElementBlock("tr", {
                        ...
                        createBaseVNode("td", _hoisted_34, toDisplayString(h.name), 1),
                        createBaseVNode("td", _hoisted_35, [
                          createBaseVNode("span", {
                            class: normalizeClass(["px-2 py-0.5 rounded text-[9px] font-bold uppercase border", h.format === "pdf" ? "bg-red-50 border-red-100 text-red-655" : "bg-green-50 border-green-100 text-green-700"])
                          }, toDisplayString(h.format), 3)
                        ]),
                        createBaseVNode("td", _hoisted_36, toDisplayString(h.generatedAt), 1),
                        createBaseVNode("td", _hoisted_37, [
                          createBaseVNode("button", {
                            ...
                            _cache[16] || (_cache[16] = createTextVNode(" Download ", -1))
                          ], 8, _hoisted_38)
                        ])
                      ]);
                    }), 128))
        ...
        exportModal.show ? (openBlock(), createElementBlock("div", {
          ...
          createBaseVNode("div", _hoisted_39, [
            createBaseVNode("div", _hoisted_40, [
              createBaseVNode("div", null, [
                _cache[18] || (_cache[18] = createBaseVNode("h3", { class: "text-base font-bold text-slate-800" }, "Export Report", -1)),
                createBaseVNode("p", _hoisted_41, toDisplayString(exportModal.reportName), 1)
              ]),
              createBaseVNode("button", {
                onClick: _cache[1] || (_cache[1] = ($event) => exportModal.show = false),
                class: "p-2 rounded-xl hover:bg-slate-50 text-slate-450 transition-colors cursor-pointer"
              }, [
                createVNode(unref(X), { class: "w-4.5 h-4.5" })
              ])
            ]),
            createBaseVNode("div", _hoisted_42, [
              _cache[19] || (_cache[19] = createBaseVNode("label", { class: "block text-xs font-bold text-slate-500 mb-2 uppercase tracking-wider" }, "Time Period", -1)),
                ...
                (openBlock(), createElementBlock(Fragment, null, renderList(timespanOptions, (ts) => {
                  return createBaseVNode("button", {
                    ...
                    class: normalizeClass([
                      ...
                      exportModal.timespan === ts.value ? "bg-purple-600 text-white border-purple-600 shadow-sm" : "bg-slate-50 text-slate-655 border-slate-200 hover:border-purple-250 hover:bg-purple-50"
                    ])
                  }, toDisplayString(ts.label), 11, _hoisted_44);
                }), 64))
              ])
            ]),
            createBaseVNode("div", {
              class: normalizeClass(["mb-5 p-4 rounded-xl border flex items-center gap-2.5", exportModal.format === "pdf" ? "bg-red-50 border-red-100 text-red-700" : "bg-green-50 border-green-100 text-green-700"])
            }, [
              ...
              createBaseVNode("span", _hoisted_45, toDisplayString(exportModal.format === "pdf" ? "PDF Document" : "Excel Spreadsheet"), 1)
            ], 2),
            createBaseVNode("div", _hoisted_46, [
              createBaseVNode("button", {
                onClick: _cache[2] || (_cache[2] = ($event) => exportModal.show = false),
                class: "flex-1 py-2.5 rounded-xl font-bold text-slate-550 bg-slate-100 hover:bg-slate-150 transition-all text-xs cursor-pointer border border-transparent"
              }, "Cancel"),
              createBaseVNode("button", {
                onClick: confirmExport,
                class: "flex-1 py-2.5 rounded-xl font-bold text-white bg-purple-600 hover:bg-purple-750 transition-all text-xs cursor-pointer shadow-sm border border-transparent"
              }, "Generate")
            ])
          ])
        ...
        createVNode(Transition, { name: "slide-up" }, {
          default: withCtx(() => [
            exportToast.show ? (openBlock(), createElementBlock("div", _hoisted_47, [
              exportToast.status === "loading" ? (openBlock(), createElementBlock("div", _hoisted_48, [
                createVNode(unref(RefreshCw), { class: "w-5 h-5 text-purple-650 animate-spin" })
              ...
              createBaseVNode("button", {
                ...
                class: "ml-auto p-1 rounded-lg hover:bg-slate-50 text-slate-400 cursor-pointer"
              }, [
...
const ReportsPage = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-d42d69f0"]]);
export {
