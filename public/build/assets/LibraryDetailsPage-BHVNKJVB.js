import { d as defineComponent, z as useAuth, r as ref, a as computed, o as onMounted, b as createElementBlock, e as createBaseVNode, g as createVNode, w as withCtx, h as resolveComponent, u as unref, t as toDisplayString, j as createTextVNode, p as createCommentVNode, C as Clock, n as normalizeClass, F as Fragment, k as renderList, s as withDirectives, v as vModelText, i as createBlock, R as RefreshCw, x as normalizeStyle, J as useRoute, S as studentAPI, q as resolveDynamicComponent, m as openBlock, _ as _export_sfc } from "./main-BeUqjoax.js";
...
import { C as Coffee, W as Wind } from "./wind-C6OxODCy.js";
...
const _hoisted_46 = {
  key: 2,
  class: "flex flex-col sm:flex-row sm:items-center justify-between gap-3 pt-2 pb-1 text-left"
};
const _hoisted_47 = { class: "text-xs font-bold text-slate-700 uppercase tracking-wider" };
const _hoisted_48 = { class: "flex items-center space-x-1 p-0.5 bg-slate-100/80 rounded-xl text-[11px] font-semibold w-fit" };
...
const _hoisted_53 = { class: "w-9 h-9 flex-shrink-0" };
const _hoisted_54 = ["src", "onError"];
const _hoisted_55 = { class: "flex-1 min-w-0" };
const _hoisted_56 = { class: "flex items-center justify-between mb-1.5" };
const _hoisted_57 = { class: "font-semibold text-slate-800 text-xs leading-none truncate pr-3" };
const _hoisted_58 = { class: "text-[10px] text-slate-400 font-semibold flex-shrink-0" };
const _hoisted_59 = { class: "flex items-center mb-1.5 leading-none" };
const _hoisted_60 = { class: "text-xs text-slate-500 leading-relaxed" };
const _hoisted_61 = {
  key: 0,
...
const _hoisted_63 = { class: "space-y-6" };
const _hoisted_64 = { class: "bg-white rounded-2xl p-6 shadow-sm border border-slate-100 text-left" };
const _hoisted_65 = { class: "space-y-3" };
const _hoisted_66 = {
  key: 0,
...
const _hoisted_68 = { class: "bg-white rounded-2xl p-6 shadow-sm border border-slate-200 sticky top-24 text-left" };
const _hoisted_69 = { class: "space-y-2 mb-6" };
const _hoisted_70 = { class: "flex justify-between text-xs font-medium leading-none" };
const _hoisted_71 = { class: "text-green-600" };
const _hoisted_72 = { class: "w-full bg-slate-100 rounded-full h-1.5 overflow-hidden" };
const _hoisted_73 = { class: "mt-5 pt-5 border-t border-slate-100 space-y-3.5" };
const _hoisted_74 = { class: "flex items-center text-xs text-slate-600 font-semibold leading-none" };
const _hoisted_75 = { class: "flex items-center text-xs text-slate-600 font-semibold leading-none" };
const _hoisted_76 = { class: "truncate" };
const _hoisted_77 = {
  key: 0,
...
const _hoisted_78 = { class: "flex flex-col text-left" };
const _hoisted_79 = { class: "font-mono text-xs font-bold text-emerald-900 mt-1 select-all" };
const _hoisted_80 = {
  key: 2,
          ...
          createBaseVNode("div", _hoisted_11, [
            ...
            createBaseVNode("section", _hoisted_33, [
              ...
              createBaseVNode("div", _hoisted_49, [
                    ...
                    return openBlock(), createElementBlock("div", {
                      ...
                      createBaseVNode("div", _hoisted_52, [
                        createBaseVNode("div", _hoisted_53, [
                          review.user?.profile_picture && !imageLoadErrors.value[review.id] ? (openBlock(), createElementBlock("img", {
                            key: 0,
                            src: getProfilePictureUrl(review.user.profile_picture),
                            onError: ($event) => onAvatarError(review.id),
                            class: "w-9 h-9 rounded-full object-cover border border-slate-100 shadow-2xs"
                          }, null, 40, _hoisted_54)) : (openBlock(), createElementBlock("div", {
                            key: 1,
                            class: normalizeClass([
                          ...
                          }, toDisplayString(getInitials(review.user?.name)), 3))
                        ]),
                        createBaseVNode("div", _hoisted_55, [
                          createBaseVNode("div", _hoisted_56, [
                            createBaseVNode("h4", _hoisted_57, toDisplayString(review.user.name), 1),
                            createBaseVNode("span", _hoisted_58, toDisplayString(formatDateRelative(review.created_at)), 1)
                          ]),
                          ...
                          createBaseVNode("p", _hoisted_60, toDisplayString(review.comment), 1)
                        ])
                      ])
                    ]);
                  }), 128)),
                  hasMoreOtherReviews.value ? (openBlock(), createElementBlock("div", _hoisted_61, [
                    createBaseVNode("button", {
                ...
                ])) : !userReview.value ? (openBlock(), createElementBlock("div", _hoisted_62, [
              ...
              createBaseVNode("div", _hoisted_65, [
                (openBlock(true), createElementBlock(Fragment, null, renderList(library.value.operating_days, (day) => {
                  return openBlock(), createElementBlock("div", {
                    ...
                    day.isOpen ? (openBlock(), createElementBlock("span", _hoisted_66, toDisplayString(formatTime12(day.openTime)) + " - " + toDisplayString(formatTime12(day.closeTime)), 1)) : (openBlock(), createElementBlock("span", _hoisted_67, "Closed"))
                  ], 2);
                }), 128))
              ])
            ]),
            createBaseVNode("div", _hoisted_68, [
              _cache[24] || (_cache[24] = createBaseVNode("h3", { class: "text-base font-semibold text-slate-800 mb-1.5" }, "Reserve a Seat", -1)),
              _cache[25] || (_cache[25] = createBaseVNode("p", { class: "text-slate-500 text-xs mb-5 leading-relaxed font-semibold" }, "Book your preferred spot in advance to ensure a productive study session.", -1)),
              createBaseVNode("div", _hoisted_69, [
                createBaseVNode("div", _hoisted_70, [
                  _cache[21] || (_cache[21] = createBaseVNode("span", { class: "text-slate-400 uppercase tracking-wide" }, "Available Seats", -1)),
                  createBaseVNode("span", _hoisted_71, toDisplayString(library.value.availableSeats || 0) + " / " + toDisplayString(libraryCapacity.value), 1)
                ]),
              ...
              createBaseVNode("div", _hoisted_73, [
                ...
                createBaseVNode("div", _hoisted_75, [
                  ...
                  createBaseVNode("span", _hoisted_76, toDisplayString(library.value.contact_info?.email || "Not available"), 1)
                ]),
                library.value.wifi_password ? (openBlock(), createElementBlock("div", _hoisted_77, [
                  createVNode(unref(Wifi), { class: "w-4.5 h-4.5 mr-2.5 text-emerald-600 flex-shrink-0" }),
                  createBaseVNode("div", _hoisted_78, [
                    _cache[23] || (_cache[23] = createBaseVNode("span", { class: "text-[9px] uppercase tracking-wider text-emerald-600/80 font-bold" }, "WiFi Password", -1)),
                    createBaseVNode("span", _hoisted_79, toDisplayString(library.value.wifi_password), 1)
                  ])
                ])) : createCommentVNode("", true)
              ])
            ])
...
const LibraryDetailsPage = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-1422e358"]]);
export {
