import { d as defineComponent, r as ref, E as watch, o as onMounted, a as createElementBlock, b as createBaseVNode, f as createVNode, l as createCommentVNode, u as unref, F as Fragment, j as renderList, t as toDisplayString, z as withModifiers, p as withDirectives, v as vModelText, D as vModelSelect, B as vModelCheckbox, n as normalizeClass, i as createTextVNode, k as openBlock } from "./main-BV94XoeK.js";
import { s as superadminAPI } from "./superadminApi-C5-ZGb9_.js";
import { _ as _sfc_main$1 } from "./LibrarySelector.vue_vue_type_script_setup_true_lang-CcaCAMaA.js";
...
const _hoisted_7 = { class: "h-40 bg-slate-50 relative overflow-hidden" };
...
const _hoisted_10 = { class: "absolute top-3 right-3" };
const _hoisted_11 = { class: "p-5 flex-1 flex flex-col justify-between text-left" };
const _hoisted_12 = { class: "space-y-3" };
const _hoisted_13 = { class: "flex items-center justify-between text-[10px] font-bold text-slate-400 uppercase tracking-widest" };
const _hoisted_14 = { class: "text-purple-750 font-extrabold" };
const _hoisted_15 = { class: "flex items-center font-bold" };
const _hoisted_16 = { class: "text-sm font-bold text-slate-700 group-hover:text-purple-700 transition-colors" };
const _hoisted_17 = { class: "text-xs text-slate-500 line-clamp-2 leading-relaxed" };
const _hoisted_18 = { class: "space-y-2 pt-2" };
const _hoisted_19 = { class: "flex items-center text-xs font-semibold text-slate-550" };
const _hoisted_20 = { class: "flex items-center text-xs font-semibold text-slate-550" };
const _hoisted_21 = { class: "flex items-center text-xs font-semibold text-slate-550" };
const _hoisted_22 = {
  key: 0,
  class: "flex items-center text-xs font-bold text-slate-655 mt-1"
};
const _hoisted_23 = { class: "ml-2 text-slate-700 font-extrabold" };
const _hoisted_24 = { class: "flex items-center justify-end space-x-2 pt-4 mt-4 border-t border-slate-100" };
...
const _hoisted_28 = { class: "bg-white rounded-3xl shadow-xl w-full max-w-md overflow-hidden animate-in fade-in zoom-in duration-200 border border-slate-100 flex flex-col" };
const _hoisted_29 = { class: "p-6 border-b border-slate-100 flex items-center justify-between text-left" };
const _hoisted_30 = { class: "text-lg font-bold text-slate-800" };
const _hoisted_31 = ["value"];
const _hoisted_32 = { class: "grid grid-cols-2 gap-4" };
const _hoisted_33 = { class: "grid grid-cols-3 gap-2" };
const _hoisted_34 = { class: "col-span-1" };
const _hoisted_35 = { class: "grid grid-cols-2 gap-4" };
const _hoisted_36 = { class: "flex items-center space-x-4 pt-6 justify-center" };
const _hoisted_37 = { class: "flex items-center space-x-2 cursor-pointer" };
const _hoisted_38 = { class: "flex items-center space-x-2 cursor-pointer" };
const _hoisted_39 = { key: 0 };
const _hoisted_40 = { class: "pt-4 flex items-center space-x-3 border-t border-slate-100" };
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", _hoisted_1, [
        ...
        loading.value && events.value.length === 0 ? (openBlock(), createElementBlock("div", _hoisted_4, [..._cache[14] || (_cache[14] = [
          ...
          createVNode(unref(Calendar), { class: "w-12 h-12 text-slate-300 mx-auto mb-4 animate-pulse" }),
          _cache[15] || (_cache[15] = createBaseVNode("p", { class: "text-xs font-bold text-slate-455 uppercase tracking-widest" }, "No events found. Create your first event to get started.", -1))
              ...
              createBaseVNode("div", _hoisted_11, [
                createBaseVNode("div", _hoisted_12, [
                  createBaseVNode("div", _hoisted_13, [
                    createBaseVNode("span", _hoisted_14, toDisplayString(event.type || "General"), 1),
                  ...
                  createBaseVNode("h3", _hoisted_16, toDisplayString(event.title), 1),
                  createBaseVNode("p", _hoisted_17, toDisplayString(event.description || "No description provided."), 1),
                  createBaseVNode("div", _hoisted_18, [
                    ...
                    event.is_paid ? (openBlock(), createElementBlock("div", _hoisted_22, [
                      _cache[16] || (_cache[16] = createBaseVNode("span", { class: "px-2 py-0.5 rounded bg-purple-50 border border-purple-100 text-purple-700 text-[10px] font-extrabold uppercase" }, "Paid", -1)),
                      createBaseVNode("span", _hoisted_23, "Rs. " + toDisplayString(event.price), 1)
        ...
        showModal.value ? (openBlock(), createElementBlock("div", _hoisted_27, [
          createBaseVNode("div", _hoisted_28, [
            createBaseVNode("div", _hoisted_29, [
              createBaseVNode("h2", _hoisted_30, toDisplayString(isEditing.value ? "Edit Event" : "Create New Event"), 1),
              createBaseVNode("button", {
                onClick: closeModal,
            ...
            createBaseVNode("form", {
              ...
              createBaseVNode("div", null, [
                _cache[17] || (_cache[17] = createBaseVNode("label", { class: "block text-xs font-bold text-slate-500 mb-1.5 uppercase tracking-wider" }, "Event Title", -1)),
                ...
                withDirectives(createBaseVNode("select", {
                  ...
                  (openBlock(true), createElementBlock(Fragment, null, renderList(libraries.value, (lib) => {
                    return openBlock(), createElementBlock("option", {
                      key: lib.id,
                      value: lib.id
                    }, toDisplayString(lib.name), 9, _hoisted_31);
                  }), 128))
                ], 512), [
              ...
              form.value.is_paid ? (openBlock(), createElementBlock("div", _hoisted_39, [
...
const EventsPage = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-7fb3a34c"]]);
export {
