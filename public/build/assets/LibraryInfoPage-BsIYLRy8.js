...
import { W as Wifi } from "./wifi-DXAy1TD1.js";
import { N as Navigation } from "./navigation-Dz8kdbq1.js";
import { c as createLucideIcon } from "./createLucideIcon-BgnXjtcZ.js";
import { P as PanelsTopLeft } from "./panels-top-left-Da8DkFNO.js";
import { G as Grid3x3 } from "./grid-3x3-C2g9m4Zl.js";
...
import { I as Info } from "./info-_w0egxA6.js";
...
import { C as Coffee, W as Wind } from "./wind-Cs0HDwiF.js";
...
import { L as Lock } from "./lock-Bxz9r02U.js";
import { C as Camera } from "./camera-CSdkdqlB.js";
...
const _hoisted_71 = { class: "flex flex-col sm:flex-row items-center justify-between gap-4" };
const _hoisted_72 = { class: "relative flex-1 w-full" };
const _hoisted_73 = { class: "flex items-center space-x-3 w-full sm:w-auto" };
...
const _hoisted_78 = { class: "flex items-start justify-between" };
const _hoisted_79 = { class: "flex items-center space-x-3.5" };
const _hoisted_80 = { class: "w-10 h-10 rounded-full overflow-hidden bg-emerald-50 border border-emerald-100 flex items-center justify-center text-emerald-700 font-bold text-sm flex-shrink-0" };
const _hoisted_81 = ["src"];
const _hoisted_82 = { key: 1 };
const _hoisted_83 = { class: "text-sm font-bold text-slate-800 leading-snug" };
const _hoisted_84 = { class: "flex items-center space-x-2 text-[10px] font-semibold text-slate-400 mt-0.5" };
const _hoisted_85 = {
  key: 0,
  class: "uppercase"
};
const _hoisted_86 = { key: 1 };
const _hoisted_87 = { class: "text-right" };
const _hoisted_88 = { class: "flex items-center space-x-0.5 justify-end" };
const _hoisted_89 = { class: "text-[10px] font-medium text-slate-400 mt-1 block" };
const _hoisted_90 = { class: "text-xs text-slate-600 font-normal leading-relaxed pl-1" };
const _hoisted_91 = {
  key: 2,
  class: "fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-md"
};
const _hoisted_92 = { class: "bg-white rounded-3xl shadow-2xl w-full max-w-2xl overflow-hidden border border-slate-100 flex flex-col max-h-[90vh] md:max-h-[85vh] text-left" };
const _hoisted_93 = { class: "px-6 py-4 bg-gradient-to-r from-emerald-700 to-teal-800 text-white flex items-center justify-between" };
const _hoisted_94 = { class: "flex items-center space-x-2" };
const _hoisted_95 = { class: "p-6 space-y-4 flex-grow flex flex-col min-h-0" };
const _hoisted_96 = { class: "relative" };
const _hoisted_97 = { class: "flex items-center gap-2" };
const _hoisted_98 = { class: "relative flex-1" };
const _hoisted_99 = ["onKeydown"];
...
const _hoisted_102 = ["onMousedown"];
const _hoisted_103 = { class: "min-w-0 flex-1" };
const _hoisted_104 = { class: "text-xs font-bold text-slate-800 truncate" };
const _hoisted_105 = { class: "text-[10px] text-slate-400 font-medium truncate mt-0.5" };
const _hoisted_106 = {
  key: 1,
...
const _hoisted_107 = { class: "p-4 bg-slate-50 border border-slate-100 rounded-2xl flex flex-wrap items-center justify-between gap-4 text-xs font-semibold text-slate-700 font-outfit" };
const _hoisted_108 = { class: "flex space-x-6" };
const _hoisted_109 = { class: "font-mono text-sm" };
const _hoisted_110 = { class: "font-mono text-sm" };
const _hoisted_111 = { class: "px-6 py-4 bg-slate-50 border-t border-slate-100 flex items-center justify-end space-x-3" };
    ...
    return (_ctx, _cache) => {
      ...
      return openBlock(), createElementBlock("div", _hoisted_1, [
        loading.value ? (openBlock(), createElementBlock("div", _hoisted_2, [
          ...
          _cache[21] || (_cache[21] = createBaseVNode("p", { class: "text-slate-400 font-semibold uppercase tracking-wider text-xs animate-pulse" }, "Loading library info...", -1))
        ])) : (openBlock(), createElementBlock(Fragment, { key: 1 }, [
          createBaseVNode("div", _hoisted_3, [
            _cache[25] || (_cache[25] = createBaseVNode("div", { class: "absolute top-0 right-0 w-64 h-64 bg-white/5 rounded-full -translate-y-1/2 translate-x-1/3" }, null, -1)),
            _cache[26] || (_cache[26] = createBaseVNode("div", { class: "absolute bottom-0 left-16 w-40 h-40 bg-white/5 rounded-full translate-y-1/2" }, null, -1)),
            _cache[27] || (_cache[27] = createBaseVNode("div", { class: "absolute top-8 right-32 w-20 h-20 bg-white/5 rounded-full" }, null, -1)),
            ...
            createBaseVNode("div", _hoisted_12, [
              createBaseVNode("div", _hoisted_13, [
                _cache[22] || (_cache[22] = createBaseVNode("p", { class: "text-white/60 text-[10px] font-semibold uppercase tracking-wider" }, "Total Capacity", -1)),
                createBaseVNode("p", _hoisted_14, toDisplayString(libraryData.value.total_seats || 0), 1)
              ]),
              createBaseVNode("div", _hoisted_15, [
                _cache[23] || (_cache[23] = createBaseVNode("p", { class: "text-white/60 text-[10px] font-semibold uppercase tracking-wider" }, "Current Occupancy", -1)),
                createBaseVNode("p", _hoisted_16, toDisplayString(libraryData.value.current_occupancy || 0), 1)
              ]),
              createBaseVNode("div", _hoisted_17, [
                _cache[24] || (_cache[24] = createBaseVNode("p", { class: "text-white/60 text-[10px] font-semibold uppercase tracking-wider" }, "Occupancy Rate", -1)),
          ...
          createBaseVNode("div", _hoisted_23, [
            activeTab.value === "basic" ? (openBlock(), createElementBlock("div", _hoisted_24, [
              createBaseVNode("div", _hoisted_25, [
                createBaseVNode("div", null, [
                  _cache[28] || (_cache[28] = createBaseVNode("label", { class: "block text-[10px] font-semibold text-slate-400 mb-1.5 uppercase tracking-wider" }, "Library Name", -1)),
                ...
                createBaseVNode("div", null, [
                  _cache[29] || (_cache[29] = createBaseVNode("label", { class: "block text-[10px] font-semibold text-slate-400 mb-1.5 uppercase tracking-wider" }, "Library Photo", -1)),
                ...
                createBaseVNode("div", null, [
                  _cache[30] || (_cache[30] = createBaseVNode("label", { class: "block text-[10px] font-semibold text-slate-400 mb-1.5 uppercase tracking-wider" }, "Contact Number", -1)),
                  withDirectives(createBaseVNode("input", {
                ...
                createBaseVNode("div", null, [
                  _cache[31] || (_cache[31] = createBaseVNode("label", { class: "block text-[10px] font-semibold text-slate-400 mb-1.5 uppercase tracking-wider" }, "Email", -1)),
                  withDirectives(createBaseVNode("input", {
                ...
                createBaseVNode("div", _hoisted_29, [
                  _cache[32] || (_cache[32] = createBaseVNode("label", { class: "block text-[10px] font-semibold text-slate-400 mb-1.5 uppercase tracking-wider" }, "Address", -1)),
                ...
                createBaseVNode("div", null, [
                  _cache[33] || (_cache[33] = createBaseVNode("label", { class: "block text-[10px] font-semibold text-slate-400 mb-1.5 uppercase tracking-wider" }, "Website", -1)),
                  withDirectives(createBaseVNode("input", {
                ...
                createBaseVNode("div", null, [
                  _cache[34] || (_cache[34] = createBaseVNode("label", { class: "block text-[10px] font-semibold text-slate-400 mb-1.5 uppercase tracking-wider flex items-center justify-between" }, [
                ...
                createBaseVNode("div", _hoisted_31, [
                  createBaseVNode("div", _hoisted_32, [
                    _cache[35] || (_cache[35] = createBaseVNode("label", { class: "block text-[10px] font-semibold text-slate-400 mb-1.5 uppercase tracking-wider" }, "Latitude", -1)),
                    withDirectives(createBaseVNode("input", {
                  ...
                  createBaseVNode("div", _hoisted_33, [
                    _cache[36] || (_cache[36] = createBaseVNode("label", { class: "block text-[10px] font-semibold text-slate-400 mb-1.5 uppercase tracking-wider" }, "Longitude", -1)),
                    withDirectives(createBaseVNode("input", {
                  ...
                  createBaseVNode("div", _hoisted_34, [
                    createBaseVNode("button", {
                      ...
                      _cache[37] || (_cache[37] = createBaseVNode("span", null, "Auto-detect", -1))
                    ]),
                    createBaseVNode("button", {
                      type: "button",
                      ...
                      _cache[38] || (_cache[38] = createBaseVNode("span", null, "Select on Map", -1))
                    ])
                  ])
                ])
              ])
                ...
                return openBlock(), createElementBlock("div", {
                  ...
                  createBaseVNode("div", _hoisted_36, [
                    createBaseVNode("label", _hoisted_37, [
                      ...
                      _cache[39] || (_cache[39] = createBaseVNode("div", { class: "w-9 h-5 bg-gray-200 peer-focus:outline-none peer-focus:ring-2 peer-focus:ring-emerald-300 rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-4 after:w-4 after:transition-all peer-checked:bg-emerald-600" }, null, -1))
                    ]),
                  ...
                  day.isOpen ? (openBlock(), createElementBlock("div", _hoisted_40, [
                    ...
                    _cache[40] || (_cache[40] = createBaseVNode("span", { class: "text-slate-300 font-medium text-xs" }, "→", -1)),
                    withDirectives(createBaseVNode("input", {
            ...
            activeTab.value === "facilities" ? (openBlock(), createElementBlock("div", _hoisted_44, [
              ...
              createBaseVNode("div", null, [
                _cache[41] || (_cache[41] = createBaseVNode("label", { class: "block text-[10px] font-semibold text-slate-400 mb-1.5 uppercase tracking-wider" }, "Additional Features", -1)),
                withDirectives(createBaseVNode("textarea", {
            ...
            activeTab.value === "rules" ? (openBlock(), createElementBlock("div", _hoisted_48, [
              createBaseVNode("div", null, [
                _cache[42] || (_cache[42] = createBaseVNode("label", { class: "block text-[10px] font-semibold text-slate-400 mb-1.5 uppercase tracking-wider" }, "Library Rules (One per line)", -1)),
                withDirectives(createBaseVNode("textarea", {
              ...
              createBaseVNode("div", null, [
                _cache[43] || (_cache[43] = createBaseVNode("label", { class: "block text-[10px] font-semibold text-slate-400 mb-1.5 uppercase tracking-wider" }, "Cancellation Policy", -1)),
                withDirectives(createBaseVNode("textarea", {
            ...
            activeTab.value === "settings" ? (openBlock(), createElementBlock("div", _hoisted_49, [
              (openBlock(), createElementBlock(Fragment, null, renderList(settingsConfig, (setting) => {
                return createBaseVNode("div", {
                  ...
                  createBaseVNode("label", _hoisted_52, [
                    ...
                    _cache[44] || (_cache[44] = createBaseVNode("div", { class: "w-11 h-6 bg-gray-200 peer-focus:outline-none peer-focus:ring-2 peer-focus:ring-emerald-300 rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-emerald-600" }, null, -1))
                  ])
                ]);
              }), 64)),
              createBaseVNode("div", _hoisted_54, [
                createBaseVNode("div", _hoisted_55, [
                  _cache[45] || (_cache[45] = createBaseVNode("label", { class: "block text-[10px] font-semibold text-slate-400 mb-1.5 uppercase tracking-wider" }, "Max Booking Duration (hrs)", -1)),
                  withDirectives(createBaseVNode("input", {
                ...
                createBaseVNode("div", _hoisted_56, [
                  _cache[46] || (_cache[46] = createBaseVNode("label", { class: "block text-[10px] font-semibold text-slate-400 mb-1.5 uppercase tracking-wider" }, "Advance Booking Days", -1)),
                  withDirectives(createBaseVNode("input", {
                ...
                createBaseVNode("div", _hoisted_57, [
                  _cache[47] || (_cache[47] = createBaseVNode("label", { class: "block text-[10px] font-semibold text-slate-400 mb-1.5 uppercase tracking-wider" }, "Min Study Minutes for Streak", -1)),
                  withDirectives(createBaseVNode("input", {
              ...
              createBaseVNode("div", _hoisted_58, [
                createBaseVNode("h4", _hoisted_59, [
                  ...
                  _cache[48] || (_cache[48] = createBaseVNode("span", null, "Seat Layout System Redesign", -1))
                ]),
            ...
            activeTab.value === "reviews" ? (openBlock(), createElementBlock("div", _hoisted_61, [
              ...
              createBaseVNode("div", _hoisted_71, [
                createBaseVNode("div", _hoisted_72, [
                  ...
                  withDirectives(createBaseVNode("input", {
                    "onUpdate:modelValue": _cache[17] || (_cache[17] = ($event) => reviewSearch.value = $event),
                    type: "text",
                ...
                createBaseVNode("div", _hoisted_73, [
                  withDirectives(createBaseVNode("select", {
                    "onUpdate:modelValue": _cache[18] || (_cache[18] = ($event) => reviewRatingFilter.value = $event),
                    ...
                    createStaticVNode('<option value="all" data-v-712d5e90>All Ratings</option><option value="5" data-v-712d5e90>5 Stars</option><option value="4" data-v-712d5e90>4 Stars</option><option value="3" data-v-712d5e90>3 Stars</option><option value="2" data-v-712d5e90>2 Stars</option><option value="1" data-v-712d5e90>1 Star</option>', 6)
                  ])], 512), [
              ...
              reviewsLoading.value ? (openBlock(), createElementBlock("div", _hoisted_75, [
                createVNode(unref(RefreshCw), { class: "w-8 h-8 text-emerald-600 animate-spin" })
              ])) : filteredReviewsList.value.length === 0 ? (openBlock(), createElementBlock("div", _hoisted_76, [
                createVNode(unref(MessageSquare), { class: "w-12 h-12 text-slate-300 mx-auto mb-3" }),
                _cache[53] || (_cache[53] = createBaseVNode("p", { class: "text-xs font-bold text-slate-400 uppercase tracking-widest" }, "No student reviews match your selection.", -1))
              ])) : (openBlock(), createElementBlock("div", _hoisted_77, [
                (openBlock(true), createElementBlock(Fragment, null, renderList(filteredReviewsList.value, (review) => {
                  return openBlock(), createElementBlock("div", {
                    key: review.id,
                    ...
                    createBaseVNode("div", _hoisted_78, [
                      createBaseVNode("div", _hoisted_79, [
                        createBaseVNode("div", _hoisted_80, [
                          review.user?.profile_picture ? (openBlock(), createElementBlock("img", {
                            ...
                            class: "w-full h-full object-cover"
                          }, null, 8, _hoisted_81)) : (openBlock(), createElementBlock("span", _hoisted_82, toDisplayString(review.user?.name ? review.user.name.charAt(0).toUpperCase() : "S"), 1))
                        ]),
                        createBaseVNode("div", null, [
                          createBaseVNode("h4", _hoisted_83, toDisplayString(review.user?.name || "Anonymous Student"), 1),
                          createBaseVNode("div", _hoisted_84, [
                            review.user?.crn ? (openBlock(), createElementBlock("span", _hoisted_85, "CRN: " + toDisplayString(review.user.crn), 1)) : createCommentVNode("", true),
                            review.user?.ca_level ? (openBlock(), createElementBlock("span", _hoisted_86, "• " + toDisplayString(review.user.ca_level), 1)) : createCommentVNode("", true)
                          ])
                        ])
                      ]),
                      createBaseVNode("div", _hoisted_87, [
                        ...
                        createBaseVNode("span", _hoisted_89, toDisplayString(new Date(review.created_at).toLocaleDateString("en-US", { month: "short", day: "numeric", year: "numeric" })), 1)
                      ])
                    ]),
                    createBaseVNode("p", _hoisted_90, toDisplayString(review.comment || "No written comment provided."), 1)
                  ]);
                }), 128))
              ]))
            ])) : createCommentVNode("", true)
        ...
        showMapModal.value ? (openBlock(), createElementBlock("div", _hoisted_91, [
          createBaseVNode("div", _hoisted_92, [
            createBaseVNode("div", _hoisted_93, [
              createBaseVNode("div", _hoisted_94, [
                createVNode(unref(MapPin), { class: "w-5 h-5 text-emerald-350" }),
                _cache[54] || (_cache[54] = createBaseVNode("h3", { class: "font-bold text-sm uppercase tracking-wider" }, "Select Location on Map", -1))
              ]),
              createBaseVNode("button", {
            ...
            createBaseVNode("div", _hoisted_95, [
              _cache[60] || (_cache[60] = createBaseVNode("p", { class: "text-xs text-slate-500 font-medium" }, "Click on the map or drag the marker to pin your library's exact coordinates.", -1)),
              createBaseVNode("div", _hoisted_96, [
                createBaseVNode("div", _hoisted_97, [
                  createBaseVNode("div", _hoisted_98, [
                    withDirectives(createBaseVNode("input", {
                      id: "picker-search-input",
                      "onUpdate:modelValue": _cache[19] || (_cache[19] = ($event) => mapSearchQuery.value = $event),
                      onInput: onSearchInput,
                      onFocus: _cache[20] || (_cache[20] = ($event) => showSearchDropdown.value = searchResults.value.length > 0),
                  ...
                  createBaseVNode("button", {
                    ...
                    _cache[55] || (_cache[55] = createBaseVNode("span", null, "Search", -1))
                  ], 8, _hoisted_100)
                ]),
                showSearchDropdown.value && searchResults.value.length > 0 ? (openBlock(), createElementBlock("div", _hoisted_101, [
                  (openBlock(true), createElementBlock(Fragment, null, renderList(searchResults.value, (result, index) => {
                    return openBlock(), createElementBlock("div", {
                      ...
                      createBaseVNode("div", _hoisted_103, [
                        createBaseVNode("div", _hoisted_104, toDisplayString(result.display_name.split(",")[0]), 1),
                        createBaseVNode("div", _hoisted_105, toDisplayString(result.display_name), 1)
                      ])
                    ], 40, _hoisted_102);
                  }), 128))
                ])) : createCommentVNode("", true),
                isSearchingDropdown.value ? (openBlock(), createElementBlock("div", _hoisted_106, [
                  createVNode(unref(RefreshCw), { class: "w-3.5 h-3.5 animate-spin text-emerald-600" }),
                  _cache[56] || (_cache[56] = createBaseVNode("span", null, "Searching matching locations...", -1))
                ])) : createCommentVNode("", true)
              ]),
              _cache[61] || (_cache[61] = createBaseVNode("div", { class: "relative w-full h-[350px] bg-slate-50 rounded-2xl overflow-hidden border border-slate-200 shadow-inner" }, [
                createBaseVNode("div", {
                  id: "picker-map",
              ...
              createBaseVNode("div", _hoisted_107, [
                createBaseVNode("div", _hoisted_108, [
                  createBaseVNode("div", null, [
                    _cache[57] || (_cache[57] = createBaseVNode("span", { class: "text-slate-400 font-medium uppercase tracking-wider block text-[9px] mb-0.5" }, "Latitude", -1)),
                    createBaseVNode("span", _hoisted_109, toDisplayString(tempLatitude.value !== null ? tempLatitude.value.toFixed(6) : "None"), 1)
                  ]),
                  createBaseVNode("div", null, [
                    _cache[58] || (_cache[58] = createBaseVNode("span", { class: "text-slate-400 font-medium uppercase tracking-wider block text-[9px] mb-0.5" }, "Longitude", -1)),
                    createBaseVNode("span", _hoisted_110, toDisplayString(tempLongitude.value !== null ? tempLongitude.value.toFixed(6) : "None"), 1)
                  ])
                ]),
                createBaseVNode("button", {
                  type: "button",
                  ...
                  createVNode(unref(Navigation), { class: "w-3.5 h-3.5" }),
                  _cache[59] || (_cache[59] = createBaseVNode("span", null, "My Location", -1))
                ])
              ])
            ]),
            createBaseVNode("div", _hoisted_111, [
              ...
              createBaseVNode("button", {
                ...
                _cache[62] || (_cache[62] = createBaseVNode("span", null, "Confirm Location", -1))
              ])
            ])
          ])
        ])) : createCommentVNode("", true)
...
const LibraryInfoPage = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-712d5e90"]]);
export {
