import { d as defineComponent, r as ref, H as watch, o as onMounted, c as createElementBlock, b as createBaseVNode, v as withDirectives, B as vModelSelect, f as createVNode, u as unref, j as createTextVNode, t as toDisplayString, F as Fragment, h as renderList, I as normalizeStyle, i as openBlock } from "./main-Dk2mUbjP.js";
import { l as librarianAPI } from "./librarianApi-B5boLA6X.js";
...
import { A as Award } from "./award-DBnQSSwI.js";
...
const _hoisted_40 = { class: "w-8 h-8 rounded-full bg-gradient-to-r from-purple-600 to-indigo-600 flex items-center justify-center text-white text-sm font-bold" };
const _hoisted_41 = { class: "font-medium text-gray-900" };
const _hoisted_42 = { class: "text-sm text-gray-500" };
const _hoisted_43 = { class: "flex items-center space-x-2" };
const _hoisted_44 = { class: "text-sm font-medium text-gray-900" };
const _hoisted_45 = { class: "bg-white rounded-xl shadow-sm border border-gray-200" };
const _hoisted_46 = { class: "p-6" };
const _hoisted_47 = { class: "space-y-4" };
const _hoisted_48 = {
  key: 0,
  class: "text-center py-8"
};
const _hoisted_49 = { class: "flex items-center space-x-3" };
const _hoisted_50 = { class: "p-2 bg-purple-100 rounded-lg" };
const _hoisted_51 = { class: "font-medium text-gray-900" };
const _hoisted_52 = { class: "text-sm text-gray-500" };
const _hoisted_53 = { class: "text-right" };
const _hoisted_54 = { class: "text-sm font-medium text-gray-900" };
      ...
      return openBlock(), createElementBlock("div", _hoisted_1, [
        ...
        createBaseVNode("div", _hoisted_34, [
          createBaseVNode("div", _hoisted_35, [
            _cache[14] || (_cache[14] = createBaseVNode("div", { class: "p-6 border-b border-gray-200" }, [
              createBaseVNode("h2", { class: "text-lg font-bold text-gray-900" }, "Top Active Students")
            ], -1)),
            createBaseVNode("div", _hoisted_36, [
              createBaseVNode("div", _hoisted_37, [
                topStudents.value.length === 0 ? (openBlock(), createElementBlock("div", _hoisted_38, [
                  createVNode(unref(Award), { class: "w-10 h-10 text-gray-200 mx-auto mb-2" }),
                  _cache[13] || (_cache[13] = createBaseVNode("p", { class: "text-sm text-gray-500" }, "No active students found in this period", -1))
                  ...
                  return openBlock(), createElementBlock("div", {
                    ...
                    createBaseVNode("div", _hoisted_39, [
                      createBaseVNode("div", _hoisted_40, toDisplayString(index + 1), 1),
                      createBaseVNode("div", null, [
                        createBaseVNode("h4", _hoisted_41, toDisplayString(student.name), 1),
                        createBaseVNode("p", _hoisted_42, toDisplayString(student.hours || 0) + " hours studied", 1)
                      ])
                    ]),
                    createBaseVNode("div", _hoisted_43, [
                      createVNode(unref(Award), { class: "w-5 h-5 text-yellow-500" }),
                      createBaseVNode("span", _hoisted_44, toDisplayString(student.points || 0) + " pts", 1)
                    ])
                  ]);
                }), 128))
              ])
          ...
          createBaseVNode("div", _hoisted_45, [
            _cache[17] || (_cache[17] = createBaseVNode("div", { class: "p-6 border-b border-gray-200" }, [
              createBaseVNode("h2", { class: "text-lg font-bold text-gray-900" }, "Most Popular Seats")
            ], -1)),
            createBaseVNode("div", _hoisted_46, [
              createBaseVNode("div", _hoisted_47, [
                popularSeats.value.length === 0 ? (openBlock(), createElementBlock("div", _hoisted_48, [
                  createVNode(unref(MapPin), { class: "w-10 h-10 text-gray-200 mx-auto mb-2" }),
                  _cache[15] || (_cache[15] = createBaseVNode("p", { class: "text-sm text-gray-500" }, "No seat data available for this period", -1))
                  ...
                  return openBlock(), createElementBlock("div", {
                    ...
                    createBaseVNode("div", _hoisted_49, [
                      ...
                      createBaseVNode("div", null, [
                        createBaseVNode("h4", _hoisted_51, "Seat " + toDisplayString(seat.number), 1),
                        createBaseVNode("p", _hoisted_52, toDisplayString(seat.bookings) + " bookings", 1)
                      ])
                    ]),
                    createBaseVNode("div", _hoisted_53, [
                      createBaseVNode("p", _hoisted_54, toDisplayString(seat.utilization) + "%", 1),
                      _cache[16] || (_cache[16] = createBaseVNode("p", { class: "text-xs text-gray-500" }, "utilization", -1))
                    ])
                  ]);
                }), 128))
              ])
