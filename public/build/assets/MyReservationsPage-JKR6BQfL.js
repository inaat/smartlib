import { d as defineComponent, r as ref, o as onMounted, b as createElementBlock, e as createBaseVNode, F as Fragment, k as renderList, g as createVNode, u as unref, w as withCtx, h as resolveComponent, S as studentAPI, t as toDisplayString, n as normalizeClass, C as Clock, p as createCommentVNode, j as createTextVNode, m as openBlock, _ as _export_sfc } from "./main-BeUqjoax.js";
...
const _hoisted_22 = {
  key: 2,
  class: "bg-white rounded-2xl p-8 text-center py-20 border border-dashed border-slate-200 shadow-sm"
};
const _hoisted_23 = { class: "w-16 h-16 bg-slate-50 text-slate-500 rounded-full flex items-center justify-center mx-auto mb-4 border border-slate-200 shadow-inner" };
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const getDaysRemaining = (reservation) => {
    ...
    const getDaysRemainingColor = (reservation) => {
                ...
                createBaseVNode("div", _hoisted_12, [
                  ...
                  createBaseVNode("div", _hoisted_15, [
                    createVNode(unref(CircleAlert), {
                      class: normalizeClass(["w-4 h-4 mr-2 flex-shrink-0", getDaysRemainingColor(reservation)])
                    }, null, 8, ["class"]),
                    createBaseVNode("span", {
                      class: normalizeClass(["font-semibold uppercase tracking-wide text-[10px]", getDaysRemainingColor(reservation)])
                    }, toDisplayString(getDaysRemaining(reservation)), 3)
                  ])
                ])
              ]),
...
const MyReservationsPage = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-057b45f0"]]);
export {
