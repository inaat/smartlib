import { d as defineComponent, x as useAuth, r as ref, c as computed, o as onMounted, a as createElementBlock, b as createBaseVNode, t as toDisplayString, u as unref, l as createCommentVNode, f as createVNode, i as createTextVNode, w as withCtx, g as resolveComponent, F as Fragment, j as renderList, e as createStaticVNode, q as normalizeStyle, P as librarianAPI, n as normalizeClass, h as createBlock, m as resolveDynamicComponent, k as openBlock } from "./main-DKJzpCzk.js";
    ...
    return (_ctx, _cache) => {
      ...
      return openBlock(), createElementBlock("div", _hoisted_1, [
          ...
          createBaseVNode("div", _hoisted_47, [
            ...
            createBaseVNode("div", _hoisted_55, [
              ...
              createBaseVNode("div", _hoisted_56, [
                ...
                _cache[24] || (_cache[24] = createStaticVNode('<div class="mt-4 space-y-2 pt-2 border-t border-slate-100" data-v-59a9d3ae><div class="flex items-center justify-between text-xs font-semibold" data-v-59a9d3ae><span class="text-slate-500" data-v-59a9d3ae>Peak Hours Today</span><span class="font-bold text-gray-700 bg-slate-100 px-2 py-0.5 rounded-lg" data-v-59a9d3ae>2:00 PM - 6:00 PM</span></div><div class="flex items-center justify-between text-xs font-semibold" data-v-59a9d3ae><span class="text-slate-500" data-v-59a9d3ae>Avg. Study Duration</span><span class="font-bold text-gray-700 bg-slate-100 px-2 py-0.5 rounded-lg" data-v-59a9d3ae>3.5 Hours</span></div></div>', 1))
              ])
            ])
          ])
        ]),
        createBaseVNode("div", _hoisted_62, [
          ...
          _cache[27] || (_cache[27] = createStaticVNode('<div class="p-6 border-b border-gray-100" data-v-59a9d3ae><div class="flex items-center justify-between" data-v-59a9d3ae><h2 class="text-lg font-bold text-slate-700" data-v-59a9d3ae>Upcoming Schedule</h2><div class="flex items-center space-x-1 p-1 bg-slate-100 rounded-xl" data-v-59a9d3ae><button class="px-3.5 py-1.5 rounded-lg text-xs font-bold bg-white text-slate-700 shadow-sm cursor-pointer" data-v-59a9d3ae> All </button><button class="px-3.5 py-1.5 rounded-lg text-xs font-bold text-slate-500 hover:text-slate-700 transition-colors cursor-pointer" data-v-59a9d3ae> Events </button><button class="px-3.5 py-1.5 rounded-lg text-xs font-bold text-slate-500 hover:text-slate-700 transition-colors cursor-pointer" data-v-59a9d3ae> Maintenance </button></div></div></div>', 1)),
...
const Dashboard = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-59a9d3ae"]]);
export {
