import { d as defineComponent, r as ref, c as computed, o as onMounted, a as createElementBlock, b as createBaseVNode, f as createVNode, n as normalizeClass, u as unref, p as withDirectives, v as vModelText, D as vModelSelect, e as createStaticVNode, l as createCommentVNode, F as Fragment, j as renderList, P as librarianAPI, h as createBlock, t as toDisplayString, i as createTextVNode, k as openBlock } from "./main-BV94XoeK.js";
...
const _hoisted_33 = { class: "px-6 py-4 whitespace-nowrap text-right text-xs font-bold" };
const _hoisted_34 = {
  key: 0,
          ...
          createBaseVNode("div", _hoisted_5, [
            ...
            createBaseVNode("div", _hoisted_7, [
              withDirectives(createBaseVNode("select", {
                ...
                createStaticVNode('<option value="all" data-v-dadb25ec>All Statuses</option><option value="pending" data-v-dadb25ec>Pending</option><option value="approved" data-v-dadb25ec>Approved</option><option value="rejected" data-v-dadb25ec>Rejected</option><option value="collected" data-v-dadb25ec>Collected</option><option value="pending_return" data-v-dadb25ec>Pending Return</option><option value="returned" data-v-dadb25ec>Returned</option><option value="overdue" data-v-dadb25ec>Overdue</option>', 8)
              ])], 512), [
          ...
          createBaseVNode("div", _hoisted_9, [
            createBaseVNode("table", _hoisted_10, [
              ...
              createBaseVNode("tbody", _hoisted_11, [
                loading.value ? (openBlock(), createElementBlock("tr", _hoisted_12, [..._cache[3] || (_cache[3] = [
                  createBaseVNode("td", {
                    colspan: "5",
                    class: "px-6 py-12 text-center text-slate-400 text-xs font-semibold"
                  }, "Loading reservations...", -1)
                ])])) : filteredReservations.value.length === 0 ? (openBlock(), createElementBlock("tr", _hoisted_13, [..._cache[4] || (_cache[4] = [
                  createBaseVNode("td", {
                    colspan: "5",
                    class: "px-6 py-12 text-center text-slate-400 text-xs font-semibold"
                ...
                (openBlock(true), createElementBlock(Fragment, null, renderList(filteredReservations.value, (reservation) => {
                  return openBlock(), createElementBlock("tr", {
                    ...
                    createBaseVNode("td", _hoisted_33, [
                      reservation.status === "pending" ? (openBlock(), createElementBlock("div", _hoisted_34, [
                        createBaseVNode("button", {
                      ...
                      }, toDisplayString(processing.value === reservation.id ? "Processing..." : "Approve Return"), 9, _hoisted_37)) : (openBlock(), createElementBlock("span", _hoisted_38, "-"))
                    ])
                  ]);
                }), 128))
              ])
...
const ReservedBooksPage = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-dadb25ec"]]);
export {
