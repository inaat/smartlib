...
const _hoisted_6$2 = {
  key: 2,
  class: "absolute bottom-3 left-3 bg-slate-900/70 backdrop-blur-md text-white px-2 py-1 rounded-lg text-[10px] font-extrabold flex items-center space-x-1 border border-white/10 shadow-sm"
};
...
const _hoisted_14$1 = {
  key: 0,
  class: "text-[10px] font-extrabold text-blue-600 bg-blue-50/50 border border-blue-100 px-2 py-0.5 rounded-lg flex-shrink-0 leading-none self-start"
};
...
const _hoisted_18 = { class: "text-xs text-slate-500 font-bold truncate" };
const _hoisted_19 = { class: "flex flex-wrap gap-1.5 pt-1" };
const _hoisted_20 = { class: "ml-1 leading-none" };
const _hoisted_21 = {
  key: 0,
  class: "text-[9px] font-extrabold text-slate-400 bg-slate-50 border border-slate-100 px-2 py-0.5 rounded-lg"
};
          ...
          createBaseVNode("div", _hoisted_8$2, [
            createBaseVNode("div", _hoisted_9$2, [
              createBaseVNode("div", _hoisted_10$2, [
                createBaseVNode("h3", {
                  class: "text-base font-extrabold text-slate-800 group-hover:text-blue-600 transition-colors leading-snug truncate",
            ...
            createBaseVNode("div", _hoisted_16, [
              ...
              createBaseVNode("span", {
                class: normalizeClass(["text-[9px] font-black px-2.5 py-0.5 rounded-lg border shadow-sm flex-shrink-0 leading-none", getAvailabilityColor()])
...
const LibraryCard = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["__scopeId", "data-v-b24414cc"]]);
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", _hoisted_1, [
        ...
        filteredLibraries.value.length === 0 ? (openBlock(), createElementBlock("div", _hoisted_10, [
          ...
          _cache[7] || (_cache[7] = createBaseVNode("h3", { class: "text-base font-bold text-slate-800 mb-1" }, "No libraries found", -1)),
...
const LibrariesPage = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-002e903a"]]);
export {
