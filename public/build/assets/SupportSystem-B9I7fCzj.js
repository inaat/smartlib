import { d as defineComponent, x as useAuth, c as computed, r as ref, o as onMounted, E as watch, a as createElementBlock, b as createBaseVNode, j as createCommentVNode, n as normalizeClass, f as createVNode, u as unref, t as toDisplayString, p as withDirectives, v as vModelText, F as Fragment, k as renderList, i as createTextVNode, R as withKeys, z as withModifiers, h as createBlock, D as vModelSelect, S as supportAPI, L as studentAPI, U as nextTick, l as openBlock } from "./main-BGbL_8Ba.js";
...
import { L as LifeBuoy } from "./life-buoy-C_DgfD_v.js";
import { A as ArrowLeft } from "./arrow-left-igOt9G28.js";
...
const _hoisted_2 = { class: "grid grid-cols-1 sm:grid-cols-3 gap-3.5 sm:gap-5" };
const _hoisted_3 = { class: "absolute -right-4 -top-4 text-slate-50/10 group-hover:scale-105 transition-transform duration-500 pointer-events-none" };
const _hoisted_4 = { class: "flex justify-between items-start relative z-10" };
const _hoisted_5 = { class: "text-2xl sm:text-3xl font-extrabold mt-1.5 sm:mt-2 tracking-tight" };
const _hoisted_6 = { class: "absolute -right-4 -top-4 text-slate-50/10 group-hover:scale-105 transition-transform duration-500 pointer-events-none" };
const _hoisted_7 = { class: "flex justify-between items-start relative z-10" };
const _hoisted_8 = { class: "text-2xl sm:text-3xl font-extrabold mt-1.5 sm:mt-2 tracking-tight" };
...
const _hoisted_12 = { class: "flex flex-col md:flex-row h-[calc(100vh-14rem)] min-h-[500px] max-h-[750px] bg-white rounded-2xl shadow-sm border border-slate-100 overflow-hidden font-outfit" };
const _hoisted_13 = { class: "p-4 border-b border-slate-100 flex justify-between items-center bg-white text-left" };
const _hoisted_14 = { class: "p-3 bg-white border-b border-slate-50" };
const _hoisted_15 = { class: "relative" };
const _hoisted_16 = { class: "flex-1 overflow-y-auto divide-y divide-slate-100/50" };
const _hoisted_17 = {
  key: 0,
...
const _hoisted_20 = { class: "flex justify-between items-start gap-2 mb-1.5" };
const _hoisted_21 = { class: "flex flex-shrink-0 gap-1 items-center" };
const _hoisted_22 = { class: "text-[10px] text-slate-400 line-clamp-1 mb-2 pr-2 font-medium" };
const _hoisted_23 = { class: "flex justify-between items-center text-[10px] text-slate-450 font-semibold mt-1" };
const _hoisted_24 = { class: "flex items-center text-slate-500 truncate mr-2" };
const _hoisted_25 = { class: "truncate" };
const _hoisted_26 = { class: "text-slate-400 flex-shrink-0" };
const _hoisted_27 = ["title"];
const _hoisted_28 = { class: "bg-white p-3.5 sm:p-4 border-b border-slate-100 flex justify-between items-center shadow-sm relative z-10 text-left" };
const _hoisted_29 = { class: "flex items-center space-x-2.5 sm:space-x-3.5 min-w-0" };
const _hoisted_30 = { class: "w-8 h-8 sm:w-9 sm:h-9 border border-slate-100 rounded-xl bg-slate-50 flex items-center justify-center text-slate-600 flex-shrink-0" };
const _hoisted_31 = { class: "min-w-0" };
const _hoisted_32 = { class: "font-bold text-slate-800 text-xs sm:text-sm leading-tight truncate" };
const _hoisted_33 = { class: "text-[10px] text-slate-400 mt-0.5 font-semibold flex flex-wrap items-center gap-1.5 leading-none" };
const _hoisted_34 = { class: "font-bold text-slate-600" };
...
const _hoisted_36 = { class: "flex items-center space-x-1.5 sm:space-x-2 flex-shrink-0" };
...
const _hoisted_41 = { class: "whitespace-pre-wrap leading-relaxed" };
const _hoisted_42 = {
  key: 0,
  class: "p-3.5 sm:p-4 bg-slate-100/80 border-t border-slate-200 text-center"
};
const _hoisted_43 = { class: "text-xs font-bold text-slate-500 flex items-center justify-center gap-1.5" };
const _hoisted_44 = {
  key: 1,
  class: "p-3 sm:p-4 bg-white border-t border-slate-100"
};
const _hoisted_45 = { class: "flex items-end space-x-2" };
const _hoisted_46 = { class: "flex-1 relative" };
...
const _hoisted_50 = { class: "w-14 h-14 sm:w-16 sm:h-16 border border-slate-100 rounded-2xl flex items-center justify-center mb-4 bg-white text-slate-400" };
const _hoisted_51 = {
  key: 0,
  class: "fixed inset-0 z-[60] flex items-center justify-center p-4 bg-black/50 backdrop-blur-sm animate-fade-in"
};
const _hoisted_52 = { class: "relative bg-white rounded-3xl shadow-xl w-full max-w-md max-h-[90vh] overflow-y-auto border border-slate-100 text-left animate-in duration-200" };
const _hoisted_53 = { class: "p-5 sm:p-6 border-b border-slate-100 flex justify-between items-center text-left" };
const _hoisted_54 = { class: "grid grid-cols-2 gap-4" };
const _hoisted_55 = { key: 0 };
const _hoisted_56 = ["value"];
const _hoisted_57 = { class: "pt-2 flex space-x-3" };
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", _hoisted_1, [
        ...
        createBaseVNode("div", _hoisted_12, [
          createBaseVNode("div", {
            ...
            createBaseVNode("div", _hoisted_13, [
              _cache[18] || (_cache[18] = createBaseVNode("h2", { class: "text-xs font-bold text-slate-800 uppercase tracking-wider" }, "Tickets", -1)),
              userRole.value === "student" ? (openBlock(), createElementBlock("button", {
                ...
                _cache[17] || (_cache[17] = createBaseVNode("span", null, "New Ticket", -1))
            ...
            createBaseVNode("div", _hoisted_16, [
              loading.value ? (openBlock(), createElementBlock("div", _hoisted_17, [
                ...
                _cache[19] || (_cache[19] = createBaseVNode("p", { class: "text-[10px] text-slate-400 font-bold uppercase tracking-wider" }, "Loading tickets...", -1))
              ])) : filteredTickets.value.length === 0 ? (openBlock(), createElementBlock("div", _hoisted_18, [
                createVNode(unref(LifeBuoy), { class: "w-8 h-8 text-slate-200 mb-3" }),
                _cache[20] || (_cache[20] = createBaseVNode("p", { class: "text-xs font-semibold tracking-wide italic text-slate-400" }, "No tickets found.", -1))
                ...
                return openBlock(), createElementBlock("div", {
                  ...
                  createBaseVNode("p", _hoisted_22, toDisplayString(ticket.messages?.[0]?.message || "No messages"), 1),
                  createBaseVNode("div", _hoisted_23, [
                    createBaseVNode("span", _hoisted_24, [
                      createVNode(unref(User), { class: "w-3.5 h-3.5 mr-1 text-slate-400 flex-shrink-0" }),
                      createBaseVNode("span", _hoisted_25, toDisplayString(ticket.user?.name || "User"), 1)
                    ]),
            ...
            selectedTicket.value ? (openBlock(), createElementBlock(Fragment, { key: 0 }, [
              createBaseVNode("div", _hoisted_28, [
                ...
                createBaseVNode("div", _hoisted_36, [
                  ...
                  ])], 40, _hoisted_37)) : ["open", "in_progress", "resolved"].includes(selectedTicket.value.status) ? (openBlock(), createElementBlock("button", {
                    key: 1,
                  ...
                  selectedTicket.value.status === "closed" ? (openBlock(), createElementBlock("span", _hoisted_38, [
                    createVNode(unref(Lock), { class: "w-3 h-3 text-slate-400" }),
                    _cache[22] || (_cache[22] = createTextVNode(" Locked ", -1))
                  ])) : createCommentVNode("", true),
                  createBaseVNode("button", {
                  ...
                  return openBlock(), createElementBlock("div", {
                    ...
                    createBaseVNode("div", {
                      ...
                      message.user_id !== unref(currentUser)?.id ? (openBlock(), createElementBlock("div", _hoisted_39, [
                        ...
                        _cache[23] || (_cache[23] = createBaseVNode("span", null, "•", -1)),
              ...
              selectedTicket.value.status === "closed" ? (openBlock(), createElementBlock("div", _hoisted_42, [
                createBaseVNode("p", _hoisted_43, [
                  createVNode(unref(Lock), { class: "w-4 h-4 text-slate-400" }),
                  _cache[24] || (_cache[24] = createTextVNode(" This complaint is completely closed and locked. ", -1))
                ])
                ...
                _cache[25] || (_cache[25] = createBaseVNode("p", { class: "text-[9px] font-extrabold text-slate-400 uppercase tracking-widest mt-2 text-center hidden sm:block" }, "Press Enter to send (Shift+Enter for newline)", -1))
              ]))
            ], 64)) : (openBlock(), createElementBlock("div", _hoisted_49, [
              createBaseVNode("div", _hoisted_50, [
                createVNode(unref(LifeBuoy), { class: "w-6 h-6 animate-pulse" })
              ]),
              _cache[26] || (_cache[26] = createBaseVNode("h3", { class: "text-xs sm:text-sm font-bold text-slate-800 mb-1 uppercase tracking-wider" }, "Support Desk", -1)),
              _cache[27] || (_cache[27] = createBaseVNode("p", { class: "text-xs text-slate-400 max-w-xs leading-relaxed font-semibold" }, "Select a ticket from the left panel to open the conversation, or submit a new ticket for assistance.", -1)),
              userRole.value === "student" ? (openBlock(), createElementBlock("button", {
                key: 0,
        ...
        showCreateModal.value ? (openBlock(), createElementBlock("div", _hoisted_51, [
          createBaseVNode("div", _hoisted_52, [
            ...
            createBaseVNode("form", {
              ...
              createBaseVNode("div", null, [
                _cache[29] || (_cache[29] = createBaseVNode("label", { class: "block text-xs font-bold text-slate-500 mb-1.5 uppercase tracking-wider" }, "Subject", -1)),
                withDirectives(createBaseVNode("input", {
              ...
              createBaseVNode("div", _hoisted_54, [
                createBaseVNode("div", null, [
                  _cache[31] || (_cache[31] = createBaseVNode("label", { class: "block text-xs font-bold text-slate-500 mb-1.5 uppercase tracking-wider" }, "Category", -1)),
                ...
                createBaseVNode("div", null, [
                  _cache[33] || (_cache[33] = createBaseVNode("label", { class: "block text-xs font-bold text-slate-500 mb-1.5 uppercase tracking-wider" }, "Priority", -1)),
                  withDirectives(createBaseVNode("select", {
              ...
              createForm.value.ticket_type === "library" ? (openBlock(), createElementBlock("div", _hoisted_55, [
                _cache[35] || (_cache[35] = createBaseVNode("label", { class: "block text-xs font-bold text-slate-500 mb-1.5 uppercase tracking-wider" }, "Select Library", -1)),
                withDirectives(createBaseVNode("select", {
                  "onUpdate:modelValue": _cache[14] || (_cache[14] = ($event) => createForm.value.library_id = $event),
                  required: "",
                  class: "w-full px-4 py-2 border border-slate-200 rounded-xl text-xs font-bold text-slate-655 focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 focus:bg-white transition-all outline-none bg-white cursor-pointer"
                }, [
                  _cache[34] || (_cache[34] = createBaseVNode("option", {
                    value: null,
                    disabled: ""
                  }, "Select a library", -1)),
                  (openBlock(true), createElementBlock(Fragment, null, renderList(libraries.value, (lib) => {
                    return openBlock(), createElementBlock("option", {
                      key: lib.id,
                      value: lib.id
                    }, toDisplayString(lib.name), 9, _hoisted_56);
                  }), 128))
                ], 512), [
              ...
              createBaseVNode("div", null, [
                _cache[36] || (_cache[36] = createBaseVNode("label", { class: "block text-xs font-bold text-slate-500 mb-1.5 uppercase tracking-wider" }, "Description", -1)),
                withDirectives(createBaseVNode("textarea", {
              ...
              createBaseVNode("div", _hoisted_57, [
                ...
                createBaseVNode("button", {
                  ...
                  !creating.value ? (openBlock(), createElementBlock("span", _hoisted_59, "Submit Ticket")) : (openBlock(), createBlock(unref(LoaderCircle), {
                    key: 1,
...
const SupportSystem = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-bbc87231"]]);
export {
  SupportSystem as S
};
