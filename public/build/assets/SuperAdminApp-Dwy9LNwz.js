...
import { L as Library } from "./library-CO2Mqfde.js";
...
const _hoisted_8 = { class: "hidden md:block text-right" };
const _hoisted_9 = { class: "text-sm font-semibold text-gray-800" };
const _hoisted_10 = { class: "w-10 h-10 rounded-full bg-indigo-100 flex items-center justify-center border-2 border-indigo-50 overflow-hidden" };
          ...
          createBaseVNode("div", _hoisted_7, [
            createBaseVNode("button", {
              ...
              createBaseVNode("div", _hoisted_8, [
                createBaseVNode("div", _hoisted_9, toDisplayString(unref(user)?.name), 1),
              ...
              createBaseVNode("div", _hoisted_10, [
                ...
                }, null, 8, _hoisted_11)) : (openBlock(), createBlock(unref(User), {
                  key: 1,
