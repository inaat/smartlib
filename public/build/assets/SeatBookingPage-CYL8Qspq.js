import { d as defineComponent, r as ref, x as useAuth, c as computed, E as watch, o as onMounted, a as createElementBlock, b as createBaseVNode, l as createCommentVNode, e as createStaticVNode, f as createVNode, w as withCtx, g as resolveComponent, u as unref, t as toDisplayString, F as Fragment, p as withDirectives, D as vModelSelect, j as renderList, v as vModelText, h as createBlock, C as useRouter, G as useRoute, L as studentAPI, i as createTextVNode, k as openBlock } from "./main-BV94XoeK.js";
import { _ as _sfc_main$1 } from "./SeatMap.vue_vue_type_script_setup_true_lang-B7pcY_np.js";
...
import "./panels-top-left-DtWQRakP.js";
import "./building-2-CoiD_Ne8.js";
import "./chevron-down-BtP5tQNe.js";
const _hoisted_1 = {
  key: 0,
    ...
    return (_ctx, _cache) => {
      ...
      return loading.value ? (openBlock(), createElementBlock("div", _hoisted_1, [..._cache[4] || (_cache[4] = [
        ...
        createBaseVNode("div", _hoisted_3, [
          ...
          _cache[7] || (_cache[7] = createStaticVNode('<div class="flex flex-wrap items-center gap-2 bg-slate-50 border border-slate-100 p-1.5 rounded-xl" data-v-72859b0f><div class="flex items-center px-3 py-1 text-[10px] font-semibold text-slate-500 uppercase tracking-wider" data-v-72859b0f><div class="w-2.5 h-2.5 rounded-full bg-[#29B072] mr-2" data-v-72859b0f></div><span data-v-72859b0f>Available</span></div><div class="flex items-center px-3 py-1 text-[10px] font-extrabold text-slate-500 uppercase tracking-wider" data-v-72859b0f><div class="w-2.5 h-2.5 rounded-full bg-[#FF9D43] mr-2" data-v-72859b0f></div><span data-v-72859b0f>Occupied</span></div><div class="flex items-center px-3 py-1 text-[10px] font-extrabold text-slate-500 uppercase tracking-wider" data-v-72859b0f><div class="w-2.5 h-2.5 rounded-full bg-[#617DFF] mr-2" data-v-72859b0f></div><span data-v-72859b0f>Reserved</span></div><div class="flex items-center px-3 py-1 text-[10px] font-extrabold text-slate-500 uppercase tracking-wider" data-v-72859b0f><div class="w-2.5 h-2.5 rounded-full bg-blue-600 mr-2" data-v-72859b0f></div><span data-v-72859b0f>Selected</span></div></div>', 1))
        ]),
                  ...
                  createBaseVNode("div", _hoisted_27, [
                    selectedSeat.value.status === "available" ? (openBlock(), createElementBlock("button", {
                      ...
                      createBaseVNode("div", _hoisted_31, [
                        ...
                        _cache[15] || (_cache[15] = createBaseVNode("p", { class: "text-[9px] text-slate-400 font-semibold uppercase tracking-widest mb-2.5 leading-none" }, "Seat Occupied", -1)),
...
const SeatBookingPage = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-72859b0f"]]);
export {
