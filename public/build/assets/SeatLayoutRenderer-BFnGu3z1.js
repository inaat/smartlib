...
const _hoisted_1$1 = { class: "bg-slate-50/80 backdrop-blur-sm border border-slate-100 rounded-2xl px-4 py-2 flex flex-wrap items-center justify-center gap-4.5 shadow-2xs" };
          ...
          currentSubsections.value.length > 0 ? (openBlock(), createElementBlock("div", _hoisted_6, [
            createBaseVNode("button", {
              ...
              class: normalizeClass([
                ...
                activeSubsectionId.value === null ? "bg-white text-blue-700 shadow-sm border-blue-200/40" : "text-blue-600/80 hover:text-blue-900"
              ])
            }, " All Subsections ", 2),
            (openBlock(true), createElementBlock(Fragment, null, renderList(currentSubsections.value, (sub) => {
              return openBlock(), createElementBlock("button", {
                ...
                class: normalizeClass([
                  ...
                  activeSubsectionId.value === sub.id ? "bg-white text-blue-700 shadow-sm border-blue-200/40" : "text-blue-600/80 hover:text-blue-900"
                ])
              }, [
...
const SeatLayoutRenderer = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-4463ed32"]]);
export {
