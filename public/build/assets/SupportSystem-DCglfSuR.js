import { d as defineComponent, x as useAuth, c as computed, r as ref, o as onMounted, E as watch, a as createElementBlock, b as createBaseVNode, j as createCommentVNode, n as normalizeClass, f as createVNode, u as unref, t as toDisplayString, p as withDirectives, v as vModelText, F as Fragment, k as renderList, i as createTextVNode, R as withKeys, z as withModifiers, h as createBlock, D as vModelSelect, S as supportAPI, L as studentAPI, U as nextTick, l as openBlock } from "./main-D4odWxzi.js";
...
import { L as LoaderCircle } from "./loader-circle-DaFspnIx.js";
...
const _hoisted_31 = { class: "w-9 h-9 border border-slate-100 rounded-xl bg-slate-50 flex items-center justify-center text-slate-600" };
...
const _hoisted_38 = ["value", "disabled"];
const _hoisted_39 = {
  key: 2,
  class: "px-2.5 py-1 rounded-xl bg-slate-100 border border-slate-200 text-slate-500 text-[10px] font-bold uppercase tracking-wider flex items-center gap-1"
};
const _hoisted_40 = {
  key: 0,
  class: "flex items-center space-x-1 mb-1.5 opacity-80 text-[8px] font-bold text-slate-400 uppercase tracking-wider"
};
const _hoisted_41 = { class: "font-extrabold" };
const _hoisted_42 = { class: "whitespace-pre-wrap" };
const _hoisted_43 = {
  key: 0,
  class: "p-4 bg-slate-100/80 border-t border-slate-200 text-center"
};
const _hoisted_44 = { class: "text-xs font-bold text-slate-500 flex items-center justify-center gap-1.5" };
const _hoisted_45 = {
  key: 1,
  class: "p-4 bg-white border-t border-slate-100"
};
const _hoisted_46 = { class: "flex items-end space-x-2" };
const _hoisted_47 = { class: "flex-1 relative" };
...
const _hoisted_51 = { class: "w-16 h-16 border border-slate-100 rounded-2xl flex items-center justify-center mb-5 bg-white text-slate-400" };
const _hoisted_52 = {
  key: 0,
  class: "fixed inset-0 z-[60] flex items-center justify-center p-4 bg-black/50 backdrop-blur-sm animate-fade-in"
};
const _hoisted_53 = { class: "relative bg-white rounded-3xl shadow-xl w-full max-w-md overflow-hidden border border-slate-100 text-left animate-in duration-200" };
const _hoisted_54 = { class: "p-6 border-b border-slate-100 flex justify-between items-center text-left" };
const _hoisted_55 = { class: "grid grid-cols-2 gap-4" };
const _hoisted_56 = { key: 0 };
const _hoisted_57 = ["value"];
const _hoisted_58 = { class: "pt-2 flex space-x-3" };
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", _hoisted_1, [
        ...
        createBaseVNode("div", _hoisted_12, [
          createBaseVNode("div", _hoisted_13, [
            createBaseVNode("div", _hoisted_14, [
              _cache[16] || (_cache[16] = createBaseVNode("h2", { class: "text-xs font-bold text-slate-850 uppercase tracking-wider" }, "Tickets", -1)),
            ...
            createBaseVNode("div", _hoisted_17, [
              loading.value ? (openBlock(), createElementBlock("div", _hoisted_18, [
                ...
                _cache[17] || (_cache[17] = createBaseVNode("p", { class: "text-[10px] text-slate-400 font-bold uppercase tracking-wider" }, "Loading tickets...", -1))
                ...
                _cache[18] || (_cache[18] = createBaseVNode("p", { class: "text-xs font-semibold tracking-wide italic text-slate-400" }, "No tickets found.", -1))
                ...
                return openBlock(), createElementBlock("div", {
                  ...
                  class: normalizeClass([
                    ...
                    selectedTicket.value?.id === ticket.id ? userRole.value === "student" ? "bg-blue-50/30 border-blue-600" : userRole.value === "admin" ? "bg-purple-50/30 border-purple-600" : "bg-emerald-50/30 border-emerald-600" : "border-transparent"
                  ])
                }, [
                  createBaseVNode("div", _hoisted_21, [
                    createBaseVNode("h3", {
                      class: normalizeClass(["text-xs font-bold truncate pr-1", selectedTicket.value?.id === ticket.id ? "text-slate-800" : "text-slate-750"])
            ...
            selectedTicket.value ? (openBlock(), createElementBlock(Fragment, { key: 0 }, [
              createBaseVNode("div", _hoisted_29, [
                ...
                createBaseVNode("div", _hoisted_37, [
                  ...
                  ])], 40, _hoisted_38)) : ["open", "in_progress", "resolved"].includes(selectedTicket.value.status) ? (openBlock(), createElementBlock("button", {
                    key: 1,
                  ...
                  selectedTicket.value.status === "closed" ? (openBlock(), createElementBlock("span", _hoisted_39, [
                    createVNode(unref(Lock), { class: "w-3 h-3 text-slate-400" }),
                    _cache[20] || (_cache[20] = createTextVNode(" Locked ", -1))
                  ])) : createCommentVNode("", true),
                ...
                (openBlock(true), createElementBlock(Fragment, null, renderList(selectedTicket.value.messages, (message) => {
                  return openBlock(), createElementBlock("div", {
                    ...
                    createBaseVNode("div", {
                      ...
                      message.user_id !== unref(currentUser)?.id ? (openBlock(), createElementBlock("div", _hoisted_40, [
                        createBaseVNode("span", null, toDisplayString(message.user?.role || "Support"), 1),
                        _cache[21] || (_cache[21] = createBaseVNode("span", null, "•", -1)),
                        createBaseVNode("span", _hoisted_41, toDisplayString(message.user?.name), 1)
                      ])) : createCommentVNode("", true),
                      createBaseVNode("p", _hoisted_42, toDisplayString(message.message), 1),
                      createBaseVNode("div", {
                        class: normalizeClass([
              ...
              selectedTicket.value.status === "closed" ? (openBlock(), createElementBlock("div", _hoisted_43, [
                createBaseVNode("p", _hoisted_44, [
                  createVNode(unref(Lock), { class: "w-4 h-4 text-slate-400" }),
                  _cache[22] || (_cache[22] = createTextVNode(" This complaint is completely closed and locked. No further messages can be sent. ", -1))
                ])
                ...
                _cache[23] || (_cache[23] = createBaseVNode("p", { class: "text-[9px] font-extrabold text-slate-400 uppercase tracking-widest mt-2.5 text-center" }, "Press Enter to send (Shift+Enter for newline)", -1))
              ]))
            ], 64)) : (openBlock(), createElementBlock("div", _hoisted_50, [
              createBaseVNode("div", _hoisted_51, [
                createVNode(unref(LifeBuoy), { class: "w-6 h-6 animate-pulse" })
              ]),
              _cache[24] || (_cache[24] = createBaseVNode("h3", { class: "text-sm font-bold text-slate-800 mb-1 uppercase tracking-wider" }, "Support Desk", -1)),
              _cache[25] || (_cache[25] = createBaseVNode("p", { class: "text-xs text-slate-400 max-w-xs leading-relaxed font-semibold" }, "Select a ticket from the left panel to open the conversation, or submit a new ticket for assistance.", -1)),
              userRole.value === "student" ? (openBlock(), createElementBlock("button", {
                key: 0,
        ...
        showCreateModal.value ? (openBlock(), createElementBlock("div", _hoisted_52, [
          createBaseVNode("div", _hoisted_53, [
            createBaseVNode("div", _hoisted_54, [
              _cache[26] || (_cache[26] = createBaseVNode("div", null, [
                createBaseVNode("h2", { class: "text-lg font-bold text-slate-800" }, "Submit Support Ticket")
              ], -1)),
              createBaseVNode("button", {
            ...
            createBaseVNode("form", {
              ...
              createBaseVNode("div", null, [
                _cache[27] || (_cache[27] = createBaseVNode("label", { class: "block text-xs font-bold text-slate-500 mb-1.5 uppercase tracking-wider" }, "Subject", -1)),
                withDirectives(createBaseVNode("input", {
                  "onUpdate:modelValue": _cache[10] || (_cache[10] = ($event) => createForm.value.subject = $event),
                  type: "text",
                  required: "",
              ...
              createBaseVNode("div", _hoisted_55, [
                createBaseVNode("div", null, [
                  _cache[29] || (_cache[29] = createBaseVNode("label", { class: "block text-xs font-bold text-slate-500 mb-1.5 uppercase tracking-wider" }, "Category", -1)),
                  withDirectives(createBaseVNode("select", {
                    "onUpdate:modelValue": _cache[11] || (_cache[11] = ($event) => createForm.value.ticket_type = $event),
                ...
                createBaseVNode("div", null, [
                  _cache[31] || (_cache[31] = createBaseVNode("label", { class: "block text-xs font-bold text-slate-500 mb-1.5 uppercase tracking-wider" }, "Priority", -1)),
                  withDirectives(createBaseVNode("select", {
                    "onUpdate:modelValue": _cache[12] || (_cache[12] = ($event) => createForm.value.priority = $event),
                    class: "w-full px-4 py-2 border border-slate-200 rounded-xl text-xs font-bold text-slate-655 focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 focus:bg-white transition-all outline-none bg-white cursor-pointer"
                  }, [..._cache[30] || (_cache[30] = [
              ...
              createForm.value.ticket_type === "library" ? (openBlock(), createElementBlock("div", _hoisted_56, [
                _cache[33] || (_cache[33] = createBaseVNode("label", { class: "block text-xs font-bold text-slate-500 mb-1.5 uppercase tracking-wider" }, "Select Library", -1)),
                withDirectives(createBaseVNode("select", {
                  "onUpdate:modelValue": _cache[13] || (_cache[13] = ($event) => createForm.value.library_id = $event),
                  required: "",
                  class: "w-full px-4 py-2 border border-slate-200 rounded-xl text-xs font-bold text-slate-655 focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 focus:bg-white transition-all outline-none bg-white cursor-pointer"
                }, [
                  ...
                  (openBlock(true), createElementBlock(Fragment, null, renderList(libraries.value, (lib) => {
                    return openBlock(), createElementBlock("option", {
                      key: lib.id,
                      value: lib.id
                    }, toDisplayString(lib.name), 9, _hoisted_57);
                  }), 128))
                ], 512), [
              ...
              createBaseVNode("div", null, [
                _cache[34] || (_cache[34] = createBaseVNode("label", { class: "block text-xs font-bold text-slate-500 mb-1.5 uppercase tracking-wider" }, "Description", -1)),
                withDirectives(createBaseVNode("textarea", {
                  "onUpdate:modelValue": _cache[14] || (_cache[14] = ($event) => createForm.value.message = $event),
                  required: "",
                  rows: "4",
              ...
              createBaseVNode("div", _hoisted_58, [
                createBaseVNode("button", {
                  type: "button",
                  onClick: _cache[15] || (_cache[15] = ($event) => showCreateModal.value = false),
                ...
                createBaseVNode("button", {
                  ...
                  !creating.value ? (openBlock(), createElementBlock("span", _hoisted_60, "Submit Ticket")) : (openBlock(), createBlock(unref(LoaderCircle), {
                    key: 1,
...
const SupportSystem = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-c95dcb4c"]]);
export {
  SupportSystem as S
};
