import { d as defineComponent, r as ref, c as computed, G as watch, o as onMounted, a as createElementBlock, b as createBaseVNode, f as createVNode, u as unref, i as createTextVNode, t as toDisplayString, F as Fragment, j as renderList, e as createStaticVNode, q as normalizeStyle, n as normalizeClass, w as withCtx, g as resolveComponent, L as studentAPI, l as createCommentVNode, k as openBlock } from "./main-DKJzpCzk.js";
...
import { C as CalendarCheck } from "./calendar-check-CYaxBsba.js";
...
const _hoisted_7 = { class: "text-3xl font-black text-slate-800 leading-none" };
...
const _hoisted_12 = { class: "text-3xl font-black text-slate-800 leading-none" };
...
const _hoisted_17 = { class: "text-3xl font-black text-slate-800 leading-none" };
...
const _hoisted_22 = { class: "text-base font-black text-slate-800" };
...
const _hoisted_30 = { class: "flex items-center justify-between text-xs font-bold" };
const _hoisted_31 = { class: "font-extrabold text-slate-800" };
const _hoisted_32 = { class: "flex items-center justify-between text-xs font-bold" };
const _hoisted_33 = { class: "font-extrabold text-emerald-600" };
...
const _hoisted_45 = { class: "w-9 h-9 rounded-xl bg-slate-50 border border-slate-100 flex items-center justify-center text-slate-600 font-black text-xs group-hover:bg-blue-600 group-hover:text-white group-hover:border-blue-500 transition-all duration-300" };
const _hoisted_46 = { class: "text-left" };
const _hoisted_47 = { class: "text-xs font-bold text-slate-800 leading-snug" };
const _hoisted_48 = { class: "text-[9px] text-slate-400 font-extrabold uppercase mt-0.5 leading-none" };
const _hoisted_49 = { class: "px-6 py-4 text-left" };
const _hoisted_50 = { class: "text-xs font-bold text-slate-700" };
const _hoisted_51 = { class: "px-6 py-4" };
const _hoisted_52 = { class: "flex items-center text-[11px] font-extrabold text-emerald-600 bg-emerald-50/60 border border-emerald-100/50 px-2.5 py-1 rounded-lg w-fit" };
const _hoisted_53 = { class: "px-6 py-4" };
const _hoisted_54 = {
  key: 0,
  class: "flex items-center text-[11px] font-extrabold text-red-500 bg-red-50/60 border border-red-100/50 px-2.5 py-1 rounded-lg w-fit"
};
const _hoisted_55 = {
  key: 1,
  class: "flex items-center text-[9px] font-black uppercase tracking-widest text-blue-600 bg-blue-50/50 border border-blue-100/30 px-2.5 py-1 rounded-lg w-fit animate-pulse"
};
const _hoisted_56 = { class: "px-6 py-4 text-center" };
const _hoisted_57 = { class: "text-xs font-black text-slate-700" };
const _hoisted_58 = { class: "px-6 py-4 text-right" };
const _hoisted_59 = { class: "px-6 py-4 bg-slate-50/30 border-t border-slate-100 flex items-center justify-between text-[10px] font-extrabold text-slate-400 uppercase tracking-widest" };
        ...
        createBaseVNode("div", _hoisted_2, [
          createBaseVNode("div", _hoisted_3, [
            ...
            createBaseVNode("div", _hoisted_6, [
              _cache[1] || (_cache[1] = createBaseVNode("p", { class: "text-[10px] font-extrabold text-slate-400 uppercase tracking-widest leading-none mb-2" }, "This Month", -1)),
              createBaseVNode("p", _hoisted_7, [
                createTextVNode(toDisplayString(stats.value.attendance_this_month || 0) + " ", 1),
                _cache[0] || (_cache[0] = createBaseVNode("span", { class: "text-xs font-bold text-slate-400 ml-1 uppercase tracking-wide" }, "Days", -1))
              ])
            ])
          ]),
          createBaseVNode("div", _hoisted_8, [
            ...
            createBaseVNode("div", _hoisted_11, [
              _cache[3] || (_cache[3] = createBaseVNode("p", { class: "text-[10px] font-extrabold text-slate-400 uppercase tracking-widest leading-none mb-2" }, "Current Streak", -1)),
              createBaseVNode("p", _hoisted_12, [
                createTextVNode(toDisplayString(stats.value.current_streak || 0) + " ", 1),
                _cache[2] || (_cache[2] = createBaseVNode("span", { class: "text-xs font-bold text-slate-400 ml-1 uppercase tracking-wide" }, "Days", -1))
              ])
            ])
          ]),
          createBaseVNode("div", _hoisted_13, [
            ...
            createBaseVNode("div", _hoisted_16, [
              _cache[5] || (_cache[5] = createBaseVNode("p", { class: "text-[10px] font-extrabold text-slate-400 uppercase tracking-widest leading-none mb-2" }, "Total Hours", -1)),
              createBaseVNode("p", _hoisted_17, [
                createTextVNode(toDisplayString(stats.value.total_hours || 0) + " ", 1),
                _cache[4] || (_cache[4] = createBaseVNode("span", { class: "text-xs font-bold text-slate-400 ml-1 uppercase tracking-wide" }, "Hours", -1))
              ])
            ])
          ])
        ]),
          ...
          createBaseVNode("div", _hoisted_19, [
            ...
            createBaseVNode("div", _hoisted_24, [
              (openBlock(), createElementBlock(Fragment, null, renderList(["S", "M", "T", "W", "T", "F", "S"], (d) => {
                return createBaseVNode("div", {
                  key: d + Math.random(),
                  class: "text-[10px] font-extrabold text-slate-400 uppercase tracking-widest py-1"
                }, toDisplayString(d), 1);
              }), 64))
            ]),
            calendarLoading.value ? (openBlock(), createElementBlock("div", _hoisted_25, [..._cache[6] || (_cache[6] = [
            ...
            createBaseVNode("div", _hoisted_29, [
              createBaseVNode("div", _hoisted_30, [
                _cache[7] || (_cache[7] = createBaseVNode("span", { class: "text-slate-400 uppercase tracking-wide" }, "Days attended", -1)),
                createBaseVNode("span", _hoisted_31, toDisplayString(calendarData.value.total_attended) + " days", 1)
              ]),
              createBaseVNode("div", _hoisted_32, [
                _cache[8] || (_cache[8] = createBaseVNode("span", { class: "text-slate-400 uppercase tracking-wide" }, "Attendance rate", -1)),
              ...
              _cache[9] || (_cache[9] = createStaticVNode('<div class="flex flex-wrap gap-x-4 gap-y-1.5 pt-1" data-v-d4a5e0e2><div class="flex items-center space-x-1.5 text-[10px] font-extrabold text-slate-400 uppercase tracking-wide" data-v-d4a5e0e2><div class="w-2.5 h-2.5 rounded-full bg-emerald-50 border border-emerald-300" data-v-d4a5e0e2></div><span data-v-d4a5e0e2>Attended</span></div><div class="flex items-center space-x-1.5 text-[10px] font-extrabold text-slate-400 uppercase tracking-wide" data-v-d4a5e0e2><div class="w-2.5 h-2.5 rounded-full bg-blue-600" data-v-d4a5e0e2></div><span data-v-d4a5e0e2>Today</span></div><div class="flex items-center space-x-1.5 text-[10px] font-extrabold text-slate-400 uppercase tracking-wide" data-v-d4a5e0e2><div class="w-2.5 h-2.5 rounded-full bg-white border border-slate-200" data-v-d4a5e0e2></div><span data-v-d4a5e0e2>Absent</span></div></div>', 1))
            ])
          ]),
          createBaseVNode("div", _hoisted_35, [
            createBaseVNode("div", _hoisted_36, [
              _cache[10] || (_cache[10] = createBaseVNode("div", { class: "text-left" }, [
                createBaseVNode("h2", { class: "text-base font-extrabold text-slate-800" }, "Attendance Logs"),
                createBaseVNode("p", { class: "text-xs text-slate-400 mt-0.5" }, "A detailed record of your library visits")
              ], -1)),
              createBaseVNode("button", {
            ...
            loading.value ? (openBlock(), createElementBlock("div", _hoisted_37, [..._cache[11] || (_cache[11] = [
              createBaseVNode("div", { class: "w-9 h-9 border-2 border-blue-600 border-t-transparent rounded-full animate-spin" }, null, -1),
              createBaseVNode("p", { class: "text-slate-400 font-extrabold animate-pulse uppercase tracking-wider text-[10px]" }, "Loading logs...", -1)
            ])])) : attendance.value.length === 0 ? (openBlock(), createElementBlock("div", _hoisted_38, [
              createBaseVNode("div", _hoisted_39, [
                createVNode(unref(FileText), { class: "w-7 h-7" })
              ]),
              _cache[13] || (_cache[13] = createBaseVNode("h3", { class: "text-base font-bold text-slate-800 mb-1" }, "No Attendance Yet", -1)),
              _cache[14] || (_cache[14] = createBaseVNode("p", { class: "text-xs text-slate-400 max-w-xs mx-auto leading-relaxed" }, "Start by booking a seat and checking in. Your attendance will automatically appear here.", -1)),
              createVNode(_component_router_link, {
                to: "/student/libraries",
                class: "mt-6 inline-flex items-center space-x-1.5 bg-blue-600 hover:from-blue-700 hover:to-cyan-600 text-white px-5 py-2.5 rounded-xl font-extrabold shadow-md shadow-blue-500/10 active:scale-98 transition-all uppercase tracking-wider text-[10px]"
              }, {
                default: withCtx(() => [
                  createVNode(unref(Armchair), { class: "w-4 h-4" }),
                  _cache[12] || (_cache[12] = createBaseVNode("span", null, "Book Your First Seat", -1))
                ]),
                _: 1
              })
              ...
              createBaseVNode("table", _hoisted_41, [
                _cache[15] || (_cache[15] = createBaseVNode("thead", null, [
                  createBaseVNode("tr", { class: "bg-slate-50/50 border-b border-slate-100 text-[10px] uppercase font-black tracking-wider text-slate-400" }, [
...
const AttendancePage = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-d4a5e0e2"]]);
export {
