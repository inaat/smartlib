import { d as defineComponent, r as ref, c as computed, o as onMounted, a as createElementBlock, b as createBaseVNode, l as createCommentVNode, f as createVNode, u as unref, p as withDirectives, v as vModelText, D as vModelSelect, n as normalizeClass, F as Fragment, j as renderList, t as toDisplayString, z as withModifiers, h as createBlock, B as vModelCheckbox, X as adminAPI, i as createTextVNode, q as normalizeStyle, w as withCtx, g as resolveComponent, k as openBlock } from "./main-BV94XoeK.js";
...
const _hoisted_20 = { class: "text-xs text-slate-500 line-clamp-2 mt-2 leading-relaxed text-left" };
const _hoisted_21 = { class: "space-y-1 pt-1 text-left" };
const _hoisted_22 = { class: "flex items-center justify-between text-[10px] font-bold text-slate-400 uppercase tracking-wider" };
const _hoisted_23 = { class: "w-full bg-slate-100 rounded-full h-2 overflow-hidden" };
const _hoisted_24 = { class: "grid grid-cols-2 gap-3 my-2 pt-1" };
const _hoisted_25 = { class: "p-3 bg-purple-50/50 rounded-xl flex flex-col text-left border border-slate-100" };
const _hoisted_26 = { class: "text-base font-black text-purple-700 mt-1" };
const _hoisted_27 = { class: "p-3 bg-fuchsia-50/40 rounded-xl flex flex-col text-left border border-slate-100" };
const _hoisted_28 = { class: "text-base font-black text-fuchsia-700 mt-1" };
const _hoisted_29 = { class: "flex items-center justify-between pt-4 mt-4 border-t border-slate-100" };
const _hoisted_30 = { class: "flex items-center space-x-1.5" };
...
const _hoisted_34 = { class: "bg-white rounded-3xl shadow-xl w-full max-w-md overflow-hidden animate-in fade-in zoom-in duration-200 border border-slate-100 flex flex-col" };
...
const _hoisted_38 = { class: "flex items-center space-x-4 mt-1" };
const _hoisted_39 = { class: "w-12 h-12 rounded-lg border border-slate-200 bg-slate-50 overflow-hidden flex items-center justify-center flex-shrink-0" };
const _hoisted_40 = ["src"];
const _hoisted_41 = { class: "flex items-center space-x-4 pt-1" };
const _hoisted_42 = { class: "flex items-center space-x-2 cursor-pointer" };
const _hoisted_43 = { class: "flex items-center space-x-2 cursor-pointer" };
const _hoisted_44 = { class: "pt-4 flex items-center space-x-3" };
            ...
            return openBlock(), createElementBlock("div", {
              ...
              createBaseVNode("div", _hoisted_15, [
                createBaseVNode("div", _hoisted_16, [
                  ...
                  createBaseVNode("p", _hoisted_20, toDisplayString(library.description || "No description provided."), 1),
                  ...
                  createBaseVNode("div", _hoisted_24, [
                    createBaseVNode("div", _hoisted_25, [
                      ...
                      createBaseVNode("span", _hoisted_26, toDisplayString(library.totalSeats || library.capacity), 1)
                    ]),
                    createBaseVNode("div", _hoisted_27, [
                      ...
                      createBaseVNode("span", _hoisted_28, toDisplayString(library.availableSeats || 0), 1)
                    ])
                  ])
                ]),
        ...
        showModal.value ? (openBlock(), createElementBlock("div", _hoisted_33, [
          createBaseVNode("div", _hoisted_34, [
            createBaseVNode("div", _hoisted_35, [
              createBaseVNode("h2", _hoisted_36, toDisplayString(isEditing.value ? "Edit Library" : "Add New Library"), 1),
              createBaseVNode("button", {
            ...
            createBaseVNode("form", {
                ...
                createBaseVNode("div", _hoisted_38, [
                  createBaseVNode("div", _hoisted_39, [
                    adminPhotoPreview.value || form.value.photo_url ? (openBlock(), createElementBlock("img", {
                      ...
                      class: "w-full h-full object-cover",
                      alt: "Library preview"
                    }, null, 8, _hoisted_40)) : (openBlock(), createBlock(unref(Building2), {
                      key: 1,
              ...
              createBaseVNode("div", _hoisted_44, [
                ...
                createBaseVNode("button", {
                  ...
                  saving.value ? (openBlock(), createElementBlock("span", _hoisted_46, "Saving...")) : (openBlock(), createElementBlock("span", _hoisted_47, toDisplayString(isEditing.value ? "Update Library" : "Create Library"), 1))
                ], 8, _hoisted_45)
              ])
            ], 32)
          ])
...
const LibraryManagementPage = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-fc66a928"]]);
export {
