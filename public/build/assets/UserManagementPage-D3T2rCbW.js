import { d as defineComponent, r as ref, c as computed, o as onMounted, a as createElementBlock, b as createBaseVNode, j as createCommentVNode, f as createVNode, u as unref, t as toDisplayString, p as withDirectives, v as vModelText, D as vModelSelect, F as Fragment, k as renderList, e as createStaticVNode, n as normalizeClass, z as withModifiers, X as adminAPI, h as createBlock, i as createTextVNode, l as openBlock } from "./main-BGbL_8Ba.js";
...
import { C as CreditCard } from "./credit-card-DF3rztsE.js";
...
const _hoisted_41 = { class: "text-xs font-bold text-slate-700" };
const _hoisted_42 = { class: "text-[10px] text-slate-400 font-semibold tracking-wide mt-0.5 uppercase" };
const _hoisted_43 = { class: "px-6 py-4 whitespace-nowrap text-left" };
const _hoisted_44 = {
  key: 0,
  class: "flex flex-col"
};
const _hoisted_45 = { class: "inline-flex items-center px-2.5 py-0.5 rounded-full text-[10px] font-bold bg-purple-50 text-purple-700 border border-purple-100" };
const _hoisted_46 = { class: "text-[9px] text-slate-400 mt-1" };
const _hoisted_47 = {
  key: 1,
  class: "text-xs text-slate-400 italic"
};
const _hoisted_48 = { class: "px-6 py-4 whitespace-nowrap text-left" };
const _hoisted_49 = ["onClick", "disabled"];
const _hoisted_50 = { class: "px-6 py-4 whitespace-nowrap text-right" };
const _hoisted_51 = { class: "flex items-center justify-end space-x-2" };
...
const _hoisted_57 = { class: "bg-white rounded-3xl shadow-xl w-full max-w-md overflow-hidden animate-in fade-in zoom-in duration-200 border border-slate-100 flex flex-col" };
const _hoisted_58 = { class: "p-6 border-b border-slate-100 flex items-center justify-between text-left" };
const _hoisted_59 = { class: "text-lg font-bold text-slate-800" };
const _hoisted_60 = { class: "grid grid-cols-2 gap-4" };
const _hoisted_61 = { key: 0 };
const _hoisted_62 = { class: "grid grid-cols-2 gap-4" };
const _hoisted_63 = { class: "pt-4 flex items-center space-x-3" };
...
const _hoisted_68 = { class: "bg-white rounded-3xl shadow-xl w-full max-w-md overflow-hidden animate-in fade-in zoom-in duration-200 border border-slate-100 flex flex-col" };
const _hoisted_69 = { class: "p-6 border-b border-slate-100 flex items-center justify-between text-left" };
const _hoisted_70 = { class: "text-xs text-slate-500 mt-1 mb-2 font-medium" };
const _hoisted_71 = { class: "pt-4 flex items-center space-x-3" };
        ...
        createBaseVNode("div", _hoisted_21, [
          createBaseVNode("div", _hoisted_22, [
            ...
            withDirectives(createBaseVNode("select", {
              ...
              createStaticVNode('<option value="" data-v-61c4ebdf>All Status</option><option value="approved" data-v-61c4ebdf>Approved</option><option value="pending" data-v-61c4ebdf>Pending</option><option value="suspended" data-v-61c4ebdf>Suspended</option><option value="banned" data-v-61c4ebdf>Banned</option>', 5)
            ])], 512), [
                ...
                (openBlock(true), createElementBlock(Fragment, null, renderList(filteredUsers.value, (user) => {
                  return openBlock(), createElementBlock("tr", {
                    ...
                    createBaseVNode("td", _hoisted_40, [
                      createBaseVNode("div", _hoisted_41, "CRN: " + toDisplayString(user.crn || "N/A"), 1),
                      createBaseVNode("div", _hoisted_42, "Level: " + toDisplayString(user.ca_level || "No Level"), 1)
                    ]),
                    createBaseVNode("td", _hoisted_43, [
                      user.active_subscription ? (openBlock(), createElementBlock("div", _hoisted_44, [
                        createBaseVNode("span", _hoisted_45, toDisplayString(user.active_subscription.subscription_plan?.name), 1),
                        createBaseVNode("span", _hoisted_46, "Expires: " + toDisplayString(formatDate(user.active_subscription.expires_at)), 1)
                      ])) : (openBlock(), createElementBlock("div", _hoisted_47, "No active plan"))
                    ]),
        ...
        showModal.value ? (openBlock(), createElementBlock("div", _hoisted_56, [
          createBaseVNode("div", _hoisted_57, [
            createBaseVNode("div", _hoisted_58, [
              createBaseVNode("h2", _hoisted_59, toDisplayString(isEditing.value ? "Edit Student" : "Add New Student"), 1),
              createBaseVNode("button", {
            ...
            createBaseVNode("form", {
              ...
              !isEditing.value ? (openBlock(), createElementBlock("div", _hoisted_61, [
              ...
              createBaseVNode("div", _hoisted_63, [
                ...
                createBaseVNode("button", {
                  ...
                  saving.value ? (openBlock(), createElementBlock("span", _hoisted_65, "Saving...")) : (openBlock(), createElementBlock("span", _hoisted_66, toDisplayString(isEditing.value ? "Update Student" : "Create Student"), 1))
                ], 8, _hoisted_64)
              ])
            ], 32)
          ])
        ])) : createCommentVNode("", true),
        showBanModal.value ? (openBlock(), createElementBlock("div", _hoisted_67, [
          createBaseVNode("div", _hoisted_68, [
            ...
            createBaseVNode("form", {
              ...
              createBaseVNode("div", null, [
                ...
                createBaseVNode("p", _hoisted_70, "Student: " + toDisplayString(banForm.value.userName), 1)
              ]),
              createBaseVNode("div", null, [
              ...
              createBaseVNode("div", _hoisted_71, [
                ...
                createBaseVNode("button", {
                  ...
                  banning.value ? (openBlock(), createElementBlock("span", _hoisted_73, "Banning...")) : (openBlock(), createElementBlock("span", _hoisted_74, "Confirm Ban"))
                ], 8, _hoisted_72)
              ])
            ], 32)
          ])
...
const UserManagementPage = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-61c4ebdf"]]);
export {
