import { c as createLucideIcon, d as defineComponent, z as useAuth, r as ref, A as reactive, o as onMounted, a as computed, h as resolveComponent, b as createElementBlock, m as openBlock, f as createStaticVNode, e as createBaseVNode, p as createCommentVNode, g as createVNode, n as normalizeClass, s as withDirectives, H as vModelSelect, F as Fragment, k as renderList, t as toDisplayString, v as vModelText, u as unref, C as Clock, R as RefreshCw, j as createTextVNode, i as createBlock, B as withModifiers, W as librarianAPI, a0 as supportAPI, _ as _export_sfc } from "./main-BeUqjoax.js";
...
`;
    ...
    const toggleScheduleStatus = async (sr) => {
      try {
    ...
    const deleteScheduled = async (sr) => {
      try {
    ...
    return (_ctx, _cache) => {
      ...
      return openBlock(), createElementBlock("div", _hoisted_1, [
        _cache[133] || (_cache[133] = createStaticVNode('<div class="relative overflow-hidden rounded-xl bg-emerald-700 p-6 text-white shadow-md text-left" data-v-c46a405a><div class="absolute top-0 right-0 w-64 h-64 bg-white/5 rounded-full -translate-y-1/2 translate-x-1/3" data-v-c46a405a></div><div class="absolute bottom-0 left-16 w-40 h-40 bg-white/5 rounded-full translate-y-1/2" data-v-c46a405a></div><div class="relative z-10 max-w-2xl" data-v-c46a405a><h1 class="text-2xl font-bold tracking-tight leading-tight" data-v-c46a405a>Library Reports Center</h1><p class="text-white/70 mt-1 text-xs font-medium leading-relaxed" data-v-c46a405a> Generate real-time analytics, export data spreadsheets, or configure automated report delivery directly to your inbox. </p></div></div>', 1)),
          ...
          createBaseVNode("div", {
            ...
            createBaseVNode("div", null, [
              ...
              withDirectives(createBaseVNode("select", {
                ...
                createStaticVNode('<option value="today" data-v-c46a405a>Today</option><option value="week" data-v-c46a405a>This Week</option><option value="month" data-v-c46a405a>This Month</option><option value="year" data-v-c46a405a>This Year</option><option value="custom" data-v-c46a405a>Custom Range</option>', 5)
              ])], 544), [
            ...
            createBaseVNode("div", _hoisted_8, [
              ...
              createBaseVNode("div", null, [
                ...
                withDirectives(createBaseVNode("select", {
                  ...
                  createStaticVNode('<option value="all" data-v-c46a405a>All Statuses</option><option value="booked" data-v-c46a405a>Booked</option><option value="checked_in" data-v-c46a405a>Checked In</option><option value="checked_out" data-v-c46a405a>Checked Out</option><option value="cancelled" data-v-c46a405a>Cancelled</option>', 5)
                ])], 512), [
              ...
              createBaseVNode("div", null, [
                ...
                withDirectives(createBaseVNode("select", {
                  ...
                  createStaticVNode('<option value="all" data-v-c46a405a>All Overstays</option><option value="on_time" data-v-c46a405a>Checked Out On Time</option><option value="early" data-v-c46a405a>Early Check-out</option><option value="overstay" data-v-c46a405a>Overstay (&lt; 1 Hour)</option><option value="serious_overstay" data-v-c46a405a>Serious Overstay (≥ 1 Hour)</option><option value="cancelled" data-v-c46a405a>Auto Cancelled</option>', 6)
                ])], 512), [
            ...
            createBaseVNode("div", _hoisted_10, [
              ...
              createBaseVNode("div", null, [
                ...
                withDirectives(createBaseVNode("select", {
                  ...
                  createStaticVNode('<option value="all" data-v-c46a405a>All Categories</option><option value="Fiction" data-v-c46a405a>Fiction</option><option value="Science" data-v-c46a405a>Science</option><option value="Technology" data-v-c46a405a>Technology</option><option value="Mathematics" data-v-c46a405a>Mathematics</option><option value="History" data-v-c46a405a>History</option><option value="Biography" data-v-c46a405a>Biography</option>', 7)
                ])], 512), [
              ...
              createBaseVNode("div", null, [
                ...
                withDirectives(createBaseVNode("select", {
                  ...
                  createStaticVNode('<option value="all" data-v-c46a405a>All Statuses</option><option value="pending" data-v-c46a405a>Pending Approval</option><option value="approved" data-v-c46a405a>Approved</option><option value="rejected" data-v-c46a405a>Rejected</option><option value="collected" data-v-c46a405a>Collected</option>', 5)
                ])], 512), [
              ...
              createBaseVNode("div", null, [
                ...
                withDirectives(createBaseVNode("select", {
                  ...
                  createStaticVNode('<option value="all" data-v-c46a405a>All Returns</option><option value="Returned On Time" data-v-c46a405a>Returned On Time</option><option value="Returned Early" data-v-c46a405a>Returned Early</option><option value="Returned Late" data-v-c46a405a>Returned Late</option><option value="Not Picked Up" data-v-c46a405a>Not Picked Up</option><option value="Borrowed" data-v-c46a405a>Borrowed (Active)</option><option value="Overdue" data-v-c46a405a>Overdue (Active)</option>', 7)
                ])], 512), [
            ...
            createBaseVNode("div", _hoisted_14, [
              ...
              createBaseVNode("div", null, [
                ...
                withDirectives(createBaseVNode("select", {
                  ...
                  createStaticVNode('<option value="all" data-v-c46a405a>All Statuses</option><option value="available" data-v-c46a405a>Available</option><option value="borrowed" data-v-c46a405a>Borrowed</option><option value="reserved" data-v-c46a405a>Reserved</option><option value="maintenance" data-v-c46a405a>Maintenance</option>', 5)
                ])], 512), [
            ...
            createBaseVNode("div", _hoisted_16, [
              ...
              createBaseVNode("div", null, [
                ...
                withDirectives(createBaseVNode("select", {
                  ...
                  createStaticVNode('<option value="all" data-v-c46a405a>All Priorities</option><option value="low" data-v-c46a405a>Low</option><option value="medium" data-v-c46a405a>Medium</option><option value="high" data-v-c46a405a>High</option><option value="urgent" data-v-c46a405a>Urgent</option>', 5)
                ])], 512), [
              ...
              createBaseVNode("div", null, [
                ...
                withDirectives(createBaseVNode("select", {
                  ...
                  createStaticVNode('<option value="all" data-v-c46a405a>All Statuses</option><option value="open" data-v-c46a405a>Pending</option><option value="in_progress" data-v-c46a405a>In Progress</option><option value="resolved" data-v-c46a405a>Resolved</option><option value="closed" data-v-c46a405a>Closed</option>', 5)
                ])], 512), [
            ...
            createBaseVNode("div", _hoisted_18, [
              ...
              createBaseVNode("div", null, [
                ...
                withDirectives(createBaseVNode("select", {
                  ...
                  createStaticVNode('<option value="all" data-v-c46a405a>All Types</option><option value="seminar" data-v-c46a405a>Seminar</option><option value="workshop" data-v-c46a405a>Workshop</option><option value="study_group" data-v-c46a405a>Study Group</option><option value="exam_prep" data-v-c46a405a>Exam Prep</option><option value="career_guidance" data-v-c46a405a>Career Guidance</option><option value="networking" data-v-c46a405a>Networking</option>', 7)
                ])], 512), [
              ...
              createBaseVNode("div", null, [
                ...
                withDirectives(createBaseVNode("select", {
                  ...
                  createStaticVNode('<option value="all" data-v-c46a405a>All Statuses</option><option value="upcoming" data-v-c46a405a>Upcoming</option><option value="ongoing" data-v-c46a405a>Ongoing</option><option value="completed" data-v-c46a405a>Completed</option><option value="cancelled" data-v-c46a405a>Cancelled</option>', 5)
                ])], 512), [
                    ...
                    return openBlock(), createElementBlock("tr", {
                      ...
                      createBaseVNode("td", _hoisted_167, [
                        createBaseVNode("div", _hoisted_168, [
                          createBaseVNode("button", {
                            onClick: ($event) => toggleScheduleStatus(sr),
                          ...
                          createBaseVNode("button", {
                            onClick: ($event) => deleteScheduled(sr),
...
const ReportsPage = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-c46a405a"]]);
export {
