...
const _hoisted_8 = { class: "text-[10px] font-extrabold text-slate-400 uppercase tracking-widest leading-none truncate" };
const _hoisted_9 = { class: "text-xl font-black text-slate-800 mt-1 leading-none" };
...
const _hoisted_16 = { class: "absolute bottom-full left-1/2 transform -translate-x-1/2 mb-2 px-2.5 py-1.5 bg-slate-800 text-white text-[10px] rounded-lg opacity-0 group-hover:opacity-100 transition-opacity duration-200 whitespace-nowrap z-10 shadow-lg font-bold border border-slate-700" };
const _hoisted_17 = { class: "flex justify-between mt-5 px-2 text-[10px] font-extrabold text-slate-400 uppercase tracking-wider" };
...
const _hoisted_28 = { class: "text-xs font-bold text-slate-800 block truncate leading-snug" };
const _hoisted_29 = { class: "text-[9px] uppercase font-extrabold text-slate-400 tracking-wider leading-none mt-1 block" };
...
const _hoisted_41 = { class: "text-xs font-bold text-slate-800" };
const _hoisted_42 = { class: "px-6 py-4.5 text-xs font-bold text-slate-600" };
const _hoisted_43 = { class: "px-6 py-4.5" };
const _hoisted_44 = { class: "px-6 py-4.5 text-xs font-extrabold text-slate-400 text-right" };
          ...
          createBaseVNode("div", _hoisted_10, [
            createBaseVNode("div", _hoisted_11, [
              createBaseVNode("div", _hoisted_12, [
                createBaseVNode("div", _hoisted_13, [
                  ...
                  _cache[1] || (_cache[1] = createBaseVNode("h3", { class: "font-extrabold text-slate-800 text-sm" }, "Study Frequency (Last 30 Days)", -1))
                ])
              ]),
            ...
            createBaseVNode("div", _hoisted_18, [
              createBaseVNode("div", _hoisted_19, [
                ...
                _cache[2] || (_cache[2] = createBaseVNode("h3", { class: "font-extrabold text-slate-800 text-sm" }, "Favorite Spots", -1))
              ]),
          ...
          createBaseVNode("div", _hoisted_30, [
            createBaseVNode("div", _hoisted_31, [
              createBaseVNode("div", _hoisted_32, [
                ...
                _cache[4] || (_cache[4] = createBaseVNode("h3", { class: "font-extrabold text-slate-800 text-sm" }, "Recent Activity", -1))
              ]),
              createVNode(_component_router_link, {
                to: "/student/libraries",
                class: "text-[10px] font-black text-emerald-600 hover:text-emerald-700 uppercase tracking-widest bg-emerald-50 hover:bg-emerald-100 px-3 py-1.5 rounded-lg border border-emerald-200 transition-colors"
              }, {
            ...
            createBaseVNode("div", _hoisted_34, [
              createBaseVNode("table", _hoisted_35, [
                _cache[7] || (_cache[7] = createBaseVNode("thead", null, [
                  createBaseVNode("tr", { class: "bg-slate-50/50 border-b border-slate-100 text-slate-400 text-[10px] font-extrabold uppercase tracking-wider" }, [
                    ...
                    return openBlock(), createElementBlock("tr", {
                      ...
                      createBaseVNode("td", _hoisted_43, [
                        createBaseVNode("span", {
                          class: normalizeClass(["px-2.5 py-1 rounded-lg text-[9px] font-black uppercase tracking-wider border", getStatusClass(booking.status)])
...
const AnalyticsPage = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-b6da2f10"]]);
export {
