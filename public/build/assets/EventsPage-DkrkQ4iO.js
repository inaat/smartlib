...
const _hoisted_12 = { class: "inline-block text-[9px] font-semibold text-blue-600 bg-blue-50/50 px-2 py-0.5 rounded uppercase tracking-wider" };
const _hoisted_13 = { class: "flex items-center text-[10px] text-slate-400 font-medium uppercase tracking-wide" };
...
const _hoisted_20 = { class: "flex items-center justify-between text-[10px] text-slate-400 font-semibold uppercase tracking-wide" };
...
const _hoisted_39 = { class: "inline-block text-[9px] font-semibold text-blue-600 bg-blue-50 px-2 py-0.5 rounded border border-blue-150 uppercase tracking-widest" };
const _hoisted_40 = { class: "text-lg font-semibold leading-tight text-slate-900 tracking-tight line-clamp-2" };
const _hoisted_41 = { class: "grid grid-cols-2 gap-4 bg-slate-50 border border-slate-100 rounded-xl p-3.5" };
const _hoisted_42 = { class: "text-[11px] font-semibold text-slate-800 mt-0.5" };
const _hoisted_43 = { class: "text-[11px] font-semibold text-slate-800 mt-0.5" };
const _hoisted_44 = { class: "text-[11px] font-semibold text-slate-800 mt-0.5 truncate" };
...
const _hoisted_51 = { class: "text-xs font-semibold truncate text-slate-900 leading-snug" };
    ...
    return (_ctx, _cache) => {
      ...
      return openBlock(), createElementBlock("div", _hoisted_1, [
        ...
        loading.value ? (openBlock(), createElementBlock("div", _hoisted_4, [..._cache[0] || (_cache[0] = [
          ...
          (openBlock(true), createElementBlock(Fragment, null, renderList(events.value, (event) => {
            return openBlock(), createElementBlock("div", {
              ...
              createBaseVNode("div", _hoisted_10, [
                ...
                createBaseVNode("h3", {
                  class: "font-semibold text-slate-800 text-base mb-1.5 leading-snug group-hover:text-blue-600 transition-colors line-clamp-1",
                  title: event.title
          ...
          _cache[4] || (_cache[4] = createBaseVNode("h3", { class: "text-base font-semibold text-slate-800 mb-1" }, "No upcoming events", -1)),
        ...
        isPassModalOpen.value ? (openBlock(), createElementBlock("div", _hoisted_30, [
          createBaseVNode("div", _hoisted_31, [
            createBaseVNode("div", _hoisted_32, [
              _cache[6] || (_cache[6] = createBaseVNode("span", { class: "text-xs font-semibold uppercase tracking-widest text-slate-500" }, "Digital Event Pass", -1)),
              createBaseVNode("button", {
              ...
              createBaseVNode("div", {
                ...
                createBaseVNode("div", _hoisted_34, [
                  ...
                  _cache[7] || (_cache[7] = createBaseVNode("div", { class: "min-w-0 flex-1" }, [
                    createBaseVNode("h4", { class: "text-sm font-bold uppercase tracking-[0.15em] text-white" }, "GATE PASS")
                  ], -1))
                ]),
                createBaseVNode("div", _hoisted_37, [
                  ...
                  createBaseVNode("div", _hoisted_41, [
                    createBaseVNode("div", null, [
                      _cache[8] || (_cache[8] = createBaseVNode("span", { class: "text-[8px] font-medium text-slate-400 uppercase tracking-widest" }, "Date", -1)),
                      createBaseVNode("p", _hoisted_42, toDisplayString(selectedPassEvent.value ? formatDate(selectedPassEvent.value.date) : ""), 1)
                    ]),
                    createBaseVNode("div", null, [
                      _cache[9] || (_cache[9] = createBaseVNode("span", { class: "text-[8px] font-medium text-slate-400 uppercase tracking-widest" }, "Time", -1)),
                      createBaseVNode("p", _hoisted_43, toDisplayString(selectedPassEvent.value ? formatTime(selectedPassEvent.value.start_time) : ""), 1)
                    ]),
                    createBaseVNode("div", null, [
                      _cache[10] || (_cache[10] = createBaseVNode("span", { class: "text-[8px] font-medium text-slate-400 uppercase tracking-widest" }, "Venue", -1)),
                    ...
                    _cache[11] || (_cache[11] = createBaseVNode("div", null, [
                      createBaseVNode("span", { class: "text-[8px] font-medium text-slate-400 uppercase tracking-widest" }, "Seat"),
                      createBaseVNode("p", { class: "text-[11px] font-semibold text-blue-600 mt-0.5" }, "General Admission")
                    ], -1))
                  ])
                ]),
                  ...
                  createBaseVNode("div", _hoisted_46, [
                    createBaseVNode("div", _hoisted_47, [
                      ...
                      createBaseVNode("div", _hoisted_50, [
                        _cache[12] || (_cache[12] = createBaseVNode("span", { class: "text-[8px] font-medium text-slate-400 uppercase tracking-widest" }, "Attendee", -1)),
                        createBaseVNode("h5", _hoisted_51, toDisplayString(unref(user)?.name), 1),
                        _cache[13] || (_cache[13] = createBaseVNode("p", { class: "text-[9px] text-blue-600 font-semibold uppercase mt-0.5" }, "Verified", -1))
                      ])
                    ]),
                    createBaseVNode("div", null, [
                      _cache[14] || (_cache[14] = createBaseVNode("span", { class: "text-[8px] font-medium text-slate-400 uppercase tracking-widest" }, "Student CRN", -1)),
...
const EventsPage = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-86a5f086"]]);
export {
