import { d as defineComponent, r as ref, c as computed, o as onMounted, a as createElementBlock, b as createBaseVNode, l as createCommentVNode, f as createVNode, p as withDirectives, u as unref, v as vModelText, D as vModelSelect, F as Fragment, j as renderList, t as toDisplayString, i as createTextVNode, n as normalizeClass, h as createBlock, L as studentAPI, k as openBlock } from "./main-DKJzpCzk.js";
import { u as useSwal } from "./useSwal-pQW_XkRe.js";
import { S as Search } from "./search-CJLoyzlx.js";
import { F as Funnel } from "./funnel-DAbrLVrY.js";
...
import { E as Eye } from "./eye-C04wWCod.js";
...
const _hoisted_14 = { class: "absolute top-2.5 right-2.5" };
const _hoisted_15 = {
  key: 0,
...
const _hoisted_18 = { class: "flex-1 flex flex-col min-w-0" };
const _hoisted_19 = { class: "mb-4" };
const _hoisted_20 = { class: "inline-block text-[9px] font-extrabold text-blue-600 bg-blue-50/50 px-2 py-0.5 rounded uppercase tracking-wider mb-2" };
const _hoisted_21 = ["onClick", "title"];
const _hoisted_22 = { class: "text-xs text-slate-400 font-semibold mt-1" };
const _hoisted_23 = { class: "mt-auto mb-4 p-2 bg-slate-50 border border-slate-100/50 rounded-xl flex items-center space-x-2" };
const _hoisted_24 = ["title"];
const _hoisted_25 = { class: "pt-3 border-t border-slate-100 flex items-center space-x-2" };
...
const _hoisted_30 = { class: "w-16 h-16 bg-slate-100 text-slate-400 rounded-full flex items-center justify-center mx-auto mb-4 border border-slate-200/50 shadow-inner animate-pulse-slow" };
const _hoisted_31 = {
  key: 3,
  class: "fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-md animate-fade-in font-outfit"
};
const _hoisted_32 = { class: "bg-white rounded-3xl shadow-2xl w-full max-w-2xl overflow-hidden border border-slate-100 flex flex-col max-h-[90vh] md:max-h-[85vh] animate-scale-up text-left" };
const _hoisted_33 = { class: "px-6 py-4 bg-gradient-to-r from-blue-600 to-indigo-700 text-white flex items-center justify-between" };
const _hoisted_34 = { class: "p-6 overflow-y-auto space-y-6 flex-1" };
const _hoisted_35 = { class: "flex flex-col md:flex-row gap-6" };
const _hoisted_36 = { class: "w-full md:w-44 aspect-[3/4.2] md:h-56 bg-slate-50 border border-slate-100 rounded-2xl overflow-hidden flex-shrink-0 flex items-center justify-center shadow-md" };
const _hoisted_37 = ["src", "alt"];
const _hoisted_38 = {
  key: 1,
  class: "w-full h-full flex flex-col items-center justify-center text-slate-300"
};
const _hoisted_39 = { class: "flex-1 space-y-4" };
const _hoisted_40 = { class: "px-2.5 py-1 bg-blue-50 text-blue-600 text-[10px] font-black uppercase tracking-wider rounded-lg border border-blue-100" };
const _hoisted_41 = { class: "font-black text-slate-800 text-lg leading-tight mt-2.5" };
const _hoisted_42 = { class: "text-xs text-slate-400 font-semibold mt-1" };
const _hoisted_43 = { class: "text-slate-650 font-bold" };
const _hoisted_44 = { class: "grid grid-cols-2 gap-3.5 bg-slate-50/50 p-3.5 border border-slate-100 rounded-2xl text-xs text-slate-500" };
const _hoisted_45 = { class: "font-bold text-slate-700" };
const _hoisted_46 = { class: "font-bold text-slate-700 capitalize" };
const _hoisted_47 = { class: "font-bold text-slate-700" };
const _hoisted_48 = { class: "space-y-2" };
const _hoisted_49 = { class: "text-slate-600 text-xs leading-relaxed bg-slate-50/30 p-4 border border-slate-100 rounded-2xl whitespace-pre-line" };
const _hoisted_50 = {
  key: 0,
...
const _hoisted_53 = { class: "text-xs font-black text-blue-600 bg-blue-50 px-2.5 py-1 rounded-lg border border-blue-100 mt-1 inline-block" };
const _hoisted_54 = { class: "flex flex-col sm:flex-row items-center gap-4 bg-white p-4 rounded-xl border border-slate-100" };
const _hoisted_55 = { class: "flex-1 w-full flex items-center space-x-3.5" };
const _hoisted_56 = ["max"];
const _hoisted_57 = { class: "text-xs font-bold text-slate-400" };
const _hoisted_58 = { class: "flex items-center space-x-2" };
const _hoisted_59 = ["max"];
const _hoisted_60 = { class: "px-6 py-4 bg-slate-50 border-t border-slate-100 flex items-center justify-end space-x-3" };
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", _hoisted_1, [
            ...
            createBaseVNode("div", _hoisted_5, [
              createBaseVNode("div", _hoisted_6, [
                ...
                withDirectives(createBaseVNode("select", {
                  ...
                  _cache[9] || (_cache[9] = createBaseVNode("option", { value: "" }, "All Categories", -1)),
        ...
        loading.value ? (openBlock(), createElementBlock("div", _hoisted_9, [..._cache[11] || (_cache[11] = [
            ...
            return openBlock(), createElementBlock("div", {
              ...
              createBaseVNode("div", {
                ...
                book.cover_url ? (openBlock(), createElementBlock("img", {
                  ...
                  _cache[12] || (_cache[12] = createBaseVNode("span", { class: "text-[10px] font-bold uppercase tracking-wider" }, "No Cover", -1))
                ])),
                createBaseVNode("div", _hoisted_14, [
                  book.type?.toLowerCase() === "digital" ? (openBlock(), createElementBlock("span", _hoisted_15, " Digital ")) : book.availability === "available" ? (openBlock(), createElementBlock("span", _hoisted_16, " Available ")) : (openBlock(), createElementBlock("span", _hoisted_17, " Reserved "))
                ])
              ], 8, _hoisted_11),
              createBaseVNode("div", _hoisted_18, [
                createBaseVNode("div", _hoisted_19, [
                  createBaseVNode("span", _hoisted_20, toDisplayString(book.category), 1),
                  createBaseVNode("h3", {
                    onClick: ($event) => openDetailsModal(book),
                    class: "font-bold text-slate-800 text-sm line-clamp-2 leading-snug group-hover:text-blue-600 transition-colors cursor-pointer",
                    title: book.title
                  }, toDisplayString(book.title), 9, _hoisted_21),
                  createBaseVNode("p", _hoisted_22, "by " + toDisplayString(book.author), 1)
                ]),
                createBaseVNode("div", _hoisted_23, [
                  ...
                  }, toDisplayString(book.library?.name || "Main Library"), 9, _hoisted_24)
                ]),
                createBaseVNode("div", _hoisted_25, [
                  book.type?.toLowerCase() === "digital" ? (openBlock(), createElementBlock(Fragment, { key: 0 }, [
                    createBaseVNode("button", {
                      ...
                      _cache[13] || (_cache[13] = createBaseVNode("span", null, "Read", -1))
                    ], 8, _hoisted_26),
                    createBaseVNode("button", {
          ...
          _cache[14] || (_cache[14] = createBaseVNode("h3", { class: "text-base font-bold text-slate-800 mb-1" }, "No books found", -1)),
          _cache[15] || (_cache[15] = createBaseVNode("p", { class: "text-xs text-slate-400 max-w-sm mx-auto leading-relaxed" }, "Try adjusting your search or filters to find what you're looking for.", -1)),
          createBaseVNode("button", {
            onClick: resetFilters,
            class: "mt-4 px-4 py-2 bg-white hover:bg-slate-50 text-blue-600 rounded-xl text-xs font-bold border border-slate-300 transition-all shadow-sm"
          }, " Clear all filters ")
        ])),
        isDetailsModalOpen.value ? (openBlock(), createElementBlock("div", _hoisted_31, [
          createBaseVNode("div", _hoisted_32, [
            createBaseVNode("div", _hoisted_33, [
              _cache[16] || (_cache[16] = createBaseVNode("h2", { class: "font-extrabold text-sm uppercase tracking-wider" }, "Book Details", -1)),
              createBaseVNode("button", {
                onClick: _cache[3] || (_cache[3] = ($event) => isDetailsModalOpen.value = false),
            ...
            createBaseVNode("div", _hoisted_34, [
              createBaseVNode("div", _hoisted_35, [
                createBaseVNode("div", _hoisted_36, [
                  ...
                  }, null, 8, _hoisted_37)) : (openBlock(), createElementBlock("div", _hoisted_38, [
                    createVNode(unref(Book), { class: "w-12 h-12 mb-2 stroke-1" }),
                    _cache[17] || (_cache[17] = createBaseVNode("span", { class: "text-xs font-bold uppercase tracking-wider" }, "No Cover", -1))
                  ]))
                ]),
                createBaseVNode("div", _hoisted_39, [
                  createBaseVNode("div", null, [
                    createBaseVNode("span", _hoisted_40, toDisplayString(selectedBook.value.category), 1),
                    createBaseVNode("h3", _hoisted_41, toDisplayString(selectedBook.value.title), 1),
                    createBaseVNode("p", _hoisted_42, [
                      _cache[18] || (_cache[18] = createTextVNode("by ", -1)),
                      createBaseVNode("span", _hoisted_43, toDisplayString(selectedBook.value.author), 1)
                    ])
                  ]),
                  createBaseVNode("div", _hoisted_44, [
                    createBaseVNode("div", null, [
                      _cache[19] || (_cache[19] = createBaseVNode("span", { class: "block text-[10px] text-slate-400 uppercase font-black tracking-wider" }, "ISBN", -1)),
                      createBaseVNode("span", _hoisted_45, toDisplayString(selectedBook.value.isbn || "N/A"), 1)
                    ]),
                    createBaseVNode("div", null, [
                      _cache[20] || (_cache[20] = createBaseVNode("span", { class: "block text-[10px] text-slate-400 uppercase font-black tracking-wider" }, "Format / Type", -1)),
                      createBaseVNode("span", _hoisted_46, toDisplayString(selectedBook.value.type), 1)
                    ]),
                    createBaseVNode("div", null, [
                      _cache[21] || (_cache[21] = createBaseVNode("span", { class: "block text-[10px] text-slate-400 uppercase font-black tracking-wider" }, "Availability", -1)),
                      createBaseVNode("span", {
                    ...
                    createBaseVNode("div", null, [
                      _cache[22] || (_cache[22] = createBaseVNode("span", { class: "block text-[10px] text-slate-400 uppercase font-black tracking-wider" }, "Location / Shelf", -1)),
                      createBaseVNode("span", _hoisted_47, toDisplayString(selectedBook.value.location || "N/A"), 1)
                    ])
                  ])
                ])
              ]),
              createBaseVNode("div", _hoisted_48, [
                _cache[23] || (_cache[23] = createBaseVNode("h4", { class: "text-xs font-black uppercase tracking-wider text-slate-450" }, "Synopsis / Description", -1)),
                createBaseVNode("p", _hoisted_49, toDisplayString(selectedBook.value.description || "No description available for this book."), 1)
              ]),
              selectedBook.value.type?.toLowerCase() === "physical" && selectedBook.value.availability === "available" ? (openBlock(), createElementBlock("div", _hoisted_50, [
                createBaseVNode("div", _hoisted_51, [
                  _cache[25] || (_cache[25] = createBaseVNode("div", null, [
                    createBaseVNode("h4", { class: "text-xs font-bold text-slate-800 uppercase tracking-wide" }, "Reservation Duration"),
                  ...
                  createBaseVNode("div", _hoisted_52, [
                    _cache[24] || (_cache[24] = createBaseVNode("span", { class: "block text-[9px] text-slate-400 uppercase font-black tracking-wider" }, "Max Period", -1)),
                    createBaseVNode("span", _hoisted_53, toDisplayString(maxAllowedDays.value) + " Days ", 1)
                  ])
                ]),
                createBaseVNode("div", _hoisted_54, [
                  createBaseVNode("div", _hoisted_55, [
                    _cache[26] || (_cache[26] = createBaseVNode("span", { class: "text-xs font-bold text-slate-400" }, "1d", -1)),
                    withDirectives(createBaseVNode("input", {
                      type: "range",
                      min: "1",
                      max: maxAllowedDays.value,
                      "onUpdate:modelValue": _cache[4] || (_cache[4] = ($event) => reservationDays.value = $event),
                    ...
                    createBaseVNode("span", _hoisted_57, toDisplayString(maxAllowedDays.value) + "d", 1)
                  ]),
                  createBaseVNode("div", _hoisted_58, [
                    ...
                    _cache[27] || (_cache[27] = createBaseVNode("span", { class: "text-xs font-bold text-slate-500" }, "Days", -1))
                  ])
                ])
            ...
            createBaseVNode("div", _hoisted_60, [
              createBaseVNode("button", {
                onClick: _cache[6] || (_cache[6] = ($event) => isDetailsModalOpen.value = false),
              ...
              selectedBook.value.type?.toLowerCase() === "digital" ? (openBlock(), createElementBlock(Fragment, { key: 0 }, [
                createBaseVNode("button", {
                  onClick: _cache[7] || (_cache[7] = ($event) => readBook(selectedBook.value)),
                ...
                createBaseVNode("button", {
                  onClick: _cache[8] || (_cache[8] = ($event) => downloadBook(selectedBook.value)),
                ...
                reserving.value === selectedBook.value.id ? (openBlock(), createElementBlock("span", _hoisted_62)) : (openBlock(), createBlock(unref(Book), {
                  key: 1,
                  class: "w-3.5 h-3.5"
                })),
                _cache[30] || (_cache[30] = createBaseVNode("span", null, "Request Reservation", -1))
...
const BooksPage = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-e738b991"]]);
export {
