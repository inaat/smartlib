...
const sweetalert2_esm_all = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  default: Swal
...
const useSwal = () => {
  ...
  const showConfirm = async (title, text, confirmButtonText = "Yes, confirm") => {
  ...
  const toast = (title, text, icon = "success", timer = 3e3) => {
