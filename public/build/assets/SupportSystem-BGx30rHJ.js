import { d as defineComponent, x as useAuth, c as computed, r as ref, o as onMounted, E as watch, a as createElementBlock, b as createBaseVNode, l as createCommentVNode, n as normalizeClass, f as createVNode, u as unref, t as toDisplayString, p as withDirectives, v as vModelText, F as Fragment, j as renderList, i as createTextVNode, S as withKeys, z as withModifiers, h as createBlock, D as vModelSelect, U as supportAPI, L as studentAPI, N as nextTick, k as openBlock } from "./main-BV94XoeK.js";
...
import { C as CircleCheck } from "./circle-check-BE6-4uUs.js";
...
import { L as LifeBuoy } from "./life-buoy-Cfgxehzf.js";
...
const _hoisted_50 = { class: "relative bg-white rounded-3xl shadow-xl w-full max-w-md overflow-hidden border border-slate-100 text-left animate-in duration-200" };
const _hoisted_51 = { class: "p-6 border-b border-slate-100 flex justify-between items-center text-left" };
          ...
          createBaseVNode("div", _hoisted_28, [
            selectedTicket.value ? (openBlock(), createElementBlock(Fragment, { key: 0 }, [
                  ...
                  return openBlock(), createElementBlock("div", {
                    ...
                    createBaseVNode("div", {
                      ...
                      message.user_id !== unref(currentUser)?.id ? (openBlock(), createElementBlock("div", _hoisted_39, [
                        ...
                        _cache[20] || (_cache[20] = createBaseVNode("span", null, "•", -1)),
              ...
              createBaseVNode("div", _hoisted_42, [
                ...
                _cache[21] || (_cache[21] = createBaseVNode("p", { class: "text-[9px] font-extrabold text-slate-400 uppercase tracking-widest mt-2.5 text-center" }, "Press Enter to send (Shift+Enter for newline)", -1))
              ])
            ], 64)) : (openBlock(), createElementBlock("div", _hoisted_47, [
              createBaseVNode("div", _hoisted_48, [
                createVNode(unref(LifeBuoy), { class: "w-6 h-6 animate-pulse" })
              ]),
              _cache[22] || (_cache[22] = createBaseVNode("h3", { class: "text-sm font-bold text-slate-800 mb-1 uppercase tracking-wider" }, "Support Desk", -1)),
              _cache[23] || (_cache[23] = createBaseVNode("p", { class: "text-xs text-slate-400 max-w-xs leading-relaxed font-semibold" }, "Select a ticket from the left panel to open the conversation, or submit a new ticket for assistance.", -1)),
              userRole.value === "student" ? (openBlock(), createElementBlock("button", {
                key: 0,
        ...
        showCreateModal.value ? (openBlock(), createElementBlock("div", _hoisted_49, [
          createBaseVNode("div", _hoisted_50, [
            ...
            createBaseVNode("form", {
              ...
              createBaseVNode("div", null, [
                _cache[25] || (_cache[25] = createBaseVNode("label", { class: "block text-xs font-bold text-slate-500 mb-1.5 uppercase tracking-wider" }, "Subject", -1)),
                withDirectives(createBaseVNode("input", {
              ...
              createBaseVNode("div", _hoisted_52, [
                createBaseVNode("div", null, [
                  _cache[27] || (_cache[27] = createBaseVNode("label", { class: "block text-xs font-bold text-slate-500 mb-1.5 uppercase tracking-wider" }, "Category", -1)),
                ...
                createBaseVNode("div", null, [
                  _cache[29] || (_cache[29] = createBaseVNode("label", { class: "block text-xs font-bold text-slate-500 mb-1.5 uppercase tracking-wider" }, "Priority", -1)),
                  withDirectives(createBaseVNode("select", {
              ...
              createForm.value.ticket_type === "library" ? (openBlock(), createElementBlock("div", _hoisted_53, [
                _cache[31] || (_cache[31] = createBaseVNode("label", { class: "block text-xs font-bold text-slate-500 mb-1.5 uppercase tracking-wider" }, "Select Library", -1)),
                withDirectives(createBaseVNode("select", {
              ...
              createBaseVNode("div", null, [
                _cache[32] || (_cache[32] = createBaseVNode("label", { class: "block text-xs font-bold text-slate-500 mb-1.5 uppercase tracking-wider" }, "Description", -1)),
                withDirectives(createBaseVNode("textarea", {
...
const SupportSystem = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-9eb652a5"]]);
export {
  SupportSystem as S
};
