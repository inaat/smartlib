import { d as defineComponent, r as ref, c as computed, E as watch, o as onMounted, H as onUnmounted, a as createElementBlock, b as createBaseVNode, f as createVNode, j as createCommentVNode, n as normalizeClass, u as unref, t as toDisplayString, g as resolveComponent, F as Fragment, k as renderList, w as withCtx, T as Transition, p as withDirectives, D as vModelSelect, B as vModelCheckbox, v as vModelText, z as withModifiers, N as api, i as createTextVNode, _ as __vitePreload, l as openBlock } from "./main-BGbL_8Ba.js";
import { u as useSwal } from "./useSwal-pQW_XkRe.js";
import { s as superadminAPI } from "./superadminApi-DlPKiCG5.js";
import { _ as _sfc_main$1 } from "./LibrarySelector.vue_vue_type_script_setup_true_lang-CTjBgaIY.js";
import { S as SeatLayoutRenderer } from "./SeatLayoutRenderer-DKfRoJ-Y.js";
...
const _hoisted_45 = { class: "space-y-4" };
...
const _hoisted_62 = { class: "flex items-center space-x-2" };
const _hoisted_63 = { class: "flex items-center space-x-2" };
const _hoisted_64 = { class: "flex items-center space-x-4" };
const _hoisted_65 = { class: "flex items-center space-x-3 pt-4" };
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const filteredSectionSeats = computed(() => {
      return seats.value.filter((s) => {
        ...
        if (searchQuery.value) {
          ...
          return s.seat_number && s.seat_number.toLowerCase().includes(q) || s.cabin_number && s.cabin_number.toLowerCase().includes(q);
        }
        return true;
      });
    });
    ...
    const autoArrangeLayout = async () => {
      ...
      const naturalCompare = (a, b) => a.localeCompare(b, void 0, { numeric: true, sensitivity: "base" });
  ...
  `;
    ...
    let pollSuperAdminSeatsTimer = null;
    onMounted(() => {
      fetchData();
      ...
      return openBlock(), createElementBlock("div", _hoisted_1, [
        createBaseVNode("div", _hoisted_2, [
          ...
          createBaseVNode("div", _hoisted_3, [
            createBaseVNode("button", {
              onClick: _cache[0] || (_cache[0] = () => fetchData()),
            ...
            selectedLibraryId.value ? (openBlock(), createElementBlock("button", {
              key: 0,
              onClick: _cache[1] || (_cache[1] = ($event) => isLayoutMode.value = !isLayoutMode.value),
            ...
            selectedLibraryId.value ? (openBlock(), createElementBlock("button", {
              ...
              _cache[22] || (_cache[22] = createBaseVNode("span", { class: "text-sm font-medium" }, "Add Seat", -1))
            ])) : createCommentVNode("", true)
          ])
        ]),
        createVNode(_sfc_main$1, {
          modelValue: selectedLibraryId.value,
          "onUpdate:modelValue": _cache[2] || (_cache[2] = ($event) => selectedLibraryId.value = $event)
        }, null, 8, ["modelValue"]),
        selectedLibraryId.value ? (openBlock(), createElementBlock("div", _hoisted_7, [
          createBaseVNode("div", _hoisted_8, [
            createBaseVNode("div", _hoisted_9, [
              ...
              createBaseVNode("div", null, [
                _cache[24] || (_cache[24] = createBaseVNode("p", { class: "text-xs text-gray-600" }, "Total Seats", -1)),
          ...
          createBaseVNode("div", _hoisted_12, [
            createBaseVNode("div", _hoisted_13, [
              ...
              createBaseVNode("div", null, [
                _cache[25] || (_cache[25] = createBaseVNode("p", { class: "text-xs text-gray-600" }, "Available", -1)),
          ...
          createBaseVNode("div", _hoisted_16, [
            createBaseVNode("div", _hoisted_17, [
              ...
              createBaseVNode("div", null, [
                _cache[26] || (_cache[26] = createBaseVNode("p", { class: "text-xs text-gray-600" }, "Occupied", -1)),
          ...
          createBaseVNode("div", _hoisted_20, [
            createBaseVNode("div", _hoisted_21, [
              ...
              createBaseVNode("div", null, [
                _cache[27] || (_cache[27] = createBaseVNode("p", { class: "text-xs text-gray-600" }, "Reserved", -1)),
          ...
          createBaseVNode("div", _hoisted_24, [
            createBaseVNode("div", _hoisted_25, [
              ...
              createBaseVNode("div", null, [
                _cache[28] || (_cache[28] = createBaseVNode("p", { class: "text-xs text-gray-600" }, "Maintenance", -1)),
        ...
        selectedLibraryId.value && sections.value.length > 0 ? (openBlock(), createElementBlock("div", _hoisted_28, [
          createBaseVNode("div", _hoisted_29, [
            createBaseVNode("button", {
              onClick: _cache[3] || (_cache[3] = ($event) => activeSectionId.value = null),
              class: normalizeClass([
          ...
          createBaseVNode("button", {
            ...
            _cache[29] || (_cache[29] = createBaseVNode("span", { class: "hidden sm:inline" }, "Print Section QR", -1))
          ])
        ])) : createCommentVNode("", true),
          ...
          default: withCtx(() => [
            isLayoutMode.value && selectedLibraryId.value ? (openBlock(), createElementBlock("div", _hoisted_31, [
              createBaseVNode("div", _hoisted_32, [
                _cache[30] || (_cache[30] = createBaseVNode("div", { class: "px-3 border-r border-gray-100 mr-2 py-1" }, [
                ...
                _cache[31] || (_cache[31] = createBaseVNode("div", { class: "w-px h-6 bg-gray-100 mx-2" }, null, -1)),
              ...
              createBaseVNode("div", _hoisted_36, [
                ...
                _cache[32] || (_cache[32] = createTextVNode(" Drag seats to reposition or use auto-arrange for standard layouts ", -1))
              ])
            ])) : createCommentVNode("", true)
          ]),
          _: 1
        ...
        selectedLibraryId.value ? (openBlock(), createElementBlock("div", _hoisted_37, [
          ...
          }, null, 8, ["seats", "floors", "sections", "tables", "selected-seat", "draggable", "seat-clickable", "layout-mode"])
          ...
          createBaseVNode("div", _hoisted_40, [
            createBaseVNode("div", _hoisted_41, [
              ...
              createBaseVNode("div", _hoisted_43, [
                selectedSeat.value.qr_code_url ? (openBlock(), createElementBlock("button", {
                  key: 0,
                  onClick: _cache[4] || (_cache[4] = ($event) => printQRCode(selectedSeat.value)),
                ...
                createBaseVNode("button", {
                  onClick: _cache[5] || (_cache[5] = ($event) => selectedSeat.value = null),
            ...
            createBaseVNode("div", _hoisted_44, [
              createBaseVNode("div", _hoisted_45, [
                createBaseVNode("div", null, [
                  _cache[34] || (_cache[34] = createBaseVNode("label", { class: "block text-sm font-medium text-gray-700 mb-1" }, "Status", -1)),
                  withDirectives(createBaseVNode("select", {
                    "onUpdate:modelValue": _cache[6] || (_cache[6] = ($event) => selectedSeat.value.status = $event),
              ...
              createBaseVNode("div", _hoisted_46, [
                createBaseVNode("div", null, [
                  _cache[35] || (_cache[35] = createBaseVNode("label", { class: "block text-sm font-medium text-gray-700 mb-1" }, "Floor", -1)),
                  withDirectives(createBaseVNode("select", {
                ...
                createBaseVNode("div", null, [
                  _cache[37] || (_cache[37] = createBaseVNode("label", { class: "block text-sm font-medium text-gray-700 mb-1" }, "Section", -1)),
                  withDirectives(createBaseVNode("select", {
                    "onUpdate:modelValue": _cache[8] || (_cache[8] = ($event) => selectedSeat.value.section_id = $event),
                    class: "w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500"
                  }, [
                    _cache[36] || (_cache[36] = createBaseVNode("option", { value: null }, "No Section", -1)),
                    (openBlock(true), createElementBlock(Fragment, null, renderList(sections.value, (section) => {
                      return openBlock(), createElementBlock("option", {
                        key: section.id,
                        value: section.id
              ...
              createBaseVNode("div", _hoisted_49, [
                createBaseVNode("label", _hoisted_50, [
                  ...
                  _cache[38] || (_cache[38] = createBaseVNode("span", { class: "text-sm font-medium text-gray-700" }, "Has Computer", -1))
                ]),
                createBaseVNode("label", _hoisted_51, [
                  ...
                  _cache[39] || (_cache[39] = createBaseVNode("span", { class: "text-sm font-medium text-gray-700" }, "Near Window", -1))
                ]),
                createBaseVNode("div", _hoisted_52, [
                  _cache[40] || (_cache[40] = createBaseVNode("span", { class: "text-sm font-medium text-gray-700" }, "Socket Count:", -1)),
                  withDirectives(createBaseVNode("input", {
        ...
        showCreateModal.value ? (openBlock(), createElementBlock("div", _hoisted_55, [
          createBaseVNode("div", _hoisted_56, [
            createBaseVNode("div", _hoisted_57, [
              _cache[41] || (_cache[41] = createBaseVNode("h3", { class: "text-xl font-bold text-gray-900" }, "Add New Seat", -1)),
              createBaseVNode("button", {
            ...
            createBaseVNode("form", {
              ...
              createBaseVNode("div", null, [
                _cache[42] || (_cache[42] = createBaseVNode("label", { class: "block text-sm font-medium text-gray-700 mb-1" }, "Seat Number", -1)),
                withDirectives(createBaseVNode("input", {
              ...
              createBaseVNode("div", _hoisted_58, [
                createBaseVNode("div", null, [
                  _cache[43] || (_cache[43] = createBaseVNode("label", { class: "block text-sm font-medium text-gray-700 mb-1" }, "Floor", -1)),
                  withDirectives(createBaseVNode("select", {
                ...
                createBaseVNode("div", null, [
                  _cache[45] || (_cache[45] = createBaseVNode("label", { class: "block text-sm font-medium text-gray-700 mb-1" }, "Section", -1)),
                  withDirectives(createBaseVNode("select", {
                    "onUpdate:modelValue": _cache[16] || (_cache[16] = ($event) => form.value.section_id = $event),
                    class: "w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500"
                  }, [
                    _cache[44] || (_cache[44] = createBaseVNode("option", { value: null }, "No Section", -1)),
                    (openBlock(true), createElementBlock(Fragment, null, renderList(sections.value, (section) => {
                      return openBlock(), createElementBlock("option", {
                        key: section.id,
                        value: section.id
              ...
              createBaseVNode("div", null, [
                _cache[47] || (_cache[47] = createBaseVNode("label", { class: "block text-sm font-medium text-gray-700 mb-1" }, "Status", -1)),
                withDirectives(createBaseVNode("select", {
                  "onUpdate:modelValue": _cache[17] || (_cache[17] = ($event) => form.value.status = $event),
                  class: "w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500"
                }, [..._cache[46] || (_cache[46] = [
                  createBaseVNode("option", { value: "available" }, "Available", -1),
                  createBaseVNode("option", { value: "maintenance" }, "Maintenance", -1),
              ...
              createBaseVNode("div", _hoisted_61, [
                createBaseVNode("label", _hoisted_62, [
                  withDirectives(createBaseVNode("input", {
                    "onUpdate:modelValue": _cache[18] || (_cache[18] = ($event) => form.value.has_computer = $event),
                    type: "checkbox",
                    class: "w-4 h-4 text-indigo-600 rounded"
                  }, null, 512), [
                    [vModelCheckbox, form.value.has_computer]
                  ]),
                  _cache[48] || (_cache[48] = createBaseVNode("span", { class: "text-sm font-medium text-gray-700" }, "Has Computer", -1))
                ]),
                createBaseVNode("label", _hoisted_63, [
                  withDirectives(createBaseVNode("input", {
                    "onUpdate:modelValue": _cache[19] || (_cache[19] = ($event) => form.value.near_window = $event),
                    type: "checkbox",
                    class: "w-4 h-4 text-indigo-600 rounded"
                  }, null, 512), [
                    [vModelCheckbox, form.value.near_window]
                  ]),
                  _cache[49] || (_cache[49] = createBaseVNode("span", { class: "text-sm font-medium text-gray-700" }, "Near Window", -1))
                ]),
                createBaseVNode("div", _hoisted_64, [
                  _cache[50] || (_cache[50] = createBaseVNode("span", { class: "text-sm font-medium text-gray-700" }, "Socket Count:", -1)),
                  withDirectives(createBaseVNode("input", {
                    "onUpdate:modelValue": _cache[20] || (_cache[20] = ($event) => form.value.socket_count = $event),
                    type: "number",
                    min: "0",
                    class: "w-20 px-2 py-1 border border-gray-300 rounded-lg"
                  }, null, 512), [
              ...
              createBaseVNode("div", _hoisted_65, [
                createBaseVNode("button", {
                  ...
                  disabled: loading.value,
                  class: "flex-1 px-4 py-2 bg-indigo-600 text-white rounded-lg hover:bg-indigo-700 transition-colors disabled:opacity-50"
                }, toDisplayString(loading.value ? "Creating..." : "Create Seat"), 9, _hoisted_66),
                createBaseVNode("button", {
                  type: "button",
                  onClick: _cache[21] || (_cache[21] = ($event) => showCreateModal.value = false),
