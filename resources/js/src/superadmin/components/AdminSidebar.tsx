...
const AdminSidebar: React.FC<AdminSidebarProps> = ({ isOpen, onClose }) => {
  ...
  const adminNavItems = [
    { path: '/superadmin', label: 'Dashboard', icon: Home, exact: true },
    { path: '/superadmin/users', label: 'User Management', icon: Users },
    { path: '/superadmin/libraries', label: 'Library Management', icon: MapPin },
    { path: '/superadmin/books', label: 'Book Management', icon: BookOpen },
    { path: '/superadmin/bookings', label: 'Booking Management', icon: Calendar },
    { path: '/superadmin/analytics', label: 'Analytics & Reports', icon: BarChart3 },
  ];

  const superAdminNavItems = [
    { path: '/superadmin', label: 'Super Dashboard', icon: Crown, exact: true },
    { path: '/superadmin/users', label: 'User Management', icon: Users },
    { path: '/superadmin/libraries', label: 'Library Network', icon: Database },
    { path: '/superadmin/books', label: 'Content Management', icon: BookOpen },
    { path: '/superadmin/subscription-plans', label: 'Subscription Plans', icon: CreditCard },
    { path: '/superadmin/bookings', label: 'All Bookings', icon: Calendar },
