...
const AdminSidebar: React.FC<AdminSidebarProps> = ({ isOpen, onClose }) => {
  ...
  const adminNavItems = [
    { path: '/librarian', label: 'Dashboard', icon: Home, exact: true },
    { path: '/librarian/books', label: 'Book Management', icon: BookOpen },
    { path: '/librarian/seats', label: 'Seat Management', icon: MapPin },
    { path: '/librarian/events', label: 'Event Management', icon: Calendar },
    { path: '/librarian/bookings', label: 'Booking Management', icon: Calendar },
    { path: '/librarian/analytics', label: 'Analytics & Reports', icon: BarChart3 },
  ];

  const superAdminNavItems = [
    { path: '/librarian', label: 'Super Dashboard', icon: Home, exact: true },
    { path: '/librarian/system', label: 'System Overview', icon: Database },
    { path: '/librarian/users', label: 'User Management', icon: Users },
    { path: '/librarian/admins', label: 'Admin Management', icon: UserCheck },
    { path: '/librarian/libraries', label: 'Library Network', icon: MapPin },
    { path: '/librarian/books', label: 'Content Management', icon: BookOpen },
    { path: '/librarian/subscriptions', label: 'Subscriptions', icon: CreditCard },
    { path: '/librarian/analytics', label: 'Global Analytics', icon: BarChart3 },
    { path: '/librarian/reports', label: 'System Reports', icon: FileText },
    { path: '/librarian/integrations', label: 'Integrations', icon: Zap },
    { path: '/librarian/settings', label: 'System Settings', icon: Settings },
  ];
